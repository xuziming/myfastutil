 ...
 * @see HashCommon
 */
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap
	...
	public Byte2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final Map<? extends Byte, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final Map<? extends Byte, ? extends Double> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final Byte2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2DoubleOpenCustomHashMap(final Byte2DoubleMap m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2DoubleOpenCustomHashMap(final byte[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Byte2DoubleOpenCustomHashMap(final byte[] k, final double[] v,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	...
	public boolean containsValue(final double v) {
		...
		if (containsNullKey && (Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v)))
			return true;
		for (int i = n; i-- != 0;)
			if (!((key[i]) == ((byte) 0)) && (Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)))
				return true;
		return false;
	}
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsent(final byte k, final java.util.function.IntToDoubleFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final byte k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Double newValue = remappingFunction.apply(Byte.valueOf(k), Double.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((byte) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Double newValue = remappingFunction.apply(Byte.valueOf(k), pos >= 0 ? Double.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), ((byte) 0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final byte k, final double v,
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Byte2DoubleOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2DoubleOpenCustomHashMap.this.remove(wrapped.getByte(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((byte) 0))))
				return Byte2DoubleOpenCustomHashMap.this.containsNullKey
		...
		public void forEach(final Consumer<? super Byte2DoubleMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractByte2DoubleMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((byte) 0)))
					consumer.accept(new AbstractByte2DoubleMap.BasicEntry(key[pos], value[pos]));
		}
