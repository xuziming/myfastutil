...
public final class Byte2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator(Byte2CharSortedMap map) {
		...
		return entries instanceof Byte2CharSortedMap.FastSortedEntrySet
				? ((Byte2CharSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Byte2CharMaps.EmptyMap
			implements Byte2CharSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Byte2CharMaps.Singleton
			implements Byte2CharSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2CharMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Byte2CharMaps.SynchronizedMap
			implements Byte2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2CharEntrySet(), sync);
			return (ObjectSortedSet<Byte2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2CharMaps.UnmodifiableMap
			implements Byte2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2CharSortedMap sortedMap;
		...
		public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2CharEntrySet());
			return (ObjectSortedSet<Byte2CharMap.Entry>) entries;
		}
