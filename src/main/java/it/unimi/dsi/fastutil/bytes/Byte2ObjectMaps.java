...
public final class Byte2ObjectMaps {
	...
	public static <V> ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator(Byte2ObjectMap<V> map) {
		...
		return entries instanceof Byte2ObjectMap.FastEntrySet
				? ((Byte2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Byte2ObjectMap<V> map,
			final Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Byte2ObjectMap.Entry<V>> entries = map.byte2ObjectEntrySet();
		if (entries instanceof Byte2ObjectMap.FastEntrySet)
			((Byte2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Byte2ObjectMap.Entry<V>> fastIterable(Byte2ObjectMap<V> map) {
		...
		return entries instanceof Byte2ObjectMap.FastEntrySet ? new ObjectIterable<Byte2ObjectMap.Entry<V>>() {
			public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() {
				return ((Byte2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Byte2ObjectFunctions.EmptyFunction<V>
			implements Byte2ObjectMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Byte2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Byte2ObjectMap<V> singleton(final byte key, V value) {
	...
	public static class SynchronizedMap<V> extends Byte2ObjectFunctions.SynchronizedFunction<V>
			implements Byte2ObjectMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Byte2ObjectFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2ObjectEntrySet());
			return entries;
		}
