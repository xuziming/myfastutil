...
public final class Byte2ReferenceFunctions {
	 ...
	 */
	public static <V> Byte2ReferenceFunction<V> synchronize(final Byte2ReferenceFunction<V> f) {
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Byte2ReferenceFunction<V> synchronize(final Byte2ReferenceFunction<V> f, final Object sync) {
	...
	public static class UnmodifiableFunction<V> extends AbstractByte2ReferenceFunction<V>
		...
		protected UnmodifiableFunction(final Byte2ReferenceFunction<V> f) {
			if (f == null)
				throw new NullPointerException();
			this.function = f;
		}
	 ...
	 */
	public static <V> Byte2ReferenceFunction<V> unmodifiable(final Byte2ReferenceFunction<V> f) {
	...
	public static <V> Byte2ReferenceFunction<V> primitive(
			final java.util.function.Function<? super Byte, ? extends V> f) {
