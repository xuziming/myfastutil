...
public final class Byte2FloatMaps {
	...
	public static ObjectIterator<Byte2FloatMap.Entry> fastIterator(Byte2FloatMap map) {
		...
		return entries instanceof Byte2FloatMap.FastEntrySet ? ((Byte2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Byte2FloatFunctions.EmptyFunction
			implements Byte2FloatMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Byte2FloatFunctions.Singleton
			implements Byte2FloatMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2FloatFunctions.SynchronizedFunction
			implements Byte2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Byte, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final byte key,
		...
		@Override
		public float computeIfPresent(final byte key,
		...
		@Override
		public float compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final byte key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Byte2FloatFunctions.UnmodifiableFunction
			implements Byte2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2FloatMap map;
		protected transient ObjectSet<Byte2FloatMap.Entry> entries;
		...
		public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2FloatEntrySet());
			return entries;
		}
