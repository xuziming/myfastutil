 ...
 */
public abstract class AbstractByte2ShortMap extends AbstractByte2ShortFunction
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					private final ObjectIterator<Byte2ShortMap.Entry> i = Byte2ShortMaps
							.fastIterator(AbstractByte2ShortMap.this);
