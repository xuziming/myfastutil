 ...
 * iterator}.
 */
public class Byte2FloatAVLTreeMap extends AbstractByte2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Byte2FloatAVLTreeMap(final Comparator<? super Byte> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Byte2FloatAVLTreeMap(final Map<? extends Byte, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Byte2FloatAVLTreeMap(final SortedMap<Byte, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Byte2FloatAVLTreeMap(final Byte2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Byte2FloatAVLTreeMap(final Byte2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2FloatAVLTreeMap(final byte[] k, final float v[], final Comparator<? super Byte> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Byte2FloatAVLTreeMap(final byte[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Byte2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>() {
				final Comparator<? super Byte2FloatMap.Entry> comparator = (Comparator<Byte2FloatMap.Entry>) (x,
						y) -> Byte2FloatAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
				...
				public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry from, Byte2FloatMap.Entry to) {
					return subMap(from.getByteKey(), to.getByteKey()).byte2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry to) {
					return headMap(to.getByteKey()).byte2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry from) {
					return tailMap(from.getByteKey()).byte2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractByte2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final byte k) {
			return (bottom || Byte2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Byte2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Byte2FloatAVLTreeMap.Entry f = findKey(((Byte) (e.getKey())).byteValue());
					...
					@Override
					public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry from,
							Byte2FloatMap.Entry to) {
						return subMap(from.getByteKey(), to.getByteKey()).byte2FloatEntrySet();
					}
		...
		public boolean containsKey(final byte k) {
			return in(k) && Byte2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		public float get(final byte k) {
			final Byte2FloatAVLTreeMap.Entry e;
			final byte kk = k;
		...
		public float put(final byte k, final float v) {
			...
			final float oldValue = Byte2FloatAVLTreeMap.this.put(k, v);
		...
		public float remove(final byte k) {
			...
			final float oldValue = Byte2FloatAVLTreeMap.this.remove(k);
		...
		@Override
		public byte firstByteKey() {
			Byte2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public byte lastByteKey() {
			Byte2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Byte2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Byte2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
