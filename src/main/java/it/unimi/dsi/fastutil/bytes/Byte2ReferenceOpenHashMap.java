...
public class Byte2ReferenceOpenHashMap<V> extends AbstractByte2ReferenceMap<V>
	...
	final class MapEntry implements Byte2ReferenceMap.Entry<V>, Map.Entry<Byte, V> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).byteValue())) && ((value[index]) == ((e.getValue())));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2ReferenceOpenHashMap.this.remove(wrapped.getByte(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((byte) 0)))
				return Byte2ReferenceOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2ReferenceOpenHashMap.this.key;
			int pos;
			// The starting point.
