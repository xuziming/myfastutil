...
public final class Byte2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2LongMap.Entry> fastIterator(Byte2LongSortedMap map) {
		...
		return entries instanceof Byte2LongSortedMap.FastSortedEntrySet
	...
	public static class EmptySortedMap extends Byte2LongMaps.EmptyMap
			implements Byte2LongSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2LongMaps.Singleton
		...
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2LongMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Byte2LongMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Byte2LongMaps.SynchronizedMap
			implements Byte2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2LongEntrySet(), sync);
			return (ObjectSortedSet<Byte2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2LongMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2LongEntrySet());
			return (ObjectSortedSet<Byte2LongMap.Entry>) entries;
		}
