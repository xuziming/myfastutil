...
public final class Byte2ReferenceMaps {
	...
	public static <V> ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator(Byte2ReferenceMap<V> map) {
		...
		return entries instanceof Byte2ReferenceMap.FastEntrySet
				? ((Byte2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Byte2ReferenceMap<V> map,
			final Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Byte2ReferenceMap.Entry<V>> entries = map.byte2ReferenceEntrySet();
		if (entries instanceof Byte2ReferenceMap.FastEntrySet)
			((Byte2ReferenceMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Byte2ReferenceMap.Entry<V>> fastIterable(Byte2ReferenceMap<V> map) {
		...
		return entries instanceof Byte2ReferenceMap.FastEntrySet ? new ObjectIterable<Byte2ReferenceMap.Entry<V>>() {
			public ObjectIterator<Byte2ReferenceMap.Entry<V>> iterator() {
				return ((Byte2ReferenceMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Byte2ReferenceFunctions.EmptyFunction<V>
			implements Byte2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Byte2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<Byte, V>> entrySet() {
			return (ObjectSet) byte2ReferenceEntrySet();
		}
	...
	public static class SynchronizedMap<V> extends Byte2ReferenceFunctions.SynchronizedFunction<V>
			implements Byte2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2ReferenceEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Byte, ? super V> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Byte, ? super V, ? extends V> function) {
			synchronized (sync) {
		...
		@Override
		public V computeIfAbsent(final byte key, final java.util.function.IntFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V computeIfPresent(final byte key,
		...
		@Override
		public V compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V merge(final byte key, final V value,
		...
		@Deprecated
		@Override
		public V computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<V> extends Byte2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2ReferenceEntrySet());
			return entries;
		}
