...
public final class Byte2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2DoubleMap.Entry> fastIterator(Byte2DoubleSortedMap map) {
		...
		return entries instanceof Byte2DoubleSortedMap.FastSortedEntrySet
				? ((Byte2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Byte2DoubleMaps.EmptyMap
			implements Byte2DoubleSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Byte2DoubleMaps.Singleton
			implements Byte2DoubleSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Byte2DoubleMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Byte, Double>> entrySet() {
			return (ObjectSortedSet) byte2DoubleEntrySet();
		}
	...
	public static class SynchronizedSortedMap extends Byte2DoubleMaps.SynchronizedMap
			implements Byte2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Byte2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2DoubleMaps.UnmodifiableMap
			implements Byte2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2DoubleSortedMap sortedMap;
		...
		public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2DoubleEntrySet());
			return (ObjectSortedSet<Byte2DoubleMap.Entry>) entries;
		}
