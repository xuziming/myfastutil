 ...
 * @see HashCommon
 */
public class Byte2LongOpenCustomHashMap extends AbstractByte2LongMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Byte2LongOpenCustomHashMap(final int expected, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final Map<? extends Byte, ? extends Long> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final Map<? extends Byte, ? extends Long> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final Byte2LongMap m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2LongOpenCustomHashMap(final Byte2LongMap m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2LongOpenCustomHashMap(final byte[] k, final long[] v, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Byte2LongOpenCustomHashMap(final byte[] k, final long[] v,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	...
	private int find(final byte k) {
		...
		while (true) {
			if (((curr = key[pos = (pos + 1) & mask]) == ((byte) 0)))
				return -(pos + 1);
			if ((strategy.equals((k), (curr))))
				return pos;
		}
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsent(final byte k, final java.util.function.IntToLongFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsentNullable(final byte k,
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfPresent(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Long, ? extends Long> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Long newValue = remappingFunction.apply(Byte.valueOf(k), Long.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((byte) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public long compute(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Long, ? extends Long> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Long newValue = remappingFunction.apply(Byte.valueOf(k), pos >= 0 ? Long.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), ((byte) 0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public long merge(final byte k, final long v,
	...
	final class MapEntry implements Byte2LongMap.Entry, Map.Entry<Byte, Long> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey()).byteValue())))
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final byte key[] = Byte2LongOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2LongOpenCustomHashMap.this.remove(wrapped.getByte(-pos - 1));
	...
	private class EntryIterator extends MapIterator implements ObjectIterator<Byte2LongMap.Entry> {
	...
	private class FastEntryIterator extends MapIterator implements ObjectIterator<Byte2LongMap.Entry> {
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((byte) 0))))
				return Byte2LongOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2LongOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2LongMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractByte2LongMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((byte) 0)))
					consumer.accept(new AbstractByte2LongMap.BasicEntry(key[pos], value[pos]));
		}
