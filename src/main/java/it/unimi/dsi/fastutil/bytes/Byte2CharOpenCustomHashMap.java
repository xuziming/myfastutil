...
public class Byte2CharOpenCustomHashMap extends AbstractByte2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Byte2CharOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2CharOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2CharOpenCustomHashMap(final Map<? extends Byte, ? extends Character> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2CharOpenCustomHashMap(final Map<? extends Byte, ? extends Character> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2CharOpenCustomHashMap(final Byte2CharMap m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2CharOpenCustomHashMap(final Byte2CharMap m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2CharOpenCustomHashMap(final byte[] k, final char[] v, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Byte2CharOpenCustomHashMap(final byte[] k, final char[] v,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final byte k,
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final byte k,
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Character newValue = remappingFunction.apply(Byte.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final byte k, final char v,
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((byte) 0))))
				return Byte2CharOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2CharOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2CharMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractByte2CharMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((byte) 0)))
					consumer.accept(new AbstractByte2CharMap.BasicEntry(key[pos], value[pos]));
		}
