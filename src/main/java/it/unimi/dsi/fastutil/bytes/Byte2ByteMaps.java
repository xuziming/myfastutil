...
public final class Byte2ByteMaps {
	...
	public static ObjectIterator<Byte2ByteMap.Entry> fastIterator(Byte2ByteMap map) {
		...
		return entries instanceof Byte2ByteMap.FastEntrySet ? ((Byte2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Byte2ByteMap map, final Consumer<? super Byte2ByteMap.Entry> consumer) {
		final ObjectSet<Byte2ByteMap.Entry> entries = map.byte2ByteEntrySet();
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Byte2ByteFunctions.EmptyFunction
			implements Byte2ByteMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Byte2ByteFunctions.Singleton
			implements Byte2ByteMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2ByteFunctions.SynchronizedFunction
			implements Byte2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Byte, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final byte key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final byte key,
		...
		@Override
		public byte computeIfPresent(final byte key,
		...
		@Override
		public byte compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final byte key, final byte value,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Byte2ByteFunctions.UnmodifiableFunction
			implements Byte2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2ByteMap map;
		protected transient ObjectSet<Byte2ByteMap.Entry> entries;
		...
		public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2ByteEntrySet());
			return entries;
		}
