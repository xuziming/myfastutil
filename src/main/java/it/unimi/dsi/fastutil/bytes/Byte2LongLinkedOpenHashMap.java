 ...
 * @see HashCommon
 */
public class Byte2LongLinkedOpenHashMap extends AbstractByte2LongSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Byte2LongMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry fromElement,
				Byte2LongMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((byte) 0)))
				return Byte2LongLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2LongLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2LongMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractByte2LongMap.BasicEntry(key[curr], value[curr]));
			}
		}
