...
public final class Byte2ObjectSortedMaps {
	...
	public static Comparator<? super Map.Entry<Byte, ?>> entryComparator(final ByteComparator comparator) {
		return (Comparator<Map.Entry<Byte, ?>>) (x, y) -> comparator.compare((x.getKey()).byteValue(),
				(y.getKey()).byteValue());
	}
	...
	public static <V> ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> fastIterator(Byte2ObjectSortedMap<V> map) {
		...
		return entries instanceof Byte2ObjectSortedMap.FastSortedEntrySet
				? ((Byte2ObjectSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<V> extends Byte2ObjectMaps.EmptyMap<V>
			implements Byte2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<V> extends Byte2ObjectMaps.Singleton<V>
			implements Byte2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2ObjectMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Byte2ObjectMap.Entry<V>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Byte2ObjectSortedMap<V> singleton(final Byte key, V value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Byte2ObjectSortedMap<V> singleton(final Byte key, V value, ByteComparator comparator) {
	...
	public static class SynchronizedSortedMap<V> extends Byte2ObjectMaps.SynchronizedMap<V>
			implements Byte2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Byte2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Byte2ObjectMaps.UnmodifiableMap<V>
			implements Byte2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2ObjectSortedMap<V> sortedMap;
		...
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2ObjectEntrySet());
			return (ObjectSortedSet<Byte2ObjectMap.Entry<V>>) entries;
		}
