...
public final class Byte2LongMaps {
	...
	public static ObjectIterator<Byte2LongMap.Entry> fastIterator(Byte2LongMap map) {
		...
		return entries instanceof Byte2LongMap.FastEntrySet ? ((Byte2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Byte2LongFunctions.EmptyFunction
			implements Byte2LongMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2LongFunctions.Singleton
		...
		public ObjectSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2LongFunctions.SynchronizedFunction
			implements Byte2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Byte, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final byte key,
		...
		@Override
		public long computeIfPresent(final byte key,
		...
		@Override
		public long compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final byte key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Byte2LongFunctions.UnmodifiableFunction
		...
		public ObjectSet<Byte2LongMap.Entry> byte2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2LongEntrySet());
			return entries;
		}
