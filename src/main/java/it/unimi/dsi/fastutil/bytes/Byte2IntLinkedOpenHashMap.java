 ...
 * @see HashCommon
 */
public class Byte2IntLinkedOpenHashMap extends AbstractByte2IntSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Byte2IntMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((byte) 0)))
				return Byte2IntLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2IntLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2IntMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractByte2IntMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet byte2IntEntrySet() {
		if (entries == null)
