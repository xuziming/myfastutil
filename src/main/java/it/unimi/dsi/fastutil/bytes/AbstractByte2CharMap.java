...
public abstract class AbstractByte2CharMap extends AbstractByte2CharFunction
	...
	public boolean containsKey(final byte k) {
		final ObjectIterator<Byte2CharMap.Entry> i = byte2CharEntrySet().iterator();
		while (i.hasNext())
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					private final ObjectIterator<Byte2CharMap.Entry> i = Byte2CharMaps
							.fastIterator(AbstractByte2CharMap.this);
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Byte2CharMap.Entry> i = Byte2CharMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
