...
public class Byte2BooleanOpenCustomHashMap extends AbstractByte2BooleanMap
	...
	public Byte2BooleanOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final Map<? extends Byte, ? extends Boolean> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final Map<? extends Byte, ? extends Boolean> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final Byte2BooleanMap m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2BooleanOpenCustomHashMap(final Byte2BooleanMap m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2BooleanOpenCustomHashMap(final byte[] k, final boolean[] v, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Byte2BooleanOpenCustomHashMap(final byte[] k, final boolean[] v,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsent(final byte k, final java.util.function.IntPredicate mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsentNullable(final byte k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfPresent(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Boolean newValue = remappingFunction.apply(Byte.valueOf(k), Boolean.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((byte) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public boolean compute(final byte k,
			final java.util.function.BiFunction<? super Byte, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Boolean newValue = remappingFunction.apply(Byte.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public boolean merge(final byte k, final boolean v,
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2BooleanOpenCustomHashMap.this.remove(wrapped.getByte(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((byte) 0))))
				return Byte2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2BooleanMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractByte2BooleanMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((byte) 0)))
					consumer.accept(new AbstractByte2BooleanMap.BasicEntry(key[pos], value[pos]));
		}
