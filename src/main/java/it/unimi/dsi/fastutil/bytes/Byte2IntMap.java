...
public interface Byte2IntMap extends Byte2IntFunction, Map<Byte, Integer> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Byte2IntMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Byte2IntMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsent(final byte key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsentNullable(final byte key,
	 ...
	 * @since 8.0.0
	 */
	default int computeIfPresent(final byte key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Integer newValue = remappingFunction.apply(Byte.valueOf(key), Integer.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default int compute(final byte key,
			final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Integer newValue = remappingFunction.apply(Byte.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default int merge(final byte key, final int value,
	...
	@Deprecated
	@Override
	default Integer computeIfAbsent(final Byte key,
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Byte key,
			final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Byte key,
			final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Byte key, final Integer value,
			final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Byte, Integer> {
		/**
