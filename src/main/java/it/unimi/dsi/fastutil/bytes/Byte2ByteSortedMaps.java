...
public final class Byte2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2ByteMap.Entry> fastIterator(Byte2ByteSortedMap map) {
		...
		return entries instanceof Byte2ByteSortedMap.FastSortedEntrySet
				? ((Byte2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Byte2ByteMaps.EmptyMap
			implements Byte2ByteSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2ByteMaps.Singleton
		...
		public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Byte2ByteMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Byte, Byte>> entrySet() {
			return (ObjectSortedSet) byte2ByteEntrySet();
		}
	...
	public static class SynchronizedSortedMap extends Byte2ByteMaps.SynchronizedMap
			implements Byte2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2ByteEntrySet(), sync);
			return (ObjectSortedSet<Byte2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2ByteMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2ByteEntrySet());
			return (ObjectSortedSet<Byte2ByteMap.Entry>) entries;
		}
