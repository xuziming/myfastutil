...
public interface Byte2ByteMap extends Byte2ByteFunction, Map<Byte, Byte> {
	 ...
	 * @since 8.0.0
	 */
	default byte computeIfAbsentNullable(final byte key,
	 ...
	 * @since 8.0.0
	 */
	default byte computeIfPresent(final byte key,
	 ...
	 * @since 8.0.0
	 */
	default byte compute(final byte key,
			final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final byte oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default byte merge(final byte key, final byte value,
			final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final byte oldValue = get(key), drv = defaultReturnValue();
		final byte newValue;
	...
	@Deprecated
	@Override
	default Byte computeIfAbsent(final Byte key,
