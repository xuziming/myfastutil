...
public final class Byte2ShortMaps {
	...
	public static ObjectIterator<Byte2ShortMap.Entry> fastIterator(Byte2ShortMap map) {
		...
		return entries instanceof Byte2ShortMap.FastEntrySet ? ((Byte2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Byte2ShortFunctions.EmptyFunction
			implements Byte2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2ShortFunctions.Singleton
		...
		public ObjectSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2ShortMap.BasicEntry(key, value));
			return entries;
		}
		...
		public ShortCollection values() {
			if (values == null)
				values = ShortSets.singleton(value);
			return values;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Byte2ShortMap singleton(final byte key, short value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Byte2ShortMap singleton(final Byte key, final Short value) {
	...
	public static class SynchronizedMap extends Byte2ShortFunctions.SynchronizedFunction
			implements Byte2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public ShortCollection values() {
			synchronized (sync) {
				if (values == null)
					return ShortCollections.synchronize(map.values(), sync);
				return values;
			}
		}
		...
		// Defaultable methods
		@Override
		public short getOrDefault(final byte key, final short defaultValue) {
			synchronized (sync) {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Byte, ? super Short> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Byte, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public boolean remove(final byte key, final short value) {
			synchronized (sync) {
		...
		@Override
		public short replace(final byte key, final short value) {
			synchronized (sync) {
		...
		@Override
		public boolean replace(final byte key, final short oldValue, final short newValue) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsent(final byte key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final byte key,
		...
		@Override
		public short computeIfAbsentPartial(final byte key, final Byte2ShortFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short computeIfPresent(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final byte key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends Short> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	 ...
	 */
	public static Byte2ShortMap synchronize(final Byte2ShortMap m) {
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static Byte2ShortMap synchronize(final Byte2ShortMap m, final Object sync) {
	...
	public static class UnmodifiableMap extends Byte2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2ShortEntrySet());
			return entries;
		}
		...
		public ShortCollection values() {
			if (values == null)
				return ShortCollections.unmodifiable(map.values());
			return values;
		}
	 ...
	 */
	public static Byte2ShortMap unmodifiable(final Byte2ShortMap m) {
