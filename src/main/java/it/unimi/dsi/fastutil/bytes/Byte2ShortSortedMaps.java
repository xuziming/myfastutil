...
public final class Byte2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2ShortMap.Entry> fastIterator(Byte2ShortSortedMap map) {
		...
		return entries instanceof Byte2ShortSortedMap.FastSortedEntrySet
				? ((Byte2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Byte2ShortMaps.EmptyMap
			implements Byte2ShortSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Byte2ShortMaps.Singleton
			implements Byte2ShortSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2ShortMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Byte2ShortMaps.SynchronizedMap
			implements Byte2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2ShortEntrySet(), sync);
			return (ObjectSortedSet<Byte2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2ShortMaps.UnmodifiableMap
			implements Byte2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Byte2ShortSortedMap sortedMap;
		...
		public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2ShortEntrySet());
			return (ObjectSortedSet<Byte2ShortMap.Entry>) entries;
		}
