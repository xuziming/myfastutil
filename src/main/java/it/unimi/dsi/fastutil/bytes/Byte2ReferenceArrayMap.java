 ...
 */
public class Byte2ReferenceArrayMap<V> extends AbstractByte2ReferenceMap<V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		@Override
		public ObjectIterator<Byte2ReferenceMap.Entry<V>> iterator() {
			return new ObjectIterator<Byte2ReferenceMap.Entry<V>>() {
				...
				public Entry<V> next() {
					...
					return new AbstractByte2ReferenceMap.BasicEntry<>(key[curr = next], (V) value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Byte2ReferenceArrayMap.this.containsKey(k)
					&& ((Byte2ReferenceArrayMap.this.get(k)) == ((e.getValue())));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Byte2ReferenceArrayMap.this.key, oldPos + 1, Byte2ReferenceArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Byte2ReferenceArrayMap.this.value, oldPos + 1, Byte2ReferenceArrayMap.this.value, oldPos,
					tail);
			Byte2ReferenceArrayMap.this.size--;
			Byte2ReferenceArrayMap.this.value[size] = null;
			return true;
		}
	}
