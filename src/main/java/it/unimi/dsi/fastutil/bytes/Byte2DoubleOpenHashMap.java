 ...
 * @see HashCommon
 */
public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2DoubleOpenHashMap.this.remove(wrapped.getByte(-pos - 1));
