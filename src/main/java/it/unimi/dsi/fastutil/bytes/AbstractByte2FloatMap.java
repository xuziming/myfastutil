 ...
 */
public abstract class AbstractByte2FloatMap extends AbstractByte2FloatFunction
		...
		return new AbstractByteSet() {
			...
			public ByteIterator iterator() {
				return new ByteIterator() {
					private final ObjectIterator<Byte2FloatMap.Entry> i = Byte2FloatMaps
							.fastIterator(AbstractByte2FloatMap.this);
