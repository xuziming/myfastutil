 ...
 * @see HashCommon
 */
public class Byte2ObjectLinkedOpenHashMap<V> extends AbstractByte2ObjectSortedMap<V>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>
		...
		@Override
		public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> fromElement,
				Byte2ObjectMap.Entry<V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((byte) 0)))
				return Byte2ObjectLinkedOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			byte curr;
			final byte[] key = Byte2ObjectLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
