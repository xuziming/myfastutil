...
public final class Byte2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Byte2FloatMap.Entry> fastIterator(Byte2FloatSortedMap map) {
		...
		return entries instanceof Byte2FloatSortedMap.FastSortedEntrySet
				? ((Byte2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Byte2FloatMaps.EmptyMap
			implements Byte2FloatSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2FloatMaps.Singleton
		...
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractByte2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Byte2FloatMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Byte2FloatMaps.SynchronizedMap
			implements Byte2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.byte2FloatEntrySet(), sync);
			return (ObjectSortedSet<Byte2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Byte2FloatMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.byte2FloatEntrySet());
			return (ObjectSortedSet<Byte2FloatMap.Entry>) entries;
		}
