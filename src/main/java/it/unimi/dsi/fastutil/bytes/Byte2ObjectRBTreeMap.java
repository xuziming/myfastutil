 ...
 *
 */
public class Byte2ObjectRBTreeMap<V> extends AbstractByte2ObjectSortedMap<V>
	 ...
	 */
	public Byte2ObjectRBTreeMap(final Comparator<? super Byte> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Byte2ObjectRBTreeMap(final Map<? extends Byte, ? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Byte2ObjectRBTreeMap(final SortedMap<Byte, V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Byte2ObjectRBTreeMap(final Byte2ObjectMap<? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Byte2ObjectRBTreeMap(final Byte2ObjectSortedMap<V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2ObjectRBTreeMap(final byte[] k, final V v[], final Comparator<? super Byte> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Byte2ObjectRBTreeMap(final byte[] k, final V v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry<V> extends AbstractByte2ObjectMap.BasicEntry<V> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).byteValue())) && java.util.Objects.equals(value, (e.getValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Byte2ObjectRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
				final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = (Comparator<Byte2ObjectMap.Entry<V>>) (x,
						y) -> Byte2ObjectRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
				...
				@Override
				public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(
						final Byte2ObjectMap.Entry<V> from) {
				...
				@Override
				public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from,
						Byte2ObjectMap.Entry<V> to) {
					return subMap(from.getByteKey(), to.getByteKey()).byte2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) {
					return headMap(to.getByteKey()).byte2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) {
					return tailMap(from.getByteKey()).byte2ObjectEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractByte2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final byte k) {
			return (bottom || Byte2ObjectRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Byte2ObjectRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Byte))
							return false;
						final Byte2ObjectRBTreeMap.Entry<V> f = findKey(((Byte) (e.getKey())).byteValue());
		...
		public boolean containsKey(final byte k) {
			return in(k) && Byte2ObjectRBTreeMap.this.containsKey(k);
		}
		...
		public V get(final byte k) {
			final Byte2ObjectRBTreeMap.Entry<V> e;
			final byte kk = k;
		...
		public V put(final byte k, final V v) {
			...
			final V oldValue = Byte2ObjectRBTreeMap.this.put(k, v);
		...
		public V remove(final byte k) {
			...
			final V oldValue = Byte2ObjectRBTreeMap.this.remove(k);
		...
		@Override
		public byte firstByteKey() {
			Byte2ObjectRBTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public byte lastByteKey() {
			Byte2ObjectRBTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Byte2ObjectRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Byte2ObjectRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
