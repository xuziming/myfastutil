...
public final class Byte2IntMaps {
	...
	public static ObjectIterator<Byte2IntMap.Entry> fastIterator(Byte2IntMap map) {
		...
		return entries instanceof Byte2IntMap.FastEntrySet ? ((Byte2IntMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Byte2IntFunctions.EmptyFunction
			implements Byte2IntMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Byte2IntFunctions.Singleton
		...
		public ObjectSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractByte2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Byte2IntFunctions.SynchronizedFunction
			implements Byte2IntMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.byte2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final byte key,
		...
		@Override
		public int computeIfPresent(final byte key,
		...
		@Override
		public int compute(final byte key,
				final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int merge(final byte key, final int value,
		...
		@Deprecated
		@Override
		public Integer computeIfAbsent(final Byte key,
				final java.util.function.Function<? super Byte, ? extends Integer> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Byte key,
				final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer compute(final Byte key,
				final java.util.function.BiFunction<? super Byte, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer merge(final Byte key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Byte2IntFunctions.UnmodifiableFunction
		...
		public ObjectSet<Byte2IntMap.Entry> byte2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.byte2IntEntrySet());
			return entries;
		}
