 ...
 * @see HashCommon
 */
public class Byte2DoubleLinkedOpenHashMap extends AbstractByte2DoubleSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Byte2DoubleMap.Entry>
		...
		@Override
		public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry fromElement,
				Byte2DoubleMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public void forEach(final Consumer<? super Byte2DoubleMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractByte2DoubleMap.BasicEntry(key[curr], value[curr]));
			}
		}
