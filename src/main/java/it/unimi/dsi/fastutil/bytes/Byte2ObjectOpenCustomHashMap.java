...
public class Byte2ObjectOpenCustomHashMap<V> extends AbstractByte2ObjectMap<V>
	...
	public Byte2ObjectOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final Map<? extends Byte, ? extends V> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final Map<? extends Byte, ? extends V> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final Byte2ObjectMap<V> m, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Byte2ObjectOpenCustomHashMap(final Byte2ObjectMap<V> m,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Byte2ObjectOpenCustomHashMap(final byte[] k, final V[] v, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Byte2ObjectOpenCustomHashMap(final byte[] k, final V[] v,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	...
	public boolean containsValue(final Object v) {
		...
		if (containsNullKey && java.util.Objects.equals(value[n], v))
			return true;
		for (int i = n; i-- != 0;)
			if (!((key[i]) == ((byte) 0)) && java.util.Objects.equals(value[i], v))
				return true;
		return false;
	}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Byte2ObjectOpenCustomHashMap.this.remove(wrapped.getByte(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((byte) 0))))
				return Byte2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			byte curr;
			final byte[] key = Byte2ObjectOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractByte2ObjectMap.BasicEntry<V>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((byte) 0)))
					consumer.accept(new AbstractByte2ObjectMap.BasicEntry<V>(key[pos], value[pos]));
		}
