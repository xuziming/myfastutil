...
public interface Byte2CharMap extends Byte2CharFunction, Map<Byte, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Byte2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Byte2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final byte key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final byte key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final byte key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Byte.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final byte key,
			final java.util.function.BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Byte.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final byte key, final char value,
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Byte key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Byte key,
			final java.util.function.BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Byte key,
			final java.util.function.BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Byte key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Byte, Character> {
		/**
