 ...
 * @see HashCommon
 */
public class ByteLinkedOpenCustomHashSet extends AbstractByteSortedSet
	...
	public ByteLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final Collection<? extends Byte> c, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final Collection<? extends Byte> c,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final ByteCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final ByteCollection c,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final ByteIterator i, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final ByteIterator i,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final byte[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final byte[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final byte[] a, final float f,
			final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ByteLinkedOpenCustomHashSet(final byte[] a, final it.unimi.dsi.fastutil.bytes.ByteHash.Strategy strategy) {
	 ...
	 */
	public boolean addAndMoveToFirst(final byte k) {
		int pos;
		if ((strategy.equals((k), ((byte) 0)))) {
			if (containsNull) {
				moveIndexToFirst(n);
	 ...
	 * @return true if the key was not present.
	 */
	public boolean addAndMoveToLast(final byte k) {
		int pos;
		if ((strategy.equals((k), ((byte) 0)))) {
			if (containsNull) {
				moveIndexToLast(n);
	...
	private class SetIterator implements ByteListIterator {
		...
		SetIterator(byte from) {
			...
			// The starting point.
			final byte key[] = ByteLinkedOpenCustomHashSet.this.key;
		...
		public byte nextByte() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !((key[curr]) == ((byte) 0)) : "Position " + curr + " is not used";
			return key[curr];
		}
		...
		public void remove() {
			...
			if (pos == n) {
				...
				ByteLinkedOpenCustomHashSet.this.key[n] = ((byte) 0);
			} else {
				byte curr;
				final byte[] key = ByteLinkedOpenCustomHashSet.this.key;
	...
	protected void rehash(final int newN) {
		...
		first = -1;
		for (int j = size; j-- != 0;) {
			if ((strategy.equals((key[i]), ((byte) 0))))
				pos = newN;
			else {
