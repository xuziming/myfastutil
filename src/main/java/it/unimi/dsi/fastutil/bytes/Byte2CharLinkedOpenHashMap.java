...
public class Byte2CharLinkedOpenHashMap extends AbstractByte2CharSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Byte2CharMap.Entry> implements FastSortedEntrySet {
		...
		@Override
		public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry fromElement,
				Byte2CharMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((byte) 0)))
				return Byte2CharLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			byte curr;
			final byte[] key = Byte2CharLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
