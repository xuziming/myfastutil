...
public class IndirectPriorityQueues {
	...
	/**
	 * Returns a synchronized type-specific indirect priority queue backed by the
	 * specified type-specific indirect priority queue.
	 *
	 * @param q the indirect priority queue to be wrapped in a synchronized indirect
	 *          priority queue.
	...
	/**
	 * Returns a synchronized type-specific indirect priority queue backed by the
	 * specified type-specific indirect priority queue, using an assigned object to
	 * synchronize.
	 *
	 * @param q    the indirect priority queue to be wrapped in a synchronized
