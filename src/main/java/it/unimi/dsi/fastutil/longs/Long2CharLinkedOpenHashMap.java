...
public class Long2CharLinkedOpenHashMap extends AbstractLong2CharSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2CharMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry fromElement,
				Long2CharMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Long2CharLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2CharLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Long2CharMap.Entry> iterator(final Long2CharMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Long2CharMap.Entry> fastIterator(final Long2CharMap.Entry from) {
		...
		public void forEach(final Consumer<? super Long2CharMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractLong2CharMap.BasicEntry(key[curr], value[curr]));
			}
		}
