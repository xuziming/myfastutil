...
public class Long2DoubleOpenCustomHashMap extends AbstractLong2DoubleMap
	...
	public Long2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final Map<? extends Long, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final Map<? extends Long, ? extends Double> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final Long2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Long2DoubleOpenCustomHashMap(final Long2DoubleMap m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2DoubleOpenCustomHashMap(final long[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Long2DoubleOpenCustomHashMap(final long[] k, final double[] v,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsent(final long k, final java.util.function.LongToDoubleFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final long k,
			final java.util.function.LongFunction<? extends Double> mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final int pos = find(k);
		if (pos >= 0)
			return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final long k,
			final java.util.function.BiFunction<? super Long, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Double newValue = remappingFunction.apply(Long.valueOf(k), Double.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), (0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final long k,
			final java.util.function.BiFunction<? super Long, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Double newValue = remappingFunction.apply(Long.valueOf(k), pos >= 0 ? Double.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), (0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final long k, final double v,
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final long key[] = Long2DoubleOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Long2DoubleOpenCustomHashMap.this.remove(wrapped.getLong(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements FastEntrySet {
		@Override
