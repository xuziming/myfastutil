 ...
 * @see HashCommon
 */
public class Long2ShortLinkedOpenHashMap extends AbstractLong2ShortSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2ShortMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry fromElement,
				Long2ShortMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Long2ShortLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2ShortLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Long2ShortMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractLong2ShortMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet long2ShortEntrySet() {
		if (entries == null)
