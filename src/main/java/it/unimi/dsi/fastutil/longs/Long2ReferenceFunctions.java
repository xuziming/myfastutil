...
public final class Long2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<V> extends AbstractLong2ReferenceFunction<V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<V> extends AbstractLong2ReferenceFunction<V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Long2ReferenceFunction<V> singleton(final long key, V value) {
	...
	public static class SynchronizedFunction<V> implements Long2ReferenceFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<V> extends AbstractLong2ReferenceFunction<V>
	...
	public static class PrimitiveFunction<V> implements Long2ReferenceFunction<V> {
		...
		public V get(long key) {
			V v = function.apply(Long.valueOf(key));
			if (v == null)
				return null;
			return (v);
		}
	...
	public static <V> Long2ReferenceFunction<V> primitive(
			final java.util.function.Function<? super Long, ? extends V> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Long2ReferenceFunction)
			return (Long2ReferenceFunction<V>) f;
		if (f instanceof java.util.function.LongFunction)
			return ((java.util.function.LongFunction<V>) f)::apply;
