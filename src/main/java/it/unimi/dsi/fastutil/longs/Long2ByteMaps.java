...
public final class Long2ByteMaps {
	...
	public static ObjectIterator<Long2ByteMap.Entry> fastIterator(Long2ByteMap map) {
		...
		return entries instanceof Long2ByteMap.FastEntrySet ? ((Long2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2ByteFunctions.EmptyFunction
			implements Long2ByteMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2ByteFunctions.Singleton
		...
		public ObjectSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2ByteFunctions.SynchronizedFunction
			implements Long2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final long key,
		...
		@Override
		public byte computeIfPresent(final long key,
		...
		@Override
		public byte compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final long key, final byte value,
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Long2ByteFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2ByteEntrySet());
			return entries;
		}
