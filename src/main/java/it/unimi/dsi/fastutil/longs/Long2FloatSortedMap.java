...
public interface Long2FloatSortedMap extends Long2FloatMap, SortedMap<Long, Float> {
	 ...
	 */
	Long2FloatSortedMap subMap(long fromKey, long toKey);
	 ...
	 */
	Long2FloatSortedMap headMap(long toKey);
	 ...
	 */
	Long2FloatSortedMap tailMap(long fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Long2FloatMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Long2FloatMap.Entry> fastIterator(Long2FloatMap.Entry from);
	}
