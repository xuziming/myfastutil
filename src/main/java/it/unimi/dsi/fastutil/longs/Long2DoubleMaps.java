...
public final class Long2DoubleMaps {
	...
	public static ObjectIterator<Long2DoubleMap.Entry> fastIterator(Long2DoubleMap map) {
		...
		return entries instanceof Long2DoubleMap.FastEntrySet ? ((Long2DoubleMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2DoubleFunctions.EmptyFunction
			implements Long2DoubleMap, java.io.Serializable, Cloneable {
	...
	public static class SynchronizedMap extends Long2DoubleFunctions.SynchronizedFunction
			implements Long2DoubleMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final long key,
		...
		@Override
		public double computeIfPresent(final long key,
		...
		@Override
		public double compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double merge(final long key, final double value,
		...
		@Deprecated
		@Override
		public Double computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends Double> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Long2DoubleFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2DoubleEntrySet());
			return entries;
		}
