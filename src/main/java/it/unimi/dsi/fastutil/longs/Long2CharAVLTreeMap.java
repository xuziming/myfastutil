 ...
 * iterator}.
 */
public class Long2CharAVLTreeMap extends AbstractLong2CharSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Long2CharAVLTreeMap(final Comparator<? super Long> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Long2CharAVLTreeMap(final Map<? extends Long, ? extends Character> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2CharAVLTreeMap(final SortedMap<Long, Character> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Long2CharAVLTreeMap(final Long2CharMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2CharAVLTreeMap(final Long2CharSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2CharAVLTreeMap(final long[] k, final char v[], final Comparator<? super Long> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Long2CharAVLTreeMap(final long[] k, final char v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractLong2CharMap.BasicEntry implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).longValue())) && ((value) == ((e.getValue()).charValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Long2CharAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
				final Comparator<? super Long2CharMap.Entry> comparator = (Comparator<Long2CharMap.Entry>) (x,
						y) -> Long2CharAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
				...
				public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry to) {
					return subMap(from.getLongKey(), to.getLongKey()).long2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry to) {
					return headMap(to.getLongKey()).long2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from) {
					return tailMap(from.getLongKey()).long2CharEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractLong2CharSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final long k) {
			return (bottom || Long2CharAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Long2CharAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Long2CharAVLTreeMap.Entry f = findKey(((Long) (e.getKey())).longValue());
		...
		public boolean containsKey(final long k) {
			return in(k) && Long2CharAVLTreeMap.this.containsKey(k);
		}
		...
		public char get(final long k) {
			final Long2CharAVLTreeMap.Entry e;
			final long kk = k;
		...
		public char put(final long k, final char v) {
			...
			final char oldValue = Long2CharAVLTreeMap.this.put(k, v);
		...
		public char remove(final long k) {
			...
			final char oldValue = Long2CharAVLTreeMap.this.remove(k);
		...
		@Override
		public long firstLongKey() {
			Long2CharAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2CharAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2CharAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2CharAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
