...
public final class Long2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2IntMap.Entry> fastIterator(Long2IntSortedMap map) {
		...
		return entries instanceof Long2IntSortedMap.FastSortedEntrySet
				? ((Long2IntSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Long2IntMaps.EmptyMap
			implements Long2IntSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2IntMaps.Singleton
		...
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2IntMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2IntMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Long2IntMaps.SynchronizedMap
			implements Long2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2IntEntrySet(), sync);
			return (ObjectSortedSet<Long2IntMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2IntMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2IntEntrySet());
			return (ObjectSortedSet<Long2IntMap.Entry>) entries;
		}
