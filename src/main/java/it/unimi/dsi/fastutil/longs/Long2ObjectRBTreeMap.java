 ...
 *
 */
public class Long2ObjectRBTreeMap<V> extends AbstractLong2ObjectSortedMap<V>
	 ...
	 */
	public Long2ObjectRBTreeMap(final Comparator<? super Long> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Long2ObjectRBTreeMap(final Map<? extends Long, ? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2ObjectRBTreeMap(final SortedMap<Long, V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Long2ObjectRBTreeMap(final Long2ObjectMap<? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2ObjectRBTreeMap(final Long2ObjectSortedMap<V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2ObjectRBTreeMap(final long[] k, final V v[], final Comparator<? super Long> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Long2ObjectRBTreeMap(final long[] k, final V v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry<V> extends AbstractLong2ObjectMap.BasicEntry<V> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).longValue())) && java.util.Objects.equals(value, (e.getValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Long2ObjectRBTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
				final Comparator<? super Long2ObjectMap.Entry<V>> comparator = (Comparator<Long2ObjectMap.Entry<V>>) (x,
						y) -> Long2ObjectRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	...
	private final class Submap extends AbstractLong2ObjectSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2ObjectRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Long2ObjectRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Long))
							return false;
						final Long2ObjectRBTreeMap.Entry<V> f = findKey(((Long) (e.getKey())).longValue());
		...
		public V get(final long k) {
			final Long2ObjectRBTreeMap.Entry<V> e;
			final long kk = k;
		...
		public V put(final long k, final V v) {
			...
			final V oldValue = Long2ObjectRBTreeMap.this.put(k, v);
		...
		public V remove(final long k) {
			...
			final V oldValue = Long2ObjectRBTreeMap.this.remove(k);
		...
		@Override
		public long firstLongKey() {
			Long2ObjectRBTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2ObjectRBTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2ObjectRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2ObjectRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
