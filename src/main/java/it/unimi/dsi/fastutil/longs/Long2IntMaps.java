...
public final class Long2IntMaps {
	...
	public static ObjectIterator<Long2IntMap.Entry> fastIterator(Long2IntMap map) {
		...
		return entries instanceof Long2IntMap.FastEntrySet ? ((Long2IntMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class Singleton extends Long2IntFunctions.Singleton
		...
		public ObjectSet<Long2IntMap.Entry> long2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2IntFunctions.SynchronizedFunction
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Long, ? super Integer> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final long key, final java.util.function.LongToIntFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final long key,
		...
		@Override
		public int computeIfPresent(final long key,
		...
		@Override
		public int compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int merge(final long key, final int value,
		...
		@Deprecated
		@Override
		public Integer computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends Integer> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Long key,
				final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer compute(final Long key,
				final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer merge(final Long key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
