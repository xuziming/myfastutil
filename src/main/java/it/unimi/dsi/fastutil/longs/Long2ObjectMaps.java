...
public final class Long2ObjectMaps {
	...
	public static <V> ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator(Long2ObjectMap<V> map) {
		...
		return entries instanceof Long2ObjectMap.FastEntrySet
				? ((Long2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Long2ObjectMap<V> map,
			final Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Long2ObjectMap.Entry<V>> entries = map.long2ObjectEntrySet();
		if (entries instanceof Long2ObjectMap.FastEntrySet)
			((Long2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Long2ObjectMap.Entry<V>> fastIterable(Long2ObjectMap<V> map) {
		...
		return entries instanceof Long2ObjectMap.FastEntrySet ? new ObjectIterable<Long2ObjectMap.Entry<V>>() {
			public ObjectIterator<Long2ObjectMap.Entry<V>> iterator() {
				return ((Long2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class Singleton<V> extends Long2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
