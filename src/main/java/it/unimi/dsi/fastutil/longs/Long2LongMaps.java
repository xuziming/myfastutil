...
public final class Long2LongMaps {
	...
	public static ObjectIterator<Long2LongMap.Entry> fastIterator(Long2LongMap map) {
		...
		return entries instanceof Long2LongMap.FastEntrySet ? ((Long2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2LongFunctions.EmptyFunction
			implements Long2LongMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2LongFunctions.Singleton
		...
		public ObjectSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2LongFunctions.SynchronizedFunction
		...
		public ObjectSet<Long2LongMap.Entry> long2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Long, ? super Long> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsent(final long key, final java.util.function.LongUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final long key,
		...
		@Override
		public long computeIfPresent(final long key,
		...
		@Override
		public long compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final long key, final long value,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Long2LongFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2LongEntrySet());
			return entries;
		}
