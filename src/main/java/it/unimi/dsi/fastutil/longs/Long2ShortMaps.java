...
public final class Long2ShortMaps {
	...
	public static ObjectIterator<Long2ShortMap.Entry> fastIterator(Long2ShortMap map) {
		...
		return entries instanceof Long2ShortMap.FastEntrySet ? ((Long2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2ShortFunctions.EmptyFunction
			implements Long2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2ShortFunctions.Singleton
		...
		public ObjectSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2ShortFunctions.SynchronizedFunction
			implements Long2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final long key,
		...
		@Override
		public short computeIfPresent(final long key,
		...
		@Override
		public short compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final long key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Long key,
	...
	public static class UnmodifiableMap extends Long2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2ShortEntrySet());
			return entries;
		}
