...
public abstract class AbstractLong2ObjectMap<V> extends AbstractLong2ObjectFunction<V>
	...
	public boolean containsKey(final long k) {
		final ObjectIterator<Long2ObjectMap.Entry<V>> i = long2ObjectEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry<V> implements Long2ObjectMap.Entry<V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Long2ObjectMap.Entry) {
				final Long2ObjectMap.Entry<V> e = (Long2ObjectMap.Entry<V>) o;
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					private final ObjectIterator<Long2ObjectMap.Entry<V>> i = Long2ObjectMaps
							.fastIterator(AbstractLong2ObjectMap.this);
	...
	public void putAll(final Map<? extends Long, ? extends V> m) {
		if (m instanceof Long2ObjectMap) {
			...
			while (i.hasNext()) {
				final Long2ObjectMap.Entry<? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Long2ObjectMap.Entry<V>> i = Long2ObjectMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
