 ...
 *
 */
public class Long2LongRBTreeMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Long2LongRBTreeMap(final Comparator<? super Long> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Long2LongRBTreeMap(final Map<? extends Long, ? extends Long> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2LongRBTreeMap(final SortedMap<Long, Long> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Long2LongRBTreeMap(final Long2LongMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2LongRBTreeMap(final Long2LongSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2LongRBTreeMap(final long[] k, final long v[], final Comparator<? super Long> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Long2LongRBTreeMap(final long[] k, final long v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Long2LongRBTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
				final Comparator<? super Long2LongMap.Entry> comparator = (Comparator<Long2LongMap.Entry>) (x,
						y) -> Long2LongRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	...
	private final class Submap extends AbstractLong2LongSortedMap implements java.io.Serializable {
		...
		final boolean in(final long k) {
			return (bottom || Long2LongRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Long2LongRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Long))
							return false;
						final Long2LongRBTreeMap.Entry f = findKey(((Long) (e.getKey())).longValue());
		...
		public boolean containsKey(final long k) {
			return in(k) && Long2LongRBTreeMap.this.containsKey(k);
		}
		...
		public long get(final long k) {
			final Long2LongRBTreeMap.Entry e;
			final long kk = k;
		...
		public long put(final long k, final long v) {
			...
			final long oldValue = Long2LongRBTreeMap.this.put(k, v);
		...
		public long remove(final long k) {
			...
			final long oldValue = Long2LongRBTreeMap.this.remove(k);
		...
		@Override
		public long firstLongKey() {
			Long2LongRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2LongRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2LongRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2LongRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
