 ...
 * @see HashCommon
 */
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Long2FloatOpenHashMap.this.remove(wrapped.getLong(-pos - 1));
