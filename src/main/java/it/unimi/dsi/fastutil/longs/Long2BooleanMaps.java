...
public final class Long2BooleanMaps {
	...
	public static ObjectIterator<Long2BooleanMap.Entry> fastIterator(Long2BooleanMap map) {
		...
		return entries instanceof Long2BooleanMap.FastEntrySet ? ((Long2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Long2BooleanFunctions.EmptyFunction
			implements Long2BooleanMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Long2BooleanFunctions.Singleton
			implements Long2BooleanMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2BooleanFunctions.SynchronizedFunction
			implements Long2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final long key,
				final java.util.function.LongFunction<? extends Boolean> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentPartial(final long key, final Long2BooleanFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfPresent(final long key,
				final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final long key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends Boolean> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Long2BooleanFunctions.UnmodifiableFunction
			implements Long2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2BooleanMap map;
		protected transient ObjectSet<Long2BooleanMap.Entry> entries;
		...
		public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2BooleanEntrySet());
			return entries;
		}
