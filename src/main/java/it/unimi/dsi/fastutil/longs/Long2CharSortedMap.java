...
public interface Long2CharSortedMap extends Long2CharMap, SortedMap<Long, Character> {
	 ...
	 */
	Long2CharSortedMap subMap(long fromKey, long toKey);
	 ...
	 */
	Long2CharSortedMap headMap(long toKey);
	 ...
	 */
	Long2CharSortedMap tailMap(long fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Long2CharMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Long2CharMap.Entry> fastIterator(Long2CharMap.Entry from);
	}
