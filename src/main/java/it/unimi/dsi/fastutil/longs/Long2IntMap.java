...
public interface Long2IntMap extends Long2IntFunction, Map<Long, Integer> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Long2IntMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Long2IntMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsent(final long key, final java.util.function.LongToIntFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsentNullable(final long key,
	 ...
	 * @since 8.0.0
	 */
	default int computeIfPresent(final long key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Integer newValue = remappingFunction.apply(Long.valueOf(key), Integer.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default int compute(final long key,
			final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Integer newValue = remappingFunction.apply(Long.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default int merge(final long key, final int value,
	...
	@Deprecated
	@Override
	default Integer computeIfAbsent(final Long key,
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Long key,
			final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Long key,
			final java.util.function.BiFunction<? super Long, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Long key, final Integer value,
			final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Long, Integer> {
		/**
