 ...
 */
public class Long2ShortArrayMap extends AbstractLong2ShortMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Long2ShortMap.Entry> iterator() {
			return new ObjectIterator<Long2ShortMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractLong2ShortMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Long2ShortArrayMap.this.containsKey(k)
					&& ((Long2ShortArrayMap.this.get(k)) == (((Short) (e.getValue())).shortValue()));
		}
