...
public interface Long2ReferenceSortedMap<V> extends Long2ReferenceMap<V>, SortedMap<Long, V> {
	 ...
	 */
	Long2ReferenceSortedMap<V> subMap(long fromKey, long toKey);
	 ...
	 */
	Long2ReferenceSortedMap<V> headMap(long toKey);
	 ...
	 */
	Long2ReferenceSortedMap<V> tailMap(long fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Long2ReferenceMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> fastIterator(Long2ReferenceMap.Entry<V> from);
	}
