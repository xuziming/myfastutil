...
public final class Long2FloatMaps {
	...
	public static ObjectIterator<Long2FloatMap.Entry> fastIterator(Long2FloatMap map) {
		...
		return entries instanceof Long2FloatMap.FastEntrySet ? ((Long2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2FloatFunctions.EmptyFunction
			implements Long2FloatMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2FloatFunctions.Singleton
		...
		public ObjectSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2FloatFunctions.SynchronizedFunction
		...
		public ObjectSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final long key,
		...
		@Override
		public float computeIfPresent(final long key,
		...
		@Override
		public float compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final long key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Long key,
	...
	public static class UnmodifiableMap extends Long2FloatFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2FloatEntrySet());
			return entries;
		}
