 ...
 * iterator}.
 */
public class Long2LongAVLTreeMap extends AbstractLong2LongSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Long2LongAVLTreeMap(final Comparator<? super Long> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Long2LongAVLTreeMap(final Map<? extends Long, ? extends Long> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2LongAVLTreeMap(final SortedMap<Long, Long> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Long2LongAVLTreeMap(final Long2LongMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2LongAVLTreeMap(final Long2LongSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2LongAVLTreeMap(final long[] k, final long v[], final Comparator<? super Long> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Long2LongAVLTreeMap(final long[] k, final long v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractLong2LongMap.BasicEntry implements Cloneable {
		 ...
		 * @param v a value.
		 */
		Entry(final long k, final long v) {
			super(k, v);
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).longValue())) && ((value) == ((e.getValue()).longValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Long2LongAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	 ...
	 * This class can iterate in both directions on a threaded tree.
	 */
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Long2LongMap.Entry> {
		EntryIterator() {
		}
	...
	public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
				final Comparator<? super Long2LongMap.Entry> comparator = (Comparator<Long2LongMap.Entry>) (x,
						y) -> Long2LongAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
				...
				public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) {
					return subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) {
					return headMap(to.getLongKey()).long2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) {
					return tailMap(from.getLongKey()).long2LongEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractLong2LongSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final long k) {
			return (bottom || Long2LongAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Long2LongAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Long))
							return false;
						final Long2LongAVLTreeMap.Entry f = findKey(((Long) (e.getKey())).longValue());
		...
		public boolean containsKey(final long k) {
			return in(k) && Long2LongAVLTreeMap.this.containsKey(k);
		}
		...
		public long get(final long k) {
			final Long2LongAVLTreeMap.Entry e;
			final long kk = k;
		...
		public long put(final long k, final long v) {
			...
			final long oldValue = Long2LongAVLTreeMap.this.put(k, v);
		...
		public long remove(final long k) {
			...
			final long oldValue = Long2LongAVLTreeMap.this.remove(k);
		...
		@Override
		public long firstLongKey() {
			Long2LongAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2LongAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2LongAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2LongAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry readTree(final java.io.ObjectInputStream s, final int n, final Entry pred, final Entry succ)
		...
		if (n == 1) {
			final Entry top = new Entry(s.readLong(), s.readLong());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
