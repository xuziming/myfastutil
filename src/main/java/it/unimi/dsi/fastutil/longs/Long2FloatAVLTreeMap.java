 ...
 * iterator}.
 */
public class Long2FloatAVLTreeMap extends AbstractLong2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Long2FloatAVLTreeMap(final Comparator<? super Long> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Long2FloatAVLTreeMap(final Map<? extends Long, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2FloatAVLTreeMap(final SortedMap<Long, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Long2FloatAVLTreeMap(final Long2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Long2FloatAVLTreeMap(final Long2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2FloatAVLTreeMap(final long[] k, final float v[], final Comparator<? super Long> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Long2FloatAVLTreeMap(final long[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Long2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
				final Comparator<? super Long2FloatMap.Entry> comparator = (Comparator<Long2FloatMap.Entry>) (x,
						y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
				...
				public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) {
					return subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) {
					return headMap(to.getLongKey()).long2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) {
					return tailMap(from.getLongKey()).long2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractLong2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final long k) {
			return (bottom || Long2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Long2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Long2FloatAVLTreeMap.Entry f = findKey(((Long) (e.getKey())).longValue());
					...
					@Override
					public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from,
							Long2FloatMap.Entry to) {
						return subMap(from.getLongKey(), to.getLongKey()).long2FloatEntrySet();
					}
		...
		public boolean containsKey(final long k) {
			return in(k) && Long2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		public float get(final long k) {
			final Long2FloatAVLTreeMap.Entry e;
			final long kk = k;
		...
		public float put(final long k, final float v) {
			...
			final float oldValue = Long2FloatAVLTreeMap.this.put(k, v);
		...
		public float remove(final long k) {
			...
			final float oldValue = Long2FloatAVLTreeMap.this.remove(k);
		...
		@Override
		public long firstLongKey() {
			Long2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
