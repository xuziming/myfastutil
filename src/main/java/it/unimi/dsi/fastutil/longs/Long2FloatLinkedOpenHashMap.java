 ...
 * @see HashCommon
 */
public class Long2FloatLinkedOpenHashMap extends AbstractLong2FloatSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2FloatMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry fromElement,
				Long2FloatMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public void forEach(final Consumer<? super Long2FloatMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractLong2FloatMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet long2FloatEntrySet() {
		if (entries == null)
