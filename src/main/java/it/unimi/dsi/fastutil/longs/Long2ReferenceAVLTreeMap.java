...
public class Long2ReferenceAVLTreeMap<V> extends AbstractLong2ReferenceSortedMap<V>
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() {
				final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = (Comparator<Long2ReferenceMap.Entry<V>>) (
						x, y) -> Long2ReferenceAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
	...
	private final class Submap extends AbstractLong2ReferenceSortedMap<V> implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Long))
							return false;
						final Long2ReferenceAVLTreeMap.Entry<V> f = findKey(((Long) (e.getKey())).longValue());
		...
		@Override
		public long firstLongKey() {
			Long2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public long lastLongKey() {
			Long2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Long2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Long2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
