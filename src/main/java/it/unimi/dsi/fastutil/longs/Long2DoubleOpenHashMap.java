 ...
 * @see HashCommon
 */
public class Long2DoubleOpenHashMap extends AbstractLong2DoubleMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Long2DoubleOpenHashMap.this.remove(wrapped.getLong(-pos - 1));
