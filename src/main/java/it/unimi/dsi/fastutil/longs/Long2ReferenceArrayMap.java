 ...
 */
public class Long2ReferenceArrayMap<V> extends AbstractLong2ReferenceMap<V> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		@Override
		public ObjectIterator<Long2ReferenceMap.Entry<V>> iterator() {
			return new ObjectIterator<Long2ReferenceMap.Entry<V>>() {
				...
				public Entry<V> next() {
					...
					return new AbstractLong2ReferenceMap.BasicEntry<>(key[curr = next], (V) value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Long2ReferenceArrayMap.this.containsKey(k)
					&& ((Long2ReferenceArrayMap.this.get(k)) == ((e.getValue())));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Long2ReferenceArrayMap.this.key, oldPos + 1, Long2ReferenceArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Long2ReferenceArrayMap.this.value, oldPos + 1, Long2ReferenceArrayMap.this.value, oldPos,
					tail);
			Long2ReferenceArrayMap.this.size--;
			Long2ReferenceArrayMap.this.value[size] = null;
			return true;
		}
	}
