...
public class Long2FloatArrayMap extends AbstractLong2FloatMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements FastEntrySet {
		...
		public boolean contains(Object o) {
			...
			return Long2FloatArrayMap.this.containsKey(k)
					&& (Float.floatToIntBits(Long2FloatArrayMap.this.get(k)) == Float
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1
					|| !(Float.floatToIntBits(v) == Float.floatToIntBits(Long2FloatArrayMap.this.value[oldPos])))
				return false;
