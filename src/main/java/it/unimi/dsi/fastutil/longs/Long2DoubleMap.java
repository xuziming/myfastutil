...
public interface Long2DoubleMap extends Long2DoubleFunction, Map<Long, Double> {
	 ...
	 * @since 8.0.0
	 */
	default double computeIfAbsentNullable(final long key,
	 ...
	 * @since 8.0.0
	 */
	default double computeIfPresent(final long key,
	 ...
	 * @since 8.0.0
	 */
	default double compute(final long key,
			final java.util.function.BiFunction<? super Long, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final double oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default double merge(final long key, final double value,
	...
	@Deprecated
	@Override
	default Double computeIfAbsent(final Long key,
