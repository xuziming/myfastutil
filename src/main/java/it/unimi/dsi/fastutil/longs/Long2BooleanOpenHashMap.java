 ...
 * @see HashCommon
 */
public class Long2BooleanOpenHashMap extends AbstractLong2BooleanMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Long2BooleanOpenHashMap.this.remove(wrapped.getLong(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Long2BooleanOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2BooleanOpenHashMap.this.key;
			int pos;
			// The starting point.
