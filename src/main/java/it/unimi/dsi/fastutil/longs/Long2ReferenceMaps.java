...
public final class Long2ReferenceMaps {
	...
	public static <V> ObjectIterator<Long2ReferenceMap.Entry<V>> fastIterator(Long2ReferenceMap<V> map) {
		...
		return entries instanceof Long2ReferenceMap.FastEntrySet
				? ((Long2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Long2ReferenceMap<V> map,
			final Consumer<? super Long2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Long2ReferenceMap.Entry<V>> entries = map.long2ReferenceEntrySet();
		if (entries instanceof Long2ReferenceMap.FastEntrySet)
			((Long2ReferenceMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Long2ReferenceMap.Entry<V>> fastIterable(Long2ReferenceMap<V> map) {
		...
		return entries instanceof Long2ReferenceMap.FastEntrySet ? new ObjectIterable<Long2ReferenceMap.Entry<V>>() {
			public ObjectIterator<Long2ReferenceMap.Entry<V>> iterator() {
				return ((Long2ReferenceMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Long2ReferenceFunctions.EmptyFunction<V>
			implements Long2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Long2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<Long, V>> entrySet() {
			return (ObjectSet) long2ReferenceEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Long2ReferenceMap<V> singleton(final long key, V value) {
	...
	public static class SynchronizedMap<V> extends Long2ReferenceFunctions.SynchronizedFunction<V>
			implements Long2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2ReferenceEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Long, ? super V> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Long, ? super V, ? extends V> function) {
			synchronized (sync) {
		...
		@Override
		public V computeIfAbsent(final long key, final java.util.function.LongFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public V computeIfAbsent(final Long key,
				final java.util.function.Function<? super Long, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<V> extends Long2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2ReferenceEntrySet());
			return entries;
		}
