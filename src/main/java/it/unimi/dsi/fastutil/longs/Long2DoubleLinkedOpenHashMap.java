 ...
 * @see HashCommon
 */
public class Long2DoubleLinkedOpenHashMap extends AbstractLong2DoubleSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2DoubleMap.Entry>
		...
		@Override
		public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry fromElement,
				Long2DoubleMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Long2DoubleMap.Entry> iterator(final Long2DoubleMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Long2DoubleMap.Entry> fastIterator(final Long2DoubleMap.Entry from) {
