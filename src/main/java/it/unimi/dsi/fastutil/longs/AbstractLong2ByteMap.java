 ...
 */
public abstract class AbstractLong2ByteMap extends AbstractLong2ByteFunction
	...
	public boolean containsKey(final long k) {
		final ObjectIterator<Long2ByteMap.Entry> i = long2ByteEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Long2ByteMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Long2ByteMap.Entry) {
				final Long2ByteMap.Entry e = (Long2ByteMap.Entry) o;
				return ((key) == (e.getLongKey())) && ((value) == (e.getByteValue()));
			}
			...
			if (value == null || !(value instanceof Byte))
				return false;
			return ((this.key) == (((Long) (key)).longValue())) && ((this.value) == (((Byte) (value)).byteValue()));
		}
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Long2ByteMap.Entry) {
				final Long2ByteMap.Entry e = (Long2ByteMap.Entry) o;
				return map.remove(e.getLongKey(), e.getByteValue());
			}
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					private final ObjectIterator<Long2ByteMap.Entry> i = Long2ByteMaps
							.fastIterator(AbstractLong2ByteMap.this);
	...
	public void putAll(final Map<? extends Long, ? extends Byte> m) {
		if (m instanceof Long2ByteMap) {
			...
			while (i.hasNext()) {
				final Long2ByteMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Long2ByteMap.Entry> i = Long2ByteMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
