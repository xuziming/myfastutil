...
public class Long2FloatOpenCustomHashMap extends AbstractLong2FloatMap
	...
	public Long2FloatOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Long2FloatOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2FloatOpenCustomHashMap(final Map<? extends Long, ? extends Float> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2FloatOpenCustomHashMap(final Map<? extends Long, ? extends Float> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2FloatOpenCustomHashMap(final Long2FloatMap m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Long2FloatOpenCustomHashMap(final Long2FloatMap m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2FloatOpenCustomHashMap(final long[] k, final float[] v, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Long2FloatOpenCustomHashMap(final long[] k, final float[] v,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public float computeIfAbsent(final long k, final java.util.function.LongToDoubleFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public float computeIfAbsentNullable(final long k,
	...
	/** {@inheritDoc} */
	@Override
	public float computeIfPresent(final long k,
			final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Float newValue = remappingFunction.apply(Long.valueOf(k), Float.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), (0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public float compute(final long k,
			final java.util.function.BiFunction<? super Long, ? super Float, ? extends Float> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Float newValue = remappingFunction.apply(Long.valueOf(k), pos >= 0 ? Float.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), (0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public float merge(final long k, final float v,
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements FastEntrySet {
		...
		public void forEach(final Consumer<? super Long2FloatMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractLong2FloatMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (0)))
					consumer.accept(new AbstractLong2FloatMap.BasicEntry(key[pos], value[pos]));
		}
