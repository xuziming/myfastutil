...
import it.unimi.dsi.fastutil.longs.Long2FloatSortedMap.FastSortedEntrySet;
...
public final class Long2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2FloatMap.Entry> fastIterator(Long2FloatSortedMap map) {
		...
		return entries instanceof Long2FloatSortedMap.FastSortedEntrySet
				? ((Long2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Long2FloatMaps.EmptyMap
			implements Long2FloatSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Long2FloatMaps.Singleton
			implements Long2FloatSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final LongComparator comparator;

		protected Singleton(final long key, final float value, LongComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2FloatMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2FloatSortedMap singleton(final Long key, Float value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2FloatSortedMap singleton(final Long key, Float value, LongComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2FloatSortedMap singleton(final long key, final float value, LongComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Long2FloatMaps.SynchronizedMap
			implements Long2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2FloatEntrySet(), sync);
			return (ObjectSortedSet<Long2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2FloatMaps.UnmodifiableMap
			implements Long2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2FloatSortedMap sortedMap;
		...
		public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2FloatEntrySet());
			return (ObjectSortedSet<Long2FloatMap.Entry>) entries;
		}
