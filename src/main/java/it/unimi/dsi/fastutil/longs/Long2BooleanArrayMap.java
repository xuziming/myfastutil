...
public class Long2BooleanArrayMap extends AbstractLong2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements FastEntrySet {
		...
		public boolean contains(Object o) {
			...
			return Long2BooleanArrayMap.this.containsKey(k)
					&& ((Long2BooleanArrayMap.this.get(k)) == (((Boolean) (e.getValue())).booleanValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Long2BooleanArrayMap.this.value, oldPos + 1, Long2BooleanArrayMap.this.value, oldPos,
					tail);
