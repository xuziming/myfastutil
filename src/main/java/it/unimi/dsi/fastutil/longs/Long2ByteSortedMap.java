...
public interface Long2ByteSortedMap extends Long2ByteMap, SortedMap<Long, Byte> {
	 ...
	 */
	Long2ByteSortedMap subMap(long fromKey, long toKey);
	 ...
	 */
	Long2ByteSortedMap headMap(long toKey);
	 ...
	 */
	Long2ByteSortedMap tailMap(long fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Long2ByteMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator(Long2ByteMap.Entry from);
	}
