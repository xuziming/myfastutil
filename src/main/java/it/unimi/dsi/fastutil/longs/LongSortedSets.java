...
public final class LongSortedSets {
	...
	public static class SynchronizedSortedSet extends LongSets.SynchronizedSet
			implements LongSortedSet, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedSet extends LongSets.UnmodifiableSet
		...
		@Override
		public LongBidirectionalIterator iterator() {
			return LongIterators.unmodifiable(sortedSet.iterator());
		}

		@Override
		public LongBidirectionalIterator iterator(final long from) {
			return LongIterators.unmodifiable(sortedSet.iterator(from));
		}
