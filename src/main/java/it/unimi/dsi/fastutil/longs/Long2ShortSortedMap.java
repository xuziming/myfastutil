...
public interface Long2ShortSortedMap extends Long2ShortMap, SortedMap<Long, Short> {
	 ...
	 */
	Long2ShortSortedMap subMap(long fromKey, long toKey);
	 ...
	 */
	Long2ShortSortedMap headMap(long toKey);
	 ...
	 */
	Long2ShortSortedMap tailMap(long fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Long2ShortMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator(Long2ShortMap.Entry from);
	}
