...
public final class Long2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2CharMap.Entry> fastIterator(Long2CharSortedMap map) {
		...
		return entries instanceof Long2CharSortedMap.FastSortedEntrySet
	...
	public static class EmptySortedMap extends Long2CharMaps.EmptyMap
			implements Long2CharSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2CharMaps.Singleton
		...
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2CharMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2CharMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Long2CharMaps.SynchronizedMap
			implements Long2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2CharEntrySet(), sync);
			return (ObjectSortedSet<Long2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2CharMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2CharEntrySet());
			return (ObjectSortedSet<Long2CharMap.Entry>) entries;
		}
