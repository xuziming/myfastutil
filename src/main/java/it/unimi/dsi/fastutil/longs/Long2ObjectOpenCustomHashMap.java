...
public class Long2ObjectOpenCustomHashMap<V> extends AbstractLong2ObjectMap<V>
	...
	public Long2ObjectOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ObjectOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ObjectOpenCustomHashMap(final Map<? extends Long, ? extends V> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ObjectOpenCustomHashMap(final Map<? extends Long, ? extends V> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ObjectOpenCustomHashMap(final Long2ObjectMap<V> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ObjectOpenCustomHashMap(final Long2ObjectMap<V> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2ObjectOpenCustomHashMap(final long[] k, final V[] v, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Long2ObjectOpenCustomHashMap(final long[] k, final V[] v,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Long2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			long curr;
			final long[] key = Long2ObjectOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractLong2ObjectMap.BasicEntry<V>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (0)))
					consumer.accept(new AbstractLong2ObjectMap.BasicEntry<V>(key[pos], value[pos]));
		}
