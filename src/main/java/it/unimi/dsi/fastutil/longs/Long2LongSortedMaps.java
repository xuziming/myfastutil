...
public final class Long2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator(Long2LongSortedMap map) {
		final ObjectSortedSet<Long2LongMap.Entry> entries = map.long2LongEntrySet();
		return entries instanceof Long2LongSortedMap.FastSortedEntrySet
				? ((Long2LongSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Long2LongMaps.EmptyMap
			implements Long2LongSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Long2LongMaps.Singleton
			implements Long2LongSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2LongMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2LongMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Long2LongMaps.SynchronizedMap
			implements Long2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2LongEntrySet(), sync);
			return (ObjectSortedSet<Long2LongMap.Entry>) entries;
		}
	 ...
	 */
	public static Long2LongSortedMap synchronize(final Long2LongSortedMap m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static Long2LongSortedMap synchronize(final Long2LongSortedMap m, final Object sync) {
		return new SynchronizedSortedMap(m, sync);
	}

	/** An unmodifiable wrapper class for sorted maps. */
	public static class UnmodifiableSortedMap extends Long2LongMaps.UnmodifiableMap
			implements Long2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2LongSortedMap sortedMap;
		...
		public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2LongEntrySet());
			return (ObjectSortedSet<Long2LongMap.Entry>) entries;
		}
	 ...
	 */
	public static Long2LongSortedMap unmodifiable(final Long2LongSortedMap m) {
