 ...
 * @see HashCommon
 */
public class Long2ObjectOpenHashMap<V> extends AbstractLong2ObjectMap<V>
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Long2ObjectOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			long curr;
			final long[] key = Long2ObjectOpenHashMap.this.key;
			int pos;
			// The starting point.
