...
public interface Long2CharMap extends Long2CharFunction, Map<Long, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Long2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Long2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char getOrDefault(final long key, final char defaultValue) {
		final char v;
	 ...
	 * @since 8.0.0
	 */
	default char putIfAbsent(final long key, final char value) {
	 ...
	 * @since 8.0.0
	 */
	default boolean remove(final long key, final char value) {
	 ...
	 * @since 8.0.0
	 */
	default boolean replace(final long key, final char oldValue, final char newValue) {
		final char curValue = get(key);
	 ...
	 * @since 8.0.0
	 */
	default char replace(final long key, final char value) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final long key, final java.util.function.LongToIntFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final long key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentPartial(final long key, final Long2CharFunction mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final char v = get(key), drv = defaultReturnValue();
		if (v != drv || containsKey(key))
			return v;
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final long key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Long.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final long key,
			final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Long.valueOf(key),
				contained ? Character.valueOf(oldValue) : null);
		if (newValue == null) {
			if (contained)
				remove(key);
			return drv;
	 ...
	 * @since 8.0.0
	 */
	default char merge(final long key, final char value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final char newValue;
		if (oldValue != drv || containsKey(key)) {
			final Character mergedValue = remappingFunction.apply(Character.valueOf(oldValue),
	...
	@Deprecated
	@Override
	default Character putIfAbsent(final Long key, final Character value) {
	...
	@Deprecated
	@Override
	default boolean replace(final Long key, final Character oldValue, final Character newValue) {
	...
	@Deprecated
	@Override
	default Character replace(final Long key, final Character value) {
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Long key,
			final java.util.function.Function<? super Long, ? extends Character> mappingFunction) {
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Long key,
			final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Long key,
			final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Long key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Long, Character> {
		/**
