...
public class Long2ReferenceOpenCustomHashMap<V> extends AbstractLong2ReferenceMap<V>
	...
	public Long2ReferenceOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final Map<? extends Long, ? extends V> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final Map<? extends Long, ? extends V> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final Long2ReferenceMap<V> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Long2ReferenceOpenCustomHashMap(final Long2ReferenceMap<V> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2ReferenceOpenCustomHashMap(final long[] k, final V[] v, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Long2ReferenceOpenCustomHashMap(final long[] k, final V[] v,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	final class MapEntry implements Long2ReferenceMap.Entry<V>, Map.Entry<Long, V> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey()).longValue()))) && ((value[index]) == ((e.getValue())));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Long2ReferenceOpenCustomHashMap.this.remove(wrapped.getLong(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Long2ReferenceOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2ReferenceOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
