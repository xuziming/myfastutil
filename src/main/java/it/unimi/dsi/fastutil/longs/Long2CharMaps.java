...
public final class Long2CharMaps {
	...
	public static ObjectIterator<Long2CharMap.Entry> fastIterator(Long2CharMap map) {
		...
		return entries instanceof Long2CharMap.FastEntrySet ? ((Long2CharMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Long2CharFunctions.EmptyFunction
			implements Long2CharMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2CharFunctions.Singleton
		...
		public ObjectSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractLong2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Long2CharFunctions.SynchronizedFunction
			implements Long2CharMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Long2CharMap.Entry> long2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.long2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final long key,
		...
		@Override
		public char computeIfAbsentPartial(final long key, final Long2CharFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char computeIfPresent(final long key,
		...
		@Override
		public char compute(final long key,
				final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char merge(final long key, final char value,
		...
		@Deprecated
		@Override
		public Character computeIfAbsent(final Long key,
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Long key,
				final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character compute(final Long key,
				final java.util.function.BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character merge(final Long key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Long2CharFunctions.UnmodifiableFunction
		...
		public ObjectSet<Long2CharMap.Entry> long2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.long2CharEntrySet());
			return entries;
		}
