...
public final class Long2ReferenceSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> fastIterator(
			Long2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Long2ReferenceMap.Entry<V>> entries = map.long2ReferenceEntrySet();
		return entries instanceof Long2ReferenceSortedMap.FastSortedEntrySet
				? ((Long2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Long2ReferenceMap.Entry<V>> fastIterable(
			Long2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Long2ReferenceMap.Entry<V>> entries = map.long2ReferenceEntrySet();
		return entries instanceof Long2ReferenceSortedMap.FastSortedEntrySet
				? ((Long2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	...
	public static class EmptySortedMap<V> extends Long2ReferenceMaps.EmptyMap<V>
			implements Long2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Long2ReferenceMaps.Singleton<V>
		...
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2ReferenceMap.Entry<V>>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Long, V>> entrySet() {
			return (ObjectSortedSet) long2ReferenceEntrySet();
		}
	...
	public static class SynchronizedSortedMap<V> extends Long2ReferenceMaps.SynchronizedMap<V>
			implements Long2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Long2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Long2ReferenceMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2ReferenceEntrySet());
			return (ObjectSortedSet<Long2ReferenceMap.Entry<V>>) entries;
		}
