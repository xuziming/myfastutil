...
public abstract class AbstractLong2FloatMap extends AbstractLong2FloatFunction
	...
	public boolean containsKey(final long k) {
		final ObjectIterator<Long2FloatMap.Entry> i = long2FloatEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Long2FloatMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Long2FloatMap.Entry) {
				final Long2FloatMap.Entry e = (Long2FloatMap.Entry) o;
				return ((key) == (e.getLongKey()))
			...
			if (value == null || !(value instanceof Float))
				return false;
			return ((this.key) == (((Long) (key)).longValue()))
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public BasicEntrySet(final Long2FloatMap map) {
			this.map = map;
		}
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Long2FloatMap.Entry) {
				final Long2FloatMap.Entry e = (Long2FloatMap.Entry) o;
				return map.remove(e.getLongKey(), e.getFloatValue());
			}
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					private final ObjectIterator<Long2FloatMap.Entry> i = Long2FloatMaps
							.fastIterator(AbstractLong2FloatMap.this);
	...
	public void putAll(final Map<? extends Long, ? extends Float> m) {
		if (m instanceof Long2FloatMap) {
			...
			while (i.hasNext()) {
				final Long2FloatMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Long2FloatMap.Entry> i = Long2FloatMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
