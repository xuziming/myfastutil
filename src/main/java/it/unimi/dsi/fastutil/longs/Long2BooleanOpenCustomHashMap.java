...
public class Long2BooleanOpenCustomHashMap extends AbstractLong2BooleanMap
	...
	public Long2BooleanOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Long2BooleanOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2BooleanOpenCustomHashMap(final Map<? extends Long, ? extends Boolean> m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2BooleanOpenCustomHashMap(final Map<? extends Long, ? extends Boolean> m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Long2BooleanOpenCustomHashMap(final Long2BooleanMap m, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Long2BooleanOpenCustomHashMap(final Long2BooleanMap m,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Long2BooleanOpenCustomHashMap(final long[] k, final boolean[] v, final float f,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Long2BooleanOpenCustomHashMap(final long[] k, final boolean[] v,
			final it.unimi.dsi.fastutil.longs.LongHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsentNullable(final long k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfPresent(final long k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean compute(final long k,
			final java.util.function.BiFunction<? super Long, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Boolean newValue = remappingFunction.apply(Long.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public boolean merge(final long k, final boolean v,
	...
	private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Long2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Long2BooleanMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractLong2BooleanMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (0)))
					consumer.accept(new AbstractLong2BooleanMap.BasicEntry(key[pos], value[pos]));
		}
