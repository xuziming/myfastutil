...
public final class Long2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator(Long2ByteSortedMap map) {
		...
		return entries instanceof Long2ByteSortedMap.FastSortedEntrySet
				? ((Long2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Long2ByteMaps.EmptyMap
			implements Long2ByteSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2ByteMaps.Singleton
		...
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Long2ByteMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Long2ByteMaps.SynchronizedMap
			implements Long2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2ByteEntrySet(), sync);
			return (ObjectSortedSet<Long2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2ByteMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2ByteEntrySet());
			return (ObjectSortedSet<Long2ByteMap.Entry>) entries;
		}
