 ...
 * @see HashCommon
 */
public class Long2LongLinkedOpenHashMap extends AbstractLong2LongSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Long2LongMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry fromElement,
				Long2LongMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Long2LongLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			long curr;
			final long[] key = Long2LongLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Long2LongMap.Entry> iterator(final Long2LongMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Long2LongMap.Entry> fastIterator(final Long2LongMap.Entry from) {
		...
		public void forEach(final Consumer<? super Long2LongMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractLong2LongMap.BasicEntry(key[curr], value[curr]));
			}
		}
