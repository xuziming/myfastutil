 ...
 */
public abstract class AbstractLong2ReferenceMap<V> extends AbstractLong2ReferenceFunction<V>
	...
	public boolean containsKey(final long k) {
		final ObjectIterator<Long2ReferenceMap.Entry<V>> i = long2ReferenceEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry<V> implements Long2ReferenceMap.Entry<V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Long2ReferenceMap.Entry) {
				final Long2ReferenceMap.Entry<V> e = (Long2ReferenceMap.Entry<V>) o;
				return ((key) == (e.getLongKey())) && ((value) == (e.getValue()));
			}
			...
			return ((this.key) == (((Long) (key)).longValue())) && ((this.value) == ((value)));
		}
	...
	public abstract static class BasicEntrySet<V> extends AbstractObjectSet<Entry<V>> {
		...
		public BasicEntrySet(final Long2ReferenceMap<V> map) {
			this.map = map;
		}
		...
		return new AbstractLongSet() {
			...
			public LongIterator iterator() {
				return new LongIterator() {
					private final ObjectIterator<Long2ReferenceMap.Entry<V>> i = Long2ReferenceMaps
							.fastIterator(AbstractLong2ReferenceMap.this);
	...
	public void putAll(final Map<? extends Long, ? extends V> m) {
		if (m instanceof Long2ReferenceMap) {
			...
			while (i.hasNext()) {
				final Long2ReferenceMap.Entry<? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Long2ReferenceMap.Entry<V>> i = Long2ReferenceMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
