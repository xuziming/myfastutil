...
public final class LongIndirectHeaps {
	...
	public static int downHeap(final long[] refArray, final int[] heap, final int[] inv, final int size, int i,
	...
	public static int upHeap(final long[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final LongComparator c) {
		assert i < size;
		final int e = heap[i];
		final long E = refArray[e];
	...
	public static void makeHeap(final long[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final LongComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final long[] refArray, final int[] heap, final int[] inv, final int size,
			final LongComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
