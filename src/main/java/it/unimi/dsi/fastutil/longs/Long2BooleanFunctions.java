...
public final class Long2BooleanFunctions {
	...
	public static class SynchronizedFunction implements Long2BooleanFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class PrimitiveFunction implements Long2BooleanFunction {
		...
		public boolean get(long key) {
			Boolean v = function.apply(Long.valueOf(key));
			if (v == null)
	...
	public static Long2BooleanFunction primitive(final java.util.function.Function<? super Long, ? extends Boolean> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Long2BooleanFunction)
			return (Long2BooleanFunction) f;
		if (f instanceof java.util.function.LongPredicate)
			return ((java.util.function.LongPredicate) f)::test;
