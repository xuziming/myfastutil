...
public final class Long2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator(Long2ShortSortedMap map) {
		...
		return entries instanceof Long2ShortSortedMap.FastSortedEntrySet
				? ((Long2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Long2ShortMaps.EmptyMap
			implements Long2ShortSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Long2ShortMaps.Singleton
		...
		public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractLong2ShortMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Long2ShortMaps.SynchronizedMap
			implements Long2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2ShortEntrySet(), sync);
			return (ObjectSortedSet<Long2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2ShortMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2ShortEntrySet());
			return (ObjectSortedSet<Long2ShortMap.Entry>) entries;
		}
