...
public final class Long2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Long2DoubleMap.Entry> fastIterator(Long2DoubleSortedMap map) {
		...
		return entries instanceof Long2DoubleSortedMap.FastSortedEntrySet
				? ((Long2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Long2DoubleMaps.EmptyMap
			implements Long2DoubleSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Long2DoubleMaps.Singleton
			implements Long2DoubleSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final LongComparator comparator;

		protected Singleton(final long key, final double value, LongComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Map.Entry<Long, Double>> entrySet() {
			return (ObjectSortedSet) long2DoubleEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2DoubleSortedMap singleton(final Long key, Double value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2DoubleSortedMap singleton(final Long key, Double value, LongComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Long2DoubleSortedMap singleton(final long key, final double value, LongComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Long2DoubleMaps.SynchronizedMap
			implements Long2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.long2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Long2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Long2DoubleMaps.UnmodifiableMap
			implements Long2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Long2DoubleSortedMap sortedMap;
		...
		public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.long2DoubleEntrySet());
			return (ObjectSortedSet<Long2DoubleMap.Entry>) entries;
		}
