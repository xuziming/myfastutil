 ...
 *
 * <p>
 * Instances of this class implement the same semantics as that of {@link List}:
 * however, getters and setters use long indices, search methods return long
 * values, and iterators are of type {@link BigListIterator}.
 */
...
public interface BigList<K> extends Collection<K>, Size64 {
	...
	/**
	 * Inserts the specified element at the specified position in this big list
	 * (optional operation).
	 *
	 * @param index   a position in the big list.
	...
	/**
	 * Inserts all of the elements in the specified collection into this big list at
	 ...
	 * big list, or -1 if this big list does not contain the element.
	 *
	...
	/**
	 * Returns the index of the last occurrence of the specified element in this big
	 * list, or -1 if this big list does not contain the element.
	 *
	 * @param o the object to search for.
	 * @return the index of the last occurrence of the specified element in this big
	 *         list, or -1 if this big list does not contain the element.
	...
	/**
	 * Returns a big-list iterator of the elements in this big list, starting at the
	 * specified position in this big list.
	 *
	 * @param index index of first element to be returned from the big-list
	 *              iterator.
	 * @return a big-list iterator of the elements in this big list, starting at the
	 *         specified position in this big list.
