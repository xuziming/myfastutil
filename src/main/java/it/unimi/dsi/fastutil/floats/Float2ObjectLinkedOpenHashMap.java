 ...
 * @see HashCommon
 */
public class Float2ObjectLinkedOpenHashMap<V> extends AbstractFloat2ObjectSortedMap<V>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>
		...
		@Override
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> fromElement,
				Float2ObjectMap.Entry<V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2ObjectLinkedOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			float curr;
			final float[] key = Float2ObjectLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Float2ObjectMap.Entry<V>> iterator(final Float2ObjectMap.Entry<V> from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Float2ObjectMap.Entry<V>> fastIterator(final Float2ObjectMap.Entry<V> from) {
		...
		public void forEach(final Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractFloat2ObjectMap.BasicEntry<V>(key[curr], value[curr]));
			}
		}
