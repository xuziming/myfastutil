 ...
 * @see HashCommon
 */
public class Float2BooleanLinkedOpenHashMap extends AbstractFloat2BooleanSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2BooleanMap.Entry>
		...
		@Override
		public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry fromElement,
				Float2BooleanMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
