...
public final class Float2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2LongMap.Entry> fastIterator(Float2LongSortedMap map) {
		final ObjectSortedSet<Float2LongMap.Entry> entries = map.float2LongEntrySet();
		return entries instanceof Float2LongSortedMap.FastSortedEntrySet
				? ((Float2LongSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Float2LongMaps.EmptyMap
			implements Float2LongSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2LongMaps.Singleton
		...
		protected Singleton(final float key, final long value, FloatComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2LongMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2LongMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Float, Long>> entrySet() {
			return (ObjectSortedSet) float2LongEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2LongSortedMap singleton(final Float key, Long value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2LongSortedMap singleton(final Float key, Long value, FloatComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2LongSortedMap singleton(final float key, final long value, FloatComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Float2LongMaps.SynchronizedMap
			implements Float2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2LongEntrySet(), sync);
			return (ObjectSortedSet<Float2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2LongMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2LongEntrySet());
			return (ObjectSortedSet<Float2LongMap.Entry>) entries;
		}
