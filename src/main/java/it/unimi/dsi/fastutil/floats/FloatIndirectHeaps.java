...
public final class FloatIndirectHeaps {
	...
	public static int downHeap(final float[] refArray, final int[] heap, final int[] inv, final int size, int i,
	...
	public static int upHeap(final float[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final FloatComparator c) {
		assert i < size;
		final int e = heap[i];
		final float E = refArray[e];
	 ...
	 *                 order.
	 */
	public static void makeHeap(final float[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final FloatComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final float[] refArray, final int[] heap, final int[] inv, final int size,
			final FloatComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
