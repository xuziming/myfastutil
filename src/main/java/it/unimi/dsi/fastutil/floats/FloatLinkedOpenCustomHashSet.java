 ...
 * @see HashCommon
 */
public class FloatLinkedOpenCustomHashSet extends AbstractFloatSortedSet
	...
	public FloatLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final Collection<? extends Float> c, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final Collection<? extends Float> c,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final FloatCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final FloatCollection c,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final FloatIterator i, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final FloatIterator i,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final float[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final float[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final float[] a, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatLinkedOpenCustomHashSet(final float[] a,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	private class SetIterator implements FloatListIterator {
		...
		public float nextFloat() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !(Float.floatToIntBits(key[curr]) == 0) : "Position " + curr + " is not used";
			return key[curr];
		}
