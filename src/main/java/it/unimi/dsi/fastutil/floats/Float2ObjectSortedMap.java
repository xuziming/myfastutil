...
public interface Float2ObjectSortedMap<V> extends Float2ObjectMap<V>, SortedMap<Float, V> {
	 ...
	 */
	Float2ObjectSortedMap<V> subMap(float fromKey, float toKey);
	 ...
	 */
	Float2ObjectSortedMap<V> headMap(float toKey);
	 ...
	 */
	Float2ObjectSortedMap<V> tailMap(float fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Float2ObjectMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectMap.Entry<V> from);
	}
