...
public final class Float2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2CharMap.Entry> fastIterator(Float2CharSortedMap map) {
		...
		return entries instanceof Float2CharSortedMap.FastSortedEntrySet
				? ((Float2CharSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Float2CharMaps.EmptyMap
			implements Float2CharSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2CharMaps.Singleton
		...
		public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2CharMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2CharMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Float2CharMaps.SynchronizedMap
			implements Float2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2CharEntrySet(), sync);
			return (ObjectSortedSet<Float2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2CharMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2CharEntrySet());
			return (ObjectSortedSet<Float2CharMap.Entry>) entries;
		}
