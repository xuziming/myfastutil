 ...
 *
 */
public class Float2IntRBTreeMap extends AbstractFloat2IntSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Float2IntRBTreeMap(final Comparator<? super Float> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Float2IntRBTreeMap(final Map<? extends Float, ? extends Integer> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2IntRBTreeMap(final SortedMap<Float, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Float2IntRBTreeMap(final Float2IntMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2IntRBTreeMap(final Float2IntSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2IntRBTreeMap(final float[] k, final int v[], final Comparator<? super Float> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Float2IntRBTreeMap(final float[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Float2IntRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
				final Comparator<? super Float2IntMap.Entry> comparator = (Comparator<Float2IntMap.Entry>) (x,
						y) -> Float2IntRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
				...
				public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry from, Float2IntMap.Entry to) {
					return subMap(from.getFloatKey(), to.getFloatKey()).float2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry to) {
					return headMap(to.getFloatKey()).float2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry from) {
					return tailMap(from.getFloatKey()).float2IntEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractFloat2IntSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final float k) {
			return (bottom || Float2IntRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Float2IntRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Float2IntRBTreeMap.Entry f = findKey(((Float) (e.getKey())).floatValue());
		...
		public boolean containsKey(final float k) {
			return in(k) && Float2IntRBTreeMap.this.containsKey(k);
		}
		...
		public int get(final float k) {
			final Float2IntRBTreeMap.Entry e;
			final float kk = k;
		...
		public int put(final float k, final int v) {
			...
			final int oldValue = Float2IntRBTreeMap.this.put(k, v);
		...
		public int remove(final float k) {
			...
			final int oldValue = Float2IntRBTreeMap.this.remove(k);
		...
		@Override
		public float firstFloatKey() {
			Float2IntRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public float lastFloatKey() {
			Float2IntRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Float2IntRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Float2IntRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Float2IntRBTreeMap clone() {
		...
		try {
			c = (Float2IntRBTreeMap) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
