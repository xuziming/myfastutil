 ...
 */
public abstract class AbstractFloat2ByteMap extends AbstractFloat2ByteFunction
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					private final ObjectIterator<Float2ByteMap.Entry> i = Float2ByteMaps
							.fastIterator(AbstractFloat2ByteMap.this);
