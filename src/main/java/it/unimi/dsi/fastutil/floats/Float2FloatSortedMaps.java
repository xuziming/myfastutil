...
public final class Float2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2FloatMap.Entry> fastIterator(Float2FloatSortedMap map) {
		...
		return entries instanceof Float2FloatSortedMap.FastSortedEntrySet
				? ((Float2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Float2FloatMaps.EmptyMap
			implements Float2FloatSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Float2FloatMaps.Singleton
			implements Float2FloatSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2FloatMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Float2FloatMaps.SynchronizedMap
			implements Float2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2FloatEntrySet(), sync);
			return (ObjectSortedSet<Float2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2FloatMaps.UnmodifiableMap
			implements Float2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2FloatSortedMap sortedMap;
		...
		public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2FloatEntrySet());
			return (ObjectSortedSet<Float2FloatMap.Entry>) entries;
		}
