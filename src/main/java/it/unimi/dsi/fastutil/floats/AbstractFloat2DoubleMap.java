...
public abstract class AbstractFloat2DoubleMap extends AbstractFloat2DoubleFunction
		implements Float2DoubleMap, java.io.Serializable {
	...
	public boolean containsKey(final float k) {
		final ObjectIterator<Float2DoubleMap.Entry> i = float2DoubleEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Float2DoubleMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Float2DoubleMap.Entry) {
				final Float2DoubleMap.Entry e = (Float2DoubleMap.Entry) o;
			...
			if (value == null || !(value instanceof Double))
				return false;
			return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float) (key)).floatValue())) && (Double
					.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double) (value)).doubleValue()));
		}
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Float2DoubleMap.Entry) {
				final Float2DoubleMap.Entry e = (Float2DoubleMap.Entry) o;
				return map.remove(e.getFloatKey(), e.getDoubleValue());
			}
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					private final ObjectIterator<Float2DoubleMap.Entry> i = Float2DoubleMaps
							.fastIterator(AbstractFloat2DoubleMap.this);
	...
	public void putAll(final Map<? extends Float, ? extends Double> m) {
		if (m instanceof Float2DoubleMap) {
			...
			while (i.hasNext()) {
				final Float2DoubleMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Float2DoubleMap.Entry> i = Float2DoubleMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
