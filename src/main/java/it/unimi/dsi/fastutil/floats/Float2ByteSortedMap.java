...
public interface Float2ByteSortedMap extends Float2ByteMap, SortedMap<Float, Byte> {
	 ...
	 */
	Float2ByteSortedMap subMap(float fromKey, float toKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Float2ByteMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Float2ByteMap.Entry> fastIterator(Float2ByteMap.Entry from);
	}
