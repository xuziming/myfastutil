 ...
 * iterator}.
 */
public class Float2FloatAVLTreeMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Float2FloatAVLTreeMap(final Comparator<? super Float> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Float2FloatAVLTreeMap(final Map<? extends Float, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2FloatAVLTreeMap(final SortedMap<Float, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Float2FloatAVLTreeMap(final Float2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2FloatAVLTreeMap(final Float2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2FloatAVLTreeMap(final float[] k, final float v[], final Comparator<? super Float> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Float2FloatAVLTreeMap(final float[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractFloat2FloatMap.BasicEntry implements Cloneable {
		 ...
		 * @param v a value.
		 */
		Entry(final float k, final float v) {
			super(k, v);
		...
		public boolean equals(final Object o) {
			...
			return (Float.floatToIntBits(key) == Float.floatToIntBits((e.getKey()).floatValue()))
					&& (Float.floatToIntBits(value) == Float.floatToIntBits((e.getValue()).floatValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Float2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	 ...
	 * This class can iterate in both directions on a threaded tree.
	 */
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2FloatMap.Entry> {
		EntryIterator() {
		}
	...
	public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
				final Comparator<? super Float2FloatMap.Entry> comparator = (Comparator<Float2FloatMap.Entry>) (x,
						y) -> Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
				...
				@Override
				public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(final Float2FloatMap.Entry from) {
				...
				public boolean remove(final Object o) {
					...
					if (e.getValue() == null || !(e.getValue() instanceof Float))
						return false;
					final Entry f = findKey(((Float) (e.getKey())).floatValue());
					if (f == null || !(Float.floatToIntBits(f.getFloatValue()) == Float
				...
				@Override
				public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry from,
						Float2FloatMap.Entry to) {
					return subMap(from.getFloatKey(), to.getFloatKey()).float2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry to) {
					return headMap(to.getFloatKey()).float2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry from) {
					return tailMap(from.getFloatKey()).float2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final float k) {
			return (bottom || Float2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Float2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Float2FloatAVLTreeMap.Entry f = findKey(((Float) (e.getKey())).floatValue());
		...
		public boolean containsKey(final float k) {
			return in(k) && Float2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		public float get(final float k) {
			final Float2FloatAVLTreeMap.Entry e;
			final float kk = k;
		...
		public float put(final float k, final float v) {
			...
			final float oldValue = Float2FloatAVLTreeMap.this.put(k, v);
		...
		public float remove(final float k) {
			...
			final float oldValue = Float2FloatAVLTreeMap.this.remove(k);
		...
		@Override
		public float firstFloatKey() {
			Float2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public float lastFloatKey() {
			Float2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Float2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Float2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry readTree(final java.io.ObjectInputStream s, final int n, final Entry pred, final Entry succ)
		...
		if (n == 1) {
			final Entry top = new Entry(s.readFloat(), s.readFloat());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
