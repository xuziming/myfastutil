...
public class Float2FloatArrayMap extends AbstractFloat2FloatMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(Object o) {
			...
			return Float2FloatArrayMap.this.containsKey(k)
					&& (Float.floatToIntBits(Float2FloatArrayMap.this.get(k)) == Float
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1
					|| !(Float.floatToIntBits(v) == Float.floatToIntBits(Float2FloatArrayMap.this.value[oldPos])))
				return false;
