...
public final class Float2ReferenceMaps {
	...
	public static <V> ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator(Float2ReferenceMap<V> map) {
		...
		return entries instanceof Float2ReferenceMap.FastEntrySet
				? ((Float2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Float2ReferenceMap<V> map,
			final Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
		if (entries instanceof Float2ReferenceMap.FastEntrySet)
			((Float2ReferenceMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Float2ReferenceMap.Entry<V>> fastIterable(Float2ReferenceMap<V> map) {
		...
		return entries instanceof Float2ReferenceMap.FastEntrySet ? new ObjectIterable<Float2ReferenceMap.Entry<V>>() {
			public ObjectIterator<Float2ReferenceMap.Entry<V>> iterator() {
				return ((Float2ReferenceMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Float2ReferenceFunctions.EmptyFunction<V>
			implements Float2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Float2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Float2ReferenceFunctions.SynchronizedFunction<V>
			implements Float2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2ReferenceEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super V> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super Float, ? super V, ? extends V> function) {
			synchronized (sync) {
		...
		@Override
		public V computeIfAbsent(final float key,
				final java.util.function.DoubleFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V computeIfAbsentPartial(final float key, final Float2ReferenceFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V computeIfPresent(final float key,
		...
		@Override
		public V compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V merge(final float key, final V value,
		...
		@Override
		public V computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<V> extends Float2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2ReferenceEntrySet());
			return entries;
		}
