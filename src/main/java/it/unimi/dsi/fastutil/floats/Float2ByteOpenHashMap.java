 ...
 * @see HashCommon
 */
public class Float2ByteOpenHashMap extends AbstractFloat2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Float2ByteOpenHashMap.this.remove(wrapped.getFloat(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2ByteOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2ByteOpenHashMap.this.key;
			int pos;
			// The starting point.
