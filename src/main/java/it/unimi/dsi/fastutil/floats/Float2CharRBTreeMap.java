 ...
 *
 */
public class Float2CharRBTreeMap extends AbstractFloat2CharSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Float2CharRBTreeMap(final Comparator<? super Float> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Float2CharRBTreeMap(final Map<? extends Float, ? extends Character> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2CharRBTreeMap(final SortedMap<Float, Character> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Float2CharRBTreeMap(final Float2CharMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2CharRBTreeMap(final Float2CharSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2CharRBTreeMap(final float[] k, final char v[], final Comparator<? super Float> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Float2CharRBTreeMap(final float[] k, final char v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Float2CharRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Float2CharMap.Entry>() {
				final Comparator<? super Float2CharMap.Entry> comparator = (Comparator<Float2CharMap.Entry>) (x,
						y) -> Float2CharRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
				...
				public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) {
					return subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) {
					return headMap(to.getFloatKey()).float2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) {
					return tailMap(from.getFloatKey()).float2CharEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractFloat2CharSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final float k) {
			return (bottom || Float2CharRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Float2CharRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Float2CharMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Float2CharRBTreeMap.Entry f = findKey(((Float) (e.getKey())).floatValue());
					...
					@Override
					public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from,
							Float2CharMap.Entry to) {
						return subMap(from.getFloatKey(), to.getFloatKey()).float2CharEntrySet();
					}
		...
		public boolean containsKey(final float k) {
			return in(k) && Float2CharRBTreeMap.this.containsKey(k);
		}
		...
		public char get(final float k) {
			final Float2CharRBTreeMap.Entry e;
			final float kk = k;
		...
		public char put(final float k, final char v) {
			...
			final char oldValue = Float2CharRBTreeMap.this.put(k, v);
		...
		public char remove(final float k) {
			...
			final char oldValue = Float2CharRBTreeMap.this.remove(k);
		...
		@Override
		public float firstFloatKey() {
			Float2CharRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public float lastFloatKey() {
			Float2CharRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Float2CharRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Float2CharRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
