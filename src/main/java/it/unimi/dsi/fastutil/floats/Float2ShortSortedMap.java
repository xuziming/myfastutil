...
public interface Float2ShortSortedMap extends Float2ShortMap, SortedMap<Float, Short> {
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Float2ShortMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator(Float2ShortMap.Entry from);
	}
