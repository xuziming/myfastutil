...
public interface Float2CharMap extends Float2CharFunction, Map<Float, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Float2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Float2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final float key, final java.util.function.DoubleToIntFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final float key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final float key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Float.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final float key,
			final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Float.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final float key, final char value,
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Float key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Float key,
			final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Float key,
			final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Float key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Float, Character> {
		/**
