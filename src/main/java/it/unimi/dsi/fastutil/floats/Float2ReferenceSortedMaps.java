...
public final class Float2ReferenceSortedMaps {
	...
	public static Comparator<? super Map.Entry<Float, ?>> entryComparator(final FloatComparator comparator) {
		return (Comparator<Map.Entry<Float, ?>>) (x, y) -> comparator.compare((x.getKey()).floatValue(),
				(y.getKey()).floatValue());
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> fastIterator(
			Float2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
		return entries instanceof Float2ReferenceSortedMap.FastSortedEntrySet
				? ((Float2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Float2ReferenceMap.Entry<V>> fastIterable(
			Float2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
		return entries instanceof Float2ReferenceSortedMap.FastSortedEntrySet
				? ((Float2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	...
	public static class EmptySortedMap<V> extends Float2ReferenceMaps.EmptyMap<V>
			implements Float2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Float2ReferenceMaps.Singleton<V>
		...
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2ReferenceMap.Entry<V>>) entries;
		}
		...
		public FloatSortedSet keySet() {
			if (keys == null)
				keys = FloatSortedSets.singleton(key, comparator);
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Float2ReferenceSortedMap<V> singleton(final Float key, V value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Float2ReferenceSortedMap<V> singleton(final Float key, V value, FloatComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Float2ReferenceSortedMap<V> singleton(final float key, final V value) {
	...
	public static class SynchronizedSortedMap<V> extends Float2ReferenceMaps.SynchronizedMap<V>
			implements Float2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2ReferenceSortedMap<V> sortedMap;

		protected SynchronizedSortedMap(final Float2ReferenceSortedMap<V> m, final Object sync) {
			super(m, sync);
			sortedMap = m;
		}

		protected SynchronizedSortedMap(final Float2ReferenceSortedMap<V> m) {
			super(m);
			sortedMap = m;
		}
		...
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Float2ReferenceMap.Entry<V>>) entries;
		}
		...
		public FloatSortedSet keySet() {
			if (keys == null)
				keys = FloatSortedSets.synchronize(sortedMap.keySet(), sync);
			return (FloatSortedSet) keys;
		}
	 ...
	 */
	public static <V> Float2ReferenceSortedMap<V> synchronize(final Float2ReferenceSortedMap<V> m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static <V> Float2ReferenceSortedMap<V> synchronize(final Float2ReferenceSortedMap<V> m, final Object sync) {
	...
	public static class UnmodifiableSortedMap<V> extends Float2ReferenceMaps.UnmodifiableMap<V>
		...
		protected UnmodifiableSortedMap(final Float2ReferenceSortedMap<V> m) {
			super(m);
			sortedMap = m;
		}
		...
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2ReferenceEntrySet());
			return (ObjectSortedSet<Float2ReferenceMap.Entry<V>>) entries;
		}
		...
		public FloatSortedSet keySet() {
			if (keys == null)
				keys = FloatSortedSets.unmodifiable(sortedMap.keySet());
			return (FloatSortedSet) keys;
		}
	 ...
	 */
	public static <V> Float2ReferenceSortedMap<V> unmodifiable(final Float2ReferenceSortedMap<V> m) {
