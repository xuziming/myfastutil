...
public abstract class AbstractFloat2IntMap extends AbstractFloat2IntFunction
		implements Float2IntMap, java.io.Serializable {
	...
	public boolean containsKey(final float k) {
		final ObjectIterator<Float2IntMap.Entry> i = float2IntEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Float2IntMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Float2IntMap.Entry) {
				final Float2IntMap.Entry e = (Float2IntMap.Entry) o;
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Float2IntMap.Entry) {
				final Float2IntMap.Entry e = (Float2IntMap.Entry) o;
				return map.remove(e.getFloatKey(), e.getIntValue());
			}
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					private final ObjectIterator<Float2IntMap.Entry> i = Float2IntMaps
							.fastIterator(AbstractFloat2IntMap.this);
	...
	public void putAll(final Map<? extends Float, ? extends Integer> m) {
		if (m instanceof Float2IntMap) {
			...
			while (i.hasNext()) {
				final Float2IntMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Float2IntMap.Entry> i = Float2IntMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
