...
public final class Float2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator(Float2ShortSortedMap map) {
		...
		return entries instanceof Float2ShortSortedMap.FastSortedEntrySet
				? ((Float2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Float2ShortMaps.EmptyMap
			implements Float2ShortSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Float2ShortMaps.Singleton
			implements Float2ShortSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final FloatComparator comparator;

		protected Singleton(final float key, final short value, FloatComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2ShortMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2ShortMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2ShortSortedMap singleton(final Float key, Short value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2ShortSortedMap singleton(final Float key, Short value, FloatComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2ShortSortedMap singleton(final float key, final short value, FloatComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Float2ShortMaps.SynchronizedMap
			implements Float2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2ShortEntrySet(), sync);
			return (ObjectSortedSet<Float2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2ShortMaps.UnmodifiableMap
			implements Float2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2ShortSortedMap sortedMap;
		...
		public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2ShortEntrySet());
			return (ObjectSortedSet<Float2ShortMap.Entry>) entries;
		}
