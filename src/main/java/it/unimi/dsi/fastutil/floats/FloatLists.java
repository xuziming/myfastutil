...
public final class FloatLists {
	...
	public static class EmptyList extends FloatCollections.EmptyCollection
			implements FloatList, RandomAccess, java.io.Serializable, Cloneable {
		...
		@Override
		public void sort(final FloatComparator comparator) {
		}

		@Override
		public void unstableSort(final FloatComparator comparator) {
		}

		// Empty lists are trivially always sorted
		@Deprecated
		@Override
		public void sort(final java.util.Comparator<? super Float> comparator) {
		}

		@Deprecated
		@Override
		public void unstableSort(final java.util.Comparator<? super Float> comparator) {
		}
		...
		@Override
		public void addElements(int index, final float a[]) {
			throw new UnsupportedOperationException();
		}

		@Override
		public void setElements(final float a[]) {
			throw new UnsupportedOperationException();
		}

		@Override
		public void setElements(int index, final float a[]) {
			throw new UnsupportedOperationException();
		}
	...
	public static class SynchronizedList extends FloatCollections.SynchronizedCollection
			implements FloatList, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final FloatList list; // Due to the large number of methods that are not in COLLECTION, this is worth
										// caching.
		...
		@Override
		public boolean addAll(final int index, FloatList l) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public void add(final int i, Float k) {
			synchronized (sync) {
				list.add(i, k);
			}
		}
		...
		@Deprecated
		@Override
		public Float set(final int index, Float k) {
			synchronized (sync) {
	...
	public static class UnmodifiableList extends FloatCollections.UnmodifiableCollection
		...
		@Override
		public FloatListIterator listIterator() {
			return FloatIterators.unmodifiable(list.listIterator());
		}
		...
		@Override
		public FloatListIterator listIterator(final int i) {
			return FloatIterators.unmodifiable(list.listIterator(i));
		}
