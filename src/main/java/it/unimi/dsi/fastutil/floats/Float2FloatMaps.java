...
public final class Float2FloatMaps {
	...
	public static ObjectIterator<Float2FloatMap.Entry> fastIterator(Float2FloatMap map) {
		...
		return entries instanceof Float2FloatMap.FastEntrySet ? ((Float2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Float2FloatFunctions.EmptyFunction
			implements Float2FloatMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Float2FloatFunctions.Singleton
			implements Float2FloatMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2FloatMap.BasicEntry(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2FloatMap singleton(final float key, float value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2FloatMap singleton(final Float key, final Float value) {
		return new Singleton((key).floatValue(), (value).floatValue());
	}

	/** A synchronized wrapper class for maps. */
	public static class SynchronizedMap extends Float2FloatFunctions.SynchronizedFunction
			implements Float2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		// Defaultable methods
		@Override
		public float getOrDefault(final float key, final float defaultValue) {
			synchronized (sync) {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Float> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public boolean remove(final float key, final float value) {
			synchronized (sync) {
		...
		@Override
		public float replace(final float key, final float value) {
			synchronized (sync) {
		...
		@Override
		public boolean replace(final float key, final float oldValue, final float newValue) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final float key, final java.util.function.DoubleUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final float key,
		...
		@Override
		public float computeIfAbsentPartial(final float key, final Float2FloatFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfPresent(final float key,
		...
		@Override
		public float compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final float key, final float value,
				final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	 ...
	 */
	public static Float2FloatMap synchronize(final Float2FloatMap m) {
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static Float2FloatMap synchronize(final Float2FloatMap m, final Object sync) {
		return new SynchronizedMap(m, sync);
	}

	/** An unmodifiable wrapper class for maps. */
	public static class UnmodifiableMap extends Float2FloatFunctions.UnmodifiableFunction
			implements Float2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2FloatMap map;
		protected transient ObjectSet<Float2FloatMap.Entry> entries;
		...
		public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2FloatEntrySet());
			return entries;
		}
	 ...
	 */
	public static Float2FloatMap unmodifiable(final Float2FloatMap m) {
