 ...
 */
@FunctionalInterface
public interface Float2BooleanFunction extends Function<Float, Boolean>, java.util.function.DoublePredicate {
	/**
	 * {@inheritDoc}
	 *
	 * <p>
	 ...
	 *
	 * @throws IllegalArgumentException If the given operand is not an element of
	 *                                  the key domain.
	 * @since 8.0.0
	 ...
	 */
	default boolean remove(final float key) {
		throw new UnsupportedOperationException();
	}
	...
	default Boolean get(final Object key) {
		...
		return (v != defaultReturnValue() || containsKey(k)) ? Boolean.valueOf(v) : null;
	}
