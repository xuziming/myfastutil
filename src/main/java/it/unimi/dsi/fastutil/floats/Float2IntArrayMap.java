 ...
 */
public class Float2IntArrayMap extends AbstractFloat2IntMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Float2IntMap.Entry> iterator() {
			return new ObjectIterator<Float2IntMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractFloat2IntMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Float2IntArrayMap.this.containsKey(k)
					&& ((Float2IntArrayMap.this.get(k)) == (((Integer) (e.getValue())).intValue()));
		}
