...
public final class Float2LongMaps {
	...
	public static ObjectIterator<Float2LongMap.Entry> fastIterator(Float2LongMap map) {
		...
		return entries instanceof Float2LongMap.FastEntrySet ? ((Float2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Float2LongMap map, final Consumer<? super Float2LongMap.Entry> consumer) {
		final ObjectSet<Float2LongMap.Entry> entries = map.float2LongEntrySet();
	...
	public static class EmptyMap extends Float2LongFunctions.EmptyFunction
			implements Float2LongMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2LongFunctions.Singleton
		...
		public ObjectSet<Float2LongMap.Entry> float2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2LongFunctions.SynchronizedFunction
			implements Float2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2LongMap.Entry> float2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Long> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsent(final float key, final java.util.function.DoubleToLongFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final float key,
		...
		@Override
		public long computeIfPresent(final float key,
		...
		@Override
		public long compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final float key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
