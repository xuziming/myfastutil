...
public final class Float2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2IntMap.Entry> fastIterator(Float2IntSortedMap map) {
		...
		return entries instanceof Float2IntSortedMap.FastSortedEntrySet
				? ((Float2IntSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Float2IntMaps.EmptyMap
			implements Float2IntSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2IntMaps.Singleton
		...
		public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2IntMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Float2IntMaps.SynchronizedMap
			implements Float2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2IntEntrySet(), sync);
			return (ObjectSortedSet<Float2IntMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2IntMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2IntEntrySet());
			return (ObjectSortedSet<Float2IntMap.Entry>) entries;
		}
