...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap
	...
	public Float2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsent(final float k, final java.util.function.DoubleUnaryOperator mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final float k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final float k,
			final java.util.function.BiFunction<? super Float, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Double newValue = remappingFunction.apply(Float.valueOf(k), Double.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), (0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final float k,
			final java.util.function.BiFunction<? super Float, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Double newValue = remappingFunction.apply(Float.valueOf(k), pos >= 0 ? Double.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), (0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final float k, final double v,
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Float2DoubleOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final float key[] = Float2DoubleOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Float2DoubleOpenCustomHashMap.this.remove(wrapped.getFloat(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Float2DoubleOpenCustomHashMap.this.containsNullKey
		...
		public void forEach(final Consumer<? super Float2DoubleMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractFloat2DoubleMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!(Float.floatToIntBits(key[pos]) == 0))
					consumer.accept(new AbstractFloat2DoubleMap.BasicEntry(key[pos], value[pos]));
		}
