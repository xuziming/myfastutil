...
public final class Float2IntFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractFloat2IntFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2IntFunction singleton(final float key, int value) {
	...
	public static class SynchronizedFunction implements Float2IntFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction extends AbstractFloat2IntFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2IntFunction function;
	...
	public static class PrimitiveFunction implements Float2IntFunction {
		...
		public int get(float key) {
			Integer v = function.apply(Float.valueOf(key));
			if (v == null)
	...
	public static Float2IntFunction primitive(final java.util.function.Function<? super Float, ? extends Integer> f) {
