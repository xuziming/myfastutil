...
public class Float2IntLinkedOpenHashMap extends AbstractFloat2IntSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2IntMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry fromElement,
				Float2IntMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2IntLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2IntLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Float2IntMap.Entry> iterator(final Float2IntMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Float2IntMap.Entry> fastIterator(final Float2IntMap.Entry from) {
		...
		public void forEach(final Consumer<? super Float2IntMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractFloat2IntMap.BasicEntry(key[curr], value[curr]));
			}
		}
