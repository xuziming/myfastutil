 ...
 */
public abstract class AbstractFloat2ObjectMap<V> extends AbstractFloat2ObjectFunction<V>
	...
	public boolean containsKey(final float k) {
		final ObjectIterator<Float2ObjectMap.Entry<V>> i = float2ObjectEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry<V> implements Float2ObjectMap.Entry<V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Float2ObjectMap.Entry) {
				final Float2ObjectMap.Entry<V> e = (Float2ObjectMap.Entry<V>) o;
			...
			return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float) (key)).floatValue()))
					&& java.util.Objects.equals(this.value, (value));
		}
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					private final ObjectIterator<Float2ObjectMap.Entry<V>> i = Float2ObjectMaps
							.fastIterator(AbstractFloat2ObjectMap.this);
	...
	public void putAll(final Map<? extends Float, ? extends V> m) {
		if (m instanceof Float2ObjectMap) {
			...
			while (i.hasNext()) {
				final Float2ObjectMap.Entry<? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Float2ObjectMap.Entry<V>> i = Float2ObjectMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
