 ...
 * @see HashCommon
 */
public class Float2IntOpenHashMap extends AbstractFloat2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Float2IntOpenHashMap.this.remove(wrapped.getFloat(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2IntOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2IntOpenHashMap.this.key;
			int pos;
			// The starting point.
