...
public final class Float2ObjectMaps {
	...
	public static <V> ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectMap<V> map) {
		...
		return entries instanceof Float2ObjectMap.FastEntrySet
				? ((Float2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Float2ObjectMap<V> map,
			final Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Float2ObjectMap.Entry<V>> entries = map.float2ObjectEntrySet();
		if (entries instanceof Float2ObjectMap.FastEntrySet)
			((Float2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Float2ObjectMap.Entry<V>> fastIterable(Float2ObjectMap<V> map) {
		...
		return entries instanceof Float2ObjectMap.FastEntrySet ? new ObjectIterable<Float2ObjectMap.Entry<V>>() {
			public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() {
				return ((Float2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Float2ObjectFunctions.EmptyFunction<V>
			implements Float2ObjectMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Float2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Float2ObjectFunctions.SynchronizedFunction<V>
			implements Float2ObjectMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Float2ObjectFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2ObjectEntrySet());
			return entries;
		}
