...
public final class Float2BooleanMaps {
	...
	public static ObjectIterator<Float2BooleanMap.Entry> fastIterator(Float2BooleanMap map) {
		...
		return entries instanceof Float2BooleanMap.FastEntrySet
				? ((Float2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Float2BooleanMap map, final Consumer<? super Float2BooleanMap.Entry> consumer) {
		final ObjectSet<Float2BooleanMap.Entry> entries = map.float2BooleanEntrySet();
	...
	public static class EmptyMap extends Float2BooleanFunctions.EmptyFunction
			implements Float2BooleanMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2BooleanFunctions.Singleton
		...
		public ObjectSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2BooleanFunctions.SynchronizedFunction
			implements Float2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Boolean> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsent(final float key, final java.util.function.DoublePredicate mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final float key,
		...
		@Override
		public boolean computeIfPresent(final float key,
		...
		@Override
		public boolean compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final float key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends Boolean> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Float2BooleanFunctions.UnmodifiableFunction
		...
		public ObjectSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2BooleanEntrySet());
			return entries;
		}
