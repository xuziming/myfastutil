 ...
 * @see HashCommon
 */
public class Float2FloatLinkedOpenHashMap extends AbstractFloat2FloatSortedMap
	...
	public Float2FloatLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Float2FloatLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Float2FloatLinkedOpenHashMap(final Map<? extends Float, ? extends Float> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Float2FloatLinkedOpenHashMap(final Map<? extends Float, ? extends Float> m) {
	 ...
	 * @param f the load factor.
	 */
	public Float2FloatLinkedOpenHashMap(final Float2FloatMap m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Float2FloatLinkedOpenHashMap(final Float2FloatMap m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2FloatLinkedOpenHashMap(final float[] k, final float[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Float2FloatLinkedOpenHashMap(final float[] k, final float[] v) {
	 ...
	 */
	public float getAndMoveToFirst(final float k) {
		if ((Float.floatToIntBits(k) == 0)) {
			if (containsNullKey) {
				moveIndexToFirst(n);
				return value[n];
	 ...
	 *         default return value} if no value was present for the given key.
	 */
	public float getAndMoveToLast(final float k) {
		if ((Float.floatToIntBits(k) == 0)) {
			if (containsNullKey) {
				moveIndexToLast(n);
				return value[n];
	 ...
	 *         return value} if no value was present for the given key.
	 */
	public float putAndMoveToFirst(final float k, final float v) {
		int pos;
		if ((Float.floatToIntBits(k) == 0)) {
			if (containsNullKey) {
				moveIndexToFirst(n);
	 ...
	 *         return value} if no value was present for the given key.
	 */
	public float putAndMoveToLast(final float k, final float v) {
		int pos;
		if ((Float.floatToIntBits(k) == 0)) {
			if (containsNullKey) {
				moveIndexToLast(n);
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				float curr;
				final float[] key = Float2FloatLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2FloatMap.Entry>
		...
		@Override
		public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry fromElement,
				Float2FloatMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Float2FloatMap.Entry> iterator(final Float2FloatMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Float2FloatMap.Entry> fastIterator(final Float2FloatMap.Entry from) {
		...
		public void forEach(final Consumer<? super Float2FloatMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractFloat2FloatMap.BasicEntry(key[curr], value[curr]));
			}
		}
