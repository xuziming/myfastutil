...
public final class Float2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<V> extends AbstractFloat2ReferenceFunction<V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<V> extends AbstractFloat2ReferenceFunction<V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Float2ReferenceFunction<V> singleton(final float key, V value) {
	...
	public static class SynchronizedFunction<V> implements Float2ReferenceFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<V> extends AbstractFloat2ReferenceFunction<V>
	...
	public static class PrimitiveFunction<V> implements Float2ReferenceFunction<V> {
		...
		public V get(float key) {
			V v = function.apply(Float.valueOf(key));
			if (v == null)
				return null;
			return (v);
		}
	...
	public static <V> Float2ReferenceFunction<V> primitive(
			final java.util.function.Function<? super Float, ? extends V> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Float2ReferenceFunction)
			return (Float2ReferenceFunction<V>) f;
