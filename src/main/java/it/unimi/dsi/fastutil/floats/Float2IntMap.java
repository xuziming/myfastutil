...
public interface Float2IntMap extends Float2IntFunction, Map<Float, Integer> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Float2IntMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Float2IntMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsent(final float key, final java.util.function.DoubleToIntFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsentNullable(final float key,
	 ...
	 * @since 8.0.0
	 */
	default int computeIfPresent(final float key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Integer newValue = remappingFunction.apply(Float.valueOf(key), Integer.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default int compute(final float key,
			final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Integer newValue = remappingFunction.apply(Float.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default int merge(final float key, final int value,
	...
	@Deprecated
	@Override
	default Integer computeIfAbsent(final Float key,
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Float key,
			final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Float key,
			final java.util.function.BiFunction<? super Float, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Float key, final Integer value,
			final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Float, Integer> {
		/**
