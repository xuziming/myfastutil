 ...
 * @see HashCommon
 */
public class Float2CharOpenHashMap extends AbstractFloat2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Float2CharOpenHashMap.this.remove(wrapped.getFloat(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2CharOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2CharOpenHashMap.this.key;
			int pos;
			// The starting point.
