 ...
 */
public class Float2ReferenceArrayMap<V> extends AbstractFloat2ReferenceMap<V>
	...
	private final class EntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		@Override
		...
		public boolean contains(Object o) {
			...
			return Float2ReferenceArrayMap.this.containsKey(k)
					&& ((Float2ReferenceArrayMap.this.get(k)) == ((e.getValue())));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Float2ReferenceArrayMap.this.key, oldPos + 1, Float2ReferenceArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Float2ReferenceArrayMap.this.value, oldPos + 1, Float2ReferenceArrayMap.this.value, oldPos,
					tail);
