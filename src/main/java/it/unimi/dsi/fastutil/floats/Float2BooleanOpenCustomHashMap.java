...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap
	...
	public Float2BooleanOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final Map<? extends Float, ? extends Boolean> m, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final Map<? extends Float, ? extends Boolean> m,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final Float2BooleanMap m, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Float2BooleanOpenCustomHashMap(final Float2BooleanMap m,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2BooleanOpenCustomHashMap(final float[] k, final boolean[] v, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Float2BooleanOpenCustomHashMap(final float[] k, final boolean[] v,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsentNullable(final float k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfPresent(final float k,
			final java.util.function.BiFunction<? super Float, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean compute(final float k,
			final java.util.function.BiFunction<? super Float, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Boolean newValue = remappingFunction.apply(Float.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public boolean merge(final float k, final boolean v,
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Float2BooleanOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Float2BooleanOpenCustomHashMap.this.remove(wrapped.getFloat(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Float2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Float2BooleanMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractFloat2BooleanMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!(Float.floatToIntBits(key[pos]) == 0))
					consumer.accept(new AbstractFloat2BooleanMap.BasicEntry(key[pos], value[pos]));
		}
