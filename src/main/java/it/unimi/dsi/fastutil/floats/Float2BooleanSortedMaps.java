...
public final class Float2BooleanSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator(Float2BooleanSortedMap map) {
		final ObjectSortedSet<Float2BooleanMap.Entry> entries = map.float2BooleanEntrySet();
		return entries instanceof Float2BooleanSortedMap.FastSortedEntrySet
				? ((Float2BooleanSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Float2BooleanMaps.EmptyMap
			implements Float2BooleanSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2BooleanMaps.Singleton
		...
		protected Singleton(final float key, final boolean value, FloatComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2BooleanMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2BooleanMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2BooleanSortedMap singleton(final Float key, Boolean value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2BooleanSortedMap singleton(final Float key, Boolean value, FloatComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2BooleanSortedMap singleton(final float key, final boolean value, FloatComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Float2BooleanMaps.SynchronizedMap
			implements Float2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Float2BooleanMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2BooleanMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2BooleanEntrySet());
			return (ObjectSortedSet<Float2BooleanMap.Entry>) entries;
		}
