 ...
 */
public abstract class AbstractFloat2ReferenceMap<V> extends AbstractFloat2ReferenceFunction<V>
	...
	public boolean containsKey(final float k) {
		final ObjectIterator<Float2ReferenceMap.Entry<V>> i = float2ReferenceEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry<V> implements Float2ReferenceMap.Entry<V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Float2ReferenceMap.Entry) {
				final Float2ReferenceMap.Entry<V> e = (Float2ReferenceMap.Entry<V>) o;
				return (Float.floatToIntBits(key) == Float.floatToIntBits(e.getFloatKey()))
						&& ((value) == (e.getValue()));
			}
			...
			return (Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float) (key)).floatValue()))
					&& ((this.value) == ((value)));
		}
	...
	public abstract static class BasicEntrySet<V> extends AbstractObjectSet<Entry<V>> {
		...
		public BasicEntrySet(final Float2ReferenceMap<V> map) {
			this.map = map;
		}
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Float2ReferenceMap.Entry) {
				final Float2ReferenceMap.Entry<V> e = (Float2ReferenceMap.Entry<V>) o;
				return map.remove(e.getFloatKey(), e.getValue());
			}
		...
		return new AbstractFloatSet() {
			...
			public FloatIterator iterator() {
				return new FloatIterator() {
					private final ObjectIterator<Float2ReferenceMap.Entry<V>> i = Float2ReferenceMaps
							.fastIterator(AbstractFloat2ReferenceMap.this);
	...
	public void putAll(final Map<? extends Float, ? extends V> m) {
		if (m instanceof Float2ReferenceMap) {
			ObjectIterator<Float2ReferenceMap.Entry<V>> i = Float2ReferenceMaps.fastIterator((Float2ReferenceMap<V>) m);
			while (i.hasNext()) {
				final Float2ReferenceMap.Entry<? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Float2ReferenceMap.Entry<V>> i = Float2ReferenceMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
