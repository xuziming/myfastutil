...
public final class Float2ObjectFunctions {
	 ...
	 */
	public static class EmptyFunction<V> extends AbstractFloat2ObjectFunction<V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<V> extends AbstractFloat2ObjectFunction<V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class SynchronizedFunction<V> implements Float2ObjectFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<V> extends AbstractFloat2ObjectFunction<V>
	...
	public static <V> Float2ObjectFunction<V> primitive(
