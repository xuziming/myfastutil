...
public final class Float2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2DoubleMap.Entry> fastIterator(Float2DoubleSortedMap map) {
		final ObjectSortedSet<Float2DoubleMap.Entry> entries = map.float2DoubleEntrySet();
		return entries instanceof Float2DoubleSortedMap.FastSortedEntrySet
				? ((Float2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Float2DoubleMaps.EmptyMap
			implements Float2DoubleSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2DoubleMaps.Singleton
		...
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2DoubleMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Float2DoubleMaps.SynchronizedMap
			implements Float2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Float2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Float2DoubleMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2DoubleEntrySet());
			return (ObjectSortedSet<Float2DoubleMap.Entry>) entries;
		}
