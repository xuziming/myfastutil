 ...
 * iterator}.
 */
public class Float2DoubleAVLTreeMap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Float2DoubleAVLTreeMap(final Comparator<? super Float> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Float2DoubleAVLTreeMap(final Map<? extends Float, ? extends Double> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2DoubleAVLTreeMap(final SortedMap<Float, Double> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Float2DoubleAVLTreeMap(final Float2DoubleMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2DoubleAVLTreeMap(final Float2DoubleSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2DoubleAVLTreeMap(final float[] k, final double v[], final Comparator<? super Float> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Float2DoubleAVLTreeMap(final float[] k, final double v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Float2DoubleAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
				final Comparator<? super Float2DoubleMap.Entry> comparator = (Comparator<Float2DoubleMap.Entry>) (x,
						y) -> Float2DoubleAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
				...
				@Override
				public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry from,
						Float2DoubleMap.Entry to) {
					return subMap(from.getFloatKey(), to.getFloatKey()).float2DoubleEntrySet();
				}
	 ...
	 */
	private final class Submap extends AbstractFloat2DoubleSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final float k) {
			return (bottom || Float2DoubleAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Float2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Float2DoubleAVLTreeMap.Entry f = findKey(((Float) (e.getKey())).floatValue());
		...
		public boolean containsKey(final float k) {
			return in(k) && Float2DoubleAVLTreeMap.this.containsKey(k);
		}
		...
		public double get(final float k) {
			final Float2DoubleAVLTreeMap.Entry e;
			final float kk = k;
		...
		public double put(final float k, final double v) {
			...
			final double oldValue = Float2DoubleAVLTreeMap.this.put(k, v);
		...
		public double remove(final float k) {
			...
			final double oldValue = Float2DoubleAVLTreeMap.this.remove(k);
		...
		@Override
		public float firstFloatKey() {
			Float2DoubleAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public float lastFloatKey() {
			Float2DoubleAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Float2DoubleAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Float2DoubleAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
