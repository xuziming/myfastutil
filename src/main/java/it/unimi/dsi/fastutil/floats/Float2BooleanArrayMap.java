 ...
 */
public class Float2BooleanArrayMap extends AbstractFloat2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Float2BooleanMap.Entry> iterator() {
			return new ObjectIterator<Float2BooleanMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractFloat2BooleanMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Float2BooleanArrayMap.this.containsKey(k)
					&& ((Float2BooleanArrayMap.this.get(k)) == (((Boolean) (e.getValue())).booleanValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Float2BooleanArrayMap.this.value, oldPos + 1, Float2BooleanArrayMap.this.value, oldPos,
					tail);
