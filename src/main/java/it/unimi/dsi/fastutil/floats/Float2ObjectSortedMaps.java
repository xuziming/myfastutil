...
public final class Float2ObjectSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectSortedMap<V> map) {
		...
		return entries instanceof Float2ObjectSortedMap.FastSortedEntrySet
				? ((Float2ObjectSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<V> extends Float2ObjectMaps.EmptyMap<V>
			implements Float2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<V> extends Float2ObjectMaps.Singleton<V>
			implements Float2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2ObjectMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2ObjectMap.Entry<V>>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
			return (ObjectSortedSet) float2ObjectEntrySet();
		}
	...
	public static class SynchronizedSortedMap<V> extends Float2ObjectMaps.SynchronizedMap<V>
		...
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Float2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Float2ObjectMaps.UnmodifiableMap<V>
			implements Float2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2ObjectSortedMap<V> sortedMap;
		...
		public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2ObjectEntrySet());
			return (ObjectSortedSet<Float2ObjectMap.Entry<V>>) entries;
		}
