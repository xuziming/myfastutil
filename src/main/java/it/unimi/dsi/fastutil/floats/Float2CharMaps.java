...
public final class Float2CharMaps {
	...
	public static ObjectIterator<Float2CharMap.Entry> fastIterator(Float2CharMap map) {
		...
		return entries instanceof Float2CharMap.FastEntrySet ? ((Float2CharMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Float2CharFunctions.EmptyFunction
			implements Float2CharMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2CharFunctions.Singleton
		...
		public ObjectSet<Float2CharMap.Entry> float2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2CharFunctions.SynchronizedFunction
			implements Float2CharMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2CharMap.Entry> float2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final float key,
		...
		@Override
		public char computeIfPresent(final float key,
		...
		@Override
		public char compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char merge(final float key, final char value,
		...
		@Deprecated
		@Override
		public Character computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends Character> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Float key,
				final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character compute(final Float key,
				final java.util.function.BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character merge(final Float key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Float2CharFunctions.UnmodifiableFunction
		...
		public ObjectSet<Float2CharMap.Entry> float2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2CharEntrySet());
			return entries;
		}
