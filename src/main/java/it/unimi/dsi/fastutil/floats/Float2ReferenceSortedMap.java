...
public interface Float2ReferenceSortedMap<V> extends Float2ReferenceMap<V>, SortedMap<Float, V> {
	 ...
	 */
	Float2ReferenceSortedMap<V> subMap(float fromKey, float toKey);
	 ...
	 */
	Float2ReferenceSortedMap<V> headMap(float toKey);
	 ...
	 */
	Float2ReferenceSortedMap<V> tailMap(float fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Float2ReferenceMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> fastIterator(Float2ReferenceMap.Entry<V> from);
	}
