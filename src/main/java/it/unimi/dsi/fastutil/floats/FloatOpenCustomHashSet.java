...
public class FloatOpenCustomHashSet extends AbstractFloatSet implements java.io.Serializable, Cloneable, Hash {
	...
	public FloatOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final Collection<? extends Float> c, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final Collection<? extends Float> c,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final FloatCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final FloatCollection c,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final FloatIterator i, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final FloatIterator i,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final float[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final float[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public FloatOpenCustomHashSet(final float[] a, final float f,
			final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
