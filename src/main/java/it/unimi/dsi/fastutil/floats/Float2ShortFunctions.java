...
public final class Float2ShortFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractFloat2ShortFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Float2ShortFunction singleton(final float key, short value) {
	...
	public static class SynchronizedFunction implements Float2ShortFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		@Deprecated
		@Override
		public Short apply(final Float key) {
			synchronized (sync) {
	...
	public static class UnmodifiableFunction extends AbstractFloat2ShortFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2ShortFunction function;
	...
	public static class PrimitiveFunction implements Float2ShortFunction {
		...
		public short get(float key) {
			Short v = function.apply(Float.valueOf(key));
			if (v == null)
	...
	public static Float2ShortFunction primitive(final java.util.function.Function<? super Float, ? extends Short> f) {
		...
		if (f instanceof java.util.function.DoubleToIntFunction)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeIntToShort(((java.util.function.DoubleToIntFunction) f).applyAsInt(key));
