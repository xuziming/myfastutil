 ...
 */
public class Float2LongArrayMap extends AbstractFloat2LongMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Float2LongMap.Entry> iterator() {
			return new ObjectIterator<Float2LongMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractFloat2LongMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Float2LongArrayMap.this.containsKey(k)
					&& ((Float2LongArrayMap.this.get(k)) == (((Long) (e.getValue())).longValue()));
		}
