...
public final class Float2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Float2ByteMap.Entry> fastIterator(Float2ByteSortedMap map) {
		final ObjectSortedSet<Float2ByteMap.Entry> entries = map.float2ByteEntrySet();
		return entries instanceof Float2ByteSortedMap.FastSortedEntrySet
				? ((Float2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Float2ByteMaps.EmptyMap
			implements Float2ByteSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Float2ByteMaps.Singleton
			implements Float2ByteSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractFloat2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Float2ByteMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Float2ByteMaps.SynchronizedMap
			implements Float2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.float2ByteEntrySet(), sync);
			return (ObjectSortedSet<Float2ByteMap.Entry>) entries;
		}
	 ...
	 */
	public static Float2ByteSortedMap synchronize(final Float2ByteSortedMap m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static Float2ByteSortedMap synchronize(final Float2ByteSortedMap m, final Object sync) {
		return new SynchronizedSortedMap(m, sync);
	}

	/** An unmodifiable wrapper class for sorted maps. */
	public static class UnmodifiableSortedMap extends Float2ByteMaps.UnmodifiableMap
			implements Float2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Float2ByteSortedMap sortedMap;
		...
		public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.float2ByteEntrySet());
			return (ObjectSortedSet<Float2ByteMap.Entry>) entries;
		}
	 ...
	 */
	public static Float2ByteSortedMap unmodifiable(final Float2ByteSortedMap m) {
