...
public interface Float2IntSortedMap extends Float2IntMap, SortedMap<Float, Integer> {
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Float2IntMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Float2IntMap.Entry> fastIterator(Float2IntMap.Entry from);
	}
