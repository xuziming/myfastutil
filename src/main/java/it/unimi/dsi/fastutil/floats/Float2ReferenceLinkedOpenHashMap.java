...
public class Float2ReferenceLinkedOpenHashMap<V> extends AbstractFloat2ReferenceSortedMap<V>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>
		...
		@Override
		public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> fromElement,
				Float2ReferenceMap.Entry<V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Float.floatToIntBits(k) == 0))
				return Float2ReferenceLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			float curr;
			final float[] key = Float2ReferenceLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Float2ReferenceMap.Entry<V>> iterator(final Float2ReferenceMap.Entry<V> from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Float2ReferenceMap.Entry<V>> fastIterator(final Float2ReferenceMap.Entry<V> from) {
		...
		public void forEach(final Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry<V>(key[curr], value[curr]));
			}
		}
