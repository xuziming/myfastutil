 ...
 *
 */
public class Float2FloatRBTreeMap extends AbstractFloat2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Float2FloatRBTreeMap(final Comparator<? super Float> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Float2FloatRBTreeMap(final Map<? extends Float, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2FloatRBTreeMap(final SortedMap<Float, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Float2FloatRBTreeMap(final Float2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Float2FloatRBTreeMap(final Float2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Float2FloatRBTreeMap(final float[] k, final float v[], final Comparator<? super Float> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Float2FloatRBTreeMap(final float[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Float2FloatRBTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
				final Comparator<? super Float2FloatMap.Entry> comparator = (Comparator<Float2FloatMap.Entry>) (x,
						y) -> Float2FloatRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
	...
	private final class Submap extends AbstractFloat2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final float k) {
			return (bottom || Float2FloatRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Float2FloatRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Float2FloatRBTreeMap.Entry f = findKey(((Float) (e.getKey())).floatValue());
		...
		public boolean containsKey(final float k) {
			return in(k) && Float2FloatRBTreeMap.this.containsKey(k);
		}
		...
		public float get(final float k) {
			final Float2FloatRBTreeMap.Entry e;
			final float kk = k;
		...
		public float put(final float k, final float v) {
			...
			final float oldValue = Float2FloatRBTreeMap.this.put(k, v);
		...
		public float remove(final float k) {
			...
			final float oldValue = Float2FloatRBTreeMap.this.remove(k);
		...
		@Override
		public float firstFloatKey() {
			Float2FloatRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public float lastFloatKey() {
			Float2FloatRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Float2FloatRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Float2FloatRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
