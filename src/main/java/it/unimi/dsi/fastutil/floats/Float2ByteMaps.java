...
public final class Float2ByteMaps {
	...
	public static ObjectIterator<Float2ByteMap.Entry> fastIterator(Float2ByteMap map) {
		...
		return entries instanceof Float2ByteMap.FastEntrySet ? ((Float2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Float2ByteFunctions.EmptyFunction
			implements Float2ByteMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2ByteFunctions.Singleton
		...
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2ByteFunctions.SynchronizedFunction
			implements Float2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		// Defaultable methods
		@Override
		public byte getOrDefault(final float key, final byte defaultValue) {
			synchronized (sync) {
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Float, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public boolean remove(final float key, final byte value) {
			synchronized (sync) {
		...
		@Override
		public byte replace(final float key, final byte value) {
			synchronized (sync) {
		...
		@Override
		public boolean replace(final float key, final byte oldValue, final byte newValue) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final float key, final java.util.function.DoubleToIntFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final float key,
		...
		@Override
		public byte computeIfAbsentPartial(final float key, final Float2ByteFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfPresent(final float key,
		...
		@Override
		public byte compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final float key, final byte value,
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Float key,
				final java.util.function.Function<? super Float, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Float2ByteFunctions.UnmodifiableFunction
		...
		public ObjectSet<Float2ByteMap.Entry> float2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2ByteEntrySet());
			return entries;
		}
