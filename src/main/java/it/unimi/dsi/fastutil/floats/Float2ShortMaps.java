...
public final class Float2ShortMaps {
	...
	public static ObjectIterator<Float2ShortMap.Entry> fastIterator(Float2ShortMap map) {
		...
		return entries instanceof Float2ShortMap.FastEntrySet ? ((Float2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Float2ShortFunctions.EmptyFunction
			implements Float2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Float2ShortFunctions.Singleton
		...
		public ObjectSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractFloat2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Float2ShortFunctions.SynchronizedFunction
			implements Float2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.float2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final float key,
		...
		@Override
		public short computeIfPresent(final float key,
		...
		@Override
		public short compute(final float key,
				final java.util.function.BiFunction<? super Float, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final float key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Float key,
	...
	public static class UnmodifiableMap extends Float2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Float2ShortMap.Entry> float2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.float2ShortEntrySet());
			return entries;
		}
