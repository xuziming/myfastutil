...
public final class Reference2CharFunctions {
	 ...
	 */
	public static class EmptyFunction<K> extends AbstractReference2CharFunction<K>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K> extends AbstractReference2CharFunction<K>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2CharFunction<K> singleton(final K key, char value) {
	...
	public static class SynchronizedFunction<K> implements Reference2CharFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2CharFunction<K>
	...
	public static class PrimitiveFunction<K> implements Reference2CharFunction<K> {
		...
		public char getChar(Object key) {
			Character v = function.apply((K) (key));
			if (v == null)
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2CharFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Character> f) {
		...
		if (f instanceof java.util.function.ToIntFunction)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeIntToChar(((java.util.function.ToIntFunction<K>) f).applyAsInt((K) (key)));
