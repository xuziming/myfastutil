...
public final class Reference2CharMaps {
	...
	public static <K> ObjectIterator<Reference2CharMap.Entry<K>> fastIterator(Reference2CharMap<K> map) {
		...
		return entries instanceof Reference2CharMap.FastEntrySet
				? ((Reference2CharMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2CharMap<K> map,
			final Consumer<? super Reference2CharMap.Entry<K>> consumer) {
		final ObjectSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
		if (entries instanceof Reference2CharMap.FastEntrySet)
			((Reference2CharMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Reference2CharMap.Entry<K>> fastIterable(Reference2CharMap<K> map) {
		...
		return entries instanceof Reference2CharMap.FastEntrySet ? new ObjectIterable<Reference2CharMap.Entry<K>>() {
			public ObjectIterator<Reference2CharMap.Entry<K>> iterator() {
				return ((Reference2CharMap.FastEntrySet<K>) entries).fastIterator();
			}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Reference2CharFunctions.EmptyFunction<K>
			implements Reference2CharMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Reference2CharFunctions.Singleton<K>
			implements Reference2CharMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2CharMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<K, Character>> entrySet() {
			return (ObjectSet) reference2CharEntrySet();
		}
		...
		public CharCollection values() {
			if (values == null)
				values = CharSets.singleton(value);
			return values;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2CharMap<K> singleton(final K key, char value) {
	...
	public static class SynchronizedMap<K> extends Reference2CharFunctions.SynchronizedFunction<K>
			implements Reference2CharMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		public CharCollection values() {
			synchronized (sync) {
				if (values == null)
					return CharCollections.synchronize(map.values(), sync);
				return values;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super K, ? super Character> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeCharIfAbsent(final K key,
				final java.util.function.ToIntFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeCharIfAbsent(key, mappingFunction);
			}
		}
		...
		public char computeCharIfAbsentPartial(final K key, final Reference2CharFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeCharIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public char computeCharIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeCharIfPresent(key, remappingFunction);
			}
		}

		@Override
		public char computeChar(final K key,
				final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeChar(key, remappingFunction);
			}
		}

		@Override
		public char mergeChar(final K key, final char value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.mergeChar(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Character computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Character> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Character computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Character compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Character merge(final K key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2CharFunctions.UnmodifiableFunction<K>
			implements Reference2CharMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2CharMap<K> map;
		protected transient ObjectSet<Reference2CharMap.Entry<K>> entries;
		...
		public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2CharEntrySet());
			return entries;
		}
		...
		public CharCollection values() {
			if (values == null)
				return CharCollections.unmodifiable(map.values());
			return values;
		}
