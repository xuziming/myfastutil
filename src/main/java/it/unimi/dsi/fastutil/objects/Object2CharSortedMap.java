...
public interface Object2CharSortedMap<K> extends Object2CharMap<K>, SortedMap<K, Character> {
	 ...
	 */
	@Override
	Object2CharSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Object2CharSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Object2CharSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Object2CharMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharMap.Entry<K> from);
	}
