...
public class Object2ReferenceArrayMap<K, V> extends AbstractObject2ReferenceMap<K, V>
	 ...
	 *              {@code key}).
	 */
	public Object2ReferenceArrayMap(final Object[] key, final Object[] value) {
		this.key = key;
		this.value = value;
		size = key.length;
	 ...
	 */
	public Object2ReferenceArrayMap(final int capacity) {
	 ...
	 * @param m a map.
	 */
	public Object2ReferenceArrayMap(final Object2ReferenceMap<K, V> m) {
		this(m.size());
		putAll(m);
	}
	 ...
	 * @param m a map.
	 */
	public Object2ReferenceArrayMap(final Map<? extends K, ? extends V> m) {
		this(m.size());
		putAll(m);
	}
	 ...
	 */
	public Object2ReferenceArrayMap(final Object[] key, final Object[] value, final int size) {
		this.key = key;
		this.value = value;
		this.size = size;
		if (key.length != value.length)
	...
	private final class EntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>>
		...
		public ObjectIterator<Object2ReferenceMap.Entry<K, V>> iterator() {
			return new ObjectIterator<Object2ReferenceMap.Entry<K, V>>() {
				...
				public Entry<K, V> next() {
					...
					return new AbstractObject2ReferenceMap.BasicEntry<>((K) key[curr = next], (V) value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Object2ReferenceArrayMap.this.containsKey(k)
					&& ((Object2ReferenceArrayMap.this.get(k)) == ((e.getValue())));
		}
		...
		public boolean remove(final Object o) {
			...
			final int oldPos = Object2ReferenceArrayMap.this.findKey(k);
			if (oldPos == -1 || !((v) == (Object2ReferenceArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Object2ReferenceArrayMap.this.key, oldPos + 1, Object2ReferenceArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Object2ReferenceArrayMap.this.value, oldPos + 1, Object2ReferenceArrayMap.this.value,
					oldPos, tail);
			Object2ReferenceArrayMap.this.size--;
			Object2ReferenceArrayMap.this.key[size] = null;
			Object2ReferenceArrayMap.this.value[size] = null;
			return true;
		}
	}
