...
public interface Reference2BooleanSortedMap<K> extends Reference2BooleanMap<K>, SortedMap<K, Boolean> {
	 ...
	 */
	@Override
	Reference2BooleanSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Reference2BooleanSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Reference2BooleanSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Reference2BooleanMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Reference2BooleanMap.Entry<K>> fastIterator(Reference2BooleanMap.Entry<K> from);
	}
