...
public final class Reference2ShortSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> fastIterator(
			Reference2ShortSortedMap<K> map) {
		final ObjectSortedSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
		return entries instanceof Reference2ShortSortedMap.FastSortedEntrySet
				? ((Reference2ShortSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2ShortMap.Entry<K>> fastIterable(
			Reference2ShortSortedMap<K> map) {
		final ObjectSortedSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
		return entries instanceof Reference2ShortSortedMap.FastSortedEntrySet
				? ((Reference2ShortSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2ShortMaps.EmptyMap<K>
			implements Reference2ShortSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2ShortMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2ShortMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Reference2ShortMap.Entry<K>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2ShortSortedMap<K> singleton(final K key, Short value) {
	...
	public static class SynchronizedSortedMap<K> extends Reference2ShortMaps.SynchronizedMap<K>
			implements Reference2ShortSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.reference2ShortEntrySet(), sync);
			return (ObjectSortedSet<Reference2ShortMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2ShortMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.reference2ShortEntrySet());
			return (ObjectSortedSet<Reference2ShortMap.Entry<K>>) entries;
		}
