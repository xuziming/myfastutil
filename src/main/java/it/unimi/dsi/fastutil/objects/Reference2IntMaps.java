...
public final class Reference2IntMaps {
	...
	public static <K> ObjectIterator<Reference2IntMap.Entry<K>> fastIterator(Reference2IntMap<K> map) {
		...
		return entries instanceof Reference2IntMap.FastEntrySet
				? ((Reference2IntMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2IntMap<K> map,
			final Consumer<? super Reference2IntMap.Entry<K>> consumer) {
		final ObjectSet<Reference2IntMap.Entry<K>> entries = map.reference2IntEntrySet();
		if (entries instanceof Reference2IntMap.FastEntrySet)
			((Reference2IntMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Reference2IntMap.Entry<K>> fastIterable(Reference2IntMap<K> map) {
		...
		return entries instanceof Reference2IntMap.FastEntrySet ? new ObjectIterable<Reference2IntMap.Entry<K>>() {
			public ObjectIterator<Reference2IntMap.Entry<K>> iterator() {
				return ((Reference2IntMap.FastEntrySet<K>) entries).fastIterator();
			}
	...
	public static class EmptyMap<K> extends Reference2IntFunctions.EmptyFunction<K>
			implements Reference2IntMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2IntFunctions.Singleton<K>
		...
		public ObjectSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2IntMap.BasicEntry<>(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2IntMap<K> singleton(final K key, int value) {
	...
	public static class SynchronizedMap<K> extends Reference2IntFunctions.SynchronizedFunction<K>
			implements Reference2IntMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2IntEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Reference2IntFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2IntEntrySet());
			return entries;
		}
