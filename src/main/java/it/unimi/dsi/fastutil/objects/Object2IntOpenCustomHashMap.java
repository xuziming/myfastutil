...
public class Object2IntOpenCustomHashMap<K> extends AbstractObject2IntMap<K>
	...
	public Object2IntOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final Object2IntMap<K> m, final float f, final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntOpenCustomHashMap(final Object2IntMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2IntOpenCustomHashMap(final K[] k, final int[] v, final float f, final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2IntOpenCustomHashMap(final K[] k, final int[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2IntOpenCustomHashMap.this.removeInt(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2IntOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2IntOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
