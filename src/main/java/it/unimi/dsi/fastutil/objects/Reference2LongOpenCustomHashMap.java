...
public class Reference2LongOpenCustomHashMap<K> extends AbstractReference2LongMap<K>
	...
	public Reference2LongOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final Reference2LongMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2LongOpenCustomHashMap(final Reference2LongMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2LongOpenCustomHashMap(final K[] k, final long[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2LongOpenCustomHashMap(final K[] k, final long[] v, final Strategy<? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeLongIfPresent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public long computeLong(final K k,
			final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public long mergeLong(final K k, final long v,
	...
	final class MapEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey())))) && ((value[index]) == ((e.getValue()).longValue()));
		}
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final K key[] = Reference2LongOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2LongOpenCustomHashMap.this.removeLong(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2LongOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2LongOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2LongMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2LongMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2LongMap.BasicEntry<K>(key[pos], value[pos]));
		}
