	...
	private final class EntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements FastEntrySet<K> {
		...
		public ObjectIterator<Reference2FloatMap.Entry<K>> iterator() {
			return new ObjectIterator<Reference2FloatMap.Entry<K>>() {
				...
				public Entry<K> next() {
					...
					return new AbstractReference2FloatMap.BasicEntry<>((K) key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Reference2FloatArrayMap.this.containsKey(k)
					&& (Float.floatToIntBits(Reference2FloatArrayMap.this.getFloat(k)) == Float
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1
					|| !(Float.floatToIntBits(v) == Float.floatToIntBits(Reference2FloatArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Reference2FloatArrayMap.this.key, oldPos + 1, Reference2FloatArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2FloatArrayMap.this.value, oldPos + 1, Reference2FloatArrayMap.this.value, oldPos,
					tail);
