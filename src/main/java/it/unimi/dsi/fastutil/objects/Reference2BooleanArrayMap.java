 ...
 */
public class Reference2BooleanArrayMap<K> extends AbstractReference2BooleanMap<K>
	...
	private final class EntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		public ObjectIterator<Reference2BooleanMap.Entry<K>> iterator() {
			return new ObjectIterator<Reference2BooleanMap.Entry<K>>() {
				...
				public Entry<K> next() {
					...
					return new AbstractReference2BooleanMap.BasicEntry<>((K) key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Reference2BooleanArrayMap.this.containsKey(k)
					&& ((Reference2BooleanArrayMap.this.getBoolean(k)) == (((Boolean) (e.getValue())).booleanValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Reference2BooleanArrayMap.this.key, oldPos + 1, Reference2BooleanArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2BooleanArrayMap.this.value, oldPos + 1, Reference2BooleanArrayMap.this.value,
					oldPos, tail);
			Reference2BooleanArrayMap.this.size--;
			Reference2BooleanArrayMap.this.key[size] = null;
			return true;
		}
	}
