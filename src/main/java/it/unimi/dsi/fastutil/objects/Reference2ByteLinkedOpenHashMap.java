 ...
 * @see HashCommon
 */
public class Reference2ByteLinkedOpenHashMap<K> extends AbstractReference2ByteSortedMap<K>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ByteMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Reference2ByteMap.Entry<K>> subSet(Reference2ByteMap.Entry<K> fromElement,
				Reference2ByteMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2ByteLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2ByteLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractReference2ByteMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
