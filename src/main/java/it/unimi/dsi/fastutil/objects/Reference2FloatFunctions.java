...
public final class Reference2FloatFunctions {
	 ...
	 */
	public static class EmptyFunction<K> extends AbstractReference2FloatFunction<K>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K> extends AbstractReference2FloatFunction<K>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2FloatFunction<K> singleton(final K key, float value) {
	...
	public static class SynchronizedFunction<K> implements Reference2FloatFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2FloatFunction<K>
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2FloatFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Float> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Reference2FloatFunction)
			return (Reference2FloatFunction<K>) f;
		if (f instanceof java.util.function.ToDoubleFunction)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeDoubleToFloat(((java.util.function.ToDoubleFunction<K>) f).applyAsDouble((K) (key)));
