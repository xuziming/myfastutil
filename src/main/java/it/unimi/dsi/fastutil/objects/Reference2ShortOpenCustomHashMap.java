...
public class Reference2ShortOpenCustomHashMap<K> extends AbstractReference2ShortMap<K>
	...
	public Reference2ShortOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final Reference2ShortMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ShortOpenCustomHashMap(final Reference2ShortMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2ShortOpenCustomHashMap(final K[] k, final short[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2ShortOpenCustomHashMap(final K[] k, final short[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final K key[] = Reference2ShortOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2ShortOpenCustomHashMap.this.removeShort(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2ShortOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2ShortOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
