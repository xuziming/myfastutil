...
public final class Reference2LongSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator(
			Reference2LongSortedMap<K> map) {
		final ObjectSortedSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
		return entries instanceof Reference2LongSortedMap.FastSortedEntrySet
				? ((Reference2LongSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2LongMap.Entry<K>> fastIterable(
			Reference2LongSortedMap<K> map) {
		final ObjectSortedSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
		return entries instanceof Reference2LongSortedMap.FastSortedEntrySet
				? ((Reference2LongSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2LongMaps.EmptyMap<K>
			implements Reference2LongSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2LongMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2LongMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Reference2LongMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
			return (ObjectSortedSet) reference2LongEntrySet();
		}
	...
	public static class SynchronizedSortedMap<K> extends Reference2LongMaps.SynchronizedMap<K>
			implements Reference2LongSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.reference2LongEntrySet(), sync);
			return (ObjectSortedSet<Reference2LongMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2LongMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.reference2LongEntrySet());
			return (ObjectSortedSet<Reference2LongMap.Entry<K>>) entries;
		}
