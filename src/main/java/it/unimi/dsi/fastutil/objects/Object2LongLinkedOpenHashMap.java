 ...
 * @see HashCommon
 */
public class Object2LongLinkedOpenHashMap<K> extends AbstractObject2LongSortedMap<K>
	...
	public Object2LongLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2LongLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2LongLinkedOpenHashMap(final Map<? extends K, ? extends Long> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2LongLinkedOpenHashMap(final Map<? extends K, ? extends Long> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2LongLinkedOpenHashMap(final Object2LongMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2LongLinkedOpenHashMap(final Object2LongMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2LongLinkedOpenHashMap(final K[] k, final long[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Object2LongLinkedOpenHashMap(final K[] k, final long[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2LongLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2LongMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2LongLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2LongLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
