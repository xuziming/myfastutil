...
public interface Object2LongSortedMap<K> extends Object2LongMap<K>, SortedMap<K, Long> {
	 ...
	 */
	@Override
	Object2LongSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Object2LongSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Object2LongSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Object2LongMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongMap.Entry<K> from);
	}
