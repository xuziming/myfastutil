 ...
 *
 */
public class Object2ByteRBTreeMap<K> extends AbstractObject2ByteSortedMap<K>
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
				final Comparator<? super Object2ByteMap.Entry<K>> comparator = (Comparator<Object2ByteMap.Entry<K>>) (x,
						y) -> Object2ByteRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2ByteSortedMap<K> implements java.io.Serializable {
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2ByteRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2ByteRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
