...
public abstract class AbstractReference2ByteMap<K> extends AbstractReference2ByteFunction<K>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Reference2ByteMap.Entry<K>> i = reference2ByteEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K> implements Reference2ByteMap.Entry<K> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Reference2ByteMap.Entry) {
				final Reference2ByteMap.Entry<K> e = (Reference2ByteMap.Entry<K>) o;
				return ((key) == (e.getKey())) && ((value) == (e.getByteValue()));
			}
			...
			if (value == null || !(value instanceof Byte))
				return false;
			return ((this.key) == ((key))) && ((this.value) == (((Byte) (value)).byteValue()));
		}
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps
							.fastIterator(AbstractReference2ByteMap.this);
	...
	public void putAll(final Map<? extends K, ? extends Byte> m) {
		if (m instanceof Reference2ByteMap) {
			...
			while (i.hasNext()) {
				final Reference2ByteMap.Entry<? extends K> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Reference2ByteMap.Entry<K>> i = Reference2ByteMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
