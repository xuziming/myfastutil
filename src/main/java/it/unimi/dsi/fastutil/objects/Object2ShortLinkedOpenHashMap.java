 ...
 * @see HashCommon
 */
public class Object2ShortLinkedOpenHashMap<K> extends AbstractObject2ShortSortedMap<K>
	...
	public Object2ShortLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2ShortLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ShortLinkedOpenHashMap(final Map<? extends K, ? extends Short> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2ShortLinkedOpenHashMap(final Map<? extends K, ? extends Short> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ShortLinkedOpenHashMap(final Object2ShortMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2ShortLinkedOpenHashMap(final Object2ShortMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ShortLinkedOpenHashMap(final K[] k, final short[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Object2ShortLinkedOpenHashMap(final K[] k, final short[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2ShortLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ShortLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ShortLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
