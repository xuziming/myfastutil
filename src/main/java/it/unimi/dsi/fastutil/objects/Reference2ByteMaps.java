...
public final class Reference2ByteMaps {
	...
	public static <K> ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator(Reference2ByteMap<K> map) {
		...
		return entries instanceof Reference2ByteMap.FastEntrySet
				? ((Reference2ByteMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2ByteMap<K> map,
			final Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
		final ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
	...
	public static class EmptyMap<K> extends Reference2ByteFunctions.EmptyFunction<K>
			implements Reference2ByteMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2ByteFunctions.Singleton<K>
		...
		public ObjectSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2ByteMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2ByteFunctions.SynchronizedFunction<K>
			implements Reference2ByteMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public byte computeByteIfAbsentPartial(final K key, final Reference2ByteFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2ByteFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2ByteEntrySet());
			return entries;
		}
