...
public final class ReferenceBigLists {
	...
	public static class EmptyBigList<K> extends ReferenceCollections.EmptyCollection<K>
			implements ReferenceBigList<K>, java.io.Serializable, Cloneable {
	 ...
	 */
	public static class Singleton<K> extends AbstractReferenceBigList<K> implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class SynchronizedBigList<K> extends ReferenceCollections.SynchronizedCollection<K>
			implements ReferenceBigList<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final ReferenceBigList<K> list; // Due to the large number of methods that are not in COLLECTION, this
													// is worth caching.
	...
	public static class ListBigList<K> extends AbstractReferenceBigList<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
