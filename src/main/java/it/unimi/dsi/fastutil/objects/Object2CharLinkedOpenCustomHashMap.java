...
public class Object2CharLinkedOpenCustomHashMap<K> extends AbstractObject2CharSortedMap<K>
	...
	public Object2CharLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final Map<? extends K, ? extends Character> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final Map<? extends K, ? extends Character> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final Object2CharMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharLinkedOpenCustomHashMap(final Object2CharMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2CharLinkedOpenCustomHashMap(final K[] k, final char[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2CharLinkedOpenCustomHashMap(final K[] k, final char[] v, final Strategy<? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> fromElement,
				Object2CharMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2CharLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2CharLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2CharMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2CharMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
