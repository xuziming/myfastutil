...
public final class Object2FloatMaps {
	...
	public static <K> ObjectIterator<Object2FloatMap.Entry<K>> fastIterator(Object2FloatMap<K> map) {
		...
		return entries instanceof Object2FloatMap.FastEntrySet
				? ((Object2FloatMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2FloatMap<K> map,
			final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
		final ObjectSet<Object2FloatMap.Entry<K>> entries = map.object2FloatEntrySet();
		if (entries instanceof Object2FloatMap.FastEntrySet)
			((Object2FloatMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2FloatMap.Entry<K>> fastIterable(Object2FloatMap<K> map) {
		...
		return entries instanceof Object2FloatMap.FastEntrySet ? new ObjectIterable<Object2FloatMap.Entry<K>>() {
			public ObjectIterator<Object2FloatMap.Entry<K>> iterator() {
				return ((Object2FloatMap.FastEntrySet<K>) entries).fastIterator();
			}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2FloatFunctions.EmptyFunction<K>
			implements Object2FloatMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2FloatFunctions.Singleton<K>
			implements Object2FloatMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2FloatMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2FloatFunctions.SynchronizedFunction<K>
			implements Object2FloatMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public float computeFloatIfAbsentPartial(final K key, final Object2FloatFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K>
			implements Object2FloatMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2FloatMap<K> map;
		protected transient ObjectSet<Object2FloatMap.Entry<K>> entries;
		...
		public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2FloatEntrySet());
			return entries;
		}
