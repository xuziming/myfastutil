...
public abstract class AbstractReference2ReferenceSortedMap<K, V> extends AbstractReference2ReferenceMap<K, V>
	...
	protected class KeySet extends AbstractReferenceSortedSet<K> {
		...
		public ObjectBidirectionalIterator<K> iterator(final K from) {
			return new KeySetIterator<>(reference2ReferenceEntrySet().iterator(new BasicEntry<>(from, (null))));
		}

		@Override
		public ObjectBidirectionalIterator<K> iterator() {
			return new KeySetIterator<>(
					Reference2ReferenceSortedMaps.fastIterator(AbstractReference2ReferenceSortedMap.this));
		}
	}
