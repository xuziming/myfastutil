...
public class Object2ByteLinkedOpenHashMap<K> extends AbstractObject2ByteSortedMap<K>
	...
	public Object2ByteLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2ByteLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ByteLinkedOpenHashMap(final Map<? extends K, ? extends Byte> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2ByteLinkedOpenHashMap(final Map<? extends K, ? extends Byte> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ByteLinkedOpenHashMap(final Object2ByteMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2ByteLinkedOpenHashMap(final Object2ByteMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ByteLinkedOpenHashMap(final K[] k, final byte[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Object2ByteLinkedOpenHashMap(final K[] k, final byte[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2ByteLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ByteMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ByteLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ByteLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
