...
public final class Object2ShortMaps {
	...
	public static <K> ObjectIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap<K> map) {
		...
		return entries instanceof Object2ShortMap.FastEntrySet
				? ((Object2ShortMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2ShortMap<K> map,
			final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
		final ObjectSet<Object2ShortMap.Entry<K>> entries = map.object2ShortEntrySet();
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2ShortFunctions.EmptyFunction<K>
			implements Object2ShortMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2ShortFunctions.Singleton<K>
			implements Object2ShortMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2ShortMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2ShortFunctions.SynchronizedFunction<K>
		...
		public ObjectSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2ShortEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K> extends Object2ShortFunctions.UnmodifiableFunction<K>
			implements Object2ShortMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2ShortMap<K> map;
		protected transient ObjectSet<Object2ShortMap.Entry<K>> entries;
		...
		public ObjectSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2ShortEntrySet());
			return entries;
		}
