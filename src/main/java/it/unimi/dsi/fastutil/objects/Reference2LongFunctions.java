...
public final class Reference2LongFunctions {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2LongFunction<K> singleton(final K key, long value) {
	...
	public static class SynchronizedFunction<K> implements Reference2LongFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2LongFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Long> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Reference2LongFunction)
			return (Reference2LongFunction<K>) f;
		if (f instanceof java.util.function.ToLongFunction)
			return key -> ((java.util.function.ToLongFunction<K>) f).applyAsLong((K) (key));
