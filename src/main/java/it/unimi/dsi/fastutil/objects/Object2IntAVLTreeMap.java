 ...
 * iterator}.
 */
public class Object2IntAVLTreeMap<K> extends AbstractObject2IntSortedMap<K> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Object2IntAVLTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2IntAVLTreeMap(final Map<? extends K, ? extends Integer> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2IntAVLTreeMap(final SortedMap<K, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2IntAVLTreeMap(final Object2IntMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2IntAVLTreeMap(final Object2IntSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2IntAVLTreeMap(final K[] k, final int v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2IntAVLTreeMap(final K[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private Entry<K> add(final K k) {
		...
		if (tree == null) { // The case of the empty tree is treated separately.
			...
			Entry<K> p = tree, q = null, y = tree, z = null, w = null;
			int cmp, i = 0;
			while (true) {
	...
	private static final class Entry<K> extends AbstractObject2IntMap.BasicEntry<K> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return java.util.Objects.equals(key, (e.getKey())) && ((value) == ((e.getValue()).intValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2IntAVLTreeMap.this.removeInt(curr.key);
			curr = null;
		}
	 ...
	 * This class can iterate in both directions on a threaded tree.
	 */
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Object2IntMap.Entry<K>> {
		EntryIterator() {
		}
	...
	public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
				final Comparator<? super Object2IntMap.Entry<K>> comparator = (Comparator<Object2IntMap.Entry<K>>) (x,
						y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> from,
						Object2IntMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> to) {
					return headMap(to.getKey()).object2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> from) {
					return tailMap(from.getKey()).object2IntEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2IntSortedMap<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2IntAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2IntAVLTreeMap.this.compare(k, to) < 0);
		}
		...
		public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
					...
					@Override
					public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator(
							final Object2IntMap.Entry<K> from) {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Object2IntAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2IntAVLTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public int getInt(final Object k) {
			final Object2IntAVLTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public int put(final K k, final int v) {
			...
			final int oldValue = Object2IntAVLTreeMap.this.put(k, v);
		...
		public int removeInt(final Object k) {
			...
			final int oldValue = Object2IntAVLTreeMap.this.removeInt(k);
		...
		@Override
		public K firstKey() {
			Object2IntAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2IntAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2IntAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2IntAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	 ...
	 */
	@SuppressWarnings("unchecked")
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
			throws java.io.IOException, ClassNotFoundException {
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readInt());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
		if (n == 2) {
			 ...
			 */
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readInt());
			top.right(new Entry<>((K) s.readObject(), s.readInt()));
			top.right.pred(top);
			top.balance(1);
			top.pred(pred);
			top.right.succ(succ);
