 ...
 */
public abstract class AbstractObject2ShortMap<K> extends AbstractObject2ShortFunction<K>
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Object2ShortMap.Entry<K>> i = Object2ShortMaps
							.fastIterator(AbstractObject2ShortMap.this);
