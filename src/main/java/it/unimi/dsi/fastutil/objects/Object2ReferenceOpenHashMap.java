 ...
 * @see HashCommon
 */
public class Object2ReferenceOpenHashMap<K, V> extends AbstractObject2ReferenceMap<K, V>
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ReferenceOpenHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ReferenceOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ReferenceOpenHashMap.this.key;
			int pos;
			// The starting point.
