...
public final class Reference2ByteFunctions {
	 ...
	 */
	public static class EmptyFunction<K> extends AbstractReference2ByteFunction<K>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K> extends AbstractReference2ByteFunction<K>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2ByteFunction<K> singleton(final K key, byte value) {
	...
	public static class SynchronizedFunction<K> implements Reference2ByteFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K> extends AbstractReference2ByteFunction<K>
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2ByteFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Byte> f) {
		...
		if (f instanceof java.util.function.ToIntFunction)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeIntToByte(((java.util.function.ToIntFunction<K>) f).applyAsInt((K) (key)));
