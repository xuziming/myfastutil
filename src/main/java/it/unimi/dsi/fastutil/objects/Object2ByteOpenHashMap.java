 ...
 * @see HashCommon
 */
public class Object2ByteOpenHashMap<K> extends AbstractObject2ByteMap<K>
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Object2ByteOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ByteOpenHashMap.this.removeByte(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ByteOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ByteOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Object2ByteOpenHashMap<K> clone() {
		...
		try {
			c = (Object2ByteOpenHashMap<K>) super.clone();
