...
public interface Reference2FloatSortedMap<K> extends Reference2FloatMap<K>, SortedMap<K, Float> {
	 ...
	 */
	@Override
	Reference2FloatSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Reference2FloatSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Reference2FloatSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Reference2FloatMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Reference2FloatMap.Entry<K>> fastIterator(Reference2FloatMap.Entry<K> from);
	}
