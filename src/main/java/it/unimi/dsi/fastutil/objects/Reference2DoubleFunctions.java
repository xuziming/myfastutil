...
public final class Reference2DoubleFunctions {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2DoubleFunction<K> singleton(final K key, double value) {
	...
	public static class SynchronizedFunction<K> implements Reference2DoubleFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2DoubleFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Double> f) {
		...
		if (f instanceof java.util.function.ToDoubleFunction)
			return key -> ((java.util.function.ToDoubleFunction<K>) f).applyAsDouble((K) (key));
