 ...
 * @see HashCommon
 */
public class Object2ShortOpenCustomHashMap<K> extends AbstractObject2ShortMap<K>
	...
	public Object2ShortOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final Object2ShortMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortOpenCustomHashMap(final Object2ShortMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ShortOpenCustomHashMap(final K[] k, final short[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ShortOpenCustomHashMap(final K[] k, final short[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ShortOpenCustomHashMap.this.removeShort(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ShortOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ShortOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2ShortMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2ShortMap.BasicEntry<K>(key[pos], value[pos]));
		}
