...
public final class Object2FloatSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> fastIterator(Object2FloatSortedMap<K> map) {
		...
		return entries instanceof Object2FloatSortedMap.FastSortedEntrySet
				? ((Object2FloatSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<K> extends Object2FloatMaps.EmptyMap<K>
			implements Object2FloatSortedMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<K> extends Object2FloatMaps.Singleton<K>
			implements Object2FloatSortedMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2FloatMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2FloatMap.Entry<K>>) entries;
		}
	...
	public static class SynchronizedSortedMap<K> extends Object2FloatMaps.SynchronizedMap<K>
			implements Object2FloatSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2FloatEntrySet(), sync);
			return (ObjectSortedSet<Object2FloatMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2FloatMaps.UnmodifiableMap<K>
			implements Object2FloatSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2FloatSortedMap<K> sortedMap;
		...
		public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2FloatEntrySet());
			return (ObjectSortedSet<Object2FloatMap.Entry<K>>) entries;
		}
