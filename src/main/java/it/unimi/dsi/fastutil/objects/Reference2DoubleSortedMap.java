...
public interface Reference2DoubleSortedMap<K> extends Reference2DoubleMap<K>, SortedMap<K, Double> {
	 ...
	 */
	@Override
	Reference2DoubleSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Reference2DoubleSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Reference2DoubleSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Reference2DoubleMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Reference2DoubleMap.Entry<K>> fastIterator(Reference2DoubleMap.Entry<K> from);
	}
