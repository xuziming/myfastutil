...
public class Object2CharOpenCustomHashMap<K> extends AbstractObject2CharMap<K>
	...
	public Object2CharOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final Map<? extends K, ? extends Character> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final Map<? extends K, ? extends Character> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final Object2CharMap<K> m, final float f, final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2CharOpenCustomHashMap(final Object2CharMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2CharOpenCustomHashMap(final K[] k, final char[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2CharOpenCustomHashMap(final K[] k, final char[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Object2CharOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final K key[] = Object2CharOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2CharOpenCustomHashMap.this.removeChar(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2CharOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2CharOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2CharMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2CharMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2CharMap.BasicEntry<K>(key[pos], value[pos]));
		}
	...
	public Object2CharOpenCustomHashMap<K> clone() {
		...
		try {
			c = (Object2CharOpenCustomHashMap<K>) super.clone();
