 ...
 * @see HashCommon
 */
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K>
	...
	public Reference2FloatOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final Reference2FloatMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2FloatOpenCustomHashMap(final Reference2FloatMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2FloatOpenCustomHashMap(final K[] k, final float[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2FloatOpenCustomHashMap(final K[] k, final float[] v, final Strategy<? super K> strategy) {
	...
	public boolean remove(final Object k, final float v) {
		...
		if (((curr = key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode((K) k))) & mask]) == (null)))
			return false;
		if ((strategy.equals((K) (k), (curr))) && (Float.floatToIntBits(v) == Float.floatToIntBits(value[pos]))) {
			removeEntry(pos);
			return true;
		}
		while (true) {
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2FloatOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final K key[] = Reference2FloatOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2FloatOpenCustomHashMap.this.removeFloat(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2FloatOpenCustomHashMap.this.containsNullKey
		...
		public void forEach(final Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2FloatMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2FloatMap.BasicEntry<K>(key[pos], value[pos]));
		}
	...
	public Reference2FloatOpenCustomHashMap<K> clone() {
		...
		try {
			c = (Reference2FloatOpenCustomHashMap<K>) super.clone();
