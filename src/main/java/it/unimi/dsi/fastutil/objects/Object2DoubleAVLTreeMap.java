...
public class Object2DoubleAVLTreeMap<K> extends AbstractObject2DoubleSortedMap<K>
	 ...
	 */
	public Object2DoubleAVLTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2DoubleAVLTreeMap(final Map<? extends K, ? extends Double> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2DoubleAVLTreeMap(final SortedMap<K, Double> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2DoubleAVLTreeMap(final Object2DoubleMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2DoubleAVLTreeMap(final Object2DoubleSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleAVLTreeMap(final K[] k, final double v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleAVLTreeMap(final K[] k, final double v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry<K> extends AbstractObject2DoubleMap.BasicEntry<K> implements Cloneable {
		...
		@Override
		public int hashCode() {
			return ((key).hashCode()) ^ it.unimi.dsi.fastutil.HashCommon.double2int(value);
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2DoubleAVLTreeMap.this.removeDouble(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
				final Comparator<? super Object2DoubleMap.Entry<K>> comparator = (Comparator<Object2DoubleMap.Entry<K>>) (
						x, y) -> Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(
						final Object2DoubleMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from,
						Object2DoubleMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
					return headMap(to.getKey()).object2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
					return tailMap(from.getKey()).object2DoubleEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2DoubleSortedMap<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2DoubleAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Object2DoubleAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2DoubleAVLTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public double getDouble(final Object k) {
			final Object2DoubleAVLTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public double put(final K k, final double v) {
			...
			final double oldValue = Object2DoubleAVLTreeMap.this.put(k, v);
		...
		public double removeDouble(final Object k) {
			...
			final double oldValue = Object2DoubleAVLTreeMap.this.removeDouble(k);
		...
		@Override
		public K firstKey() {
			Object2DoubleAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2DoubleAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2DoubleAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2DoubleAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
		...
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readDouble());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
		if (n == 2) {
			 ...
			 */
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readDouble());
			top.right(new Entry<>((K) s.readObject(), s.readDouble()));
			top.right.pred(top);
			top.balance(1);
			top.pred(pred);
			top.right.succ(succ);
