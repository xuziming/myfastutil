...
public abstract class AbstractObject2CharMap<K> extends AbstractObject2CharFunction<K>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Object2CharMap.Entry<K>> i = object2CharEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K> implements Object2CharMap.Entry<K> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Object2CharMap.Entry) {
				final Object2CharMap.Entry<K> e = (Object2CharMap.Entry<K>) o;
				return java.util.Objects.equals(key, e.getKey()) && ((value) == (e.getCharValue()));
			}
			...
			if (value == null || !(value instanceof Character))
				return false;
			return java.util.Objects.equals(this.key, (key)) && ((this.value) == (((Character) (value)).charValue()));
		}
	...
	public abstract static class BasicEntrySet<K> extends AbstractObjectSet<Entry<K>> {
		...
		public BasicEntrySet(final Object2CharMap<K> map) {
			this.map = map;
		}
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Object2CharMap.Entry<K>> i = Object2CharMaps
							.fastIterator(AbstractObject2CharMap.this);
	...
	public void putAll(final Map<? extends K, ? extends Character> m) {
		if (m instanceof Object2CharMap) {
			...
			while (i.hasNext()) {
				final Object2CharMap.Entry<? extends K> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Object2CharMap.Entry<K>> i = Object2CharMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
