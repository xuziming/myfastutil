...
public final class Reference2CharSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> fastIterator(
			Reference2CharSortedMap<K> map) {
		final ObjectSortedSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
		return entries instanceof Reference2CharSortedMap.FastSortedEntrySet
				? ((Reference2CharSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2CharMap.Entry<K>> fastIterable(
			Reference2CharSortedMap<K> map) {
		final ObjectSortedSet<Reference2CharMap.Entry<K>> entries = map.reference2CharEntrySet();
		return entries instanceof Reference2CharSortedMap.FastSortedEntrySet
				? ((Reference2CharSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2CharMaps.EmptyMap<K>
			implements Reference2CharSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2CharMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2CharMap.BasicEntry<>(key, value),
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2CharSortedMap<K> singleton(final K key, Character value) {
	...
	public static class SynchronizedSortedMap<K> extends Reference2CharMaps.SynchronizedMap<K>
			implements Reference2CharSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
