...
public interface Reference2DoubleMap<K> extends Reference2DoubleFunction<K>, Map<K, Double> {
	 ...
	 */
	interface FastEntrySet<K> extends ObjectSet<Reference2DoubleMap.Entry<K>> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default double computeDoubleIfAbsent(final K key,
	 ...
	 * @since 8.0.0
	 */
	default double computeDoubleIfAbsentPartial(final K key,
	 ...
	 * @since 8.0.0
	 */
	default double computeDoubleIfPresent(final K key,
	 ...
	 * @since 8.0.0
	 */
	default double computeDouble(final K key,
			final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final double oldValue = getDouble(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default double mergeDouble(final K key, final double value,
	...
	@Deprecated
	@Override
	default Double merge(final K key, final Double value,
			final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
