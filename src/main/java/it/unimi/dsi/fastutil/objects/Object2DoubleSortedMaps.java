...
public final class Object2DoubleSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> fastIterator(
			Object2DoubleSortedMap<K> map) {
		final ObjectSortedSet<Object2DoubleMap.Entry<K>> entries = map.object2DoubleEntrySet();
		return entries instanceof Object2DoubleSortedMap.FastSortedEntrySet
				? ((Object2DoubleSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Object2DoubleMap.Entry<K>> fastIterable(
			Object2DoubleSortedMap<K> map) {
		final ObjectSortedSet<Object2DoubleMap.Entry<K>> entries = map.object2DoubleEntrySet();
		return entries instanceof Object2DoubleSortedMap.FastSortedEntrySet
				? ((Object2DoubleSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Object2DoubleMaps.EmptyMap<K>
			implements Object2DoubleSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2DoubleMaps.Singleton<K>
		...
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2DoubleMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2DoubleMap.Entry<K>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2DoubleSortedMap<K> singleton(final K key, Double value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2DoubleSortedMap<K> singleton(final K key, Double value, Comparator<? super K> comparator) {
	...
	public static class SynchronizedSortedMap<K> extends Object2DoubleMaps.SynchronizedMap<K>
			implements Object2DoubleSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Object2DoubleMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2DoubleMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2DoubleEntrySet());
			return (ObjectSortedSet<Object2DoubleMap.Entry<K>>) entries;
		}
