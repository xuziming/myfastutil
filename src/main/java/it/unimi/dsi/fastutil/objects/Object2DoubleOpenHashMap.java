...
public class Object2DoubleOpenHashMap<K> extends AbstractObject2DoubleMap<K>
	...
	public Object2DoubleOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2DoubleOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2DoubleOpenHashMap(final Map<? extends K, ? extends Double> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2DoubleOpenHashMap(final Map<? extends K, ? extends Double> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2DoubleOpenHashMap(final Object2DoubleMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2DoubleOpenHashMap(final Object2DoubleMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleOpenHashMap(final K[] k, final double[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleOpenHashMap(final K[] k, final double[] v) {
	...
	final class MapEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double> {
		...
		public boolean equals(final Object o) {
			...
			return java.util.Objects.equals(key[index], (e.getKey()))
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final K key[] = Object2DoubleOpenHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2DoubleOpenHashMap.this.removeDouble(wrapped.set(-pos - 1, null));
