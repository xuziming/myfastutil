 ...
 * iterator}.
 */
public class Object2ByteAVLTreeMap<K> extends AbstractObject2ByteSortedMap<K>
	 ...
	 */
	public Object2ByteAVLTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2ByteAVLTreeMap(final Map<? extends K, ? extends Byte> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2ByteAVLTreeMap(final SortedMap<K, Byte> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2ByteAVLTreeMap(final Object2ByteMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2ByteAVLTreeMap(final Object2ByteSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ByteAVLTreeMap(final K[] k, final byte v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2ByteAVLTreeMap(final K[] k, final byte v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2ByteAVLTreeMap.this.removeByte(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
				final Comparator<? super Object2ByteMap.Entry<K>> comparator = (Comparator<Object2ByteMap.Entry<K>>) (x,
						y) -> Object2ByteAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(
						final Object2ByteMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from,
						Object2ByteMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> to) {
					return headMap(to.getKey()).object2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from) {
					return tailMap(from.getKey()).object2ByteEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractObject2ByteSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ByteAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Byte))
							return false;
						final Object2ByteAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2ByteAVLTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public byte getByte(final Object k) {
			final Object2ByteAVLTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public byte put(final K k, final byte v) {
			...
			final byte oldValue = Object2ByteAVLTreeMap.this.put(k, v);
		...
		public byte removeByte(final Object k) {
			...
			final byte oldValue = Object2ByteAVLTreeMap.this.removeByte(k);
		...
		@Override
		public K firstKey() {
			Object2ByteAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2ByteAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2ByteAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2ByteAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
