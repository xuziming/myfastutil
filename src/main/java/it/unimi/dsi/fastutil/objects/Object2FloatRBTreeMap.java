 ...
 *
 */
public class Object2FloatRBTreeMap<K> extends AbstractObject2FloatSortedMap<K>
	 ...
	 */
	public Object2FloatRBTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2FloatRBTreeMap(final Map<? extends K, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2FloatRBTreeMap(final SortedMap<K, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2FloatRBTreeMap(final Object2FloatMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2FloatRBTreeMap(final Object2FloatSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2FloatRBTreeMap(final K[] k, final float v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2FloatRBTreeMap(final K[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry<K> extends AbstractObject2FloatMap.BasicEntry<K> implements Cloneable {
		...
		@Override
		public int hashCode() {
			return ((key).hashCode()) ^ it.unimi.dsi.fastutil.HashCommon.float2int(value);
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2FloatRBTreeMap.this.removeFloat(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
				final Comparator<? super Object2FloatMap.Entry<K>> comparator = (Comparator<Object2FloatMap.Entry<K>>) (
						x, y) -> Object2FloatRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(
						final Object2FloatMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from,
						Object2FloatMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) {
					return headMap(to.getKey()).object2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) {
					return tailMap(from.getKey()).object2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2FloatSortedMap<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2FloatRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2FloatRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Object2FloatRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2FloatRBTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public float getFloat(final Object k) {
			final Object2FloatRBTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public float put(final K k, final float v) {
			...
			final float oldValue = Object2FloatRBTreeMap.this.put(k, v);
		...
		public float removeFloat(final Object k) {
			...
			final float oldValue = Object2FloatRBTreeMap.this.removeFloat(k);
		...
		@Override
		public K firstKey() {
			Object2FloatRBTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2FloatRBTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2FloatRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2FloatRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
		...
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readFloat());
			top.pred(pred);
			top.succ(succ);
			top.black(true);
			return top;
		...
		if (n == 2) {
			...
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readFloat());
			top.black(true);
			top.right(new Entry<>((K) s.readObject(), s.readFloat()));
			top.right.pred(top);
			top.pred(pred);
			top.right.succ(succ);
			return top;
