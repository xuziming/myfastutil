...
public class Object2ReferenceOpenCustomHashMap<K, V> extends AbstractObject2ReferenceMap<K, V>
	...
	public Object2ReferenceOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final Object2ReferenceMap<K, V> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceOpenCustomHashMap(final Object2ReferenceMap<K, V> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ReferenceOpenCustomHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ReferenceOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ReferenceOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2ReferenceMap.BasicEntry<K, V>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2ReferenceMap.BasicEntry<K, V>(key[pos], value[pos]));
		}
