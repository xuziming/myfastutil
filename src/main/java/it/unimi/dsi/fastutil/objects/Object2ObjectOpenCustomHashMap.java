 ...
 * @see HashCommon
 */
public class Object2ObjectOpenCustomHashMap<K, V> extends AbstractObject2ObjectMap<K, V>
	...
	public Object2ObjectOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final Map<? extends K, ? extends V> m, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final Object2ObjectMap<K, V> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectOpenCustomHashMap(final Object2ObjectMap<K, V> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ObjectOpenCustomHashMap(final K[] k, final V[] v, final float f, final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ObjectOpenCustomHashMap(final K[] k, final V[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ObjectOpenCustomHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			K curr;
			final K[] key = Object2ObjectOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
