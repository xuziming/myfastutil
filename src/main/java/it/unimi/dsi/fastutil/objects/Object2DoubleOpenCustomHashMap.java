...
public class Object2DoubleOpenCustomHashMap<K> extends AbstractObject2DoubleMap<K>
	...
	public Object2DoubleOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final Object2DoubleMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleOpenCustomHashMap(final Object2DoubleMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleOpenCustomHashMap(final K[] k, final double[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleOpenCustomHashMap(final K[] k, final double[] v, final Strategy<? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeDoubleIfAbsent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeDoubleIfPresent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeDouble(final K k,
			final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public double mergeDouble(final K k, final double v,
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final K key[] = Object2DoubleOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2DoubleOpenCustomHashMap.this.removeDouble(wrapped.set(-pos - 1, null));
	...
	private class EntryIterator extends MapIterator implements ObjectIterator<Object2DoubleMap.Entry<K>> {
	...
	private class FastEntryIterator extends MapIterator implements ObjectIterator<Object2DoubleMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public void forEach(final Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2DoubleMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2DoubleMap.BasicEntry<K>(key[pos], value[pos]));
		}
