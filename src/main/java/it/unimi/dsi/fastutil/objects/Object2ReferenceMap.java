...
public interface Object2ReferenceMap<K, V> extends Object2ReferenceFunction<K, V>, Map<K, V> {
	 ...
	 */
	interface FastEntrySet<K, V> extends ObjectSet<Object2ReferenceMap.Entry<K, V>> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
			forEach(consumer);
		}
	}
