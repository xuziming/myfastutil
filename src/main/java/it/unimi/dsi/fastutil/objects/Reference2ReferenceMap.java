...
public interface Reference2ReferenceMap<K, V> extends Reference2ReferenceFunction<K, V>, Map<K, V> {
	 ...
	 */
	interface FastEntrySet<K, V> extends ObjectSet<Reference2ReferenceMap.Entry<K, V>> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * {@inheritDoc}
	 * <p>
	 * This default implementation just delegates to the corresponding function
	 * method.
	 */
	@Override
