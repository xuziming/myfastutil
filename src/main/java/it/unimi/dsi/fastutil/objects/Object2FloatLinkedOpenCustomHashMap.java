...
public class Object2FloatLinkedOpenCustomHashMap<K> extends AbstractObject2FloatSortedMap<K>
	...
	public Object2FloatLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final Map<? extends K, ? extends Float> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final Object2FloatMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final Object2FloatMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final K[] k, final float[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2FloatLinkedOpenCustomHashMap(final K[] k, final float[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2FloatLinkedOpenCustomHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2FloatMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> fromElement,
				Object2FloatMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public void forEach(final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2FloatMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet<K> object2FloatEntrySet() {
		if (entries == null)
