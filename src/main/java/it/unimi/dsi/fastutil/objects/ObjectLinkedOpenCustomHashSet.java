...
public class ObjectLinkedOpenCustomHashSet<K> extends AbstractObjectSortedSet<K>
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectLinkedOpenCustomHashSet(final Collection<? extends K> c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectLinkedOpenCustomHashSet(final ObjectCollection<? extends K> c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectLinkedOpenCustomHashSet(final Iterator<? extends K> i, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectLinkedOpenCustomHashSet(final K[] a, final int offset, final int length, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectLinkedOpenCustomHashSet(final K[] a, final int offset, final int length,
			final Strategy<? super K> strategy) {
	...
	private class SetIterator implements ObjectListIterator<K> {
		...
		public K next() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !((key[curr]) == null) : "Position " + curr + " is not used";
			return key[curr];
		}
