 ...
 * @see HashCommon
 */
public class Reference2IntOpenHashMap<K> extends AbstractReference2IntMap<K>
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2IntOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2IntOpenHashMap.this.removeInt(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2IntOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2IntOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Reference2IntOpenHashMap<K> clone() {
		...
		try {
			c = (Reference2IntOpenHashMap<K>) super.clone();
