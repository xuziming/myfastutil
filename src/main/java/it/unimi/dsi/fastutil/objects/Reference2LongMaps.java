...
public final class Reference2LongMaps {
	...
	public static <K> ObjectIterator<Reference2LongMap.Entry<K>> fastIterator(Reference2LongMap<K> map) {
		...
		return entries instanceof Reference2LongMap.FastEntrySet
				? ((Reference2LongMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2LongMap<K> map,
			final Consumer<? super Reference2LongMap.Entry<K>> consumer) {
		final ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
		if (entries instanceof Reference2LongMap.FastEntrySet)
			((Reference2LongMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Reference2LongMap.Entry<K>> fastIterable(Reference2LongMap<K> map) {
		...
		return entries instanceof Reference2LongMap.FastEntrySet ? new ObjectIterable<Reference2LongMap.Entry<K>>() {
			public ObjectIterator<Reference2LongMap.Entry<K>> iterator() {
				return ((Reference2LongMap.FastEntrySet<K>) entries).fastIterator();
			}
	...
	public static class EmptyMap<K> extends Reference2LongFunctions.EmptyFunction<K>
			implements Reference2LongMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2LongFunctions.Singleton<K>
		...
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<K, Long>> entrySet() {
			return (ObjectSet) reference2LongEntrySet();
		}
	...
	public static class SynchronizedMap<K> extends Reference2LongFunctions.SynchronizedFunction<K>
			implements Reference2LongMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public long computeLongIfAbsentPartial(final K key, final Reference2LongFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2LongFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2LongEntrySet());
			return entries;
		}
