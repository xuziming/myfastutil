 ...
 * iterator}.
 */
public class Object2ObjectAVLTreeMap<K, V> extends AbstractObject2ObjectSortedMap<K, V>
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2ObjectAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
				final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = (Comparator<Object2ObjectMap.Entry<K, V>>) (
						x, y) -> Object2ObjectAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2ObjectAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
				...
				entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
					...
					public boolean contains(final Object o) {
						if (!(o instanceof Map.Entry))
							return false;
						final Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
						final Object2ObjectAVLTreeMap.Entry<K, V> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2ObjectAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2ObjectAVLTreeMap.Entry<K, V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2ObjectAVLTreeMap.Entry<K, V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2ObjectAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2ObjectAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
