 ...
 * @see HashCommon
 */
public class Object2ShortOpenHashMap<K> extends AbstractObject2ShortMap<K>
	...
	public Object2ShortOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2ShortOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ShortOpenHashMap(final Map<? extends K, ? extends Short> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2ShortOpenHashMap(final Map<? extends K, ? extends Short> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ShortOpenHashMap(final Object2ShortMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2ShortOpenHashMap(final Object2ShortMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ShortOpenHashMap(final K[] k, final short[] v) {
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final K key[] = Object2ShortOpenHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ShortOpenHashMap.this.removeShort(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ShortOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ShortOpenHashMap.this.key;
			int pos;
			// The starting point.
