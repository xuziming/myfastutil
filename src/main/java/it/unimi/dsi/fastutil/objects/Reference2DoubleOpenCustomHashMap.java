 ...
 * @see HashCommon
 */
public class Reference2DoubleOpenCustomHashMap<K> extends AbstractReference2DoubleMap<K>
	...
	public Reference2DoubleOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final Reference2DoubleMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2DoubleOpenCustomHashMap(final Reference2DoubleMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2DoubleOpenCustomHashMap(final K[] k, final double[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2DoubleOpenCustomHashMap(final K[] k, final double[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2DoubleOpenCustomHashMap.this.removeDouble(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2DoubleMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2DoubleMap.BasicEntry<K>(key[pos], value[pos]));
		}
