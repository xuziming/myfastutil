 ...
 * iterator}.
 */
public class Object2FloatAVLTreeMap<K> extends AbstractObject2FloatSortedMap<K>
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2FloatAVLTreeMap.this.removeFloat(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
				final Comparator<? super Object2FloatMap.Entry<K>> comparator = (Comparator<Object2FloatMap.Entry<K>>) (
						x, y) -> Object2FloatAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2FloatSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Object2FloatAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2FloatAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2FloatAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
