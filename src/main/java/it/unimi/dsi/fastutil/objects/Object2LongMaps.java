...
public final class Object2LongMaps {
	...
	public static <K> ObjectIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongMap<K> map) {
		...
		return entries instanceof Object2LongMap.FastEntrySet
				? ((Object2LongMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2LongMap<K> map,
			final Consumer<? super Object2LongMap.Entry<K>> consumer) {
		final ObjectSet<Object2LongMap.Entry<K>> entries = map.object2LongEntrySet();
		if (entries instanceof Object2LongMap.FastEntrySet)
			((Object2LongMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2LongMap.Entry<K>> fastIterable(Object2LongMap<K> map) {
		...
		return entries instanceof Object2LongMap.FastEntrySet ? new ObjectIterable<Object2LongMap.Entry<K>>() {
			public ObjectIterator<Object2LongMap.Entry<K>> iterator() {
				return ((Object2LongMap.FastEntrySet<K>) entries).fastIterator();
			}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2LongFunctions.EmptyFunction<K>
			implements Object2LongMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2LongFunctions.Singleton<K>
			implements Object2LongMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2LongMap.BasicEntry<>(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2LongMap<K> singleton(final K key, long value) {
	...
	public static class SynchronizedMap<K> extends Object2LongFunctions.SynchronizedFunction<K>
			implements Object2LongMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		public LongCollection values() {
			synchronized (sync) {
				if (values == null)
					return LongCollections.synchronize(map.values(), sync);
				return values;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super K, ? super Long> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		@Override
		public void replaceAll(final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeLongIfAbsent(final K key,
				final java.util.function.ToLongFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeLongIfAbsent(key, mappingFunction);
			}
		}
		...
		public long computeLongIfAbsentPartial(final K key, final Object2LongFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeLongIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public long computeLongIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.computeLongIfPresent(key, remappingFunction);
			}
		}

		@Override
		public long computeLong(final K key,
				final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.computeLong(key, remappingFunction);
			}
		}

		@Override
		public long mergeLong(final K key, final long value,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.mergeLong(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Long computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Long> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Long computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Long compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Long merge(final K key, final Long value,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2LongFunctions.UnmodifiableFunction<K>
			implements Object2LongMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2LongMap<K> map;
		protected transient ObjectSet<Object2LongMap.Entry<K>> entries;
		...
		public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2LongEntrySet());
			return entries;
		}
		...
		public LongCollection values() {
			if (values == null)
				return LongCollections.unmodifiable(map.values());
			return values;
		}
