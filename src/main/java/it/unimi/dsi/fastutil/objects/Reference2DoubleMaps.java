...
public final class Reference2DoubleMaps {
	...
	public static <K> ObjectIterator<Reference2DoubleMap.Entry<K>> fastIterator(Reference2DoubleMap<K> map) {
		...
		return entries instanceof Reference2DoubleMap.FastEntrySet
				? ((Reference2DoubleMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2DoubleMap<K> map,
			final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
		final ObjectSet<Reference2DoubleMap.Entry<K>> entries = map.reference2DoubleEntrySet();
	...
	public static <K> ObjectIterable<Reference2DoubleMap.Entry<K>> fastIterable(Reference2DoubleMap<K> map) {
		final ObjectSet<Reference2DoubleMap.Entry<K>> entries = map.reference2DoubleEntrySet();
		return entries instanceof Reference2DoubleMap.FastEntrySet
				? new ObjectIterable<Reference2DoubleMap.Entry<K>>() {
	...
	public static class EmptyMap<K> extends Reference2DoubleFunctions.EmptyFunction<K>
			implements Reference2DoubleMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2DoubleFunctions.Singleton<K>
		...
		public ObjectSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2DoubleMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2DoubleFunctions.SynchronizedFunction<K>
			implements Reference2DoubleMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		public double computeDoubleIfAbsentPartial(final K key,
				final Reference2DoubleFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2DoubleFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2DoubleEntrySet());
			return entries;
		}
