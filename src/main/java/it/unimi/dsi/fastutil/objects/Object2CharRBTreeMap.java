 ...
 *
 */
public class Object2CharRBTreeMap<K> extends AbstractObject2CharSortedMap<K>
	...
	private static final class Entry<K> extends AbstractObject2CharMap.BasicEntry<K> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return java.util.Objects.equals(key, (e.getKey())) && ((value) == ((e.getValue()).charValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2CharRBTreeMap.this.removeChar(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
				final Comparator<? super Object2CharMap.Entry<K>> comparator = (Comparator<Object2CharMap.Entry<K>>) (x,
						y) -> Object2CharRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(
						final Object2CharMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from,
						Object2CharMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) {
					return headMap(to.getKey()).object2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> from) {
					return tailMap(from.getKey()).object2CharEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractObject2CharSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2CharRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2CharRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Object2CharRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2CharRBTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2CharRBTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2CharRBTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2CharRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2CharRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Object2CharRBTreeMap<K> clone() {
		...
		try {
			c = (Object2CharRBTreeMap<K>) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
	...
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
		...
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readChar());
			top.pred(pred);
			top.succ(succ);
			top.black(true);
			return top;
		...
		if (n == 2) {
			...
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readChar());
			top.black(true);
			top.right(new Entry<>((K) s.readObject(), s.readChar()));
			top.right.pred(top);
			top.pred(pred);
			top.right.succ(succ);
			return top;
