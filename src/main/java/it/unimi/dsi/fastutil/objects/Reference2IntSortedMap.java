...
public interface Reference2IntSortedMap<K> extends Reference2IntMap<K>, SortedMap<K, Integer> {
	 ...
	 */
	@Override
	Reference2IntSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Reference2IntSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Reference2IntSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Reference2IntMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Reference2IntMap.Entry<K>> fastIterator(Reference2IntMap.Entry<K> from);
	}
