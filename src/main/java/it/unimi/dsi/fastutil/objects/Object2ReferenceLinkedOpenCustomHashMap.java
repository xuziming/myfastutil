 ...
 * @see HashCommon
 */
public class Object2ReferenceLinkedOpenCustomHashMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V>
	...
	public Object2ReferenceLinkedOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final Map<? extends K, ? extends V> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final Object2ReferenceMap<K, V> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final Object2ReferenceMap<K, V> m,
			final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final K[] k, final V[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceLinkedOpenCustomHashMap(final K[] k, final V[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2ReferenceLinkedOpenCustomHashMap.this.key;
	...
	private class EntryIterator extends MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>
		...
		@Override
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> fromElement,
				Object2ReferenceMap.Entry<K, V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ReferenceLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ReferenceLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Object2ReferenceMap.Entry<K, V>> iterator(
		...
		public void forEach(final Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2ReferenceMap.BasicEntry<K, V>(key[curr], value[curr]));
			}
		}
