...
public class Object2BooleanOpenHashMap<K> extends AbstractObject2BooleanMap<K>
	...
	final class MapEntry implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
		...
		@Override
		public int hashCode() {
			return ((key[index]) == null ? 0 : (key[index]).hashCode()) ^ (value[index] ? 1231 : 1237);
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2BooleanOpenHashMap.this.removeBoolean(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2BooleanOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2BooleanOpenHashMap.this.key;
			int pos;
			// The starting point.
