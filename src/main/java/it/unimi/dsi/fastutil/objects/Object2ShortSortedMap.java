...
public interface Object2ShortSortedMap<K> extends Object2ShortMap<K>, SortedMap<K, Short> {
	 ...
	 */
	@Override
	Object2ShortSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Object2ShortSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Object2ShortSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Object2ShortMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> from);
	}
