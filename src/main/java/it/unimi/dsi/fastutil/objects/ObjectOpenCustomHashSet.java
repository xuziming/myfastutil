...
public class ObjectOpenCustomHashSet<K> extends AbstractObjectSet<K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectOpenCustomHashSet(final K[] a, final int offset, final int length, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ObjectOpenCustomHashSet(final K[] a, final int offset, final int length,
			final Strategy<? super K> strategy) {
