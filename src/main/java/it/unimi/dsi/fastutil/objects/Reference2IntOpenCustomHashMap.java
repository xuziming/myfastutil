 ...
 * @see HashCommon
 */
public class Reference2IntOpenCustomHashMap<K> extends AbstractReference2IntMap<K>
	...
	public Reference2IntOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final Reference2IntMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2IntOpenCustomHashMap(final Reference2IntMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2IntOpenCustomHashMap(final K[] k, final int[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2IntOpenCustomHashMap(final K[] k, final int[] v, final Strategy<? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public int computeIntIfAbsent(final K k, final java.util.function.ToIntFunction<? super K> mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public int computeIntIfPresent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public int computeInt(final K k,
			final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public int mergeInt(final K k, final int v,
	...
	final class MapEntry implements Reference2IntMap.Entry<K>, Map.Entry<K, Integer> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey())))) && ((value[index]) == ((e.getValue()).intValue()));
		}
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2IntOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2IntOpenCustomHashMap.this.removeInt(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2IntOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2IntOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2IntMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2IntMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2IntMap.BasicEntry<K>(key[pos], value[pos]));
		}
	...
	public Reference2IntOpenCustomHashMap<K> clone() {
		...
		try {
			c = (Reference2IntOpenCustomHashMap<K>) super.clone();
