...
public class Reference2DoubleLinkedOpenHashMap<K> extends AbstractReference2DoubleSortedMap<K>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2DoubleMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Reference2DoubleMap.Entry<K>> subSet(Reference2DoubleMap.Entry<K> fromElement,
				Reference2DoubleMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Reference2DoubleMap.Entry<K>> iterator(final Reference2DoubleMap.Entry<K> from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Reference2DoubleMap.Entry<K>> fastIterator(final Reference2DoubleMap.Entry<K> from) {
		...
		public void forEach(final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractReference2DoubleMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
