...
public abstract class AbstractObject2ReferenceSortedMap<K, V> extends AbstractObject2ReferenceMap<K, V>
	...
	protected class KeySet extends AbstractObjectSortedSet<K> {
		...
		public ObjectBidirectionalIterator<K> iterator(final K from) {
			return new KeySetIterator<>(object2ReferenceEntrySet().iterator(new BasicEntry<>(from, (null))));
		}

		@Override
		public ObjectBidirectionalIterator<K> iterator() {
			return new KeySetIterator<>(
					Object2ReferenceSortedMaps.fastIterator(AbstractObject2ReferenceSortedMap.this));
		}
	}
