...
public class Object2ReferenceAVLTreeMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V>
	...
	private Entry<K, V> add(final K k) {
		...
		if (tree == null) { // The case of the empty tree is treated separately.
			...
			Entry<K, V> p = tree, q = null, y = tree, z = null, w = null;
			int cmp, i = 0;
			while (true) {
	...
	private static final class Entry<K, V> extends AbstractObject2ReferenceMap.BasicEntry<K, V> implements Cloneable {
		...
		@Override
		public int hashCode() {
			return ((key).hashCode()) ^ ((value) == null ? 0 : System.identityHashCode(value));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2ReferenceAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
				final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = (Comparator<Object2ReferenceMap.Entry<K, V>>) (
						x, y) -> Object2ReferenceAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(
						final Object2ReferenceMap.Entry<K, V> from) {
				...
				@Override
				public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> from,
						Object2ReferenceMap.Entry<K, V> to) {
					return subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> to) {
					return headMap(to.getKey()).object2ReferenceEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> from) {
					return tailMap(from.getKey()).object2ReferenceEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2ReferenceSortedMap<K, V> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2ReferenceAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
				...
				entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
					...
					public boolean contains(final Object o) {
						if (!(o instanceof Map.Entry))
							return false;
						final Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
						final Object2ReferenceAVLTreeMap.Entry<K, V> f = findKey(((K) e.getKey()));
					...
					@Override
					public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(
							Object2ReferenceMap.Entry<K, V> to) {
						return headMap(to.getKey()).object2ReferenceEntrySet();
					}

					@Override
					public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(
							Object2ReferenceMap.Entry<K, V> from) {
						return tailMap(from.getKey()).object2ReferenceEntrySet();
					}
				};
			return entries;
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2ReferenceAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2ReferenceAVLTreeMap.Entry<K, V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2ReferenceAVLTreeMap.Entry<K, V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Object2ReferenceAVLTreeMap<K, V> clone() {
		...
		if (count != 0) {
			...
			Entry<K, V> e, p, q, rp = new Entry<>(), rq = new Entry<>();
			p = rp;
			rp.left(tree);
			q = rq;
			rq.pred(null);
