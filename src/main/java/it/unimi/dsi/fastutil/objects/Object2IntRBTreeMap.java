 ...
 *
 */
public class Object2IntRBTreeMap<K> extends AbstractObject2IntSortedMap<K> implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Object2IntRBTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2IntRBTreeMap(final Map<? extends K, ? extends Integer> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2IntRBTreeMap(final SortedMap<K, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2IntRBTreeMap(final Object2IntMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2IntRBTreeMap(final Object2IntSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2IntRBTreeMap(final K[] k, final int v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2IntRBTreeMap(final K[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2IntRBTreeMap.this.removeInt(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
				final Comparator<? super Object2IntMap.Entry<K>> comparator = (Comparator<Object2IntMap.Entry<K>>) (x,
						y) -> Object2IntRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2IntSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2IntRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2IntRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Object2IntRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2IntRBTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public int getInt(final Object k) {
			final Object2IntRBTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public int put(final K k, final int v) {
			...
			final int oldValue = Object2IntRBTreeMap.this.put(k, v);
		...
		public int removeInt(final Object k) {
			...
			final int oldValue = Object2IntRBTreeMap.this.removeInt(k);
		...
		@Override
		public K firstKey() {
			Object2IntRBTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2IntRBTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2IntRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2IntRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Object2IntRBTreeMap<K> clone() {
		...
		try {
			c = (Object2IntRBTreeMap<K>) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
