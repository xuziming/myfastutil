...
public class Reference2ReferenceOpenHashMap<K, V> extends AbstractReference2ReferenceMap<K, V>
	...
	final class MapEntry implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V> {
		...
		@Override
		public int hashCode() {
			return (System.identityHashCode(key[index]))
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2ReferenceOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2ReferenceOpenHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2ReferenceOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2ReferenceOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Reference2ReferenceOpenHashMap<K, V> clone() {
		...
		try {
			c = (Reference2ReferenceOpenHashMap<K, V>) super.clone();
