 ...
 * @see HashCommon
 */
public class Reference2ObjectOpenCustomHashMap<K, V> extends AbstractReference2ObjectMap<K, V>
	...
	public Reference2ObjectOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final Map<? extends K, ? extends V> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final Reference2ObjectMap<K, V> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ObjectOpenCustomHashMap(final Reference2ObjectMap<K, V> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2ObjectOpenCustomHashMap(final K[] k, final V[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2ObjectOpenCustomHashMap(final K[] k, final V[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2ObjectOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2ObjectOpenCustomHashMap.this.remove(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			K curr;
			final K[] key = Reference2ObjectOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2ObjectMap.BasicEntry<K, V>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2ObjectMap.BasicEntry<K, V>(key[pos], value[pos]));
		}
	...
	public Reference2ObjectOpenCustomHashMap<K, V> clone() {
		...
		try {
			c = (Reference2ObjectOpenCustomHashMap<K, V>) super.clone();
