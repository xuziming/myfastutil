 ...
 * @see HashCommon
 */
public class Object2CharLinkedOpenHashMap<K> extends AbstractObject2CharSortedMap<K>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2CharLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2CharLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Object2CharLinkedOpenHashMap<K> clone() {
		...
		try {
			c = (Object2CharLinkedOpenHashMap<K>) super.clone();
