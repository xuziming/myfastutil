...
public final class Reference2DoubleSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2DoubleMap.Entry<K>> fastIterator(
			Reference2DoubleSortedMap<K> map) {
		final ObjectSortedSet<Reference2DoubleMap.Entry<K>> entries = map.reference2DoubleEntrySet();
		return entries instanceof Reference2DoubleSortedMap.FastSortedEntrySet
				? ((Reference2DoubleSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2DoubleMap.Entry<K>> fastIterable(
			Reference2DoubleSortedMap<K> map) {
		final ObjectSortedSet<Reference2DoubleMap.Entry<K>> entries = map.reference2DoubleEntrySet();
		return entries instanceof Reference2DoubleSortedMap.FastSortedEntrySet
				? ((Reference2DoubleSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2DoubleMaps.EmptyMap<K>
			implements Reference2DoubleSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2DoubleMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2DoubleMap.Entry<K>> reference2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2DoubleMap.BasicEntry<>(key, value),
		...
		public ObjectSortedSet<Map.Entry<K, Double>> entrySet() {
			return (ObjectSortedSet) reference2DoubleEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2DoubleSortedMap<K> singleton(final K key, Double value) {
	...
	public static class SynchronizedSortedMap<K> extends Reference2DoubleMaps.SynchronizedMap<K>
			implements Reference2DoubleSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
