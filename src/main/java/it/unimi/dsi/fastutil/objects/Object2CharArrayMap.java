 ...
 */
public class Object2CharArrayMap<K> extends AbstractObject2CharMap<K> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Object2CharMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		public ObjectIterator<Object2CharMap.Entry<K>> iterator() {
			return new ObjectIterator<Object2CharMap.Entry<K>>() {
				...
				public Entry<K> next() {
					...
					return new AbstractObject2CharMap.BasicEntry<>((K) key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Object2CharArrayMap.this.containsKey(k)
					&& ((Object2CharArrayMap.this.getChar(k)) == (((Character) (e.getValue())).charValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			Object2CharArrayMap.this.key[size] = null;
			return true;
		}
	}
