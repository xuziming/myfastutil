...
public class Object2ShortLinkedOpenCustomHashMap<K> extends AbstractObject2ShortSortedMap<K>
	...
	public Object2ShortLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final Map<? extends K, ? extends Short> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final Object2ShortMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final Object2ShortMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final K[] k, final short[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ShortLinkedOpenCustomHashMap(final K[] k, final short[] v, final Strategy<? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> fromElement,
				Object2ShortMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ShortLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ShortLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2ShortMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
