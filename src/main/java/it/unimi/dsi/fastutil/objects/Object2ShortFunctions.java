...
public final class Object2ShortFunctions {
	 ...
	 */
	public static class EmptyFunction<K> extends AbstractObject2ShortFunction<K>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K> extends AbstractObject2ShortFunction<K>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2ShortFunction<K> singleton(final K key, short value) {
	...
	public static class SynchronizedFunction<K> implements Object2ShortFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2ShortFunction<K>
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Object2ShortFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Short> f) {
		...
		if (f instanceof java.util.function.ToIntFunction)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeIntToShort(((java.util.function.ToIntFunction<K>) f).applyAsInt((K) (key)));
