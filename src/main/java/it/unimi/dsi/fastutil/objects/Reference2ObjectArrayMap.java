...
public class Reference2ObjectArrayMap<K, V> extends AbstractReference2ObjectMap<K, V>
	...
	private final class EntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>>
		...
		public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator() {
			return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() {
				...
				public Entry<K, V> next() {
					...
					return new AbstractReference2ObjectMap.BasicEntry<>((K) key[curr = next], (V) value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Reference2ObjectArrayMap.this.containsKey(k)
					&& java.util.Objects.equals(Reference2ObjectArrayMap.this.get(k), (e.getValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1 || !java.util.Objects.equals(v, Reference2ObjectArrayMap.this.value[oldPos]))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Reference2ObjectArrayMap.this.key, oldPos + 1, Reference2ObjectArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2ObjectArrayMap.this.value, oldPos + 1, Reference2ObjectArrayMap.this.value,
					oldPos, tail);
