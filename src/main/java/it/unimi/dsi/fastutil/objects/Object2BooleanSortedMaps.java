...
public final class Object2BooleanSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator(
			Object2BooleanSortedMap<K> map) {
		final ObjectSortedSet<Object2BooleanMap.Entry<K>> entries = map.object2BooleanEntrySet();
		return entries instanceof Object2BooleanSortedMap.FastSortedEntrySet
				? ((Object2BooleanSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Object2BooleanMap.Entry<K>> fastIterable(
			Object2BooleanSortedMap<K> map) {
		final ObjectSortedSet<Object2BooleanMap.Entry<K>> entries = map.object2BooleanEntrySet();
		return entries instanceof Object2BooleanSortedMap.FastSortedEntrySet
				? ((Object2BooleanSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Object2BooleanMaps.EmptyMap<K>
			implements Object2BooleanSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2BooleanMaps.Singleton<K>
		...
		public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2BooleanMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2BooleanMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<K, Boolean>> entrySet() {
			return (ObjectSortedSet) object2BooleanEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2BooleanSortedMap<K> singleton(final K key, Boolean value) {
	...
	public static class SynchronizedSortedMap<K> extends Object2BooleanMaps.SynchronizedMap<K>
			implements Object2BooleanSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Object2BooleanMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2BooleanMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2BooleanEntrySet());
			return (ObjectSortedSet<Object2BooleanMap.Entry<K>>) entries;
		}
