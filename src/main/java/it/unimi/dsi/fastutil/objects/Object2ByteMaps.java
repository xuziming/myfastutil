...
public final class Object2ByteMaps {
	...
	public static <K> ObjectIterator<Object2ByteMap.Entry<K>> fastIterator(Object2ByteMap<K> map) {
		...
		return entries instanceof Object2ByteMap.FastEntrySet
				? ((Object2ByteMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2ByteMap<K> map,
			final Consumer<? super Object2ByteMap.Entry<K>> consumer) {
		final ObjectSet<Object2ByteMap.Entry<K>> entries = map.object2ByteEntrySet();
		if (entries instanceof Object2ByteMap.FastEntrySet)
			((Object2ByteMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2ByteMap.Entry<K>> fastIterable(Object2ByteMap<K> map) {
		...
		return entries instanceof Object2ByteMap.FastEntrySet ? new ObjectIterable<Object2ByteMap.Entry<K>>() {
			public ObjectIterator<Object2ByteMap.Entry<K>> iterator() {
				return ((Object2ByteMap.FastEntrySet<K>) entries).fastIterator();
			}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2ByteFunctions.EmptyFunction<K>
			implements Object2ByteMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2ByteFunctions.Singleton<K>
			implements Object2ByteMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2ByteMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2ByteFunctions.SynchronizedFunction<K>
			implements Object2ByteMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public byte computeByteIfAbsent(final K key,
				final java.util.function.ToIntFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeByteIfAbsent(key, mappingFunction);
			}
		}
		...
		public byte computeByteIfAbsentPartial(final K key, final Object2ByteFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeByteIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public byte computeByteIfPresent(final K key,
		...
		@Override
		public byte computeByte(final K key,
				final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte mergeByte(final K key, final byte value,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.mergeByte(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Byte computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Byte> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Byte computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Byte compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Byte merge(final K key, final Byte value,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2ByteFunctions.UnmodifiableFunction<K>
			implements Object2ByteMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2ByteMap<K> map;
		protected transient ObjectSet<Object2ByteMap.Entry<K>> entries;
		...
		public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2ByteEntrySet());
			return entries;
		}
