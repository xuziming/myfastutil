...
public class Object2ReferenceLinkedOpenHashMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V>
	...
	public Object2ReferenceLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Object2ReferenceLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ReferenceLinkedOpenHashMap(final Map<? extends K, ? extends V> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Object2ReferenceLinkedOpenHashMap(final Map<? extends K, ? extends V> m) {
	 ...
	 * @param f the load factor.
	 */
	public Object2ReferenceLinkedOpenHashMap(final Object2ReferenceMap<K, V> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Object2ReferenceLinkedOpenHashMap(final Object2ReferenceMap<K, V> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceLinkedOpenHashMap(final K[] k, final V[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Object2ReferenceLinkedOpenHashMap(final K[] k, final V[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2ReferenceLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ReferenceLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ReferenceLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
