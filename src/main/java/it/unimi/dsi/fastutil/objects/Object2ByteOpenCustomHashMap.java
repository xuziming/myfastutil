 ...
 * @see HashCommon
 */
public class Object2ByteOpenCustomHashMap<K> extends AbstractObject2ByteMap<K>
	...
	public Object2ByteOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final Object2ByteMap<K> m, final float f, final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteOpenCustomHashMap(final Object2ByteMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ByteOpenCustomHashMap(final K[] k, final byte[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ByteOpenCustomHashMap(final K[] k, final byte[] v, final Strategy<? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeByteIfAbsent(final K k, final java.util.function.ToIntFunction<? super K> mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeByteIfPresent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public byte computeByte(final K k,
			final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public byte mergeByte(final K k, final byte v,
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Object2ByteOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2ByteOpenCustomHashMap.this.removeByte(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ByteOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ByteOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2ByteMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2ByteMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2ByteMap.BasicEntry<K>(key[pos], value[pos]));
		}
