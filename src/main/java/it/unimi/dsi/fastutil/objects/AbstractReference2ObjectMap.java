...
public abstract class AbstractReference2ObjectMap<K, V> extends AbstractReference2ObjectFunction<K, V>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Reference2ObjectMap.Entry<K, V>> i = reference2ObjectEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K, V> implements Reference2ObjectMap.Entry<K, V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Reference2ObjectMap.Entry) {
				...
				return ((key) == (e.getKey())) && java.util.Objects.equals(value, e.getValue());
			}
			final Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
			final Object key = e.getKey();
			final Object value = e.getValue();
			return ((this.key) == ((key))) && java.util.Objects.equals(this.value, (value));
		}
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Reference2ObjectMap.Entry<K, V>> i = Reference2ObjectMaps
							.fastIterator(AbstractReference2ObjectMap.this);
	...
	public void putAll(final Map<? extends K, ? extends V> m) {
		if (m instanceof Reference2ObjectMap) {
			ObjectIterator<Reference2ObjectMap.Entry<K, V>> i = Reference2ObjectMaps
					.fastIterator((Reference2ObjectMap<K, V>) m);
			while (i.hasNext()) {
				final Reference2ObjectMap.Entry<? extends K, ? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Reference2ObjectMap.Entry<K, V>> i = Reference2ObjectMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
