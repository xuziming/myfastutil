...
public class Reference2ByteOpenCustomHashMap<K> extends AbstractReference2ByteMap<K>
	...
	public Reference2ByteOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final Map<? extends K, ? extends Byte> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final Reference2ByteMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2ByteOpenCustomHashMap(final Reference2ByteMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2ByteOpenCustomHashMap(final K[] k, final byte[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2ByteOpenCustomHashMap(final K[] k, final byte[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2ByteOpenCustomHashMap.this.removeByte(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2ByteOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2ByteOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2ByteMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2ByteMap.BasicEntry<K>(key[pos], value[pos]));
		}
