...
public final class Reference2ByteSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator(
			Reference2ByteSortedMap<K> map) {
		final ObjectSortedSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
		return entries instanceof Reference2ByteSortedMap.FastSortedEntrySet
				? ((Reference2ByteSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2ByteMap.Entry<K>> fastIterable(
			Reference2ByteSortedMap<K> map) {
		final ObjectSortedSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
		return entries instanceof Reference2ByteSortedMap.FastSortedEntrySet
				? ((Reference2ByteSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2ByteMaps.EmptyMap<K>
			implements Reference2ByteSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2ByteMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2ByteMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Reference2ByteMap.Entry<K>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2ByteSortedMap<K> singleton(final K key, Byte value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2ByteSortedMap<K> singleton(final K key, Byte value, Comparator<? super K> comparator) {
	...
	public static class SynchronizedSortedMap<K> extends Reference2ByteMaps.SynchronizedMap<K>
			implements Reference2ByteSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.reference2ByteEntrySet(), sync);
			return (ObjectSortedSet<Reference2ByteMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2ByteMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.reference2ByteEntrySet());
			return (ObjectSortedSet<Reference2ByteMap.Entry<K>>) entries;
		}
