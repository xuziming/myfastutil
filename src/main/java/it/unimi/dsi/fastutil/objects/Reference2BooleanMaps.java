...
public final class Reference2BooleanMaps {
	...
	public static <K> ObjectIterator<Reference2BooleanMap.Entry<K>> fastIterator(Reference2BooleanMap<K> map) {
		...
		return entries instanceof Reference2BooleanMap.FastEntrySet
				? ((Reference2BooleanMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2BooleanMap<K> map,
			final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
		final ObjectSet<Reference2BooleanMap.Entry<K>> entries = map.reference2BooleanEntrySet();
	...
	public static <K> ObjectIterable<Reference2BooleanMap.Entry<K>> fastIterable(Reference2BooleanMap<K> map) {
		final ObjectSet<Reference2BooleanMap.Entry<K>> entries = map.reference2BooleanEntrySet();
		return entries instanceof Reference2BooleanMap.FastEntrySet
				? new ObjectIterable<Reference2BooleanMap.Entry<K>>() {
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Reference2BooleanFunctions.EmptyFunction<K>
			implements Reference2BooleanMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Reference2BooleanFunctions.Singleton<K>
			implements Reference2BooleanMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2BooleanMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2BooleanFunctions.SynchronizedFunction<K>
			implements Reference2BooleanMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeBooleanIfAbsent(final K key,
				final java.util.function.Predicate<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeBooleanIfAbsent(key, mappingFunction);
			}
		}

		@Override
		public boolean computeBooleanIfAbsentPartial(final K key,
				final Reference2BooleanFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeBooleanIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public boolean computeBooleanIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeBoolean(final K key,
				final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean mergeBoolean(final K key, final boolean value,
				final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.mergeBoolean(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Boolean computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Boolean> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Boolean computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Boolean compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Boolean merge(final K key, final Boolean value,
				final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2BooleanFunctions.UnmodifiableFunction<K>
			implements Reference2BooleanMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2BooleanMap<K> map;
		protected transient ObjectSet<Reference2BooleanMap.Entry<K>> entries;
		...
		public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2BooleanEntrySet());
			return entries;
		}
