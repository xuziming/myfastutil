...
public interface Object2FloatSortedMap<K> extends Object2FloatMap<K>, SortedMap<K, Float> {
	 ...
	 */
	@Override
	Object2FloatSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Object2FloatSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Object2FloatSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Object2FloatMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> fastIterator(Object2FloatMap.Entry<K> from);
	}
