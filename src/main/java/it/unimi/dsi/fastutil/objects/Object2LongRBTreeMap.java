 ...
 *
 */
public class Object2LongRBTreeMap<K> extends AbstractObject2LongSortedMap<K>
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
				final Comparator<? super Object2LongMap.Entry<K>> comparator = (Comparator<Object2LongMap.Entry<K>>) (x,
						y) -> Object2LongRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2LongSortedMap<K> implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Long))
							return false;
						final Object2LongRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@Override
		public K firstKey() {
			Object2LongRBTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2LongRBTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2LongRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2LongRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
