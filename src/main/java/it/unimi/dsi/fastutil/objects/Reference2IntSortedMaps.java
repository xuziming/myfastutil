...
public final class Reference2IntSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2IntMap.Entry<K>> fastIterator(
			Reference2IntSortedMap<K> map) {
		final ObjectSortedSet<Reference2IntMap.Entry<K>> entries = map.reference2IntEntrySet();
		return entries instanceof Reference2IntSortedMap.FastSortedEntrySet
				? ((Reference2IntSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2IntMap.Entry<K>> fastIterable(
			Reference2IntSortedMap<K> map) {
		final ObjectSortedSet<Reference2IntMap.Entry<K>> entries = map.reference2IntEntrySet();
		return entries instanceof Reference2IntSortedMap.FastSortedEntrySet
				? ((Reference2IntSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	...
	public static class EmptySortedMap<K> extends Reference2IntMaps.EmptyMap<K>
			implements Reference2IntSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2IntMaps.Singleton<K>
		...
		public ObjectSortedSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2IntMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Reference2IntMap.Entry<K>>) entries;
		}
	...
	public static class SynchronizedSortedMap<K> extends Reference2IntMaps.SynchronizedMap<K>
			implements Reference2IntSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.reference2IntEntrySet(), sync);
			return (ObjectSortedSet<Reference2IntMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2IntMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Reference2IntMap.Entry<K>> reference2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.reference2IntEntrySet());
			return (ObjectSortedSet<Reference2IntMap.Entry<K>>) entries;
		}
