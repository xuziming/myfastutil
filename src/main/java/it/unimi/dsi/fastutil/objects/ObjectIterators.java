...
public final class ObjectIterators {
	 ...
	 *
	 * <p>
	 * The class of the object returned represent an abstract empty iterator that
	 * can iterate as a type-specific (list) iterator.
	 *
	 * <p>
	...
	public static <K> boolean any(final ObjectIterator<K> iterator,
			final java.util.function.Predicate<? super K> predicate) {
		return indexOf(iterator, predicate) != -1;
	}

	public static <K> boolean all(final ObjectIterator<K> iterator,
			final java.util.function.Predicate<? super K> predicate) {
	...
	public static <K> int indexOf(final ObjectIterator<K> iterator,
			final java.util.function.Predicate<? super K> predicate) {
		Objects.requireNonNull(predicate);
	 ...
	 */
	public static <K> ObjectIterator<K> concat(final ObjectIterator<? extends K> a[], final int offset,
			final int length) {
