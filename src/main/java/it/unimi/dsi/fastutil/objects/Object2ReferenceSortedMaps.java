...
public final class Object2ReferenceSortedMaps {
	...
	public static <K, V> ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator(
			Object2ReferenceSortedMap<K, V> map) {
		final ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> entries = map.object2ReferenceEntrySet();
		return entries instanceof Object2ReferenceSortedMap.FastSortedEntrySet
				? ((Object2ReferenceSortedMap.FastSortedEntrySet<K, V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K, V> ObjectBidirectionalIterable<Object2ReferenceMap.Entry<K, V>> fastIterable(
			Object2ReferenceSortedMap<K, V> map) {
		final ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> entries = map.object2ReferenceEntrySet();
		return entries instanceof Object2ReferenceSortedMap.FastSortedEntrySet
				? ((Object2ReferenceSortedMap.FastSortedEntrySet<K, V>) entries)::fastIterator
	...
	public static class EmptySortedMap<K, V> extends Object2ReferenceMaps.EmptyMap<K, V>
			implements Object2ReferenceSortedMap<K, V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K, V> extends Object2ReferenceMaps.Singleton<K, V>
		...
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<K, V> extends Object2ReferenceMaps.SynchronizedMap<K, V>
			implements Object2ReferenceSortedMap<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K, V> extends Object2ReferenceMaps.UnmodifiableMap<K, V>
		...
		public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2ReferenceEntrySet());
			return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>) entries;
		}
