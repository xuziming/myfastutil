...
public final class Object2BooleanFunctions {
	 ...
	 */
	public static class EmptyFunction<K> extends AbstractObject2BooleanFunction<K>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K> extends AbstractObject2BooleanFunction<K>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K> extends AbstractObject2BooleanFunction<K>
	 ...
	 */
	public static <K> Object2BooleanFunction<K> unmodifiable(final Object2BooleanFunction<K> f) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Object2BooleanFunction<K> primitive(
			final java.util.function.Function<? super K, ? extends Boolean> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Object2BooleanFunction)
			return (Object2BooleanFunction<K>) f;
		if (f instanceof java.util.function.Predicate)
			return key -> ((java.util.function.Predicate<K>) f).test((K) (key));
