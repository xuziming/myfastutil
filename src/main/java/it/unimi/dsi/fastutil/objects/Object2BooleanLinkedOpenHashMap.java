 ...
 * @see HashCommon
 */
public class Object2BooleanLinkedOpenHashMap<K> extends AbstractObject2BooleanSortedMap<K>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Object2BooleanLinkedOpenHashMap<K> clone() {
		...
		try {
			c = (Object2BooleanLinkedOpenHashMap<K>) super.clone();
