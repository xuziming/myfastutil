...
public class Reference2BooleanLinkedOpenHashMap<K> extends AbstractReference2BooleanSortedMap<K>
	...
	public Reference2BooleanLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Reference2BooleanLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Reference2BooleanLinkedOpenHashMap(final Map<? extends K, ? extends Boolean> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Reference2BooleanLinkedOpenHashMap(final Map<? extends K, ? extends Boolean> m) {
	 ...
	 * @param f the load factor.
	 */
	public Reference2BooleanLinkedOpenHashMap(final Reference2BooleanMap<K> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Reference2BooleanLinkedOpenHashMap(final Reference2BooleanMap<K> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2BooleanLinkedOpenHashMap(final K[] k, final boolean[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Reference2BooleanLinkedOpenHashMap(final K[] k, final boolean[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Reference2BooleanLinkedOpenHashMap.this.key;
	...
	private class EntryIterator extends MapIterator implements ObjectListIterator<Reference2BooleanMap.Entry<K>> {
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Reference2BooleanMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Reference2BooleanMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> subSet(Reference2BooleanMap.Entry<K> fromElement,
				Reference2BooleanMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Reference2BooleanMap.Entry<K>> iterator(final Reference2BooleanMap.Entry<K> from) {
		...
		@Override
		public ObjectListIterator<Reference2BooleanMap.Entry<K>> fastIterator(
				final Reference2BooleanMap.Entry<K> from) {
		...
		public void forEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractReference2BooleanMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet<K> reference2BooleanEntrySet() {
		if (entries == null)
	...
	public Reference2BooleanLinkedOpenHashMap<K> clone() {
		...
		try {
			c = (Reference2BooleanLinkedOpenHashMap<K>) super.clone();
