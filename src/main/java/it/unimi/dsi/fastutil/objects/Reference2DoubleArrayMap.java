	...
	private final class EntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements FastEntrySet<K> {
		...
		public ObjectIterator<Reference2DoubleMap.Entry<K>> iterator() {
			return new ObjectIterator<Reference2DoubleMap.Entry<K>>() {
				...
				public Entry<K> next() {
					...
					return new AbstractReference2DoubleMap.BasicEntry<>((K) key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Reference2DoubleArrayMap.this.containsKey(k)
					&& (Double.doubleToLongBits(Reference2DoubleArrayMap.this.getDouble(k)) == Double
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1 || !(Double.doubleToLongBits(v) == Double
					.doubleToLongBits(Reference2DoubleArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Reference2DoubleArrayMap.this.key, oldPos + 1, Reference2DoubleArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2DoubleArrayMap.this.value, oldPos + 1, Reference2DoubleArrayMap.this.value,
					oldPos, tail);
