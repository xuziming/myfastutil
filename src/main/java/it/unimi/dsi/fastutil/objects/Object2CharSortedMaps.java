...
public final class Object2CharSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharSortedMap<K> map) {
		...
		return entries instanceof Object2CharSortedMap.FastSortedEntrySet
				? ((Object2CharSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap<K> extends Object2CharMaps.EmptyMap<K>
			implements Object2CharSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2CharMaps.Singleton<K>
		...
		public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2CharMap.BasicEntry<>(key, value),
	...
	public static class SynchronizedSortedMap<K> extends Object2CharMaps.SynchronizedMap<K>
			implements Object2CharSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2CharEntrySet(), sync);
			return (ObjectSortedSet<Object2CharMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2CharMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2CharEntrySet());
			return (ObjectSortedSet<Object2CharMap.Entry<K>>) entries;
		}
