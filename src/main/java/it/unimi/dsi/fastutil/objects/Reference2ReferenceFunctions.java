...
public final class Reference2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<K, V> extends AbstractReference2ReferenceFunction<K, V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K, V> extends AbstractReference2ReferenceFunction<K, V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class SynchronizedFunction<K, V> implements Reference2ReferenceFunction<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 */
	public static <K, V> Reference2ReferenceFunction<K, V> synchronize(final Reference2ReferenceFunction<K, V> f) {
	...
	public static class UnmodifiableFunction<K, V> extends AbstractReference2ReferenceFunction<K, V>
	 ...
	 */
	public static <K, V> Reference2ReferenceFunction<K, V> unmodifiable(final Reference2ReferenceFunction<K, V> f) {
