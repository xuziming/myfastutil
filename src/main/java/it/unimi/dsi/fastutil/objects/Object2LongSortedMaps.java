...
public final class Object2LongSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongSortedMap<K> map) {
		final ObjectSortedSet<Object2LongMap.Entry<K>> entries = map.object2LongEntrySet();
		return entries instanceof Object2LongSortedMap.FastSortedEntrySet
				? ((Object2LongSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<K> extends Object2LongMaps.EmptyMap<K>
			implements Object2LongSortedMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<K> extends Object2LongMaps.Singleton<K>
			implements Object2LongSortedMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2LongMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2LongMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<K> keySet() {
			if (keys == null)
				keys = ObjectSortedSets.singleton(key, comparator);
	...
	public static class SynchronizedSortedMap<K> extends Object2LongMaps.SynchronizedMap<K>
			implements Object2LongSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2LongEntrySet(), sync);
			return (ObjectSortedSet<Object2LongMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<K> keySet() {
			if (keys == null)
				keys = ObjectSortedSets.synchronize(sortedMap.keySet(), sync);
			return (ObjectSortedSet<K>) keys;
		}
	 ...
	 */
	public static <K> Object2LongSortedMap<K> synchronize(final Object2LongSortedMap<K> m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static <K> Object2LongSortedMap<K> synchronize(final Object2LongSortedMap<K> m, final Object sync) {
		return new SynchronizedSortedMap<>(m, sync);
	}

	/** An unmodifiable wrapper class for sorted maps. */
	public static class UnmodifiableSortedMap<K> extends Object2LongMaps.UnmodifiableMap<K>
			implements Object2LongSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2LongSortedMap<K> sortedMap;
		...
		public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2LongEntrySet());
			return (ObjectSortedSet<Object2LongMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<K> keySet() {
			if (keys == null)
				keys = ObjectSortedSets.unmodifiable(sortedMap.keySet());
			return (ObjectSortedSet<K>) keys;
		}
	 ...
	 */
	public static <K> Object2LongSortedMap<K> unmodifiable(final Object2LongSortedMap<K> m) {
