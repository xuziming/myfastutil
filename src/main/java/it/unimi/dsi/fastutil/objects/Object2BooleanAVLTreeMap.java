 ...
 * iterator}.
 */
public class Object2BooleanAVLTreeMap<K> extends AbstractObject2BooleanSortedMap<K>
	...
	private static final class Entry<K> extends AbstractObject2BooleanMap.BasicEntry<K> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return java.util.Objects.equals(key, (e.getKey())) && ((value) == ((e.getValue()).booleanValue()));
		}

		@Override
		public int hashCode() {
			return ((key).hashCode()) ^ (value ? 1231 : 1237);
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2BooleanAVLTreeMap.this.removeBoolean(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
				final Comparator<? super Object2BooleanMap.Entry<K>> comparator = (Comparator<Object2BooleanMap.Entry<K>>) (
						x, y) -> Object2BooleanAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(
						final Object2BooleanMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> from,
						Object2BooleanMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2BooleanEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> to) {
					return headMap(to.getKey()).object2BooleanEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> from) {
					return tailMap(from.getKey()).object2BooleanEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2BooleanSortedMap<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2BooleanAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2BooleanAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Boolean))
							return false;
						final Object2BooleanAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2BooleanAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2BooleanAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2BooleanAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2BooleanAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2BooleanAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
		...
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readBoolean());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
		if (n == 2) {
			 ...
			 */
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readBoolean());
			top.right(new Entry<>((K) s.readObject(), s.readBoolean()));
			top.right.pred(top);
			top.balance(1);
			top.pred(pred);
			top.right.succ(succ);
