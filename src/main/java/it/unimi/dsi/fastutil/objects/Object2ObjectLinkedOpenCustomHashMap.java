...
public class Object2ObjectLinkedOpenCustomHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V>
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectLinkedOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectLinkedOpenCustomHashMap(final Map<? extends K, ? extends V> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectLinkedOpenCustomHashMap(final Object2ObjectMap<K, V> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ObjectLinkedOpenCustomHashMap(final Object2ObjectMap<K, V> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ObjectLinkedOpenCustomHashMap(final K[] k, final V[] v, final float f,
			final Strategy<? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>
		...
		@Override
		public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> fromElement,
				Object2ObjectMap.Entry<K, V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ObjectLinkedOpenCustomHashMap.this.containsNullKey
		...
		public void forEach(final Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2ObjectMap.BasicEntry<K, V>(key[curr], value[curr]));
			}
		}
	...
	public Object2ObjectLinkedOpenCustomHashMap<K, V> clone() {
		...
		try {
			c = (Object2ObjectLinkedOpenCustomHashMap<K, V>) super.clone();
