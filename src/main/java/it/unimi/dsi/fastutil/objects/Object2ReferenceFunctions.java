...
public final class Object2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<K, V> extends AbstractObject2ReferenceFunction<K, V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K, V> extends AbstractObject2ReferenceFunction<K, V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K, V> Object2ReferenceFunction<K, V> singleton(final K key, V value) {
		return new Singleton<>(key, value);
	}

	/** A synchronized wrapper class for functions. */
	public static class SynchronizedFunction<K, V> implements Object2ReferenceFunction<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K, V> extends AbstractObject2ReferenceFunction<K, V>
