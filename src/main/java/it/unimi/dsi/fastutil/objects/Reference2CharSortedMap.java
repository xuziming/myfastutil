...
public interface Reference2CharSortedMap<K> extends Reference2CharMap<K>, SortedMap<K, Character> {
	 ...
	 */
	@Override
	Reference2CharSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Reference2CharSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Reference2CharSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Reference2CharMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
