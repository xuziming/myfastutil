...
public final class Object2CharMaps {
	...
	public static <K> ObjectIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharMap<K> map) {
		...
		return entries instanceof Object2CharMap.FastEntrySet
				? ((Object2CharMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2CharMap<K> map,
			final Consumer<? super Object2CharMap.Entry<K>> consumer) {
		final ObjectSet<Object2CharMap.Entry<K>> entries = map.object2CharEntrySet();
		if (entries instanceof Object2CharMap.FastEntrySet)
			((Object2CharMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2CharMap.Entry<K>> fastIterable(Object2CharMap<K> map) {
		...
		return entries instanceof Object2CharMap.FastEntrySet ? new ObjectIterable<Object2CharMap.Entry<K>>() {
			public ObjectIterator<Object2CharMap.Entry<K>> iterator() {
				return ((Object2CharMap.FastEntrySet<K>) entries).fastIterator();
			}
	...
	public static class EmptyMap<K> extends Object2CharFunctions.EmptyFunction<K>
			implements Object2CharMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2CharFunctions.Singleton<K>
		...
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2CharMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2CharFunctions.SynchronizedFunction<K>
			implements Object2CharMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public char computeCharIfAbsentPartial(final K key, final Object2CharFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2CharFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2CharEntrySet());
			return entries;
		}
