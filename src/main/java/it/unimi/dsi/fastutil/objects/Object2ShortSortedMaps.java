...
public final class Object2ShortSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortSortedMap<K> map) {
		...
		return entries instanceof Object2ShortSortedMap.FastSortedEntrySet
				? ((Object2ShortSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap<K> extends Object2ShortMaps.EmptyMap<K>
			implements Object2ShortSortedMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2ShortMaps.Singleton<K>
		...
		public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2ShortMap.BasicEntry<>(key, value),
	...
	public static class SynchronizedSortedMap<K> extends Object2ShortMaps.SynchronizedMap<K>
			implements Object2ShortSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2ShortEntrySet(), sync);
			return (ObjectSortedSet<Object2ShortMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2ShortMaps.UnmodifiableMap<K>
		...
		public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2ShortEntrySet());
			return (ObjectSortedSet<Object2ShortMap.Entry<K>>) entries;
		}
