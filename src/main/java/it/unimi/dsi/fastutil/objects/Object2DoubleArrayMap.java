	...
	private final class EntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(Object o) {
			...
			return Object2DoubleArrayMap.this.containsKey(k)
					&& (Double.doubleToLongBits(Object2DoubleArrayMap.this.getDouble(k)) == Double
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1 || !(Double.doubleToLongBits(v) == Double
					.doubleToLongBits(Object2DoubleArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Object2DoubleArrayMap.this.key, oldPos + 1, Object2DoubleArrayMap.this.key, oldPos, tail);
			System.arraycopy(Object2DoubleArrayMap.this.value, oldPos + 1, Object2DoubleArrayMap.this.value, oldPos,
					tail);
