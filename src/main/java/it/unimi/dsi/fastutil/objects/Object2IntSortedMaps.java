...
public final class Object2IntSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator(Object2IntSortedMap<K> map) {
		...
		return entries instanceof Object2IntSortedMap.FastSortedEntrySet
				? ((Object2IntSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<K> extends Object2IntMaps.EmptyMap<K>
			implements Object2IntSortedMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<K> extends Object2IntMaps.Singleton<K>
			implements Object2IntSortedMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2IntMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2IntMap.Entry<K>>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<K, Integer>> entrySet() {
			return (ObjectSortedSet) object2IntEntrySet();
		}
	...
	public static class SynchronizedSortedMap<K> extends Object2IntMaps.SynchronizedMap<K>
			implements Object2IntSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2IntEntrySet(), sync);
			return (ObjectSortedSet<Object2IntMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2IntMaps.UnmodifiableMap<K>
			implements Object2IntSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2IntSortedMap<K> sortedMap;
		...
		public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2IntEntrySet());
			return (ObjectSortedSet<Object2IntMap.Entry<K>>) entries;
		}
