 ...
 */
public abstract class AbstractObject2FloatMap<K> extends AbstractObject2FloatFunction<K>
		...
		public boolean contains(final Object o) {
			...
			if (o instanceof Object2FloatMap.Entry) {
				...
				return map.containsKey(k)
						&& (Float.floatToIntBits(map.getFloat(k)) == Float.floatToIntBits(e.getFloatValue()));
			}
			final Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
			...
			if (value == null || !(value instanceof Float))
				return false;
			return map.containsKey(k)
					&& (Float.floatToIntBits(map.getFloat(k)) == Float.floatToIntBits(((Float) (value)).floatValue()));
		}
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Object2FloatMap.Entry<K>> i = Object2FloatMaps
							.fastIterator(AbstractObject2FloatMap.this);
