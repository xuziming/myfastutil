...
public interface Object2DoubleSortedMap<K> extends Object2DoubleMap<K>, SortedMap<K, Double> {
	 ...
	 */
	@Override
	Object2DoubleSortedMap<K> subMap(K fromKey, K toKey);
	 ...
	 */
	@Override
	Object2DoubleSortedMap<K> headMap(K toKey);
	 ...
	 */
	@Override
	Object2DoubleSortedMap<K> tailMap(K fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<K> extends ObjectSortedSet<Object2DoubleMap.Entry<K>>, FastEntrySet<K> {
		/**
		 * {@inheritDoc}
		 */
		@Override
