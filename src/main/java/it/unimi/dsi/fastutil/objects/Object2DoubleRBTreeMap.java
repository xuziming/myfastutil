 ...
 *
 */
public class Object2DoubleRBTreeMap<K> extends AbstractObject2DoubleSortedMap<K>
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2DoubleRBTreeMap.this.removeDouble(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
				final Comparator<? super Object2DoubleMap.Entry<K>> comparator = (Comparator<Object2DoubleMap.Entry<K>>) (
						x, y) -> Object2DoubleRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2DoubleSortedMap<K> implements java.io.Serializable {
		...
		final boolean in(final K k) {
			return (bottom || Object2DoubleRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2DoubleRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Object2DoubleRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2DoubleRBTreeMap.this.containsKey(k);
		}
		...
		@Override
		public K firstKey() {
			Object2DoubleRBTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2DoubleRBTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2DoubleRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2DoubleRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Object2DoubleRBTreeMap<K> clone() {
		...
		try {
			c = (Object2DoubleRBTreeMap<K>) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
