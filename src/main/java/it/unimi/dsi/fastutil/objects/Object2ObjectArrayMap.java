	...
	private final class EntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements FastEntrySet<K, V> {
		...
		public boolean contains(Object o) {
			...
			return Object2ObjectArrayMap.this.containsKey(k)
					&& java.util.Objects.equals(Object2ObjectArrayMap.this.get(k), (e.getValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1 || !java.util.Objects.equals(v, Object2ObjectArrayMap.this.value[oldPos]))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Object2ObjectArrayMap.this.key, oldPos + 1, Object2ObjectArrayMap.this.key, oldPos, tail);
			System.arraycopy(Object2ObjectArrayMap.this.value, oldPos + 1, Object2ObjectArrayMap.this.value, oldPos,
					tail);
