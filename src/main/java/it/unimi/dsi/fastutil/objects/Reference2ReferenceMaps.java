...
public final class Reference2ReferenceMaps {
	...
	public static <K, V> ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator(
			Reference2ReferenceMap<K, V> map) {
		final ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries = map.reference2ReferenceEntrySet();
		return entries instanceof Reference2ReferenceMap.FastEntrySet
				? ((Reference2ReferenceMap.FastEntrySet<K, V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K, V> void fastForEach(Reference2ReferenceMap<K, V> map,
			final Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
		final ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries = map.reference2ReferenceEntrySet();
		if (entries instanceof Reference2ReferenceMap.FastEntrySet)
			((Reference2ReferenceMap.FastEntrySet<K, V>) entries).fastForEach(consumer);
		else
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K, V> ObjectIterable<Reference2ReferenceMap.Entry<K, V>> fastIterable(
			Reference2ReferenceMap<K, V> map) {
		final ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries = map.reference2ReferenceEntrySet();
		return entries instanceof Reference2ReferenceMap.FastEntrySet
				? new ObjectIterable<Reference2ReferenceMap.Entry<K, V>>() {
					public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() {
						return ((Reference2ReferenceMap.FastEntrySet<K, V>) entries).fastIterator();
					}
	...
	public static class EmptyMap<K, V> extends Reference2ReferenceFunctions.EmptyFunction<K, V>
			implements Reference2ReferenceMap<K, V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K, V> extends Reference2ReferenceFunctions.Singleton<K, V>
		...
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<K, V>> entrySet() {
			return (ObjectSet) reference2ReferenceEntrySet();
		}
		...
		@Override
		public int hashCode() {
			return (System.identityHashCode(key)) ^ ((value) == null ? 0 : System.identityHashCode(value));
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K, V> Reference2ReferenceMap<K, V> singleton(final K key, V value) {
		return new Singleton<>(key, value);
	}

	/** A synchronized wrapper class for maps. */
	public static class SynchronizedMap<K, V> extends Reference2ReferenceFunctions.SynchronizedFunction<K, V>
			implements Reference2ReferenceMap<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K, V> extends Reference2ReferenceFunctions.UnmodifiableFunction<K, V>
		...
		public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2ReferenceEntrySet());
			return entries;
		}
