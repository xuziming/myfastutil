 ...
 * {@link #listIterator()}, {@link #listIterator(int)} and
 * {@link #subList(int,int)}. The former had been already strengthened upstream,
 * but unfortunately {@link List} re-specifies it.
 *
 * <p>
