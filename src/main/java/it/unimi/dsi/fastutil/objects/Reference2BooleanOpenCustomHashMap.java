...
public class Reference2BooleanOpenCustomHashMap<K> extends AbstractReference2BooleanMap<K>
	...
	public Reference2BooleanOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final Reference2BooleanMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Reference2BooleanOpenCustomHashMap(final Reference2BooleanMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Reference2BooleanOpenCustomHashMap(final K[] k, final boolean[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Reference2BooleanOpenCustomHashMap(final K[] k, final boolean[] v, final Strategy<? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeBooleanIfAbsent(final K k, final java.util.function.Predicate<? super K> mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeBooleanIfPresent(final K k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeBoolean(final K k,
			final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public boolean mergeBoolean(final K k, final boolean v,
	 ...
	 * the map
	 */
	final class MapEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2BooleanOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final K key[] = Reference2BooleanOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2BooleanOpenCustomHashMap.this.removeBoolean(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Reference2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractReference2BooleanMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (null)))
					consumer.accept(new AbstractReference2BooleanMap.BasicEntry<K>(key[pos], value[pos]));
		}

		/** {@inheritDoc} */
		@Override
		public void fastForEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
	...
	public Reference2BooleanOpenCustomHashMap<K> clone() {
		...
		try {
			c = (Reference2BooleanOpenCustomHashMap<K>) super.clone();
