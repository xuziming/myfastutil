...
public final class Object2ObjectMaps {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K, V> void fastForEach(Object2ObjectMap<K, V> map,
			final Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
		final ObjectSet<Object2ObjectMap.Entry<K, V>> entries = map.object2ObjectEntrySet();
	...
	public static class EmptyMap<K, V> extends Object2ObjectFunctions.EmptyFunction<K, V>
			implements Object2ObjectMap<K, V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K, V> extends Object2ObjectFunctions.Singleton<K, V>
		...
		public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K, V> Object2ObjectMap<K, V> singleton(final K key, V value) {
		return new Singleton<>(key, value);
	}

	/** A synchronized wrapper class for maps. */
	public static class SynchronizedMap<K, V> extends Object2ObjectFunctions.SynchronizedFunction<K, V>
			implements Object2ObjectMap<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2ObjectEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<K, V> extends Object2ObjectFunctions.UnmodifiableFunction<K, V>
		...
		public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2ObjectEntrySet());
			return entries;
		}
