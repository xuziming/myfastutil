...
public final class Object2ByteSortedMaps {
	...
	public static <K> ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> fastIterator(Object2ByteSortedMap<K> map) {
		...
		return entries instanceof Object2ByteSortedMap.FastSortedEntrySet
				? ((Object2ByteSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap<K> extends Object2ByteMaps.EmptyMap<K>
			implements Object2ByteSortedMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<K> extends Object2ByteMaps.Singleton<K>
			implements Object2ByteSortedMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractObject2ByteMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Object2ByteMap.Entry<K>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2ByteSortedMap<K> singleton(final K key, Byte value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2ByteSortedMap<K> singleton(final K key, Byte value, Comparator<? super K> comparator) {
	...
	public static class SynchronizedSortedMap<K> extends Object2ByteMaps.SynchronizedMap<K>
			implements Object2ByteSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.object2ByteEntrySet(), sync);
			return (ObjectSortedSet<Object2ByteMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Object2ByteMaps.UnmodifiableMap<K>
			implements Object2ByteSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2ByteSortedMap<K> sortedMap;
		...
		public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.object2ByteEntrySet());
			return (ObjectSortedSet<Object2ByteMap.Entry<K>>) entries;
		}
