 ...
 * @see HashCommon
 */
public class Object2LongOpenCustomHashMap<K> extends AbstractObject2LongMap<K>
	...
	public Object2LongOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final Object2LongMap<K> m, final float f, final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongOpenCustomHashMap(final Object2LongMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2LongOpenCustomHashMap(final K[] k, final long[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2LongOpenCustomHashMap(final K[] k, final long[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2LongOpenCustomHashMap.this.removeLong(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2LongOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2LongOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2LongMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2LongMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2LongMap.BasicEntry<K>(key[pos], value[pos]));
		}
