 ...
 * @see HashCommon
 */
public class Object2ObjectLinkedOpenHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V>
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == null))
				return Object2ObjectLinkedOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			K curr;
			final K[] key = Object2ObjectLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
