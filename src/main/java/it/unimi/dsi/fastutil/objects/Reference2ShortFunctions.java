...
public final class Reference2ShortFunctions {
	...
	public static class SynchronizedFunction<K> implements Reference2ShortFunction<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Reference2ShortFunction<K> primitive(
