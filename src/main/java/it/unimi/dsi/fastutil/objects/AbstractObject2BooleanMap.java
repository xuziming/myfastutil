 ...
 */
public abstract class AbstractObject2BooleanMap<K> extends AbstractObject2BooleanFunction<K>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Object2BooleanMap.Entry<K>> i = object2BooleanEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K> implements Object2BooleanMap.Entry<K> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Object2BooleanMap.Entry) {
				final Object2BooleanMap.Entry<K> e = (Object2BooleanMap.Entry<K>) o;
				return java.util.Objects.equals(key, e.getKey()) && ((value) == (e.getBooleanValue()));
			}
			...
			if (value == null || !(value instanceof Boolean))
				return false;
			return java.util.Objects.equals(this.key, (key)) && ((this.value) == (((Boolean) (value)).booleanValue()));
		}
	...
	public abstract static class BasicEntrySet<K> extends AbstractObjectSet<Entry<K>> {
		...
		public BasicEntrySet(final Object2BooleanMap<K> map) {
			this.map = map;
		}
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Object2BooleanMap.Entry<K>> i = Object2BooleanMaps
							.fastIterator(AbstractObject2BooleanMap.this);
	...
	public void putAll(final Map<? extends K, ? extends Boolean> m) {
		if (m instanceof Object2BooleanMap) {
			ObjectIterator<Object2BooleanMap.Entry<K>> i = Object2BooleanMaps.fastIterator((Object2BooleanMap<K>) m);
			while (i.hasNext()) {
				final Object2BooleanMap.Entry<? extends K> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Object2BooleanMap.Entry<K>> i = Object2BooleanMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
