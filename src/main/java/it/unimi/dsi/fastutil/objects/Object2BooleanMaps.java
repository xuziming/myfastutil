...
public final class Object2BooleanMaps {
	...
	public static <K> ObjectIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap<K> map) {
		...
		return entries instanceof Object2BooleanMap.FastEntrySet
				? ((Object2BooleanMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2BooleanMap<K> map,
			final Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
		final ObjectSet<Object2BooleanMap.Entry<K>> entries = map.object2BooleanEntrySet();
		if (entries instanceof Object2BooleanMap.FastEntrySet)
			((Object2BooleanMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2BooleanMap.Entry<K>> fastIterable(Object2BooleanMap<K> map) {
		...
		return entries instanceof Object2BooleanMap.FastEntrySet ? new ObjectIterable<Object2BooleanMap.Entry<K>>() {
			public ObjectIterator<Object2BooleanMap.Entry<K>> iterator() {
				return ((Object2BooleanMap.FastEntrySet<K>) entries).fastIterator();
			}
	...
	public static class EmptyMap<K> extends Object2BooleanFunctions.EmptyFunction<K>
			implements Object2BooleanMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Object2BooleanFunctions.Singleton<K>
		...
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2BooleanMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		@Override
		public int hashCode() {
			return ((key) == null ? 0 : (key).hashCode()) ^ (value ? 1231 : 1237);
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Object2BooleanMap<K> singleton(final K key, boolean value) {
	...
	public static class SynchronizedMap<K> extends Object2BooleanFunctions.SynchronizedFunction<K>
			implements Object2BooleanMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		public boolean computeBooleanIfAbsentPartial(final K key,
				final Object2BooleanFunction<? super K> mappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2BooleanFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2BooleanEntrySet());
			return entries;
		}
