 ...
 */
public abstract class AbstractReference2ReferenceMap<K, V> extends AbstractReference2ReferenceFunction<K, V>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Reference2ReferenceMap.Entry<K, V>> i = reference2ReferenceEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K, V> implements Reference2ReferenceMap.Entry<K, V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Reference2ReferenceMap.Entry) {
				final Reference2ReferenceMap.Entry<K, V> e = (Reference2ReferenceMap.Entry<K, V>) o;
	...
	public abstract static class BasicEntrySet<K, V> extends AbstractObjectSet<Entry<K, V>> {
		...
		public BasicEntrySet(final Reference2ReferenceMap<K, V> map) {
			this.map = map;
		}
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Reference2ReferenceMap.Entry<K, V>> i = Reference2ReferenceMaps
							.fastIterator(AbstractReference2ReferenceMap.this);
