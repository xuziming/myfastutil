 ...
 * @see HashCommon
 */
public class Object2LongLinkedOpenCustomHashMap<K> extends AbstractObject2LongSortedMap<K>
	...
	public Object2LongLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final Map<? extends K, ? extends Long> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final Object2LongMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2LongLinkedOpenCustomHashMap(final Object2LongMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2LongLinkedOpenCustomHashMap(final K[] k, final long[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2LongLinkedOpenCustomHashMap(final K[] k, final long[] v, final Strategy<? super K> strategy) {
	 ...
	 */
	public long getAndMoveToFirst(final K k) {
		if ((strategy.equals((k), (null)))) {
			if (containsNullKey) {
				moveIndexToFirst(n);
				return value[n];
	 ...
	 *         default return value} if no value was present for the given key.
	 */
	public long getAndMoveToLast(final K k) {
		if ((strategy.equals((k), (null)))) {
			if (containsNullKey) {
				moveIndexToLast(n);
				return value[n];
	 ...
	 *         return value} if no value was present for the given key.
	 */
	public long putAndMoveToFirst(final K k, final long v) {
		int pos;
		if ((strategy.equals((k), (null)))) {
			if (containsNullKey) {
				moveIndexToFirst(n);
	 ...
	 *         return value} if no value was present for the given key.
	 */
	public long putAndMoveToLast(final K k, final long v) {
		int pos;
		if ((strategy.equals((k), (null)))) {
			if (containsNullKey) {
				moveIndexToLast(n);
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2LongLinkedOpenCustomHashMap.this.key;
	...
	private class EntryIterator extends MapIterator implements ObjectListIterator<Object2LongMap.Entry<K>> {
	...
	private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2LongMap.Entry<K>> {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2LongMap.Entry<K>>
			implements FastSortedEntrySet<K> {
		@Override
		...
		@Override
		public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> fromElement,
				Object2LongMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2LongLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2LongLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Object2LongMap.Entry<K>> iterator(final Object2LongMap.Entry<K> from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Object2LongMap.Entry<K>> fastIterator(final Object2LongMap.Entry<K> from) {
		...
		public void forEach(final Consumer<? super Object2LongMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2LongMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
