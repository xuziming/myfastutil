...
public class Object2FloatOpenCustomHashMap<K> extends AbstractObject2FloatMap<K>
	...
	public Object2FloatOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final Object2FloatMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2FloatOpenCustomHashMap(final Object2FloatMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2FloatOpenCustomHashMap(final K[] k, final float[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2FloatOpenCustomHashMap(final K[] k, final float[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Object2FloatOpenCustomHashMap.this.removeFloat(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<K>> implements FastEntrySet<K> {
		...
		public void forEach(final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractObject2FloatMap.BasicEntry<K>(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == null))
					consumer.accept(new AbstractObject2FloatMap.BasicEntry<K>(key[pos], value[pos]));
		}
