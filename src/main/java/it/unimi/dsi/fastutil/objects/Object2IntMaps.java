...
public final class Object2IntMaps {
	...
	public static <K> ObjectIterator<Object2IntMap.Entry<K>> fastIterator(Object2IntMap<K> map) {
		...
		return entries instanceof Object2IntMap.FastEntrySet ? ((Object2IntMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2IntFunctions.EmptyFunction<K>
			implements Object2IntMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2IntFunctions.Singleton<K>
			implements Object2IntMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2IntMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2IntFunctions.SynchronizedFunction<K>
			implements Object2IntMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIntIfAbsent(final K key, final java.util.function.ToIntFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIntIfAbsent(key, mappingFunction);
			}
		}
		...
		public int computeIntIfAbsentPartial(final K key, final Object2IntFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeIntIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public int computeIntIfPresent(final K key,
		...
		@Override
		public int computeInt(final K key,
				final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Integer computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Integer> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Integer computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Integer compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Integer merge(final K key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2IntFunctions.UnmodifiableFunction<K>
			implements Object2IntMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2IntMap<K> map;
		protected transient ObjectSet<Object2IntMap.Entry<K>> entries;
		...
		public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2IntEntrySet());
			return entries;
		}
