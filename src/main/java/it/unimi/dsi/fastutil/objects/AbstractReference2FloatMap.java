...
public abstract class AbstractReference2FloatMap<K> extends AbstractReference2FloatFunction<K>
		implements Reference2FloatMap<K>, java.io.Serializable {
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Reference2FloatMap.Entry<K>> i = Reference2FloatMaps
							.fastIterator(AbstractReference2FloatMap.this);
