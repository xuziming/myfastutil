...
public final class Reference2ObjectFunctions {
	 ...
	 */
	public static class EmptyFunction<K, V> extends AbstractReference2ObjectFunction<K, V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<K, V> extends AbstractReference2ObjectFunction<K, V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K, V> Reference2ObjectFunction<K, V> singleton(final K key, V value) {
		return new Singleton<>(key, value);
	}

	/** A synchronized wrapper class for functions. */
	public static class SynchronizedFunction<K, V> implements Reference2ObjectFunction<K, V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction<K, V> extends AbstractReference2ObjectFunction<K, V>
