...
public class Reference2LongArrayMap<K> extends AbstractReference2LongMap<K> implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(Object o) {
			...
			return Reference2LongArrayMap.this.containsKey(k)
					&& ((Reference2LongArrayMap.this.getLong(k)) == (((Long) (e.getValue())).longValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Reference2LongArrayMap.this.key, oldPos + 1, Reference2LongArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2LongArrayMap.this.value, oldPos + 1, Reference2LongArrayMap.this.value, oldPos,
					tail);
