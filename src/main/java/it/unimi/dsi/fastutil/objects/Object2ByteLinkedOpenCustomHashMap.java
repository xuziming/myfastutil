...
public class Object2ByteLinkedOpenCustomHashMap<K> extends AbstractObject2ByteSortedMap<K>
	...
	public Object2ByteLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final Map<? extends K, ? extends Byte> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final Map<? extends K, ? extends Byte> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final Object2ByteMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final Object2ByteMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final K[] k, final byte[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2ByteLinkedOpenCustomHashMap(final K[] k, final byte[] v, final Strategy<? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2ByteMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> fromElement,
				Object2ByteMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2ByteLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2ByteMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2ByteMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
