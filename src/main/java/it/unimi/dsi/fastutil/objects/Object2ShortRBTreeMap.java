...
public class Object2ShortRBTreeMap<K> extends AbstractObject2ShortSortedMap<K>
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
				final Comparator<? super Object2ShortMap.Entry<K>> comparator = (Comparator<Object2ShortMap.Entry<K>>) (
						x, y) -> Object2ShortRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2ShortSortedMap<K> implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Short))
							return false;
						final Object2ShortRBTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2ShortRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2ShortRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
