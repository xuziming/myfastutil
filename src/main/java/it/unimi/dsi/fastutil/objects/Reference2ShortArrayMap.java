...
public class Reference2ShortArrayMap<K> extends AbstractReference2ShortMap<K>
	...
	private final class EntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements FastEntrySet<K> {
		@Override
		public ObjectIterator<Reference2ShortMap.Entry<K>> iterator() {
			return new ObjectIterator<Reference2ShortMap.Entry<K>>() {
				...
				public Entry<K> next() {
					...
					return new AbstractReference2ShortMap.BasicEntry<>((K) key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Reference2ShortArrayMap.this.containsKey(k)
					&& ((Reference2ShortArrayMap.this.getShort(k)) == (((Short) (e.getValue())).shortValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Reference2ShortArrayMap.this.key, oldPos + 1, Reference2ShortArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Reference2ShortArrayMap.this.value, oldPos + 1, Reference2ShortArrayMap.this.value, oldPos,
					tail);
			Reference2ShortArrayMap.this.size--;
			Reference2ShortArrayMap.this.key[size] = null;
			return true;
		}
	}
