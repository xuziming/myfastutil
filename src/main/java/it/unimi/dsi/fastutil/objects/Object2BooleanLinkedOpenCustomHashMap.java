 ...
 * @see HashCommon
 */
public class Object2BooleanLinkedOpenCustomHashMap<K> extends AbstractObject2BooleanSortedMap<K>
	...
	public Object2BooleanLinkedOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final Object2BooleanMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final Object2BooleanMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final K[] k, final boolean[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2BooleanLinkedOpenCustomHashMap(final K[] k, final boolean[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2BooleanLinkedOpenCustomHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> fromElement,
				Object2BooleanMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2BooleanLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2BooleanLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2BooleanMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
