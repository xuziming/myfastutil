 ...
 * iterator}.
 */
public class Object2CharAVLTreeMap<K> extends AbstractObject2CharSortedMap<K>
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
				final Comparator<? super Object2CharMap.Entry<K>> comparator = (Comparator<Object2CharMap.Entry<K>>) (x,
						y) -> Object2CharAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
	...
	private final class Submap extends AbstractObject2CharSortedMap<K> implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Object2CharAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2CharAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2CharAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
