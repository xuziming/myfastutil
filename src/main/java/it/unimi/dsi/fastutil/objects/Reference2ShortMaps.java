...
public final class Reference2ShortMaps {
	...
	public static <K> ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator(Reference2ShortMap<K> map) {
		...
		return entries instanceof Reference2ShortMap.FastEntrySet
				? ((Reference2ShortMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Reference2ShortMap<K> map,
			final Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
		final ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
		if (entries instanceof Reference2ShortMap.FastEntrySet)
			((Reference2ShortMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Reference2ShortMap.Entry<K>> fastIterable(Reference2ShortMap<K> map) {
		...
		return entries instanceof Reference2ShortMap.FastEntrySet ? new ObjectIterable<Reference2ShortMap.Entry<K>>() {
			public ObjectIterator<Reference2ShortMap.Entry<K>> iterator() {
				return ((Reference2ShortMap.FastEntrySet<K>) entries).fastIterator();
			}
	...
	public static class EmptyMap<K> extends Reference2ShortFunctions.EmptyFunction<K>
			implements Reference2ShortMap<K>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<K> extends Reference2ShortFunctions.Singleton<K>
		...
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractReference2ShortMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Reference2ShortFunctions.SynchronizedFunction<K>
			implements Reference2ShortMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.reference2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeShortIfAbsent(final K key,
				final java.util.function.ToIntFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeShortIfAbsent(key, mappingFunction);
			}
		}

		@Override
		public short computeShortIfAbsentPartial(final K key,
				final Reference2ShortFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeShortIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public short computeShortIfPresent(final K key,
		...
		@Override
		public short computeShort(final K key,
				final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short mergeShort(final K key, final short value,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.mergeShort(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Short computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Short> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Short computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Short compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Short merge(final K key, final Short value,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Reference2ShortFunctions.UnmodifiableFunction<K>
		...
		public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.reference2ShortEntrySet());
			return entries;
		}
