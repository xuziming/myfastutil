...
public class Object2DoubleLinkedOpenCustomHashMap<K> extends AbstractObject2DoubleSortedMap<K>
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleLinkedOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleLinkedOpenCustomHashMap(final Map<? extends K, ? extends Double> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2DoubleLinkedOpenCustomHashMap(final Object2DoubleMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2DoubleLinkedOpenCustomHashMap(final K[] k, final double[] v, final float f,
			final Strategy<? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> fromElement,
				Object2DoubleMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
