...
public final class Reference2BooleanSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterator<Reference2BooleanMap.Entry<K>> fastIterator(
			Reference2BooleanSortedMap<K> map) {
		...
		return entries instanceof Reference2BooleanSortedMap.FastSortedEntrySet
				? ((Reference2BooleanSortedMap.FastSortedEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <K> ObjectBidirectionalIterable<Reference2BooleanMap.Entry<K>> fastIterable(
			Reference2BooleanSortedMap<K> map) {
		final ObjectSortedSet<Reference2BooleanMap.Entry<K>> entries = map.reference2BooleanEntrySet();
		return entries instanceof Reference2BooleanSortedMap.FastSortedEntrySet
				? ((Reference2BooleanSortedMap.FastSortedEntrySet<K>) entries)::fastIterator
	 ...
	 */
	public static class EmptySortedMap<K> extends Reference2BooleanMaps.EmptyMap<K>
			implements Reference2BooleanSortedMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<K> extends Reference2BooleanMaps.Singleton<K>
			implements Reference2BooleanSortedMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Comparator<? super K> comparator;

		protected Singleton(final K key, final boolean value, Comparator<? super K> comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractReference2BooleanMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Reference2BooleanMap.Entry<K>>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <K> Reference2BooleanSortedMap<K> singleton(final K key, Boolean value) {
	...
	public static class SynchronizedSortedMap<K> extends Reference2BooleanMaps.SynchronizedMap<K>
			implements Reference2BooleanSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.reference2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Reference2BooleanMap.Entry<K>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<K> extends Reference2BooleanMaps.UnmodifiableMap<K>
			implements Reference2BooleanSortedMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Reference2BooleanSortedMap<K> sortedMap;
		...
		public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.reference2BooleanEntrySet());
			return (ObjectSortedSet<Reference2BooleanMap.Entry<K>>) entries;
		}
