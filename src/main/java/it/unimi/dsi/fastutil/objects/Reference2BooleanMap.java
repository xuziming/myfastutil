...
public interface Reference2BooleanMap<K> extends Reference2BooleanFunction<K>, Map<K, Boolean> {
	 ...
	 */
	interface FastEntrySet<K> extends ObjectSet<Reference2BooleanMap.Entry<K>> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default boolean computeBooleanIfAbsentPartial(final K key,
	 ...
	 * @since 8.0.0
	 */
	default boolean computeBooleanIfPresent(final K key,
	 ...
	 * @since 8.0.0
	 */
	default boolean computeBoolean(final K key,
			final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final boolean oldValue = getBoolean(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default boolean mergeBoolean(final K key, final boolean value,
	...
	@Deprecated
	@Override
	default Boolean merge(final K key, final Boolean value,
			final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
