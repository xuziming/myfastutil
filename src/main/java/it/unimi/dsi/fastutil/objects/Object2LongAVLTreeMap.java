 ...
 * iterator}.
 */
public class Object2LongAVLTreeMap<K> extends AbstractObject2LongSortedMap<K>
	 ...
	 */
	public Object2LongAVLTreeMap(final Comparator<? super K> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Object2LongAVLTreeMap(final Map<? extends K, ? extends Long> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2LongAVLTreeMap(final SortedMap<K, Long> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Object2LongAVLTreeMap(final Object2LongMap<? extends K> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Object2LongAVLTreeMap(final Object2LongSortedMap<K> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2LongAVLTreeMap(final K[] k, final long v[], final Comparator<? super K> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Object2LongAVLTreeMap(final K[] k, final long v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Object2LongAVLTreeMap.this.removeLong(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
				final Comparator<? super Object2LongMap.Entry<K>> comparator = (Comparator<Object2LongMap.Entry<K>>) (x,
						y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
				...
				@Override
				public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(
						final Object2LongMap.Entry<K> from) {
				...
				@Override
				public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from,
						Object2LongMap.Entry<K> to) {
					return subMap(from.getKey(), to.getKey()).object2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) {
					return headMap(to.getKey()).object2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) {
					return tailMap(from.getKey()).object2LongEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractObject2LongSortedMap<K> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final K k) {
			return (bottom || Object2LongAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Object2LongAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Long))
							return false;
						final Object2LongAVLTreeMap.Entry<K> f = findKey(((K) e.getKey()));
		...
		@SuppressWarnings("unchecked")
		public boolean containsKey(final Object k) {
			return in((K) k) && Object2LongAVLTreeMap.this.containsKey(k);
		}
		...
		@SuppressWarnings("unchecked")
		public long getLong(final Object k) {
			final Object2LongAVLTreeMap.Entry<K> e;
			final K kk = (K) k;
		...
		public long put(final K k, final long v) {
			...
			final long oldValue = Object2LongAVLTreeMap.this.put(k, v);
		...
		public long removeLong(final Object k) {
			...
			final long oldValue = Object2LongAVLTreeMap.this.removeLong(k);
		...
		@Override
		public K firstKey() {
			Object2LongAVLTreeMap.Entry<K> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public K lastKey() {
			Object2LongAVLTreeMap.Entry<K> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Object2LongAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Object2LongAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry<K> readTree(final java.io.ObjectInputStream s, final int n, final Entry<K> pred, final Entry<K> succ)
		...
		if (n == 1) {
			final Entry<K> top = new Entry<>((K) s.readObject(), s.readLong());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
