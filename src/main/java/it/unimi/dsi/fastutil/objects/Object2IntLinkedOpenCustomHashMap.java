 ...
 * @see HashCommon
 */
public class Object2IntLinkedOpenCustomHashMap<K> extends AbstractObject2IntSortedMap<K>
	...
	public Object2IntLinkedOpenCustomHashMap(final int expected, final float f, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final int expected, final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final Map<? extends K, ? extends Integer> m,
			final Strategy<? super K> strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final Object2IntMap<K> m, final float f,
			final Strategy<? super K> strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Object2IntLinkedOpenCustomHashMap(final Object2IntMap<K> m, final Strategy<? super K> strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Object2IntLinkedOpenCustomHashMap(final K[] k, final int[] v, final float f,
			final Strategy<? super K> strategy) {
	 ...
	 *                                  lengths.
	 */
	public Object2IntLinkedOpenCustomHashMap(final K[] k, final int[] v, final Strategy<? super K> strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				K curr;
				final K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Object2IntMap.Entry<K>>
		...
		@Override
		public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> fromElement,
				Object2IntMap.Entry<K> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (null))))
				return Object2IntLinkedOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Object2IntMap.Entry<K>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractObject2IntMap.BasicEntry<K>(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet<K> object2IntEntrySet() {
		if (entries == null)
	...
	public Object2IntLinkedOpenCustomHashMap<K> clone() {
		...
		try {
			c = (Object2IntLinkedOpenCustomHashMap<K>) super.clone();
