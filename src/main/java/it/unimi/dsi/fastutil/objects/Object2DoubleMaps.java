...
public final class Object2DoubleMaps {
	...
	public static <K> ObjectIterator<Object2DoubleMap.Entry<K>> fastIterator(Object2DoubleMap<K> map) {
		...
		return entries instanceof Object2DoubleMap.FastEntrySet
				? ((Object2DoubleMap.FastEntrySet<K>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <K> void fastForEach(Object2DoubleMap<K> map,
			final Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
		final ObjectSet<Object2DoubleMap.Entry<K>> entries = map.object2DoubleEntrySet();
		if (entries instanceof Object2DoubleMap.FastEntrySet)
			((Object2DoubleMap.FastEntrySet<K>) entries).fastForEach(consumer);
		else
	...
	public static <K> ObjectIterable<Object2DoubleMap.Entry<K>> fastIterable(Object2DoubleMap<K> map) {
		...
		return entries instanceof Object2DoubleMap.FastEntrySet ? new ObjectIterable<Object2DoubleMap.Entry<K>>() {
			public ObjectIterator<Object2DoubleMap.Entry<K>> iterator() {
				return ((Object2DoubleMap.FastEntrySet<K>) entries).fastIterator();
			}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<K> extends Object2DoubleFunctions.EmptyFunction<K>
			implements Object2DoubleMap<K>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<K> extends Object2DoubleFunctions.Singleton<K>
			implements Object2DoubleMap<K>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractObject2DoubleMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<K> extends Object2DoubleFunctions.SynchronizedFunction<K>
			implements Object2DoubleMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.object2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeDoubleIfAbsent(final K key,
				final java.util.function.ToDoubleFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeDoubleIfAbsent(key, mappingFunction);
			}
		}

		@Override
		public double computeDoubleIfAbsentPartial(final K key,
				final Object2DoubleFunction<? super K> mappingFunction) {
			synchronized (sync) {
				return map.computeDoubleIfAbsentPartial(key, mappingFunction);
			}
		}

		@Override
		public double computeDoubleIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double computeDouble(final K key,
				final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double mergeDouble(final K key, final double value,
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
				return map.mergeDouble(key, value, remappingFunction);
			}
		}
		...
		@Override
		public Double computeIfAbsent(final K key,
				final java.util.function.Function<? super K, ? extends Double> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Double computeIfPresent(final K key,
				final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public Double compute(final K key,
				final java.util.function.BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Double merge(final K key, final Double value,
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap<K> extends Object2DoubleFunctions.UnmodifiableFunction<K>
			implements Object2DoubleMap<K>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Object2DoubleMap<K> map;
		protected transient ObjectSet<Object2DoubleMap.Entry<K>> entries;
		...
		public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.object2DoubleEntrySet());
			return entries;
		}
