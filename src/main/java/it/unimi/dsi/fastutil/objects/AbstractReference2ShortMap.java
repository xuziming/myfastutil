...
public abstract class AbstractReference2ShortMap<K> extends AbstractReference2ShortFunction<K>
	...
	public boolean containsKey(final Object k) {
		final ObjectIterator<Reference2ShortMap.Entry<K>> i = reference2ShortEntrySet().iterator();
		while (i.hasNext())
			if (i.next().getKey() == k)
				return true;
		return false;
	...
	public static class BasicEntry<K> implements Reference2ShortMap.Entry<K> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Reference2ShortMap.Entry) {
				final Reference2ShortMap.Entry<K> e = (Reference2ShortMap.Entry<K>) o;
				return ((key) == (e.getKey())) && ((value) == (e.getShortValue()));
			}
			...
			if (value == null || !(value instanceof Short))
				return false;
			return ((this.key) == ((key))) && ((this.value) == (((Short) (value)).shortValue()));
		}
		...
		return new AbstractReferenceSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Reference2ShortMap.Entry<K>> i = Reference2ShortMaps
							.fastIterator(AbstractReference2ShortMap.this);
	...
	public void putAll(final Map<? extends K, ? extends Short> m) {
		if (m instanceof Reference2ShortMap) {
			...
			while (i.hasNext()) {
				final Reference2ShortMap.Entry<? extends K> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Reference2ShortMap.Entry<K>> i = Reference2ShortMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
