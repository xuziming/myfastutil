 ...
 */
public abstract class AbstractObject2ByteMap<K> extends AbstractObject2ByteFunction<K>
		...
		return new AbstractObjectSet<K>() {
			...
			public ObjectIterator<K> iterator() {
				return new ObjectIterator<K>() {
					private final ObjectIterator<Object2ByteMap.Entry<K>> i = Object2ByteMaps
							.fastIterator(AbstractObject2ByteMap.this);
