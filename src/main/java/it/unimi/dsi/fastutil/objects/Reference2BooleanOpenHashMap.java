...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K>
	...
	final class MapEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
		...
		@Override
		public int hashCode() {
			return (System.identityHashCode(key[index])) ^ (value[index] ? 1231 : 1237);
		}
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Reference2BooleanOpenHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final K key[] = Reference2BooleanOpenHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2BooleanOpenHashMap.this.removeBoolean(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>>
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2BooleanOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2BooleanOpenHashMap.this.key;
			int pos;
			// The starting point.
