...
public class Reference2LongOpenHashMap<K> extends AbstractReference2LongMap<K>
	...
	final class MapEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()))) && ((value[index]) == ((e.getValue()).longValue()));
		}

		@Override
		public int hashCode() {
			return (System.identityHashCode(key[index])) ^ it.unimi.dsi.fastutil.HashCommon.long2int(value[index]);
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Reference2LongOpenHashMap.this.removeLong(wrapped.set(-pos - 1, null));
	...
	private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements FastEntrySet<K> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (null)))
				return Reference2LongOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			K curr;
			final K[] key = Reference2LongOpenHashMap.this.key;
			int pos;
			// The starting point.
