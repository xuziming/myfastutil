...
public final class Char2ObjectSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> fastIterator(Char2ObjectSortedMap<V> map) {
		...
		return entries instanceof Char2ObjectSortedMap.FastSortedEntrySet
				? ((Char2ObjectSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap<V> extends Char2ObjectMaps.EmptyMap<V>
			implements Char2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Char2ObjectMaps.Singleton<V>
		...
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2ObjectMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Char2ObjectMaps.SynchronizedMap<V>
			implements Char2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Char2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Char2ObjectMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2ObjectEntrySet());
			return (ObjectSortedSet<Char2ObjectMap.Entry<V>>) entries;
		}
