...
public final class Char2ReferenceSortedMaps {
	...
	public static Comparator<? super Map.Entry<Character, ?>> entryComparator(final CharComparator comparator) {
		return (Comparator<Map.Entry<Character, ?>>) (x, y) -> comparator.compare((x.getKey()).charValue(),
				(y.getKey()).charValue());
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> fastIterator(
			Char2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Char2ReferenceMap.Entry<V>> entries = map.char2ReferenceEntrySet();
		return entries instanceof Char2ReferenceSortedMap.FastSortedEntrySet
				? ((Char2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Char2ReferenceMap.Entry<V>> fastIterable(
			Char2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Char2ReferenceMap.Entry<V>> entries = map.char2ReferenceEntrySet();
		return entries instanceof Char2ReferenceSortedMap.FastSortedEntrySet
				? ((Char2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	 ...
	 */
	public static class EmptySortedMap<V> extends Char2ReferenceMaps.EmptyMap<V>
			implements Char2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<V> extends Char2ReferenceMaps.Singleton<V>
			implements Char2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2ReferenceMap.Entry<V>>) entries;
		}
		...
		public CharSortedSet keySet() {
			if (keys == null)
				keys = CharSortedSets.singleton(key, comparator);
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Char2ReferenceSortedMap<V> singleton(final Character key, V value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Char2ReferenceSortedMap<V> singleton(final Character key, V value, CharComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Char2ReferenceSortedMap<V> singleton(final char key, final V value, CharComparator comparator) {
		return new Singleton<>(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap<V> extends Char2ReferenceMaps.SynchronizedMap<V>
			implements Char2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Char2ReferenceMap.Entry<V>>) entries;
		}
		...
		public CharSortedSet keySet() {
			if (keys == null)
				keys = CharSortedSets.synchronize(sortedMap.keySet(), sync);
			return (CharSortedSet) keys;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Char2ReferenceMaps.UnmodifiableMap<V>
			implements Char2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2ReferenceSortedMap<V> sortedMap;
		...
		public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2ReferenceEntrySet());
			return (ObjectSortedSet<Char2ReferenceMap.Entry<V>>) entries;
		}
		...
		public CharSortedSet keySet() {
			if (keys == null)
				keys = CharSortedSets.unmodifiable(sortedMap.keySet());
			return (CharSortedSet) keys;
		}
