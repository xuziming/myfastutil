...
public interface Char2BooleanMap extends Char2BooleanFunction, Map<Character, Boolean> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Char2BooleanMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Char2BooleanMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfAbsent(final char key, final java.util.function.IntPredicate mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfAbsentNullable(final char key,
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfPresent(final char key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Boolean newValue = remappingFunction.apply(Character.valueOf(key), Boolean.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default boolean compute(final char key,
			final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final boolean oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Boolean newValue = remappingFunction.apply(Character.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default boolean merge(final char key, final boolean value,
	...
	@Deprecated
	@Override
	default Boolean computeIfAbsent(final Character key,
	...
	@Deprecated
	@Override
	default Boolean computeIfPresent(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean compute(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean merge(final Character key, final Boolean value,
			final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Character, Boolean> {
		/**
