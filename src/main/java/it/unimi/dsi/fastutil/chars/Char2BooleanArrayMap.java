...
public class Char2BooleanArrayMap extends AbstractChar2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Char2BooleanMap.Entry> implements FastEntrySet {
		...
		public boolean contains(Object o) {
			...
			return Char2BooleanArrayMap.this.containsKey(k)
					&& ((Char2BooleanArrayMap.this.get(k)) == (((Boolean) (e.getValue())).booleanValue()));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Char2BooleanArrayMap.this.value, oldPos + 1, Char2BooleanArrayMap.this.value, oldPos,
					tail);
