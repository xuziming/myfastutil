...
public final class Char2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2DoubleMap.Entry> fastIterator(Char2DoubleSortedMap map) {
		...
		return entries instanceof Char2DoubleSortedMap.FastSortedEntrySet
				? ((Char2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Char2DoubleMaps.EmptyMap
			implements Char2DoubleSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2DoubleMaps.Singleton
		...
		protected Singleton(final char key, final double value, CharComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2DoubleMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Character, Double>> entrySet() {
			return (ObjectSortedSet) char2DoubleEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2DoubleSortedMap singleton(final Character key, Double value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2DoubleSortedMap singleton(final Character key, Double value, CharComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2DoubleSortedMap singleton(final char key, final double value, CharComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Char2DoubleMaps.SynchronizedMap
			implements Char2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Char2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2DoubleMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2DoubleEntrySet());
			return (ObjectSortedSet<Char2DoubleMap.Entry>) entries;
		}
