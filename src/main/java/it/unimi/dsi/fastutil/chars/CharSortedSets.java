...
public final class CharSortedSets {
	...
	public static class SynchronizedSortedSet extends CharSets.SynchronizedSet
			implements CharSortedSet, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedSet extends CharSets.UnmodifiableSet
		...
		@Override
		public CharBidirectionalIterator iterator() {
			return CharIterators.unmodifiable(sortedSet.iterator());
		}

		@Override
		public CharBidirectionalIterator iterator(final char from) {
			return CharIterators.unmodifiable(sortedSet.iterator(from));
		}
