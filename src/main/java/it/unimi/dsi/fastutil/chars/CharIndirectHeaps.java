...
public final class CharIndirectHeaps {
	...
	public static int downHeap(final char[] refArray, final int[] heap, final int[] inv, final int size, int i,
	...
	public static int upHeap(final char[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final CharComparator c) {
		assert i < size;
		final int e = heap[i];
		final char E = refArray[e];
	...
	public static void makeHeap(final char[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final CharComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final char[] refArray, final int[] heap, final int[] inv, final int size,
			final CharComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
