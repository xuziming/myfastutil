...
public final class Char2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2ByteMap.Entry> fastIterator(Char2ByteSortedMap map) {
		final ObjectSortedSet<Char2ByteMap.Entry> entries = map.char2ByteEntrySet();
		return entries instanceof Char2ByteSortedMap.FastSortedEntrySet
				? ((Char2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Char2ByteMaps.EmptyMap
			implements Char2ByteSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Char2ByteMaps.Singleton
			implements Char2ByteSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final CharComparator comparator;

		protected Singleton(final char key, final byte value, CharComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2ByteMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2ByteSortedMap singleton(final Character key, Byte value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2ByteSortedMap singleton(final Character key, Byte value, CharComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2ByteSortedMap singleton(final char key, final byte value, CharComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Char2ByteMaps.SynchronizedMap
			implements Char2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2ByteEntrySet(), sync);
			return (ObjectSortedSet<Char2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2ByteMaps.UnmodifiableMap
			implements Char2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2ByteSortedMap sortedMap;
		...
		public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2ByteEntrySet());
			return (ObjectSortedSet<Char2ByteMap.Entry>) entries;
		}
