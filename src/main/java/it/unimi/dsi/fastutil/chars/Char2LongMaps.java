...
public final class Char2LongMaps {
	...
	public static ObjectIterator<Char2LongMap.Entry> fastIterator(Char2LongMap map) {
		...
		return entries instanceof Char2LongMap.FastEntrySet ? ((Char2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Char2LongMap map, final Consumer<? super Char2LongMap.Entry> consumer) {
		final ObjectSet<Char2LongMap.Entry> entries = map.char2LongEntrySet();
	...
	public static class EmptyMap extends Char2LongFunctions.EmptyFunction
			implements Char2LongMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2LongFunctions.Singleton
		...
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2LongFunctions.SynchronizedFunction
			implements Char2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Long> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsent(final char key, final java.util.function.IntToLongFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final char key,
		...
		@Override
		public long computeIfPresent(final char key,
		...
		@Override
		public long compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final char key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Long computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Long compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Long merge(final Character key, final Long value,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2LongFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2LongEntrySet());
			return entries;
		}
