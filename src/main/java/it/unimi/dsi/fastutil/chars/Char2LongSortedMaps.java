...
public final class Char2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2LongMap.Entry> fastIterator(Char2LongSortedMap map) {
		...
		return entries instanceof Char2LongSortedMap.FastSortedEntrySet
				? ((Char2LongSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Char2LongMaps.EmptyMap
			implements Char2LongSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Char2LongMaps.Singleton
			implements Char2LongSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2LongMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Char2LongMaps.SynchronizedMap
			implements Char2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2LongEntrySet(), sync);
			return (ObjectSortedSet<Char2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2LongMaps.UnmodifiableMap
			implements Char2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2LongSortedMap sortedMap;
		...
		public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2LongEntrySet());
			return (ObjectSortedSet<Char2LongMap.Entry>) entries;
		}
