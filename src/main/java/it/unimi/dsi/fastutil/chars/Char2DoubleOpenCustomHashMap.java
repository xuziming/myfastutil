...
public class Char2DoubleOpenCustomHashMap extends AbstractChar2DoubleMap
	...
	public Char2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final Map<? extends Character, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final Map<? extends Character, ? extends Double> m,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final Char2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Char2DoubleOpenCustomHashMap(final Char2DoubleMap m,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Char2DoubleOpenCustomHashMap(final char[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Char2DoubleOpenCustomHashMap(final char[] k, final double[] v,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	...
	public boolean containsValue(final double v) {
		...
		if (containsNullKey && (Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v)))
			return true;
		for (int i = n; i-- != 0;)
			if (!((key[i]) == ((char) 0)) && (Double.doubleToLongBits(value[i]) == Double.doubleToLongBits(v)))
				return true;
		return false;
	}
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsent(final char k, final java.util.function.IntToDoubleFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final char k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final char k,
			final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Double newValue = remappingFunction.apply(Character.valueOf(k), Double.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((char) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final char k,
			final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Double newValue = remappingFunction.apply(Character.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final char k, final double v,
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final char key[] = Char2DoubleOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Char2DoubleOpenCustomHashMap.this.remove(wrapped.getChar(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements FastEntrySet {
		@Override
		...
		public void forEach(final Consumer<? super Char2DoubleMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractChar2DoubleMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((char) 0)))
					consumer.accept(new AbstractChar2DoubleMap.BasicEntry(key[pos], value[pos]));
		}
