...
public class Char2BooleanLinkedOpenHashMap extends AbstractChar2BooleanSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2BooleanMap.Entry>
		...
		@Override
		public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry fromElement,
				Char2BooleanMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((char) 0)))
				return Char2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			char curr;
			final char[] key = Char2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Char2BooleanMap.Entry> iterator(final Char2BooleanMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Char2BooleanMap.Entry> fastIterator(final Char2BooleanMap.Entry from) {
		...
		public void forEach(final Consumer<? super Char2BooleanMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractChar2BooleanMap.BasicEntry(key[curr], value[curr]));
			}
		}
