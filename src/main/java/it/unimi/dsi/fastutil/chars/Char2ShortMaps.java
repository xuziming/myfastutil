...
public final class Char2ShortMaps {
	...
	public static ObjectIterator<Char2ShortMap.Entry> fastIterator(Char2ShortMap map) {
		...
		return entries instanceof Char2ShortMap.FastEntrySet ? ((Char2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Char2ShortMap map, final Consumer<? super Char2ShortMap.Entry> consumer) {
		final ObjectSet<Char2ShortMap.Entry> entries = map.char2ShortEntrySet();
	...
	public static class EmptyMap extends Char2ShortFunctions.EmptyFunction
			implements Char2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2ShortFunctions.Singleton
		...
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2ShortFunctions.SynchronizedFunction
			implements Char2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public CharSet keySet() {
			synchronized (sync) {
				if (keys == null)
					keys = CharSets.synchronize(map.keySet(), sync);
				return keys;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Short> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsent(final char key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final char key,
		...
		@Override
		public short computeIfPresent(final char key,
		...
		@Override
		public short compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final char key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Short> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Short computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Short compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Short merge(final Character key, final Short value,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2ShortEntrySet());
			return entries;
		}
		...
		public CharSet keySet() {
			if (keys == null)
				keys = CharSets.unmodifiable(map.keySet());
			return keys;
		}
