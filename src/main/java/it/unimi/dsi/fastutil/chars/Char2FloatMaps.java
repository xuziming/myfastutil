...
public final class Char2FloatMaps {
	...
	public static ObjectIterator<Char2FloatMap.Entry> fastIterator(Char2FloatMap map) {
		...
		return entries instanceof Char2FloatMap.FastEntrySet ? ((Char2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Char2FloatFunctions.EmptyFunction
			implements Char2FloatMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2FloatFunctions.Singleton
		...
		public ObjectSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2FloatMap.BasicEntry(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2FloatMap singleton(final char key, float value) {
	...
	public static class SynchronizedMap extends Char2FloatFunctions.SynchronizedFunction
			implements Char2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Float> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final char key, final java.util.function.IntToDoubleFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final char key,
		...
		@Override
		public float computeIfPresent(final char key,
		...
		@Override
		public float compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final char key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Float computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Float compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Float merge(final Character key, final Float value,
				final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2FloatFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2FloatEntrySet());
			return entries;
		}
