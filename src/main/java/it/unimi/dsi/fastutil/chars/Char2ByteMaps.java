...
public final class Char2ByteMaps {
	...
	public static ObjectIterator<Char2ByteMap.Entry> fastIterator(Char2ByteMap map) {
		...
		return entries instanceof Char2ByteMap.FastEntrySet ? ((Char2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Char2ByteMap map, final Consumer<? super Char2ByteMap.Entry> consumer) {
		final ObjectSet<Char2ByteMap.Entry> entries = map.char2ByteEntrySet();
	...
	public static class EmptyMap extends Char2ByteFunctions.EmptyFunction
			implements Char2ByteMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2ByteFunctions.Singleton
		...
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2ByteFunctions.SynchronizedFunction
			implements Char2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final char key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final char key,
		...
		@Override
		public byte computeIfPresent(final char key,
		...
		@Override
		public byte compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final char key, final byte value,
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Byte computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Byte compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Byte merge(final Character key, final Byte value,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2ByteFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2ByteMap.Entry> char2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2ByteEntrySet());
			return entries;
		}
