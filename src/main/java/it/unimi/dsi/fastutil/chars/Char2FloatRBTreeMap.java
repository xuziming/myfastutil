 ...
 *
 */
public class Char2FloatRBTreeMap extends AbstractChar2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Char2FloatRBTreeMap(final Comparator<? super Character> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Char2FloatRBTreeMap(final Map<? extends Character, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Char2FloatRBTreeMap(final SortedMap<Character, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Char2FloatRBTreeMap(final Char2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Char2FloatRBTreeMap(final Char2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Char2FloatRBTreeMap(final char[] k, final float v[], final Comparator<? super Character> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Char2FloatRBTreeMap(final char[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Char2FloatRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
				final Comparator<? super Char2FloatMap.Entry> comparator = (Comparator<Char2FloatMap.Entry>) (x,
						y) -> Char2FloatRBTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
				...
				public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry to) {
					return subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry to) {
					return headMap(to.getCharKey()).char2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from) {
					return tailMap(from.getCharKey()).char2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractChar2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final char k) {
			return (bottom || Char2FloatRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Char2FloatRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Char2FloatRBTreeMap.Entry f = findKey(((Character) (e.getKey())).charValue());
					...
					@Override
					public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from,
							Char2FloatMap.Entry to) {
						return subMap(from.getCharKey(), to.getCharKey()).char2FloatEntrySet();
					}
		...
		public boolean containsKey(final char k) {
			return in(k) && Char2FloatRBTreeMap.this.containsKey(k);
		}
		...
		public float get(final char k) {
			final Char2FloatRBTreeMap.Entry e;
			final char kk = k;
		...
		public float put(final char k, final float v) {
			...
			final float oldValue = Char2FloatRBTreeMap.this.put(k, v);
		...
		public float remove(final char k) {
			...
			final float oldValue = Char2FloatRBTreeMap.this.remove(k);
		...
		@Override
		public char firstCharKey() {
			Char2FloatRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public char lastCharKey() {
			Char2FloatRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Char2FloatRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Char2FloatRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
