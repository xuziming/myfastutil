 ...
 * @see HashCommon
 */
public class Char2ByteOpenCustomHashMap extends AbstractChar2ByteMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Char2ByteOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final Map<? extends Character, ? extends Byte> m, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final Map<? extends Character, ? extends Byte> m,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final Char2ByteMap m, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Char2ByteOpenCustomHashMap(final Char2ByteMap m,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Char2ByteOpenCustomHashMap(final char[] k, final byte[] v, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Char2ByteOpenCustomHashMap(final char[] k, final byte[] v,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfAbsentNullable(final char k,
	...
	/** {@inheritDoc} */
	@Override
	public byte computeIfPresent(final char k,
			final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public byte compute(final char k,
			final java.util.function.BiFunction<? super Character, ? super Byte, ? extends Byte> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public byte merge(final char k, final byte v,
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Char2ByteOpenCustomHashMap.this.remove(wrapped.getChar(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((char) 0))))
				return Char2ByteOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			char curr;
			final char[] key = Char2ByteOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Char2ByteMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractChar2ByteMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((char) 0)))
					consumer.accept(new AbstractChar2ByteMap.BasicEntry(key[pos], value[pos]));
		}
