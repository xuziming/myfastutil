...
public interface Char2IntMap extends Char2IntFunction, Map<Character, Integer> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Char2IntMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Char2IntMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsent(final char key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsentNullable(final char key,
	 ...
	 * @since 8.0.0
	 */
	default int computeIfPresent(final char key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Integer newValue = remappingFunction.apply(Character.valueOf(key), Integer.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default int compute(final char key,
			final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Integer newValue = remappingFunction.apply(Character.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default int merge(final char key, final int value,
	...
	@Deprecated
	@Override
	default Integer computeIfAbsent(final Character key,
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Character key, final Integer value,
			final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Character, Integer> {
		/**
