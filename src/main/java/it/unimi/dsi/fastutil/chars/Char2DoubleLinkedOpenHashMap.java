 ...
 * @see HashCommon
 */
public class Char2DoubleLinkedOpenHashMap extends AbstractChar2DoubleSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2DoubleMap.Entry>
		...
		@Override
		public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry fromElement,
				Char2DoubleMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Char2DoubleMap.Entry> iterator(final Char2DoubleMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Char2DoubleMap.Entry> fastIterator(final Char2DoubleMap.Entry from) {
		...
		public void forEach(final Consumer<? super Char2DoubleMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractChar2DoubleMap.BasicEntry(key[curr], value[curr]));
			}
		}
