...
public final class Char2DoubleMaps {
	...
	public static ObjectIterator<Char2DoubleMap.Entry> fastIterator(Char2DoubleMap map) {
		...
		return entries instanceof Char2DoubleMap.FastEntrySet ? ((Char2DoubleMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Char2DoubleFunctions.EmptyFunction
			implements Char2DoubleMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2DoubleFunctions.Singleton
		...
		public ObjectSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2DoubleMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2DoubleFunctions.SynchronizedFunction
		...
		public ObjectSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final char key,
		...
		@Override
		public double computeIfPresent(final char key,
		...
		@Override
		public double compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double merge(final char key, final double value,
		...
		@Deprecated
		@Override
		public Double computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Double> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Double computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Double compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Double merge(final Character key, final Double value,
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2DoubleFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2DoubleEntrySet());
			return entries;
		}
