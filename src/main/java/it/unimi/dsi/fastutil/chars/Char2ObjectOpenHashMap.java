 ...
 * @see HashCommon
 */
public class Char2ObjectOpenHashMap<V> extends AbstractChar2ObjectMap<V>
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Char2ObjectOpenHashMap.this.remove(wrapped.getChar(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((char) 0)))
				return Char2ObjectOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			char curr;
			final char[] key = Char2ObjectOpenHashMap.this.key;
			int pos;
			// The starting point.
