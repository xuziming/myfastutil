...
public interface Char2CharMap extends Char2CharFunction, Map<Character, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Char2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Char2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final char key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final char key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final char key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Character.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final char key,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Character.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final char key, final char value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final char newValue;
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Character key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Character key,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Character key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Character, Character> {
		/**
