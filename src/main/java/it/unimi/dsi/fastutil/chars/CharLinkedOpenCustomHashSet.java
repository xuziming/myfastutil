...
public class CharLinkedOpenCustomHashSet extends AbstractCharSortedSet
	...
	public CharLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final Collection<? extends Character> c, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final Collection<? extends Character> c,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final CharCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final CharCollection c,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final CharIterator i, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final CharIterator i,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final char[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final char[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final char[] a, final float f,
			final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public CharLinkedOpenCustomHashSet(final char[] a, final it.unimi.dsi.fastutil.chars.CharHash.Strategy strategy) {
	 ...
	 */
	public boolean addAndMoveToFirst(final char k) {
		int pos;
		if ((strategy.equals((k), ((char) 0)))) {
			if (containsNull) {
				moveIndexToFirst(n);
	 ...
	 * @return true if the key was not present.
	 */
	public boolean addAndMoveToLast(final char k) {
		int pos;
		if ((strategy.equals((k), ((char) 0)))) {
			if (containsNull) {
				moveIndexToLast(n);
	...
	private class SetIterator implements CharListIterator {
		...
		SetIterator(char from) {
			...
			// The starting point.
			final char key[] = CharLinkedOpenCustomHashSet.this.key;
		...
		public char nextChar() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !((key[curr]) == ((char) 0)) : "Position " + curr + " is not used";
			return key[curr];
		}
		...
		public void remove() {
			...
			if (pos == n) {
				...
				CharLinkedOpenCustomHashSet.this.key[n] = ((char) 0);
			} else {
				char curr;
				final char[] key = CharLinkedOpenCustomHashSet.this.key;
	...
	protected void rehash(final int newN) {
		...
		first = -1;
		for (int j = size; j-- != 0;) {
			if ((strategy.equals((key[i]), ((char) 0))))
				pos = newN;
			else {
