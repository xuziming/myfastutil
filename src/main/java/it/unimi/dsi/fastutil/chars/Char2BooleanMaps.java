...
public final class Char2BooleanMaps {
	...
	public static ObjectIterator<Char2BooleanMap.Entry> fastIterator(Char2BooleanMap map) {
		...
		return entries instanceof Char2BooleanMap.FastEntrySet ? ((Char2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Char2BooleanFunctions.EmptyFunction
			implements Char2BooleanMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2BooleanFunctions.Singleton
		...
		public ObjectSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2BooleanFunctions.SynchronizedFunction
			implements Char2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final char key,
		...
		@Override
		public boolean computeIfPresent(final char key,
		...
		@Override
		public boolean compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final char key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Boolean> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Boolean computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Boolean compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Boolean merge(final Character key, final Boolean value,
				final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2BooleanFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2BooleanEntrySet());
			return entries;
		}
