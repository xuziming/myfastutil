...
public class Char2LongLinkedOpenHashMap extends AbstractChar2LongSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2LongMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry fromElement,
				Char2LongMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((char) 0)))
				return Char2LongLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			char curr;
			final char[] key = Char2LongLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Char2LongMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractChar2LongMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet char2LongEntrySet() {
		if (entries == null)
