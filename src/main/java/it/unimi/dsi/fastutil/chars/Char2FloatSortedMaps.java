...
public final class Char2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2FloatMap.Entry> fastIterator(Char2FloatSortedMap map) {
		...
		return entries instanceof Char2FloatSortedMap.FastSortedEntrySet
				? ((Char2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Char2FloatMaps.EmptyMap
			implements Char2FloatSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Char2FloatMaps.Singleton
			implements Char2FloatSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2FloatMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Char2FloatMaps.SynchronizedMap
			implements Char2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2FloatEntrySet(), sync);
			return (ObjectSortedSet<Char2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2FloatMaps.UnmodifiableMap
			implements Char2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2FloatSortedMap sortedMap;
		...
		public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2FloatEntrySet());
			return (ObjectSortedSet<Char2FloatMap.Entry>) entries;
		}
