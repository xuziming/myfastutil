...
public final class Char2ObjectMaps {
	...
	public static <V> ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator(Char2ObjectMap<V> map) {
		...
		return entries instanceof Char2ObjectMap.FastEntrySet
				? ((Char2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Char2ObjectMap<V> map,
			final Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Char2ObjectMap.Entry<V>> entries = map.char2ObjectEntrySet();
		if (entries instanceof Char2ObjectMap.FastEntrySet)
			((Char2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Char2ObjectMap.Entry<V>> fastIterable(Char2ObjectMap<V> map) {
		...
		return entries instanceof Char2ObjectMap.FastEntrySet ? new ObjectIterable<Char2ObjectMap.Entry<V>>() {
			public ObjectIterator<Char2ObjectMap.Entry<V>> iterator() {
				return ((Char2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Char2ObjectFunctions.EmptyFunction<V>
			implements Char2ObjectMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Char2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Char2ObjectFunctions.SynchronizedFunction<V>
		...
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2ObjectEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super V, ? extends V> function) {
			synchronized (sync) {
		...
		@Override
		public V computeIfAbsentPartial(final char key, final Char2ObjectFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V computeIfPresent(final char key,
		...
		@Override
		public V compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V merge(final char key, final V value,
		...
		@Deprecated
		@Override
		public V computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public V computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public V compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public V merge(final Character key, final V value,
				final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	 ...
	 */
	public static <V> Char2ObjectMap<V> synchronize(final Char2ObjectMap<V> m) {
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static <V> Char2ObjectMap<V> synchronize(final Char2ObjectMap<V> m, final Object sync) {
	...
	public static class UnmodifiableMap<V> extends Char2ObjectFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2ObjectEntrySet());
			return entries;
		}
	 ...
	 */
	public static <V> Char2ObjectMap<V> unmodifiable(final Char2ObjectMap<V> m) {
