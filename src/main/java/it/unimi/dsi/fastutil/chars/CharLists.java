...
public final class CharLists {
	...
	public static class EmptyList extends CharCollections.EmptyCollection
			implements CharList, RandomAccess, java.io.Serializable, Cloneable {
		...
		@Override
		public void sort(final CharComparator comparator) {
		}

		@Override
		public void unstableSort(final CharComparator comparator) {
		}

		// Empty lists are trivially always sorted
		@Deprecated
		@Override
		public void sort(final java.util.Comparator<? super Character> comparator) {
		}

		@Deprecated
		@Override
		public void unstableSort(final java.util.Comparator<? super Character> comparator) {
		}
		...
		@Override
		public void addElements(int index, final char a[]) {
			throw new UnsupportedOperationException();
		}

		@Override
		public void setElements(final char a[]) {
			throw new UnsupportedOperationException();
		}

		@Override
		public void setElements(int index, final char a[]) {
			throw new UnsupportedOperationException();
		}
	...
	public static class SynchronizedList extends CharCollections.SynchronizedCollection
			implements CharList, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final CharList list; // Due to the large number of methods that are not in COLLECTION, this is worth
										// caching.
		...
		@Override
		public boolean addAll(final int index, CharList l) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public void add(final int i, Character k) {
			synchronized (sync) {
				list.add(i, k);
			}
		}
		...
		@Deprecated
		@Override
		public Character set(final int index, Character k) {
			synchronized (sync) {
	...
	public static class UnmodifiableList extends CharCollections.UnmodifiableCollection
		...
		@Override
		public CharListIterator listIterator() {
			return CharIterators.unmodifiable(list.listIterator());
		}
		...
		@Override
		public CharListIterator listIterator(final int i) {
			return CharIterators.unmodifiable(list.listIterator(i));
		}
