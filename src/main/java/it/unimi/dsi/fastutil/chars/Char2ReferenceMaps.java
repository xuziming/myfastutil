...
public final class Char2ReferenceMaps {
	...
	public static <V> ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator(Char2ReferenceMap<V> map) {
		...
		return entries instanceof Char2ReferenceMap.FastEntrySet
				? ((Char2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Char2ReferenceMap<V> map,
			final Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Char2ReferenceMap.Entry<V>> entries = map.char2ReferenceEntrySet();
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap<V> extends Char2ReferenceFunctions.EmptyFunction<V>
			implements Char2ReferenceMap<V>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton<V> extends Char2ReferenceFunctions.Singleton<V>
			implements Char2ReferenceMap<V>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Char2ReferenceFunctions.SynchronizedFunction<V>
		...
		public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Char2ReferenceFunctions.UnmodifiableFunction<V>
			implements Char2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2ReferenceMap<V> map;
		protected transient ObjectSet<Char2ReferenceMap.Entry<V>> entries;
		...
		public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2ReferenceEntrySet());
			return entries;
		}
