...
public final class Char2CharMaps {
	...
	public static ObjectIterator<Char2CharMap.Entry> fastIterator(Char2CharMap map) {
		...
		return entries instanceof Char2CharMap.FastEntrySet ? ((Char2CharMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Char2CharFunctions.EmptyFunction
			implements Char2CharMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2CharFunctions.Singleton
		...
		public ObjectSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2CharFunctions.SynchronizedFunction
		...
		public ObjectSet<Char2CharMap.Entry> char2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final char key,
		...
		@Override
		public char computeIfPresent(final char key,
		...
		@Override
		public char compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char merge(final char key, final char value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Character computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Character> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character merge(final Character key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2CharFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2CharEntrySet());
			return entries;
		}
