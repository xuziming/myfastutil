...
public final class Char2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2IntMap.Entry> fastIterator(Char2IntSortedMap map) {
		...
		return entries instanceof Char2IntSortedMap.FastSortedEntrySet
				? ((Char2IntSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Char2IntMaps.EmptyMap
			implements Char2IntSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2IntMaps.Singleton
		...
		protected Singleton(final char key, final int value, CharComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2IntMap.BasicEntry(key, value),
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2IntSortedMap singleton(final Character key, Integer value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2IntSortedMap singleton(final Character key, Integer value, CharComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Char2IntSortedMap singleton(final char key, final int value, CharComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Char2IntMaps.SynchronizedMap
			implements Char2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends Char2IntMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2IntEntrySet());
			return (ObjectSortedSet<Char2IntMap.Entry>) entries;
		}
