...
public final class Char2BooleanSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2BooleanMap.Entry> fastIterator(Char2BooleanSortedMap map) {
		...
		return entries instanceof Char2BooleanSortedMap.FastSortedEntrySet
				? ((Char2BooleanSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Char2BooleanMaps.EmptyMap
			implements Char2BooleanSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2BooleanMaps.Singleton
		...
		public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2BooleanMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2BooleanMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Char2BooleanMaps.SynchronizedMap
			implements Char2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Char2BooleanMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2BooleanMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2BooleanEntrySet());
			return (ObjectSortedSet<Char2BooleanMap.Entry>) entries;
		}
