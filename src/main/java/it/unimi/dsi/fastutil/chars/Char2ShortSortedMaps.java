...
public final class Char2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator(Char2ShortSortedMap map) {
		final ObjectSortedSet<Char2ShortMap.Entry> entries = map.char2ShortEntrySet();
		return entries instanceof Char2ShortSortedMap.FastSortedEntrySet
				? ((Char2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Char2ShortMaps.EmptyMap
			implements Char2ShortSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2ShortMaps.Singleton
		...
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2ShortMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2ShortMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Char2ShortMaps.SynchronizedMap
			implements Char2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2ShortEntrySet(), sync);
			return (ObjectSortedSet<Char2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2ShortMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2ShortEntrySet());
			return (ObjectSortedSet<Char2ShortMap.Entry>) entries;
		}
