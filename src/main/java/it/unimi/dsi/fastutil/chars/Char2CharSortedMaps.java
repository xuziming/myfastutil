...
public final class Char2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Char2CharMap.Entry> fastIterator(Char2CharSortedMap map) {
		...
		return entries instanceof Char2CharSortedMap.FastSortedEntrySet
				? ((Char2CharSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Char2CharMaps.EmptyMap
			implements Char2CharSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Char2CharMaps.Singleton
			implements Char2CharSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractChar2CharMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Char2CharMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Char2CharMaps.SynchronizedMap
			implements Char2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.char2CharEntrySet(), sync);
			return (ObjectSortedSet<Char2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Char2CharMaps.UnmodifiableMap
			implements Char2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Char2CharSortedMap sortedMap;
		...
		public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.char2CharEntrySet());
			return (ObjectSortedSet<Char2CharMap.Entry>) entries;
		}
