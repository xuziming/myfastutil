...
public interface CharBigList
		extends BigList<Character>, CharCollection, Size64, Comparable<BigList<? extends Character>> {
	/**
	...
	@Deprecated
	@Override
	void add(long index, Character key);
	...
	@Deprecated
	@Override
	Character set(long index, Character k);
}
