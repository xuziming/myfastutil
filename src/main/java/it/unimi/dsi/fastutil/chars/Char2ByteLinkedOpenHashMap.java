 ...
 * @see HashCommon
 */
public class Char2ByteLinkedOpenHashMap extends AbstractChar2ByteSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Char2ByteMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry fromElement,
				Char2ByteMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((char) 0)))
				return Char2ByteLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			char curr;
			final char[] key = Char2ByteLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Char2ByteMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractChar2ByteMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet char2ByteEntrySet() {
		if (entries == null)
