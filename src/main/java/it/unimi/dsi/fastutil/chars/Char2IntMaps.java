...
public final class Char2IntMaps {
	...
	public static ObjectIterator<Char2IntMap.Entry> fastIterator(Char2IntMap map) {
		...
		return entries instanceof Char2IntMap.FastEntrySet ? ((Char2IntMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Char2IntMap map, final Consumer<? super Char2IntMap.Entry> consumer) {
		final ObjectSet<Char2IntMap.Entry> entries = map.char2IntEntrySet();
	...
	public static class EmptyMap extends Char2IntFunctions.EmptyFunction
			implements Char2IntMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Char2IntFunctions.Singleton
		...
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractChar2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Char2IntFunctions.SynchronizedFunction
			implements Char2IntMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.char2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Character, ? super Integer> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final char key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final char key,
		...
		@Override
		public int computeIfPresent(final char key,
		...
		@Override
		public int compute(final char key,
				final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int merge(final char key, final int value,
		...
		@Deprecated
		@Override
		public Integer computeIfAbsent(final Character key,
				final java.util.function.Function<? super Character, ? extends Integer> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer compute(final Character key,
				final java.util.function.BiFunction<? super Character, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer merge(final Character key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Char2IntFunctions.UnmodifiableFunction
		...
		public ObjectSet<Char2IntMap.Entry> char2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.char2IntEntrySet());
			return entries;
		}
