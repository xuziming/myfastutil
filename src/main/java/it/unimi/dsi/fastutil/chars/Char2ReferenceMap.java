...
public interface Char2ReferenceMap<V> extends Char2ReferenceFunction<V>, Map<Character, V> {
	 ...
	 */
	interface FastEntrySet<V> extends ObjectSet<Char2ReferenceMap.Entry<V>> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default V computeIfAbsent(final char key, final java.util.function.IntFunction<? extends V> mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default V computeIfPresent(final char key,
	 ...
	 * @since 8.0.0
	 */
	default V compute(final char key,
			final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final V oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default V merge(final char key, final V value,
	...
	@Deprecated
	@Override
	default V computeIfAbsent(final Character key,
	...
	@Deprecated
	@Override
	default V computeIfPresent(final Character key,
			final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V compute(final Character key,
			final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V merge(final Character key, final V value,
			final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
