...
public class HashCommon {
	 ...
	 *
	 * <p>
	 * This method implements the finalisation step of Austin Appleby's
	 * <a href="http://code.google.com/p/smhasher/">MurmurHash3</a>. Its purpose is
	 * to avalanche the bits of the argument to within 0.25% bias.
	 *
	 * @param x an integer.
	...
	/**
	 * The inverse of {@link #mix(int)}. This method is mainly useful to create unit
	 * tests.
	 *
	 * @param x an integer.
	...
	/**
	 * The inverse of {@link #mix(long)}. This method is mainly useful to create
	 * unit tests.
	 *
	 * @param x a long integer.
	 ...
	 * larger than or equal to {@code Math.ceil(expected / f)}.
	 *
