 ...
 * iterator}.
 */
public class Int2DoubleAVLTreeMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2DoubleAVLTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2DoubleAVLTreeMap(final Map<? extends Integer, ? extends Double> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleAVLTreeMap(final SortedMap<Integer, Double> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleAVLTreeMap(final Int2DoubleMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleAVLTreeMap(final Int2DoubleSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleAVLTreeMap(final int[] k, final double v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleAVLTreeMap(final int[] k, final double v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractInt2DoubleMap.BasicEntry implements Cloneable {
		 ...
		 * @param v a value.
		 */
		Entry(final int k, final double v) {
			super(k, v);
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2DoubleAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	 ...
	 * This class can iterate in both directions on a threaded tree.
	 */
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2DoubleMap.Entry> {
		EntryIterator() {
		}
	...
	public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
				final Comparator<? super Int2DoubleMap.Entry> comparator = (Comparator<Int2DoubleMap.Entry>) (x,
						y) -> Int2DoubleAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) {
					return headMap(to.getIntKey()).int2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) {
					return tailMap(from.getIntKey()).int2DoubleEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractInt2DoubleSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final int k) {
			return (bottom || Int2DoubleAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Int2DoubleAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
					...
					@Override
					public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from,
							Int2DoubleMap.Entry to) {
						return subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
					}
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2DoubleAVLTreeMap.this.containsKey(k);
		}
		...
		public double get(final int k) {
			final Int2DoubleAVLTreeMap.Entry e;
			final int kk = k;
		...
		public double put(final int k, final double v) {
			...
			final double oldValue = Int2DoubleAVLTreeMap.this.put(k, v);
		...
		public double remove(final int k) {
			...
			final double oldValue = Int2DoubleAVLTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2DoubleAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2DoubleAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2DoubleAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2DoubleAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	private Entry readTree(final java.io.ObjectInputStream s, final int n, final Entry pred, final Entry succ)
		...
		if (n == 1) {
			final Entry top = new Entry(s.readInt(), s.readDouble());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
