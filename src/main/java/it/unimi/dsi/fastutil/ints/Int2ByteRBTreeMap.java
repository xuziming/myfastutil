...
public class Int2ByteRBTreeMap extends AbstractInt2ByteSortedMap implements java.io.Serializable, Cloneable {
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
				final Comparator<? super Int2ByteMap.Entry> comparator = (Comparator<Int2ByteMap.Entry>) (x,
						y) -> Int2ByteRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2ByteSortedMap implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Byte))
							return false;
						final Int2ByteRBTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2ByteRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2ByteRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
