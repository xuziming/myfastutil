...
public final class Int2LongMaps {
	...
	public static ObjectIterator<Int2LongMap.Entry> fastIterator(Int2LongMap map) {
		...
		return entries instanceof Int2LongMap.FastEntrySet ? ((Int2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Int2LongFunctions.EmptyFunction
			implements Int2LongMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2LongFunctions.Singleton
		...
		public ObjectSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2LongFunctions.SynchronizedFunction
			implements Int2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2LongMap.Entry> int2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final int key,
		...
		@Override
		public long computeIfPresent(final int key,
		...
		@Override
		public long compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final int key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Integer key,
				final java.util.function.Function<? super Integer, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Long computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Long compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Long merge(final Integer key, final Long value,
				final java.util.function.BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Int2LongFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2LongEntrySet());
			return entries;
		}
