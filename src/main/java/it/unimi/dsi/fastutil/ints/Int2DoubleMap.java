...
public interface Int2DoubleMap extends Int2DoubleFunction, Map<Integer, Double> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Int2DoubleMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Int2DoubleMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default double computeIfAbsent(final int key, final java.util.function.IntToDoubleFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default double computeIfAbsentNullable(final int key,
	 ...
	 * @since 8.0.0
	 */
	default double computeIfPresent(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final double oldValue = get(key), drv = defaultReturnValue();
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Double newValue = remappingFunction.apply(Integer.valueOf(key), Double.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default double compute(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final double oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Double newValue = remappingFunction.apply(Integer.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default double merge(final int key, final double value,
	...
	@Deprecated
	@Override
	default Double computeIfAbsent(final Integer key,
			final java.util.function.Function<? super Integer, ? extends Double> mappingFunction) {
	...
	@Deprecated
	@Override
	default Double computeIfPresent(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	...
	@Deprecated
	@Override
	default Double compute(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
	...
	@Deprecated
	@Override
	default Double merge(final Integer key, final Double value,
			final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Integer, Double> {
		/**
