...
public interface Int2ShortMap extends Int2ShortFunction, Map<Integer, Short> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Int2ShortMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Int2ShortMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default short computeIfAbsent(final int key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default short computeIfAbsentNullable(final int key,
	 ...
	 * @since 8.0.0
	 */
	default short computeIfPresent(final int key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Short newValue = remappingFunction.apply(Integer.valueOf(key), Short.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default short compute(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final short oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Short newValue = remappingFunction.apply(Integer.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default short merge(final int key, final short value,
	...
	@Deprecated
	@Override
	default Short computeIfAbsent(final Integer key,
			final java.util.function.Function<? super Integer, ? extends Short> mappingFunction) {
	...
	@Deprecated
	@Override
	default Short computeIfPresent(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	@Deprecated
	@Override
	default Short compute(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
	...
	@Deprecated
	@Override
	default Short merge(final Integer key, final Short value,
			final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Integer, Short> {
		/**
