 ...
 * @see HashCommon
 */
public class Int2IntLinkedOpenHashMap extends AbstractInt2IntSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2IntMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2IntLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2IntLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Int2IntMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2IntMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet int2IntEntrySet() {
		if (entries == null)
