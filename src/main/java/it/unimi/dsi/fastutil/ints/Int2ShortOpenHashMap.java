 ...
 * @see HashCommon
 */
public class Int2ShortOpenHashMap extends AbstractInt2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Int2ShortMap.Entry, Map.Entry<Integer, Short> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).intValue())) && ((value[index]) == ((e.getValue()).shortValue()));
		}
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Int2ShortOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Int2ShortOpenHashMap.this.remove(wrapped.getInt(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2ShortOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2ShortOpenHashMap.this.key;
			int pos;
			// The starting point.
