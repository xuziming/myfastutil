...
public class Int2BooleanAVLTreeMap extends AbstractInt2BooleanSortedMap implements java.io.Serializable, Cloneable {
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
				final Comparator<? super Int2BooleanMap.Entry> comparator = (Comparator<Int2BooleanMap.Entry>) (x,
						y) -> Int2BooleanAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2BooleanSortedMap implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Boolean))
							return false;
						final Int2BooleanAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2BooleanAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2BooleanAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
