 ...
 * iterator}.
 */
public class Int2ByteAVLTreeMap extends AbstractInt2ByteSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2ByteAVLTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2ByteAVLTreeMap(final Map<? extends Integer, ? extends Byte> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2ByteAVLTreeMap(final SortedMap<Integer, Byte> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2ByteAVLTreeMap(final Int2ByteMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2ByteAVLTreeMap(final Int2ByteSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2ByteAVLTreeMap(final int[] k, final byte v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2ByteAVLTreeMap(final int[] k, final byte v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2ByteAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
				final Comparator<? super Int2ByteMap.Entry> comparator = (Comparator<Int2ByteMap.Entry>) (x,
						y) -> Int2ByteAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) {
					return headMap(to.getIntKey()).int2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) {
					return tailMap(from.getIntKey()).int2ByteEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractInt2ByteSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ByteAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2ByteAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Byte))
							return false;
						final Int2ByteAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2ByteAVLTreeMap.this.containsKey(k);
		}
		...
		public byte get(final int k) {
			final Int2ByteAVLTreeMap.Entry e;
			final int kk = k;
		...
		public byte put(final int k, final byte v) {
			...
			final byte oldValue = Int2ByteAVLTreeMap.this.put(k, v);
		...
		public byte remove(final int k) {
			...
			final byte oldValue = Int2ByteAVLTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2ByteAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2ByteAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2ByteAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2ByteAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
