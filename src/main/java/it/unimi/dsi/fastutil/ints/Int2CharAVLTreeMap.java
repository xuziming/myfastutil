...
public class Int2CharAVLTreeMap extends AbstractInt2CharSortedMap implements java.io.Serializable, Cloneable {
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
				final Comparator<? super Int2CharMap.Entry> comparator = (Comparator<Int2CharMap.Entry>) (x,
						y) -> Int2CharAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2CharSortedMap implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Int2CharAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2CharAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2CharAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
