...
public interface Int2FloatMap extends Int2FloatFunction, Map<Integer, Float> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Int2FloatMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Int2FloatMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default float computeIfAbsent(final int key, final java.util.function.IntToDoubleFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default float computeIfAbsentNullable(final int key,
	 ...
	 * @since 8.0.0
	 */
	default float computeIfPresent(final int key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Float newValue = remappingFunction.apply(Integer.valueOf(key), Float.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default float compute(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final float oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Float newValue = remappingFunction.apply(Integer.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default float merge(final int key, final float value,
	...
	@Deprecated
	@Override
	default Float computeIfAbsent(final Integer key,
	...
	@Deprecated
	@Override
	default Float computeIfPresent(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	@Deprecated
	@Override
	default Float compute(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
	...
	@Deprecated
	@Override
	default Float merge(final Integer key, final Float value,
			final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
	 ...
	 */
	interface Entry extends Map.Entry<Integer, Float> {
		/**
