...
public class Int2FloatLinkedOpenHashMap extends AbstractInt2FloatSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2FloatMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry fromElement,
				Int2FloatMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public void forEach(final Consumer<? super Int2FloatMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2FloatMap.BasicEntry(key[curr], value[curr]));
			}
		}
