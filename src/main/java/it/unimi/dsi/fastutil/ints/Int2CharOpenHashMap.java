 ...
 * @see HashCommon
 */
public class Int2CharOpenHashMap extends AbstractInt2CharMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Int2CharMap.Entry, Map.Entry<Integer, Character> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).intValue())) && ((value[index]) == ((e.getValue()).charValue()));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Int2CharOpenHashMap.this.remove(wrapped.getInt(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2CharOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2CharOpenHashMap.this.key;
			int pos;
			// The starting point.
