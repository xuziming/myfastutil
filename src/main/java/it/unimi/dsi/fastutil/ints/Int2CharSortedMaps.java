...
public final class Int2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2CharMap.Entry> fastIterator(Int2CharSortedMap map) {
		...
		return entries instanceof Int2CharSortedMap.FastSortedEntrySet
				? ((Int2CharSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Int2CharMaps.EmptyMap
			implements Int2CharSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Int2CharMaps.Singleton
			implements Int2CharSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final IntComparator comparator;

		protected Singleton(final int key, final char value, IntComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2CharMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2CharMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2CharSortedMap singleton(final Integer key, Character value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2CharSortedMap singleton(final Integer key, Character value, IntComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2CharSortedMap singleton(final int key, final char value, IntComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Int2CharMaps.SynchronizedMap
			implements Int2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2CharEntrySet(), sync);
			return (ObjectSortedSet<Int2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2CharMaps.UnmodifiableMap
			implements Int2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2CharSortedMap sortedMap;
		...
		public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2CharEntrySet());
			return (ObjectSortedSet<Int2CharMap.Entry>) entries;
		}
