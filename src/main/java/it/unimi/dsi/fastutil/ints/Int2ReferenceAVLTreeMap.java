 ...
 * iterator}.
 */
public class Int2ReferenceAVLTreeMap<V> extends AbstractInt2ReferenceSortedMap<V>
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2ReferenceAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
				final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = (Comparator<Int2ReferenceMap.Entry<V>>) (
						x, y) -> Int2ReferenceAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2ReferenceAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2ReferenceAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Integer))
							return false;
						final Int2ReferenceAVLTreeMap.Entry<V> f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2ReferenceAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public int firstIntKey() {
			Int2ReferenceAVLTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2ReferenceAVLTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2ReferenceAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2ReferenceAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Int2ReferenceAVLTreeMap<V> clone() {
		...
		try {
			c = (Int2ReferenceAVLTreeMap<V>) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
