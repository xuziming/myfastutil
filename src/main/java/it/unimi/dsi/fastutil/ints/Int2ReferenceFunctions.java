...
public final class Int2ReferenceFunctions {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Int2ReferenceFunction<V> singleton(final int key, V value) {
	...
	public static class SynchronizedFunction<V> implements Int2ReferenceFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static <V> Int2ReferenceFunction<V> primitive(
			final java.util.function.Function<? super Integer, ? extends V> f) {
		java.util.Objects.requireNonNull(f);
		if (f instanceof Int2ReferenceFunction)
			return (Int2ReferenceFunction<V>) f;
