...
public interface Int2CharMap extends Int2CharFunction, Map<Integer, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Int2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Int2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final int key, final java.util.function.IntUnaryOperator mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final int key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final int key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Integer.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Integer.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final int key, final char value,
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Integer key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Integer key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
