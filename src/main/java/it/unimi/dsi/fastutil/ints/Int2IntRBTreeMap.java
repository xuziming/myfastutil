 ...
 *
 */
public class Int2IntRBTreeMap extends AbstractInt2IntSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2IntRBTreeMap(final SortedMap<Integer, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2IntRBTreeMap(final Int2IntMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2IntRBTreeMap(final Int2IntSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2IntRBTreeMap(final int[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2IntRBTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
				final Comparator<? super Int2IntMap.Entry> comparator = (Comparator<Int2IntMap.Entry>) (x,
						y) -> Int2IntRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2IntRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2IntRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Int2IntRBTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2IntRBTreeMap.this.containsKey(k);
		}
		...
		public int get(final int k) {
			final Int2IntRBTreeMap.Entry e;
			final int kk = k;
		...
		public int remove(final int k) {
			...
			final int oldValue = Int2IntRBTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2IntRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2IntRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2IntRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2IntRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
