...
public final class Int2DoubleMaps {
	...
	public static ObjectIterator<Int2DoubleMap.Entry> fastIterator(Int2DoubleMap map) {
		...
		return entries instanceof Int2DoubleMap.FastEntrySet ? ((Int2DoubleMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Int2DoubleMap map, final Consumer<? super Int2DoubleMap.Entry> consumer) {
		final ObjectSet<Int2DoubleMap.Entry> entries = map.int2DoubleEntrySet();
	...
	public static class EmptyMap extends Int2DoubleFunctions.EmptyFunction
			implements Int2DoubleMap, java.io.Serializable, Cloneable {
	...
	public static class SynchronizedMap extends Int2DoubleFunctions.SynchronizedFunction
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Double> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> function) {
			synchronized (sync) {
	...
	public static class UnmodifiableMap extends Int2DoubleFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2DoubleEntrySet());
			return entries;
		}
