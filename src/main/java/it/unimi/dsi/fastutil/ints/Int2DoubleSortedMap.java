...
public interface Int2DoubleSortedMap extends Int2DoubleMap, SortedMap<Integer, Double> {
	 ...
	 */
	Int2DoubleSortedMap subMap(int fromKey, int toKey);
	 ...
	 */
	Int2DoubleSortedMap headMap(int toKey);
	 ...
	 */
	Int2DoubleSortedMap tailMap(int fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Int2DoubleMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Int2DoubleMap.Entry> fastIterator(Int2DoubleMap.Entry from);
	}
