...
public final class Int2FloatMaps {
	...
	public static ObjectIterator<Int2FloatMap.Entry> fastIterator(Int2FloatMap map) {
		...
		return entries instanceof Int2FloatMap.FastEntrySet ? ((Int2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Int2FloatMap map, final Consumer<? super Int2FloatMap.Entry> consumer) {
		final ObjectSet<Int2FloatMap.Entry> entries = map.int2FloatEntrySet();
	...
	public static class EmptyMap extends Int2FloatFunctions.EmptyFunction
			implements Int2FloatMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2FloatFunctions.Singleton
		...
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2FloatMap.BasicEntry(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2FloatMap singleton(final int key, float value) {
	...
	public static class SynchronizedMap extends Int2FloatFunctions.SynchronizedFunction
			implements Int2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Float> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final int key, final java.util.function.IntToDoubleFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final int key,
		...
		@Override
		public float computeIfPresent(final int key,
		...
		@Override
		public float compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final int key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Integer key,
				final java.util.function.Function<? super Integer, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Float computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Float compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Float merge(final Integer key, final Float value,
				final java.util.function.BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Int2FloatFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2FloatEntrySet());
			return entries;
		}
