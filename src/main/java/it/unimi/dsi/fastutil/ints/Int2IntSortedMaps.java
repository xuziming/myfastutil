...
public final class Int2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2IntMap.Entry> fastIterator(Int2IntSortedMap map) {
		...
		return entries instanceof Int2IntSortedMap.FastSortedEntrySet
	 ...
	 */
	public static class EmptySortedMap extends Int2IntMaps.EmptyMap
			implements Int2IntSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Int2IntMaps.Singleton
			implements Int2IntSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2IntMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2IntMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Int2IntMaps.SynchronizedMap
			implements Int2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2IntEntrySet(), sync);
			return (ObjectSortedSet<Int2IntMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2IntMaps.UnmodifiableMap
			implements Int2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2IntSortedMap sortedMap;
		...
		public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2IntEntrySet());
			return (ObjectSortedSet<Int2IntMap.Entry>) entries;
		}
