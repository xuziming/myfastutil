 ...
 * iterator}.
 */
public class Int2FloatAVLTreeMap extends AbstractInt2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2FloatAVLTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2FloatAVLTreeMap(final Map<? extends Integer, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2FloatAVLTreeMap(final SortedMap<Integer, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2FloatAVLTreeMap(final Int2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2FloatAVLTreeMap(final Int2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2FloatAVLTreeMap(final int[] k, final float v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2FloatAVLTreeMap(final int[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
				final Comparator<? super Int2FloatMap.Entry> comparator = (Comparator<Int2FloatMap.Entry>) (x,
						y) -> Int2FloatAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2FloatSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Int2FloatAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		public float get(final int k) {
			final Int2FloatAVLTreeMap.Entry e;
			final int kk = k;
		...
		public float put(final int k, final float v) {
			...
			final float oldValue = Int2FloatAVLTreeMap.this.put(k, v);
		...
		public float remove(final int k) {
			...
			final float oldValue = Int2FloatAVLTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
