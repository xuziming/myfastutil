...
public class Int2ObjectRBTreeMap<V> extends AbstractInt2ObjectSortedMap<V> implements java.io.Serializable, Cloneable {
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>() {
				final Comparator<? super Int2ObjectMap.Entry<V>> comparator = (Comparator<Int2ObjectMap.Entry<V>>) (x,
						y) -> Int2ObjectRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2ObjectSortedMap<V> implements java.io.Serializable {
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Integer))
							return false;
						final Int2ObjectRBTreeMap.Entry<V> f = findKey(((Integer) (e.getKey())).intValue());
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2ObjectRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2ObjectRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
