...
public interface Int2ShortSortedMap extends Int2ShortMap, SortedMap<Integer, Short> {
	 ...
	 */
	Int2ShortSortedMap subMap(int fromKey, int toKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Int2ShortMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Int2ShortMap.Entry> fastIterator(Int2ShortMap.Entry from);
	}
