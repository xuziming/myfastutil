...
public final class Int2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2ShortMap.Entry> fastIterator(Int2ShortSortedMap map) {
		final ObjectSortedSet<Int2ShortMap.Entry> entries = map.int2ShortEntrySet();
		return entries instanceof Int2ShortSortedMap.FastSortedEntrySet
				? ((Int2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Int2ShortMaps.EmptyMap
			implements Int2ShortSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2ShortMaps.Singleton
		...
		protected Singleton(final int key, final short value, IntComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2ShortMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2ShortMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2ShortSortedMap singleton(final Integer key, Short value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2ShortSortedMap singleton(final Integer key, Short value, IntComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2ShortSortedMap singleton(final int key, final short value, IntComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Int2ShortMaps.SynchronizedMap
			implements Int2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2ShortEntrySet(), sync);
			return (ObjectSortedSet<Int2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2ShortMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2ShortEntrySet());
			return (ObjectSortedSet<Int2ShortMap.Entry>) entries;
		}
