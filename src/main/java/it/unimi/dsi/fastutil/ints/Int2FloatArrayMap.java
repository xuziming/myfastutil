 ...
 */
public class Int2FloatArrayMap extends AbstractInt2FloatMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Int2FloatMap.Entry> iterator() {
			return new ObjectIterator<Int2FloatMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractInt2FloatMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Int2FloatArrayMap.this.containsKey(k)
					&& (Float.floatToIntBits(Int2FloatArrayMap.this.get(k)) == Float
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1
					|| !(Float.floatToIntBits(v) == Float.floatToIntBits(Int2FloatArrayMap.this.value[oldPos])))
				return false;
