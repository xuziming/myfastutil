...
public interface Int2BooleanMap extends Int2BooleanFunction, Map<Integer, Boolean> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Int2BooleanMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Int2BooleanMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default boolean getOrDefault(final int key, final boolean defaultValue) {
		final boolean v;
	 ...
	 * @since 8.0.0
	 */
	default boolean putIfAbsent(final int key, final boolean value) {
	 ...
	 * @since 8.0.0
	 */
	default boolean remove(final int key, final boolean value) {
	 ...
	 * @since 8.0.0
	 */
	default boolean replace(final int key, final boolean oldValue, final boolean newValue) {
		final boolean curValue = get(key);
	 ...
	 * @since 8.0.0
	 */
	default boolean replace(final int key, final boolean value) {
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfAbsent(final int key, final java.util.function.IntPredicate mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfAbsentNullable(final int key,
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfAbsentPartial(final int key, final Int2BooleanFunction mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final boolean v = get(key), drv = defaultReturnValue();
		if (v != drv || containsKey(key))
			return v;
	 ...
	 * @since 8.0.0
	 */
	default boolean computeIfPresent(final int key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Boolean newValue = remappingFunction.apply(Integer.valueOf(key), Boolean.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default boolean compute(final int key,
			final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final boolean oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Boolean newValue = remappingFunction.apply(Integer.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default boolean merge(final int key, final boolean value,
	...
	@Deprecated
	@Override
	default Boolean putIfAbsent(final Integer key, final Boolean value) {
	...
	@Deprecated
	@Override
	default boolean replace(final Integer key, final Boolean oldValue, final Boolean newValue) {
	...
	@Deprecated
	@Override
	default Boolean replace(final Integer key, final Boolean value) {
	...
	@Deprecated
	@Override
	default Boolean computeIfAbsent(final Integer key,
			final java.util.function.Function<? super Integer, ? extends Boolean> mappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean computeIfPresent(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean compute(final Integer key,
			final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
	...
	@Deprecated
	@Override
	default Boolean merge(final Integer key, final Boolean value,
			final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
