 ...
 * @see HashCommon
 */
public class Int2DoubleLinkedOpenHashMap extends AbstractInt2DoubleSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2DoubleMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry fromElement,
				Int2DoubleMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Int2DoubleMap.Entry> iterator(final Int2DoubleMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Int2DoubleMap.Entry> fastIterator(final Int2DoubleMap.Entry from) {
		...
		public void forEach(final Consumer<? super Int2DoubleMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2DoubleMap.BasicEntry(key[curr], value[curr]));
			}
		}
