...
public final class Int2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2DoubleMap.Entry> fastIterator(Int2DoubleSortedMap map) {
		...
		return entries instanceof Int2DoubleSortedMap.FastSortedEntrySet
				? ((Int2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Int2DoubleMaps.EmptyMap
			implements Int2DoubleSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2DoubleMaps.Singleton
		...
		protected Singleton(final int key, final double value, IntComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2DoubleMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2DoubleSortedMap singleton(final Integer key, Double value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2DoubleSortedMap singleton(final Integer key, Double value, IntComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2DoubleSortedMap singleton(final int key, final double value, IntComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Int2DoubleMaps.SynchronizedMap
			implements Int2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Int2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2DoubleMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2DoubleEntrySet());
			return (ObjectSortedSet<Int2DoubleMap.Entry>) entries;
		}
