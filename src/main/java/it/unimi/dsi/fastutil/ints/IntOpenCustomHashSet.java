...
public class IntOpenCustomHashSet extends AbstractIntSet implements java.io.Serializable, Cloneable, Hash {
	...
	public IntOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final Collection<? extends Integer> c, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final Collection<? extends Integer> c,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final IntCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final IntIterator i, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final int[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final int[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntOpenCustomHashSet(final int[] a, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
