...
public final class Int2ShortMaps {
	...
	public static ObjectIterator<Int2ShortMap.Entry> fastIterator(Int2ShortMap map) {
		...
		return entries instanceof Int2ShortMap.FastEntrySet ? ((Int2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Int2ShortFunctions.EmptyFunction
			implements Int2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2ShortFunctions.Singleton
		...
		public ObjectSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2ShortFunctions.SynchronizedFunction
			implements Int2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final int key,
		...
		@Override
		public short computeIfPresent(final int key,
		...
		@Override
		public short compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final int key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Integer key,
		...
		@Deprecated
		@Override
		public Short computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Short compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Short merge(final Integer key, final Short value,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Int2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2ShortMap.Entry> int2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2ShortEntrySet());
			return entries;
		}
