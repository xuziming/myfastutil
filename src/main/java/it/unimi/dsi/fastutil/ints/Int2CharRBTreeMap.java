 ...
 *
 */
public class Int2CharRBTreeMap extends AbstractInt2CharSortedMap implements java.io.Serializable, Cloneable {
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2CharRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
				final Comparator<? super Int2CharMap.Entry> comparator = (Comparator<Int2CharMap.Entry>) (x,
						y) -> Int2CharRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) {
					return headMap(to.getIntKey()).int2CharEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) {
					return tailMap(from.getIntKey()).int2CharEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractInt2CharSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2CharRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2CharRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Character))
							return false;
						final Int2CharRBTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2CharRBTreeMap.this.containsKey(k);
		}
		...
		@Override
		public int firstIntKey() {
			Int2CharRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2CharRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2CharRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2CharRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
