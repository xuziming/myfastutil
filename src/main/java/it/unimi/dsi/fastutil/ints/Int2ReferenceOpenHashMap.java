 ...
 * @see HashCommon
 */
public class Int2ReferenceOpenHashMap<V> extends AbstractInt2ReferenceMap<V>
	...
	final class MapEntry implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).intValue())) && ((value[index]) == ((e.getValue())));
		}
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Int2ReferenceOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Int2ReferenceOpenHashMap.this.remove(wrapped.getInt(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2ReferenceOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2ReferenceOpenHashMap.this.key;
			int pos;
			// The starting point.
	...
	public Int2ReferenceOpenHashMap<V> clone() {
		...
		try {
			c = (Int2ReferenceOpenHashMap<V>) super.clone();
