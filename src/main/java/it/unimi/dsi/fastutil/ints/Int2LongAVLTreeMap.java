 ...
 * iterator}.
 */
public class Int2LongAVLTreeMap extends AbstractInt2LongSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2LongAVLTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2LongAVLTreeMap(final Map<? extends Integer, ? extends Long> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2LongAVLTreeMap(final SortedMap<Integer, Long> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2LongAVLTreeMap(final Int2LongMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2LongAVLTreeMap(final Int2LongSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2LongAVLTreeMap(final int[] k, final long v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2LongAVLTreeMap(final int[] k, final long v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractInt2LongMap.BasicEntry implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).intValue())) && ((value) == ((e.getValue()).longValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2LongAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
				final Comparator<? super Int2LongMap.Entry> comparator = (Comparator<Int2LongMap.Entry>) (x,
						y) -> Int2LongAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry to) {
					return headMap(to.getIntKey()).int2LongEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from) {
					return tailMap(from.getIntKey()).int2LongEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractInt2LongSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final int k) {
			return (bottom || Int2LongAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2LongAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2LongMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Long))
							return false;
						final Int2LongAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2LongAVLTreeMap.this.containsKey(k);
		}
		...
		public long get(final int k) {
			final Int2LongAVLTreeMap.Entry e;
			final int kk = k;
		...
		public long put(final int k, final long v) {
			...
			final long oldValue = Int2LongAVLTreeMap.this.put(k, v);
		...
		public long remove(final int k) {
			...
			final long oldValue = Int2LongAVLTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2LongAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2LongAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2LongAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2LongAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
