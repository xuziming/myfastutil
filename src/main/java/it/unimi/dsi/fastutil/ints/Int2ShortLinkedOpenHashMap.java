...
public class Int2ShortLinkedOpenHashMap extends AbstractInt2ShortSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2ShortMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		@Override
		public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry fromElement,
				Int2ShortMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2ShortLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2ShortLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Int2ShortMap.Entry> iterator(final Int2ShortMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Int2ShortMap.Entry> fastIterator(final Int2ShortMap.Entry from) {
		...
		public void forEach(final Consumer<? super Int2ShortMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2ShortMap.BasicEntry(key[curr], value[curr]));
			}
		}
