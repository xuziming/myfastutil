...
public abstract class AbstractInt2CharMap extends AbstractInt2CharFunction
	...
	public boolean containsKey(final int k) {
		final ObjectIterator<Int2CharMap.Entry> i = int2CharEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Int2CharMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Int2CharMap.Entry) {
				final Int2CharMap.Entry e = (Int2CharMap.Entry) o;
				return ((key) == (e.getIntKey())) && ((value) == (e.getCharValue()));
			}
			...
			if (value == null || !(value instanceof Character))
				return false;
			return ((this.key) == (((Integer) (key)).intValue()))
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Int2CharMap.Entry) {
				final Int2CharMap.Entry e = (Int2CharMap.Entry) o;
				return map.remove(e.getIntKey(), e.getCharValue());
			}
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					private final ObjectIterator<Int2CharMap.Entry> i = Int2CharMaps
							.fastIterator(AbstractInt2CharMap.this);
	...
	public void putAll(final Map<? extends Integer, ? extends Character> m) {
		if (m instanceof Int2CharMap) {
			...
			while (i.hasNext()) {
				final Int2CharMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Int2CharMap.Entry> i = Int2CharMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
