...
public final class Int2CharFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractInt2CharFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2CharFunction singleton(final int key, char value) {
	...
	public static class SynchronizedFunction implements Int2CharFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction extends AbstractInt2CharFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2CharFunction function;
	...
	public static class PrimitiveFunction implements Int2CharFunction {
		...
		public char get(int key) {
			Character v = function.apply(Integer.valueOf(key));
			if (v == null)
	...
	public static Int2CharFunction primitive(
			final java.util.function.Function<? super Integer, ? extends Character> f) {
		...
		if (f instanceof java.util.function.IntUnaryOperator)
			return key -> it.unimi.dsi.fastutil.SafeMath
					.safeIntToChar(((java.util.function.IntUnaryOperator) f).applyAsInt(key));
