...
public final class Int2ReferenceSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator(
			Int2ReferenceSortedMap<V> map) {
		...
		return entries instanceof Int2ReferenceSortedMap.FastSortedEntrySet
				? ((Int2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Int2ReferenceMap.Entry<V>> fastIterable(
			Int2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Int2ReferenceMap.Entry<V>> entries = map.int2ReferenceEntrySet();
		return entries instanceof Int2ReferenceSortedMap.FastSortedEntrySet
				? ((Int2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	...
	public static class EmptySortedMap<V> extends Int2ReferenceMaps.EmptyMap<V>
			implements Int2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Int2ReferenceMaps.Singleton<V>
		...
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Int2ReferenceMaps.SynchronizedMap<V>
			implements Int2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Int2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Int2ReferenceMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2ReferenceEntrySet());
			return (ObjectSortedSet<Int2ReferenceMap.Entry<V>>) entries;
		}
