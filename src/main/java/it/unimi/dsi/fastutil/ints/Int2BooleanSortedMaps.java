...
public final class Int2BooleanSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2BooleanMap.Entry> fastIterator(Int2BooleanSortedMap map) {
		...
		return entries instanceof Int2BooleanSortedMap.FastSortedEntrySet
				? ((Int2BooleanSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Int2BooleanMaps.EmptyMap
			implements Int2BooleanSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2BooleanMaps.Singleton
		...
		public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2BooleanMap.BasicEntry(key, value),
		...
		public ObjectSortedSet<Map.Entry<Integer, Boolean>> entrySet() {
			return (ObjectSortedSet) int2BooleanEntrySet();
		}
	...
	public static class SynchronizedSortedMap extends Int2BooleanMaps.SynchronizedMap
			implements Int2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableSortedMap extends Int2BooleanMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2BooleanEntrySet());
			return (ObjectSortedSet<Int2BooleanMap.Entry>) entries;
		}
