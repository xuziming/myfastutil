...
public interface Int2ReferenceSortedMap<V> extends Int2ReferenceMap<V>, SortedMap<Integer, V> {
	 ...
	 */
	Int2ReferenceSortedMap<V> subMap(int fromKey, int toKey);
	 ...
	 */
	Int2ReferenceSortedMap<V> headMap(int toKey);
	 ...
	 */
	Int2ReferenceSortedMap<V> tailMap(int fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Int2ReferenceMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator(Int2ReferenceMap.Entry<V> from);
	}
