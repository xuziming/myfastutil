...
public interface Int2LongSortedMap extends Int2LongMap, SortedMap<Integer, Long> {
	 ...
	 */
	Int2LongSortedMap subMap(int fromKey, int toKey);
	 ...
	 */
	Int2LongSortedMap headMap(int toKey);
	 ...
	 */
	Int2LongSortedMap tailMap(int fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Int2LongMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator(Int2LongMap.Entry from);
	}
