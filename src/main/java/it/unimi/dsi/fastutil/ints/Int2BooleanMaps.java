...
public final class Int2BooleanMaps {
	...
	public static ObjectIterator<Int2BooleanMap.Entry> fastIterator(Int2BooleanMap map) {
		...
		return entries instanceof Int2BooleanMap.FastEntrySet ? ((Int2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Int2BooleanFunctions.EmptyFunction
			implements Int2BooleanMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2BooleanFunctions.Singleton
		...
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2BooleanFunctions.SynchronizedFunction
			implements Int2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Boolean> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsent(final int key, final java.util.function.IntPredicate mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final int key,
		...
		@Override
		public boolean computeIfPresent(final int key,
		...
		@Override
		public boolean compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final int key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Integer key,
		...
		@Deprecated
		@Override
		public Boolean computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Boolean compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Boolean merge(final Integer key, final Boolean value,
				final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Int2BooleanFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2BooleanEntrySet());
			return entries;
		}
