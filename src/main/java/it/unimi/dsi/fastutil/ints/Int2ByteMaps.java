...
public final class Int2ByteMaps {
	...
	public static ObjectIterator<Int2ByteMap.Entry> fastIterator(Int2ByteMap map) {
		...
		return entries instanceof Int2ByteMap.FastEntrySet ? ((Int2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Int2ByteMap map, final Consumer<? super Int2ByteMap.Entry> consumer) {
		final ObjectSet<Int2ByteMap.Entry> entries = map.int2ByteEntrySet();
	...
	public static ObjectIterable<Int2ByteMap.Entry> fastIterable(Int2ByteMap map) {
		...
		return entries instanceof Int2ByteMap.FastEntrySet ? new ObjectIterable<Int2ByteMap.Entry>() {
			...
			public void forEach(final Consumer<? super Int2ByteMap.Entry> consumer) {
				((Int2ByteMap.FastEntrySet) entries).fastForEach(consumer);
			}
		} : entries;
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Int2ByteFunctions.EmptyFunction
			implements Int2ByteMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Int2ByteFunctions.Singleton
			implements Int2ByteMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2ByteMap.BasicEntry(key, value));
			return entries;
		}
		...
		public ByteCollection values() {
			if (values == null)
				values = ByteSets.singleton(value);
			return values;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2ByteMap singleton(final int key, byte value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2ByteMap singleton(final Integer key, final Byte value) {
		return new Singleton((key).intValue(), (value).byteValue());
	}

	/** A synchronized wrapper class for maps. */
	public static class SynchronizedMap extends Int2ByteFunctions.SynchronizedFunction
		...
		protected SynchronizedMap(final Int2ByteMap m, final Object sync) {
			super(m, sync);
			this.map = m;
		}

		protected SynchronizedMap(final Int2ByteMap m) {
			super(m);
			this.map = m;
		}
		...
		public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		public ByteCollection values() {
			synchronized (sync) {
				if (values == null)
					return ByteCollections.synchronize(map.values(), sync);
				return values;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public boolean remove(final int key, final byte value) {
			synchronized (sync) {
		...
		@Override
		public byte replace(final int key, final byte value) {
			synchronized (sync) {
		...
		@Override
		public boolean replace(final int key, final byte oldValue, final byte newValue) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final int key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final int key,
				final java.util.function.IntFunction<? extends Byte> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentPartial(final int key, final Int2ByteFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfPresent(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final int key, final byte value,
		...
		@Deprecated
		@Override
		public Byte replace(final Integer key, final Byte value) {
			synchronized (sync) {
				return map.replace(key, value);
			}
		}
		...
		@Deprecated
		@Override
		public boolean replace(final Integer key, final Byte oldValue, final Byte newValue) {
			synchronized (sync) {
				return map.replace(key, oldValue, newValue);
			}
		}
		...
		@Deprecated
		@Override
		public Byte putIfAbsent(final Integer key, final Byte value) {
			synchronized (sync) {
				return map.putIfAbsent(key, value);
			}
		}
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Integer key,
				final java.util.function.Function<? super Integer, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Byte computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Byte compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Byte merge(final Integer key, final Byte value,
				final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	 ...
	 */
	public static Int2ByteMap synchronize(final Int2ByteMap m) {
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static Int2ByteMap synchronize(final Int2ByteMap m, final Object sync) {
		return new SynchronizedMap(m, sync);
	}

	/** An unmodifiable wrapper class for maps. */
	public static class UnmodifiableMap extends Int2ByteFunctions.UnmodifiableFunction
			implements Int2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2ByteMap map;
		protected transient ObjectSet<Int2ByteMap.Entry> entries;
		...
		protected UnmodifiableMap(final Int2ByteMap m) {
			super(m);
			this.map = m;
		}
		...
		public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2ByteEntrySet());
			return entries;
		}
		...
		public ByteCollection values() {
			if (values == null)
				return ByteCollections.unmodifiable(map.values());
			return values;
		}
	 ...
	 */
	public static Int2ByteMap unmodifiable(final Int2ByteMap m) {
