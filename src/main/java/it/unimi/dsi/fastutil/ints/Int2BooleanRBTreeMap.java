 ...
 *
 */
public class Int2BooleanRBTreeMap extends AbstractInt2BooleanSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2BooleanRBTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2BooleanRBTreeMap(final Map<? extends Integer, ? extends Boolean> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2BooleanRBTreeMap(final SortedMap<Integer, Boolean> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2BooleanRBTreeMap(final Int2BooleanMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2BooleanRBTreeMap(final Int2BooleanSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2BooleanRBTreeMap(final int[] k, final boolean v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2BooleanRBTreeMap(final int[] k, final boolean v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2BooleanRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
				final Comparator<? super Int2BooleanMap.Entry> comparator = (Comparator<Int2BooleanMap.Entry>) (x,
						y) -> Int2BooleanRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				@Override
				public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from,
						Int2BooleanMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2BooleanEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) {
					return headMap(to.getIntKey()).int2BooleanEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) {
					return tailMap(from.getIntKey()).int2BooleanEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractInt2BooleanSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2BooleanRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2BooleanRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Boolean))
							return false;
						final Int2BooleanRBTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2BooleanRBTreeMap.this.containsKey(k);
		}
		...
		public boolean get(final int k) {
			final Int2BooleanRBTreeMap.Entry e;
			final int kk = k;
		...
		public boolean put(final int k, final boolean v) {
			...
			final boolean oldValue = Int2BooleanRBTreeMap.this.put(k, v);
		...
		public boolean remove(final int k) {
			...
			final boolean oldValue = Int2BooleanRBTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2BooleanRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2BooleanRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2BooleanRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2BooleanRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Int2BooleanRBTreeMap clone() {
		...
		try {
			c = (Int2BooleanRBTreeMap) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
