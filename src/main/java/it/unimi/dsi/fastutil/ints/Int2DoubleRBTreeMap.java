 ...
 *
 */
public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2DoubleRBTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2DoubleRBTreeMap(final Map<? extends Integer, ? extends Double> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleRBTreeMap(final SortedMap<Integer, Double> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleRBTreeMap(final Int2DoubleMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2DoubleRBTreeMap(final Int2DoubleSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleRBTreeMap(final int[] k, final double v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleRBTreeMap(final int[] k, final double v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2DoubleRBTreeMap.this.remove(curr.key);
			curr = null;
		}
		...
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
				final Comparator<? super Int2DoubleMap.Entry> comparator = (Comparator<Int2DoubleMap.Entry>) (x,
						y) -> Int2DoubleRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
	...
	private final class Submap extends AbstractInt2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2DoubleRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2DoubleRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Int2DoubleRBTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2DoubleRBTreeMap.this.containsKey(k);
		}
		...
		public double get(final int k) {
			final Int2DoubleRBTreeMap.Entry e;
			final int kk = k;
		...
		public double put(final int k, final double v) {
			...
			final double oldValue = Int2DoubleRBTreeMap.this.put(k, v);
		...
		public double remove(final int k) {
			...
			final double oldValue = Int2DoubleRBTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2DoubleRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2DoubleRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2DoubleRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2DoubleRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
