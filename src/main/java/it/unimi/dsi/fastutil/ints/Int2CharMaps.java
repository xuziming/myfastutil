...
public final class Int2CharMaps {
	...
	public static ObjectIterator<Int2CharMap.Entry> fastIterator(Int2CharMap map) {
		...
		return entries instanceof Int2CharMap.FastEntrySet ? ((Int2CharMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Int2CharFunctions.EmptyFunction
			implements Int2CharMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2CharFunctions.Singleton
		...
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2CharMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Int2CharFunctions.SynchronizedFunction
			implements Int2CharMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Integer, ? super Character> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsent(final int key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final int key,
		...
		@Override
		public char computeIfPresent(final int key,
		...
		@Override
		public char compute(final int key,
				final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char merge(final int key, final char value,
		...
		@Deprecated
		@Override
		public Character computeIfAbsent(final Integer key,
				final java.util.function.Function<? super Integer, ? extends Character> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character compute(final Integer key,
				final java.util.function.BiFunction<? super Integer, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character merge(final Integer key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Int2CharFunctions.UnmodifiableFunction
		...
		public ObjectSet<Int2CharMap.Entry> int2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2CharEntrySet());
			return entries;
		}
