 ...
 */
public abstract class AbstractInt2ReferenceMap<V> extends AbstractInt2ReferenceFunction<V>
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					private final ObjectIterator<Int2ReferenceMap.Entry<V>> i = Int2ReferenceMaps
							.fastIterator(AbstractInt2ReferenceMap.this);
