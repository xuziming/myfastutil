 ...
 */
public class Int2BooleanArrayMap extends AbstractInt2BooleanMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Int2BooleanMap.Entry> iterator() {
			return new ObjectIterator<Int2BooleanMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractInt2BooleanMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Int2BooleanArrayMap.this.containsKey(k)
					&& ((Int2BooleanArrayMap.this.get(k)) == (((Boolean) (e.getValue())).booleanValue()));
		}
