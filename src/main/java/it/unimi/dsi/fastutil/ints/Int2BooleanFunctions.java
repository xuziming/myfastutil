...
public final class Int2BooleanFunctions {
	...
	public static class SynchronizedFunction implements Int2BooleanFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class PrimitiveFunction implements Int2BooleanFunction {
		...
		public boolean get(int key) {
			Boolean v = function.apply(Integer.valueOf(key));
			if (v == null)
	...
	public static Int2BooleanFunction primitive(
			final java.util.function.Function<? super Integer, ? extends Boolean> f) {
