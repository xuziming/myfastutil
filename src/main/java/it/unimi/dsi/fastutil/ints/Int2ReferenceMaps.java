...
public final class Int2ReferenceMaps {
	...
	public static <V> ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator(Int2ReferenceMap<V> map) {
		...
		return entries instanceof Int2ReferenceMap.FastEntrySet
				? ((Int2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Int2ReferenceMap<V> map,
			final Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Int2ReferenceMap.Entry<V>> entries = map.int2ReferenceEntrySet();
		if (entries instanceof Int2ReferenceMap.FastEntrySet)
			((Int2ReferenceMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Int2ReferenceMap.Entry<V>> fastIterable(Int2ReferenceMap<V> map) {
		...
		return entries instanceof Int2ReferenceMap.FastEntrySet ? new ObjectIterable<Int2ReferenceMap.Entry<V>>() {
			public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() {
				return ((Int2ReferenceMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Int2ReferenceFunctions.EmptyFunction<V>
			implements Int2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Int2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractInt2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
		...
		public ObjectSet<Map.Entry<Integer, V>> entrySet() {
			return (ObjectSet) int2ReferenceEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Int2ReferenceMap<V> singleton(final int key, V value) {
	...
	public static class SynchronizedMap<V> extends Int2ReferenceFunctions.SynchronizedFunction<V>
			implements Int2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.int2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Int2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.int2ReferenceEntrySet());
			return entries;
		}
