...
public class Int2DoubleOpenCustomHashMap extends AbstractInt2DoubleMap
	...
	public Int2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Int2DoubleOpenCustomHashMap(final Map<? extends Integer, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Int2DoubleOpenCustomHashMap(final Map<? extends Integer, ? extends Double> m,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Int2DoubleOpenCustomHashMap(final Int2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Int2DoubleOpenCustomHashMap(final Int2DoubleMap m,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleOpenCustomHashMap(final int[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Int2DoubleOpenCustomHashMap(final int[] k, final double[] v,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfAbsentNullable(final int k,
	...
	/** {@inheritDoc} */
	@Override
	public double computeIfPresent(final int k,
	...
	/** {@inheritDoc} */
	@Override
	public double compute(final int k,
			final java.util.function.BiFunction<? super Integer, ? super Double, ? extends Double> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Double newValue = remappingFunction.apply(Integer.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public double merge(final int k, final double v,
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements FastEntrySet {
		...
		public void forEach(final Consumer<? super Int2DoubleMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractInt2DoubleMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == (0)))
					consumer.accept(new AbstractInt2DoubleMap.BasicEntry(key[pos], value[pos]));
		}
