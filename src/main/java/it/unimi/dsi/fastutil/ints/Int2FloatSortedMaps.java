...
public final class Int2FloatSortedMaps {
	...
	public static Comparator<? super Map.Entry<Integer, ?>> entryComparator(final IntComparator comparator) {
		return (Comparator<Map.Entry<Integer, ?>>) (x, y) -> comparator.compare((x.getKey()).intValue(),
				(y.getKey()).intValue());
	}
	...
	public static ObjectBidirectionalIterator<Int2FloatMap.Entry> fastIterator(Int2FloatSortedMap map) {
		...
		return entries instanceof Int2FloatSortedMap.FastSortedEntrySet
				? ((Int2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Int2FloatMaps.EmptyMap
			implements Int2FloatSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Int2FloatMaps.Singleton
			implements Int2FloatSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final IntComparator comparator;

		protected Singleton(final int key, final float value, IntComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2FloatMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Integer, Float>> entrySet() {
			return (ObjectSortedSet) int2FloatEntrySet();
		}

		@Override
		public IntSortedSet keySet() {
			if (keys == null)
				keys = IntSortedSets.singleton(key, comparator);
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2FloatSortedMap singleton(final Integer key, Float value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2FloatSortedMap singleton(final Integer key, Float value, IntComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2FloatSortedMap singleton(final int key, final float value, IntComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Int2FloatMaps.SynchronizedMap
			implements Int2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2FloatEntrySet(), sync);
			return (ObjectSortedSet<Int2FloatMap.Entry>) entries;
		}
		...
		public IntSortedSet keySet() {
			if (keys == null)
				keys = IntSortedSets.synchronize(sortedMap.keySet(), sync);
			return (IntSortedSet) keys;
		}
	...
	public static class UnmodifiableSortedMap extends Int2FloatMaps.UnmodifiableMap
			implements Int2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2FloatSortedMap sortedMap;
		...
		public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2FloatEntrySet());
			return (ObjectSortedSet<Int2FloatMap.Entry>) entries;
		}
		...
		public IntSortedSet keySet() {
			if (keys == null)
				keys = IntSortedSets.unmodifiable(sortedMap.keySet());
			return (IntSortedSet) keys;
		}
