 ...
 * iterator}.
 */
public class Int2IntAVLTreeMap extends AbstractInt2IntSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Int2IntAVLTreeMap(final Comparator<? super Integer> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Int2IntAVLTreeMap(final Map<? extends Integer, ? extends Integer> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2IntAVLTreeMap(final SortedMap<Integer, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Int2IntAVLTreeMap(final Int2IntMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Int2IntAVLTreeMap(final Int2IntSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Int2IntAVLTreeMap(final int[] k, final int v[], final Comparator<? super Integer> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Int2IntAVLTreeMap(final int[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Int2IntAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
				final Comparator<? super Int2IntMap.Entry> comparator = (Comparator<Int2IntMap.Entry>) (x,
						y) -> Int2IntAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
				...
				public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry to) {
					return subMap(from.getIntKey(), to.getIntKey()).int2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry to) {
					return headMap(to.getIntKey()).int2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from) {
					return tailMap(from.getIntKey()).int2IntEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractInt2IntSortedMap implements java.io.Serializable {
		...
		final boolean in(final int k) {
			return (bottom || Int2IntAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Int2IntAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Int2IntAVLTreeMap.Entry f = findKey(((Integer) (e.getKey())).intValue());
		...
		public boolean containsKey(final int k) {
			return in(k) && Int2IntAVLTreeMap.this.containsKey(k);
		}
		...
		public int get(final int k) {
			final Int2IntAVLTreeMap.Entry e;
			final int kk = k;
		...
		public int put(final int k, final int v) {
			...
			final int oldValue = Int2IntAVLTreeMap.this.put(k, v);
		...
		public int remove(final int k) {
			...
			final int oldValue = Int2IntAVLTreeMap.this.remove(k);
		...
		@Override
		public int firstIntKey() {
			Int2IntAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public int lastIntKey() {
			Int2IntAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Int2IntAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Int2IntAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
