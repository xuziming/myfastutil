...
public final class Int2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator(Int2LongSortedMap map) {
		...
		return entries instanceof Int2LongSortedMap.FastSortedEntrySet
				? ((Int2LongSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Int2LongMaps.EmptyMap
			implements Int2LongSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2LongMaps.Singleton
		...
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2LongMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2LongMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Int2LongMaps.SynchronizedMap
			implements Int2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2LongEntrySet(), sync);
			return (ObjectSortedSet<Int2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2LongMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2LongEntrySet());
			return (ObjectSortedSet<Int2LongMap.Entry>) entries;
		}
