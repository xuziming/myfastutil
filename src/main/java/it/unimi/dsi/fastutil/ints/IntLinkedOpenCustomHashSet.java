...
public class IntLinkedOpenCustomHashSet extends AbstractIntSortedSet implements java.io.Serializable, Cloneable, Hash {
	...
	public IntLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final Collection<? extends Integer> c, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final Collection<? extends Integer> c,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final IntCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final IntCollection c,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final IntIterator i, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final int[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final int[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public IntLinkedOpenCustomHashSet(final int[] a, final float f,
			final it.unimi.dsi.fastutil.ints.IntHash.Strategy strategy) {
