...
public final class IntIndirectHeaps {
	...
	public static int downHeap(final int[] refArray, final int[] heap, final int[] inv, final int size, int i,
	...
	public static int upHeap(final int[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final IntComparator c) {
		assert i < size;
		final int e = heap[i];
		final int E = refArray[e];
	 ...
	 *                 order.
	 */
	public static void makeHeap(final int[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final IntComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final int[] refArray, final int[] heap, final int[] inv, final int size,
			final IntComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
