...
public interface Int2IntSortedMap extends Int2IntMap, SortedMap<Integer, Integer> {
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Int2IntMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Int2IntMap.Entry> fastIterator(Int2IntMap.Entry from);
	}
