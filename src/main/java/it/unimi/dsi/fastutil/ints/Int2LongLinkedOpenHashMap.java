 ...
 * @see HashCommon
 */
public class Int2LongLinkedOpenHashMap extends AbstractInt2LongSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2LongMap.Entry> implements FastSortedEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2LongLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2LongLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Int2LongMap.Entry> iterator(final Int2LongMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Int2LongMap.Entry> fastIterator(final Int2LongMap.Entry from) {
		...
		public void forEach(final Consumer<? super Int2LongMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2LongMap.BasicEntry(key[curr], value[curr]));
			}
		}
