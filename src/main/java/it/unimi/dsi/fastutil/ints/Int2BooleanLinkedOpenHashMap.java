...
public class Int2BooleanLinkedOpenHashMap extends AbstractInt2BooleanSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Int2BooleanMap.Entry>
		...
		@Override
		public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry fromElement,
				Int2BooleanMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Int2BooleanMap.Entry> iterator(final Int2BooleanMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Int2BooleanMap.Entry> fastIterator(final Int2BooleanMap.Entry from) {
		...
		public void forEach(final Consumer<? super Int2BooleanMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractInt2BooleanMap.BasicEntry(key[curr], value[curr]));
			}
		}
