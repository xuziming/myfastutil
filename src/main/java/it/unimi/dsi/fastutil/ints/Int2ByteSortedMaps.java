...
public final class Int2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Int2ByteMap.Entry> fastIterator(Int2ByteSortedMap map) {
		...
		return entries instanceof Int2ByteSortedMap.FastSortedEntrySet
				? ((Int2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Int2ByteMaps.EmptyMap
			implements Int2ByteSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Int2ByteMaps.Singleton
		...
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractInt2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Int2ByteMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Int2ByteMaps.SynchronizedMap
			implements Int2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.int2ByteEntrySet(), sync);
			return (ObjectSortedSet<Int2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Int2ByteMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.int2ByteEntrySet());
			return (ObjectSortedSet<Int2ByteMap.Entry>) entries;
		}
