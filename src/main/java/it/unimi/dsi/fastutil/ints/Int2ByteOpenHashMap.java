 ...
 * @see HashCommon
 */
public class Int2ByteOpenHashMap extends AbstractInt2ByteMap implements java.io.Serializable, Cloneable, Hash {
	 ...
	 * @param f the load factor.
	 */
	public Int2ByteOpenHashMap(final Int2ByteMap m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Int2ByteOpenHashMap(final Int2ByteMap m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	...
	private final class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == (0)))
				return Int2ByteOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			int curr;
			final int[] key = Int2ByteOpenHashMap.this.key;
			int pos;
			// The starting point.
