 ...
 */
public abstract class AbstractInt2ShortMap extends AbstractInt2ShortFunction
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					private final ObjectIterator<Int2ShortMap.Entry> i = Int2ShortMaps
							.fastIterator(AbstractInt2ShortMap.this);
