...
public final class Int2LongFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractInt2LongFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Int2LongFunction singleton(final int key, long value) {
	...
	public static class SynchronizedFunction implements Int2LongFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction extends AbstractInt2LongFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Int2LongFunction function;
	...
	public static class PrimitiveFunction implements Int2LongFunction {
		...
		public long get(int key) {
			Long v = function.apply(Integer.valueOf(key));
			if (v == null)
	...
	public static Int2LongFunction primitive(final java.util.function.Function<? super Integer, ? extends Long> f) {
