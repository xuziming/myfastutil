 ...
 */
public abstract class AbstractInt2LongMap extends AbstractInt2LongFunction
		...
		return new AbstractIntSet() {
			...
			public IntIterator iterator() {
				return new IntIterator() {
					private final ObjectIterator<Int2LongMap.Entry> i = Int2LongMaps
							.fastIterator(AbstractInt2LongMap.this);
