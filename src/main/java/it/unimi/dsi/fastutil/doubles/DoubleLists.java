...
public final class DoubleLists {
	...
	public static class EmptyList extends DoubleCollections.EmptyCollection
			implements DoubleList, RandomAccess, java.io.Serializable, Cloneable {
		...
		@Override
		public void setElements(final double a[]) {
			throw new UnsupportedOperationException();
		}

		@Override
		public void setElements(int index, final double a[]) {
			throw new UnsupportedOperationException();
		}
