 ...
 * iterator}.
 */
public class Double2FloatAVLTreeMap extends AbstractDouble2FloatSortedMap implements java.io.Serializable, Cloneable {
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Double2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>() {
				final Comparator<? super Double2FloatMap.Entry> comparator = (Comparator<Double2FloatMap.Entry>) (x,
						y) -> Double2FloatAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
				...
				@Override
				public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry from,
						Double2FloatMap.Entry to) {
					return subMap(from.getDoubleKey(), to.getDoubleKey()).double2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry to) {
					return headMap(to.getDoubleKey()).double2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry from) {
					return tailMap(from.getDoubleKey()).double2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractDouble2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final double k) {
			return (bottom || Double2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Double2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
		...
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>() {
					...
					@Override
					public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(
							final Double2FloatMap.Entry from) {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Double2FloatAVLTreeMap.Entry f = findKey(((Double) (e.getKey())).doubleValue());
		...
		public boolean containsKey(final double k) {
			return in(k) && Double2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public double firstDoubleKey() {
			Double2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public double lastDoubleKey() {
			Double2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Double2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Double2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
