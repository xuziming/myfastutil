 ...
 * @see HashCommon
 */
public class DoubleOpenCustomHashSet extends AbstractDoubleSet implements java.io.Serializable, Cloneable, Hash {
	...
	public DoubleOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final Collection<? extends Double> c, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final Collection<? extends Double> c,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final DoubleCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final DoubleCollection c,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final DoubleIterator i, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final DoubleIterator i,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final double[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final double[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final double[] a, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleOpenCustomHashSet(final double[] a, final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	private class SetIterator implements DoubleIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				DoubleOpenCustomHashSet.this.key[n] = (0);
			} else if (pos >= 0)
				shiftKeys(last);
			else {
				// We're removing wrapped entries.
				DoubleOpenCustomHashSet.this.remove(wrapped.getDouble(-pos - 1));
	...
	private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
		...
		for (int i = size, pos; i-- != 0;) {
			...
			if ((strategy.equals((k), (0)))) {
				...
				if (!(Double.doubleToLongBits(
						key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode(k))) & mask]) == 0))
