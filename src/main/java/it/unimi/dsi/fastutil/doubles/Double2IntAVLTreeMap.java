 ...
 * iterator}.
 */
public class Double2IntAVLTreeMap extends AbstractDouble2IntSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Double2IntAVLTreeMap(final Comparator<? super Double> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Double2IntAVLTreeMap(final Map<? extends Double, ? extends Integer> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2IntAVLTreeMap(final SortedMap<Double, Integer> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Double2IntAVLTreeMap(final Double2IntMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2IntAVLTreeMap(final Double2IntSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2IntAVLTreeMap(final double[] k, final int v[], final Comparator<? super Double> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Double2IntAVLTreeMap(final double[] k, final int v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Double2IntAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() {
				final Comparator<? super Double2IntMap.Entry> comparator = (Comparator<Double2IntMap.Entry>) (x,
						y) -> Double2IntAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
				...
				public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) {
					return subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) {
					return headMap(to.getDoubleKey()).double2IntEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) {
					return tailMap(from.getDoubleKey()).double2IntEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractDouble2IntSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final double k) {
			return (bottom || Double2IntAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Double2IntAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Integer))
							return false;
						final Double2IntAVLTreeMap.Entry f = findKey(((Double) (e.getKey())).doubleValue());
					...
					@Override
					public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from,
							Double2IntMap.Entry to) {
						return subMap(from.getDoubleKey(), to.getDoubleKey()).double2IntEntrySet();
					}
		...
		public boolean containsKey(final double k) {
			return in(k) && Double2IntAVLTreeMap.this.containsKey(k);
		}
		...
		public int get(final double k) {
			final Double2IntAVLTreeMap.Entry e;
			final double kk = k;
		...
		public int put(final double k, final int v) {
			...
			final int oldValue = Double2IntAVLTreeMap.this.put(k, v);
		...
		public int remove(final double k) {
			...
			final int oldValue = Double2IntAVLTreeMap.this.remove(k);
		...
		@Override
		public double firstDoubleKey() {
			Double2IntAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public double lastDoubleKey() {
			Double2IntAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Double2IntAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Double2IntAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
