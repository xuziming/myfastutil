...
public final class Double2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2ByteMap.Entry> fastIterator(Double2ByteSortedMap map) {
		...
		return entries instanceof Double2ByteSortedMap.FastSortedEntrySet
				? ((Double2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Double2ByteMaps.EmptyMap
			implements Double2ByteSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2ByteMaps.Singleton
		...
		public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2ByteMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Double2ByteMaps.SynchronizedMap
			implements Double2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2ByteEntrySet(), sync);
			return (ObjectSortedSet<Double2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2ByteMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2ByteEntrySet());
			return (ObjectSortedSet<Double2ByteMap.Entry>) entries;
		}
