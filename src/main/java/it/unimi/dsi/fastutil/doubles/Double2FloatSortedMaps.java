...
public final class Double2FloatSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2FloatMap.Entry> fastIterator(Double2FloatSortedMap map) {
		...
		return entries instanceof Double2FloatSortedMap.FastSortedEntrySet
				? ((Double2FloatSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Double2FloatMaps.EmptyMap
			implements Double2FloatSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2FloatMaps.Singleton
		...
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2FloatMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Double2FloatSortedMap singleton(final Double key, Float value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Double2FloatSortedMap singleton(final Double key, Float value, DoubleComparator comparator) {
	...
	public static class SynchronizedSortedMap extends Double2FloatMaps.SynchronizedMap
			implements Double2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2FloatEntrySet(), sync);
			return (ObjectSortedSet<Double2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2FloatMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2FloatEntrySet());
			return (ObjectSortedSet<Double2FloatMap.Entry>) entries;
		}
