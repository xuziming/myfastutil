...
public interface Double2CharMap extends Double2CharFunction, Map<Double, Character> {
	 ...
	 */
	interface FastEntrySet extends ObjectSet<Double2CharMap.Entry> {
		/**
		 ...
		 * @since 8.1.0
		 */
		default void fastForEach(final Consumer<? super Double2CharMap.Entry> consumer) {
			forEach(consumer);
		}
	}
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsent(final double key, final java.util.function.DoubleToIntFunction mappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final double key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final double key,
		...
		if (oldValue == drv && !containsKey(key))
			return drv;
		final Character newValue = remappingFunction.apply(Double.valueOf(key), Character.valueOf(oldValue));
		if (newValue == null) {
			remove(key);
			return drv;
		}
	 ...
	 * @since 8.0.0
	 */
	default char compute(final double key,
			final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Double.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final double key, final char value,
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Double key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Double key,
			final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Double key,
			final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Double key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
