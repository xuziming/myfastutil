...
public final class Double2FloatMaps {
	...
	public static ObjectIterator<Double2FloatMap.Entry> fastIterator(Double2FloatMap map) {
		...
		return entries instanceof Double2FloatMap.FastEntrySet ? ((Double2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2FloatFunctions.EmptyFunction
			implements Double2FloatMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2FloatFunctions.Singleton
		...
		public ObjectSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2FloatFunctions.SynchronizedFunction
			implements Double2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final double key,
		...
		@Override
		public float computeIfAbsentPartial(final double key, final Double2FloatFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfPresent(final double key,
		...
		@Override
		public float compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final double key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Double2FloatFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2FloatMap.Entry> double2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2FloatEntrySet());
			return entries;
		}
