 ...
 *
 */
public class Double2ShortRBTreeMap extends AbstractDouble2ShortSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Double2ShortRBTreeMap(final Comparator<? super Double> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Double2ShortRBTreeMap(final Map<? extends Double, ? extends Short> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2ShortRBTreeMap(final SortedMap<Double, Short> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Double2ShortRBTreeMap(final Double2ShortMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2ShortRBTreeMap(final Double2ShortSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2ShortRBTreeMap(final double[] k, final short v[], final Comparator<? super Double> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Double2ShortRBTreeMap(final double[] k, final short v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Double2ShortRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
				final Comparator<? super Double2ShortMap.Entry> comparator = (Comparator<Double2ShortMap.Entry>) (x,
						y) -> Double2ShortRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
				...
				@Override
				public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from,
						Double2ShortMap.Entry to) {
	...
	private final class Submap extends AbstractDouble2ShortSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2ShortRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Double2ShortRBTreeMap.this.compare(k, to) < 0);
		}
		...
		public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
					...
					@Override
					public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(
							final Double2ShortMap.Entry from) {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Short))
							return false;
						final Double2ShortRBTreeMap.Entry f = findKey(((Double) (e.getKey())).doubleValue());
		...
		public boolean containsKey(final double k) {
			return in(k) && Double2ShortRBTreeMap.this.containsKey(k);
		}
		...
		public short get(final double k) {
			final Double2ShortRBTreeMap.Entry e;
			final double kk = k;
		...
		public short put(final double k, final short v) {
			...
			final short oldValue = Double2ShortRBTreeMap.this.put(k, v);
		...
		public short remove(final double k) {
			...
			final short oldValue = Double2ShortRBTreeMap.this.remove(k);
		...
		@Override
		public double firstDoubleKey() {
			Double2ShortRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public double lastDoubleKey() {
			Double2ShortRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Double2ShortRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Double2ShortRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
