 ...
 * @see HashCommon
 */
public class Double2DoubleLinkedOpenHashMap extends AbstractDouble2DoubleSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2DoubleMap.Entry>
		...
		@Override
		public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry fromElement,
				Double2DoubleMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public void forEach(final Consumer<? super Double2DoubleMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractDouble2DoubleMap.BasicEntry(key[curr], value[curr]));
			}
		}
