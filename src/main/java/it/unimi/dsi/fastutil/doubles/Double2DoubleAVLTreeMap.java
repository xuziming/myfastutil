 ...
 * iterator}.
 */
public class Double2DoubleAVLTreeMap extends AbstractDouble2DoubleSortedMap implements java.io.Serializable, Cloneable {
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Double2DoubleAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
				final Comparator<? super Double2DoubleMap.Entry> comparator = (Comparator<Double2DoubleMap.Entry>) (x,
						y) -> Double2DoubleAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
				...
				@Override
				public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry from,
						Double2DoubleMap.Entry to) {
					return subMap(from.getDoubleKey(), to.getDoubleKey()).double2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry to) {
					return headMap(to.getDoubleKey()).double2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry from) {
					return tailMap(from.getDoubleKey()).double2DoubleEntrySet();
				}
			};
		return entries;
	}
	...
	private final class Submap extends AbstractDouble2DoubleSortedMap implements java.io.Serializable {
		...
		final boolean in(final double k) {
			return (bottom || Double2DoubleAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Double2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
		...
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
					...
					@Override
					public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(
							final Double2DoubleMap.Entry from) {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Double2DoubleAVLTreeMap.Entry f = findKey(((Double) (e.getKey())).doubleValue());
		...
		public boolean containsKey(final double k) {
			return in(k) && Double2DoubleAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public double firstDoubleKey() {
			Double2DoubleAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public double lastDoubleKey() {
			Double2DoubleAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Double2DoubleAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Double2DoubleAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
