	...
	public static class BasicEntry implements Double2DoubleMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			return (Double.doubleToLongBits(this.key) == Double.doubleToLongBits(((Double) (key)).doubleValue()))
					&& (Double.doubleToLongBits(this.value) == Double
		...
		return new AbstractDoubleSet() {
			...
			public DoubleIterator iterator() {
				return new DoubleIterator() {
					private final ObjectIterator<Double2DoubleMap.Entry> i = Double2DoubleMaps
							.fastIterator(AbstractDouble2DoubleMap.this);
