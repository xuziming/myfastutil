...
public final class Double2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator(Double2LongSortedMap map) {
		final ObjectSortedSet<Double2LongMap.Entry> entries = map.double2LongEntrySet();
		return entries instanceof Double2LongSortedMap.FastSortedEntrySet
				? ((Double2LongSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Double2LongMaps.EmptyMap
			implements Double2LongSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2LongMaps.Singleton
		...
		public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2LongMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2LongMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Double, Long>> entrySet() {
			return (ObjectSortedSet) double2LongEntrySet();
		}
	...
	public static class SynchronizedSortedMap extends Double2LongMaps.SynchronizedMap
			implements Double2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2LongEntrySet(), sync);
			return (ObjectSortedSet<Double2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2LongMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2LongEntrySet());
			return (ObjectSortedSet<Double2LongMap.Entry>) entries;
		}
