...
public final class Double2LongMaps {
	...
	public static ObjectIterator<Double2LongMap.Entry> fastIterator(Double2LongMap map) {
		...
		return entries instanceof Double2LongMap.FastEntrySet ? ((Double2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Double2LongFunctions.EmptyFunction
			implements Double2LongMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Double2LongFunctions.Singleton
			implements Double2LongMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2LongFunctions.SynchronizedFunction
			implements Double2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final double key,
		...
		@Override
		public long computeIfPresent(final double key,
		...
		@Override
		public long compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final double key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Double2LongFunctions.UnmodifiableFunction
			implements Double2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2LongMap map;
		protected transient ObjectSet<Double2LongMap.Entry> entries;
		...
		public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2LongEntrySet());
			return entries;
		}
