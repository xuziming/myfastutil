 ...
 * @see HashCommon
 */
public class Double2ShortLinkedOpenHashMap extends AbstractDouble2ShortSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2ShortMap.Entry>
		...
		@Override
		public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry fromElement,
				Double2ShortMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Double.doubleToLongBits(k) == 0))
				return Double2ShortLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2ShortLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Double2ShortMap.Entry> iterator(final Double2ShortMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Double2ShortMap.Entry> fastIterator(final Double2ShortMap.Entry from) {
		...
		public void forEach(final Consumer<? super Double2ShortMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractDouble2ShortMap.BasicEntry(key[curr], value[curr]));
			}
		}
