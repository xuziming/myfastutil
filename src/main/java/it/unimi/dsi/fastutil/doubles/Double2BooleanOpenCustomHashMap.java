...
public class Double2BooleanOpenCustomHashMap extends AbstractDouble2BooleanMap
	...
	public Double2BooleanOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Double2BooleanOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2BooleanOpenCustomHashMap(final Map<? extends Double, ? extends Boolean> m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2BooleanOpenCustomHashMap(final Map<? extends Double, ? extends Boolean> m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2BooleanOpenCustomHashMap(final Double2BooleanMap m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Double2BooleanOpenCustomHashMap(final Double2BooleanMap m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2BooleanOpenCustomHashMap(final double[] k, final boolean[] v, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Double2BooleanOpenCustomHashMap(final double[] k, final boolean[] v,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Double2BooleanOpenCustomHashMap.this.remove(wrapped.getDouble(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Double2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
