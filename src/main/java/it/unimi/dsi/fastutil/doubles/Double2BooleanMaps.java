...
public final class Double2BooleanMaps {
	...
	public static ObjectIterator<Double2BooleanMap.Entry> fastIterator(Double2BooleanMap map) {
		...
		return entries instanceof Double2BooleanMap.FastEntrySet
				? ((Double2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2BooleanFunctions.EmptyFunction
			implements Double2BooleanMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2BooleanFunctions.Singleton
		...
		public ObjectSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2BooleanFunctions.SynchronizedFunction
			implements Double2BooleanMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final double key,
		...
		@Override
		public boolean computeIfPresent(final double key,
		...
		@Override
		public boolean compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final double key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Double key,
	...
	public static class UnmodifiableMap extends Double2BooleanFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2BooleanEntrySet());
			return entries;
		}
