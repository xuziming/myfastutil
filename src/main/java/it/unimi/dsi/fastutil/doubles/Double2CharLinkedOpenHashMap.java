 ...
 * @see HashCommon
 */
public class Double2CharLinkedOpenHashMap extends AbstractDouble2CharSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2CharMap.Entry>
		...
		@Override
		public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry fromElement,
				Double2CharMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Double.doubleToLongBits(k) == 0))
				return Double2CharLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2CharLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Double2CharMap.Entry> iterator(final Double2CharMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Double2CharMap.Entry> fastIterator(final Double2CharMap.Entry from) {
		...
		public void forEach(final Consumer<? super Double2CharMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractDouble2CharMap.BasicEntry(key[curr], value[curr]));
			}
		}
