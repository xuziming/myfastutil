...
public class Double2ObjectAVLTreeMap<V> extends AbstractDouble2ObjectSortedMap<V>
	 ...
	 */
	public Double2ObjectAVLTreeMap(final Comparator<? super Double> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Double2ObjectAVLTreeMap(final Map<? extends Double, ? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2ObjectAVLTreeMap(final SortedMap<Double, V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Double2ObjectAVLTreeMap(final Double2ObjectMap<? extends V> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Double2ObjectAVLTreeMap(final Double2ObjectSortedMap<V> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2ObjectAVLTreeMap(final double[] k, final V v[], final Comparator<? super Double> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Double2ObjectAVLTreeMap(final double[] k, final V v[]) {
		this(k, v, null);
	}
	...
	public boolean containsValue(final Object v) {
		...
		while (j-- != 0) {
			ev = i.next();
			if (java.util.Objects.equals(ev, v))
				return true;
		}
		return false;
	}
	...
	private static final class Entry<V> extends AbstractDouble2ObjectMap.BasicEntry<V> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return (Double.doubleToLongBits(key) == Double.doubleToLongBits((e.getKey()).doubleValue()))
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Double2ObjectAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>() {
				final Comparator<? super Double2ObjectMap.Entry<V>> comparator = (Comparator<Double2ObjectMap.Entry<V>>) (
						x,
						y) -> Double2ObjectAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
				...
				@Override
				public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(
						final Double2ObjectMap.Entry<V> from) {
				...
				public boolean contains(final Object o) {
					...
					if (e.getKey() == null || !(e.getKey() instanceof Double))
						return false;
					final Entry<V> f = findKey(((Double) (e.getKey())).doubleValue());
					return e.equals(f);
				}
				...
				public boolean remove(final Object o) {
					...
					if (e.getKey() == null || !(e.getKey() instanceof Double))
						return false;
					final Entry<V> f = findKey(((Double) (e.getKey())).doubleValue());
					if (f == null || !java.util.Objects.equals(f.getValue(), (e.getValue())))
						return false;
				...
				@Override
				public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from,
						Double2ObjectMap.Entry<V> to) {
					return subMap(from.getDoubleKey(), to.getDoubleKey()).double2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) {
					return headMap(to.getDoubleKey()).double2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) {
					return tailMap(from.getDoubleKey()).double2ObjectEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractDouble2ObjectSortedMap<V> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final double k) {
			return (bottom || Double2ObjectAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Double2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Double))
							return false;
						final Double2ObjectAVLTreeMap.Entry<V> f = findKey(((Double) (e.getKey())).doubleValue());
		...
		public boolean containsKey(final double k) {
			return in(k) && Double2ObjectAVLTreeMap.this.containsKey(k);
		}
		...
		public V get(final double k) {
			final Double2ObjectAVLTreeMap.Entry<V> e;
			final double kk = k;
		...
		public V put(final double k, final V v) {
			...
			final V oldValue = Double2ObjectAVLTreeMap.this.put(k, v);
		...
		public V remove(final double k) {
			...
			final V oldValue = Double2ObjectAVLTreeMap.this.remove(k);
		...
		@Override
		public double firstDoubleKey() {
			Double2ObjectAVLTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public double lastDoubleKey() {
			Double2ObjectAVLTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Double2ObjectAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Double2ObjectAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Double2ObjectAVLTreeMap<V> clone() {
		...
		try {
			c = (Double2ObjectAVLTreeMap<V>) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
	...
	private Entry<V> readTree(final java.io.ObjectInputStream s, final int n, final Entry<V> pred, final Entry<V> succ)
		...
		if (n == 1) {
			final Entry<V> top = new Entry<>(s.readDouble(), (V) s.readObject());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
		if (n == 2) {
			 ...
			 */
			final Entry<V> top = new Entry<>(s.readDouble(), (V) s.readObject());
			top.right(new Entry<>(s.readDouble(), (V) s.readObject()));
			top.right.pred(top);
			top.balance(1);
			top.pred(pred);
			top.right.succ(succ);
