...
public final class DoubleIndirectHeaps {
	...
	public static int upHeap(final double[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final DoubleComparator c) {
		assert i < size;
		final int e = heap[i];
		final double E = refArray[e];
	...
	public static void makeHeap(final double[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final DoubleComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final double[] refArray, final int[] heap, final int[] inv, final int size,
			final DoubleComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
