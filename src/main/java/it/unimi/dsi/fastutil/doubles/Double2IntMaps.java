...
public final class Double2IntMaps {
	...
	public static ObjectIterator<Double2IntMap.Entry> fastIterator(Double2IntMap map) {
		...
		return entries instanceof Double2IntMap.FastEntrySet ? ((Double2IntMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Double2IntMap map, final Consumer<? super Double2IntMap.Entry> consumer) {
		final ObjectSet<Double2IntMap.Entry> entries = map.double2IntEntrySet();
	...
	public static class EmptyMap extends Double2IntFunctions.EmptyFunction
			implements Double2IntMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2IntFunctions.Singleton
		...
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2IntFunctions.SynchronizedFunction
			implements Double2IntMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Double, ? super Integer> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final double key, final java.util.function.DoubleToIntFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final double key,
		...
		@Override
		public int computeIfPresent(final double key,
		...
		@Override
		public int compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int merge(final double key, final int value,
		...
		@Deprecated
		@Override
		public Integer computeIfAbsent(final Double key,
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Double key,
				final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer compute(final Double key,
				final java.util.function.BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer merge(final Double key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Double2IntFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2IntEntrySet());
			return entries;
		}
