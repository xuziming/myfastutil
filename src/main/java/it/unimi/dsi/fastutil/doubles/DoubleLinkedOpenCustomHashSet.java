 ...
 * @see HashCommon
 */
public class DoubleLinkedOpenCustomHashSet extends AbstractDoubleSortedSet
	...
	public DoubleLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final Collection<? extends Double> c, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final Collection<? extends Double> c,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final DoubleCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final DoubleCollection c,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final DoubleIterator i, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final DoubleIterator i,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final double[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final double[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final double[] a, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public DoubleLinkedOpenCustomHashSet(final double[] a,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	private class SetIterator implements DoubleListIterator {
		...
		public double nextDouble() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !(Double.doubleToLongBits(key[curr]) == 0) : "Position " + curr + " is not used";
			return key[curr];
		}
		...
		public void remove() {
			...
			if (pos == n) {
				...
				DoubleLinkedOpenCustomHashSet.this.key[n] = (0);
			} else {
				double curr;
				final double[] key = DoubleLinkedOpenCustomHashSet.this.key;
