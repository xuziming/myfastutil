...
public final class Double2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2ShortMap.Entry> fastIterator(Double2ShortSortedMap map) {
		...
		return entries instanceof Double2ShortSortedMap.FastSortedEntrySet
				? ((Double2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Double2ShortMaps.EmptyMap
			implements Double2ShortSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2ShortMaps.Singleton
		...
		public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2ShortMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Double2ShortMaps.SynchronizedMap
			implements Double2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2ShortEntrySet(), sync);
			return (ObjectSortedSet<Double2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2ShortMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2ShortEntrySet());
			return (ObjectSortedSet<Double2ShortMap.Entry>) entries;
		}
