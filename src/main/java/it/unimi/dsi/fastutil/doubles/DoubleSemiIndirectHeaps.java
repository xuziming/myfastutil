...
public final class DoubleSemiIndirectHeaps {
	...
	public static int downHeap(final double[] refArray, final int[] heap, final int size, int i,
	...
	public static int upHeap(final double[] refArray, final int[] heap, final int size, int i,
			final DoubleComparator c) {
		assert i < size;
		final int e = heap[i];
		final double E = refArray[e];
	 ...
	 *                 order.
	 */
	public static void makeHeap(final double[] refArray, final int offset, final int length, final int[] heap,
			final DoubleComparator c) {
	 ...
	 */
	public static int[] makeHeap(final double[] refArray, final int offset, final int length,
			final DoubleComparator c) {
