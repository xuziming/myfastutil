...
public final class Double2CharMaps {
	...
	public static ObjectIterator<Double2CharMap.Entry> fastIterator(Double2CharMap map) {
		...
		return entries instanceof Double2CharMap.FastEntrySet ? ((Double2CharMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2CharFunctions.EmptyFunction
			implements Double2CharMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2CharFunctions.Singleton
		...
		public ObjectSet<Double2CharMap.Entry> double2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2CharMap.BasicEntry(key, value));
			return entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Double2CharMap singleton(final double key, char value) {
	...
	public static class SynchronizedMap extends Double2CharFunctions.SynchronizedFunction
			implements Double2CharMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2CharMap.Entry> double2CharEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2CharEntrySet(), sync);
				return entries;
			}
		}
		...
		public DoubleSet keySet() {
			synchronized (sync) {
				if (keys == null)
					keys = DoubleSets.synchronize(map.keySet(), sync);
				return keys;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Double, ? super Character> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> function) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsent(final double key, final java.util.function.DoubleToIntFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char computeIfAbsentNullable(final double key,
		...
		@Override
		public char computeIfPresent(final double key,
		...
		@Override
		public char compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public char merge(final double key, final char value,
		...
		@Deprecated
		@Override
		public Character computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends Character> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Character computeIfPresent(final Double key,
				final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character compute(final Double key,
				final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Character merge(final Double key, final Character value,
				final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Double2CharFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2CharMap.Entry> double2CharEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2CharEntrySet());
			return entries;
		}
		...
		public DoubleSet keySet() {
			if (keys == null)
				keys = DoubleSets.unmodifiable(map.keySet());
			return keys;
		}
