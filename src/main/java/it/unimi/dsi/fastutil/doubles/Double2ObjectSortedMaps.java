...
public final class Double2ObjectSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> fastIterator(
		...
		return entries instanceof Double2ObjectSortedMap.FastSortedEntrySet
				? ((Double2ObjectSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Double2ObjectMap.Entry<V>> fastIterable(
			Double2ObjectSortedMap<V> map) {
		final ObjectSortedSet<Double2ObjectMap.Entry<V>> entries = map.double2ObjectEntrySet();
		return entries instanceof Double2ObjectSortedMap.FastSortedEntrySet
				? ((Double2ObjectSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	 ...
	 */
	public static class EmptySortedMap<V> extends Double2ObjectMaps.EmptyMap<V>
			implements Double2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton<V> extends Double2ObjectMaps.Singleton<V>
			implements Double2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2ObjectMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Double2ObjectMaps.SynchronizedMap<V>
			implements Double2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Double2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Double2ObjectMaps.UnmodifiableMap<V>
			implements Double2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2ObjectSortedMap<V> sortedMap;
		...
		public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2ObjectEntrySet());
			return (ObjectSortedSet<Double2ObjectMap.Entry<V>>) entries;
		}
