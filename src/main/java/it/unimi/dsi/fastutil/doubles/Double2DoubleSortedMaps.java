...
public final class Double2DoubleSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2DoubleMap.Entry> fastIterator(Double2DoubleSortedMap map) {
		...
		return entries instanceof Double2DoubleSortedMap.FastSortedEntrySet
				? ((Double2DoubleSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Double2DoubleMaps.EmptyMap
			implements Double2DoubleSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2DoubleMaps.Singleton
		...
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2DoubleMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Double2DoubleMaps.SynchronizedMap
			implements Double2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Double2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Double2DoubleMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2DoubleEntrySet());
			return (ObjectSortedSet<Double2DoubleMap.Entry>) entries;
		}
