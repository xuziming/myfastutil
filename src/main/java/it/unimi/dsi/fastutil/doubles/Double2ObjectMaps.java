...
public final class Double2ObjectMaps {
	...
	public static <V> ObjectIterator<Double2ObjectMap.Entry<V>> fastIterator(Double2ObjectMap<V> map) {
		...
		return entries instanceof Double2ObjectMap.FastEntrySet
				? ((Double2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Double2ObjectMap<V> map,
			final Consumer<? super Double2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Double2ObjectMap.Entry<V>> entries = map.double2ObjectEntrySet();
		if (entries instanceof Double2ObjectMap.FastEntrySet)
			((Double2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Double2ObjectMap.Entry<V>> fastIterable(Double2ObjectMap<V> map) {
		...
		return entries instanceof Double2ObjectMap.FastEntrySet ? new ObjectIterable<Double2ObjectMap.Entry<V>>() {
			public ObjectIterator<Double2ObjectMap.Entry<V>> iterator() {
				return ((Double2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Double2ObjectFunctions.EmptyFunction<V>
			implements Double2ObjectMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Double2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Double2ObjectFunctions.SynchronizedFunction<V>
			implements Double2ObjectMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2ObjectEntrySet(), sync);
				return entries;
			}
		}
