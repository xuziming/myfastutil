...
public interface Double2ReferenceSortedMap<V> extends Double2ReferenceMap<V>, SortedMap<Double, V> {
	 ...
	 */
	Double2ReferenceSortedMap<V> subMap(double fromKey, double toKey);
	 ...
	 */
	Double2ReferenceSortedMap<V> headMap(double toKey);
	 ...
	 */
	Double2ReferenceSortedMap<V> tailMap(double fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Double2ReferenceMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> fastIterator(Double2ReferenceMap.Entry<V> from);
	}
