 ...
 */
public class Double2DoubleArrayMap extends AbstractDouble2DoubleMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Double2DoubleMap.Entry> iterator() {
			return new ObjectIterator<Double2DoubleMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractDouble2DoubleMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Double2DoubleArrayMap.this.containsKey(k)
					&& (Double.doubleToLongBits(Double2DoubleArrayMap.this.get(k)) == Double
		...
		public boolean remove(final Object o) {
			...
			if (oldPos == -1 || !(Double.doubleToLongBits(v) == Double
					.doubleToLongBits(Double2DoubleArrayMap.this.value[oldPos])))
				return false;
			final int tail = size - oldPos - 1;
			System.arraycopy(Double2DoubleArrayMap.this.key, oldPos + 1, Double2DoubleArrayMap.this.key, oldPos, tail);
			System.arraycopy(Double2DoubleArrayMap.this.value, oldPos + 1, Double2DoubleArrayMap.this.value, oldPos,
					tail);
