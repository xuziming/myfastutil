...
public class Double2CharOpenCustomHashMap extends AbstractDouble2CharMap
	...
	public Double2CharOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final Map<? extends Double, ? extends Character> m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final Map<? extends Double, ? extends Character> m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final Double2CharMap m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Double2CharOpenCustomHashMap(final Double2CharMap m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2CharOpenCustomHashMap(final double[] k, final char[] v, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Double2CharOpenCustomHashMap(final double[] k, final char[] v,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final double k,
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final double k,
			final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final double k,
			final java.util.function.BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Character newValue = remappingFunction.apply(Double.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final double k, final char v,
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final double key[] = Double2CharOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Double2CharOpenCustomHashMap.this.remove(wrapped.getDouble(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2CharMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Double2CharOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2CharOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Double2CharMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractDouble2CharMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!(Double.doubleToLongBits(key[pos]) == 0))
					consumer.accept(new AbstractDouble2CharMap.BasicEntry(key[pos], value[pos]));
		}
