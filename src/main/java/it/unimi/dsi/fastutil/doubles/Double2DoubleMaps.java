...
public final class Double2DoubleMaps {
	...
	public static ObjectIterator<Double2DoubleMap.Entry> fastIterator(Double2DoubleMap map) {
		...
		return entries instanceof Double2DoubleMap.FastEntrySet
				? ((Double2DoubleMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2DoubleFunctions.EmptyFunction
			implements Double2DoubleMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2DoubleFunctions.Singleton
		...
		public ObjectSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2DoubleMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2DoubleFunctions.SynchronizedFunction
			implements Double2DoubleMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final double key,
		...
		@Override
		public double computeIfPresent(final double key,
		...
		@Override
		public double compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double merge(final double key, final double value,
				final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Double computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends Double> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Double2DoubleFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2DoubleEntrySet());
			return entries;
		}
