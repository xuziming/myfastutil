 ...
 * @see HashCommon
 */
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap
	...
	public Double2FloatOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final Map<? extends Double, ? extends Float> m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final Map<? extends Double, ? extends Float> m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final Double2FloatMap m, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Double2FloatOpenCustomHashMap(final Double2FloatMap m,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Double2FloatOpenCustomHashMap(final double[] k, final float[] v, final float f,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Double2FloatOpenCustomHashMap(final double[] k, final float[] v,
			final it.unimi.dsi.fastutil.doubles.DoubleHash.Strategy strategy) {
	...
	public float computeIfPresent(final double k,
			final java.util.function.BiFunction<? super Double, ? super Float, ? extends Float> remappingFunction) {
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Double2FloatOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final double key[] = Double2FloatOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Double2FloatOpenCustomHashMap.this.remove(wrapped.getDouble(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), (0))))
				return Double2FloatOpenCustomHashMap.this.containsNullKey
		...
		public void forEach(final Consumer<? super Double2FloatMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractDouble2FloatMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!(Double.doubleToLongBits(key[pos]) == 0))
					consumer.accept(new AbstractDouble2FloatMap.BasicEntry(key[pos], value[pos]));
		}
