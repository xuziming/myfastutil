...
public final class Double2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Double2IntMap.Entry> fastIterator(Double2IntSortedMap map) {
		...
		return entries instanceof Double2IntSortedMap.FastSortedEntrySet
				? ((Double2IntSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Double2IntMaps.EmptyMap
			implements Double2IntSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Double2IntMaps.Singleton
			implements Double2IntSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2IntMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2IntMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Double2IntMaps.SynchronizedMap
		...
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2IntEntrySet(), sync);
			return (ObjectSortedSet<Double2IntMap.Entry>) entries;
		}
	 ...
	 */
	public static Double2IntSortedMap synchronize(final Double2IntSortedMap m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static Double2IntSortedMap synchronize(final Double2IntSortedMap m, final Object sync) {
		return new SynchronizedSortedMap(m, sync);
	}

	/** An unmodifiable wrapper class for sorted maps. */
	public static class UnmodifiableSortedMap extends Double2IntMaps.UnmodifiableMap
			implements Double2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2IntSortedMap sortedMap;
		...
		public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2IntEntrySet());
			return (ObjectSortedSet<Double2IntMap.Entry>) entries;
		}
	 ...
	 */
	public static Double2IntSortedMap unmodifiable(final Double2IntSortedMap m) {
