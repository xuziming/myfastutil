...
public final class Double2ShortMaps {
	...
	public static ObjectIterator<Double2ShortMap.Entry> fastIterator(Double2ShortMap map) {
		...
		return entries instanceof Double2ShortMap.FastEntrySet ? ((Double2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2ShortFunctions.EmptyFunction
			implements Double2ShortMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2ShortFunctions.Singleton
		...
		public ObjectSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2ShortFunctions.SynchronizedFunction
			implements Double2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final double key,
		...
		@Override
		public short computeIfPresent(final double key,
		...
		@Override
		public short compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final double key, final short value,
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Double key,
	...
	public static class UnmodifiableMap extends Double2ShortFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2ShortMap.Entry> double2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2ShortEntrySet());
			return entries;
		}
