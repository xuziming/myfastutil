...
public class Double2BooleanLinkedOpenHashMap extends AbstractDouble2BooleanSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2BooleanMap.Entry>
		...
		@Override
		public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry fromElement,
				Double2BooleanMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Double.doubleToLongBits(k) == 0))
				return Double2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Double2BooleanMap.Entry> iterator(final Double2BooleanMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Double2BooleanMap.Entry> fastIterator(final Double2BooleanMap.Entry from) {
		...
		public void forEach(final Consumer<? super Double2BooleanMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractDouble2BooleanMap.BasicEntry(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet double2BooleanEntrySet() {
		if (entries == null)
