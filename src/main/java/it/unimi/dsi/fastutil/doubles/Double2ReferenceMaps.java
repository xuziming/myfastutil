...
public final class Double2ReferenceMaps {
	...
	public static <V> ObjectIterator<Double2ReferenceMap.Entry<V>> fastIterator(Double2ReferenceMap<V> map) {
		...
		return entries instanceof Double2ReferenceMap.FastEntrySet
				? ((Double2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Double2ReferenceMap<V> map,
			final Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Double2ReferenceMap.Entry<V>> entries = map.double2ReferenceEntrySet();
	...
	public static class EmptyMap<V> extends Double2ReferenceFunctions.EmptyFunction<V>
			implements Double2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Double2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Double2ReferenceFunctions.SynchronizedFunction<V>
			implements Double2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2ReferenceEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public V computeIfAbsent(final double key,
		...
		@Override
		public V computeIfAbsentPartial(final double key, final Double2ReferenceFunction<? extends V> mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V computeIfPresent(final double key,
		...
		@Override
		public V compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V merge(final double key, final V value,
		...
		@Override
		public V computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<V> extends Double2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2ReferenceEntrySet());
			return entries;
		}
