...
public final class Double2ReferenceSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> fastIterator(
			Double2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Double2ReferenceMap.Entry<V>> entries = map.double2ReferenceEntrySet();
		return entries instanceof Double2ReferenceSortedMap.FastSortedEntrySet
				? ((Double2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Double2ReferenceMap.Entry<V>> fastIterable(
			Double2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Double2ReferenceMap.Entry<V>> entries = map.double2ReferenceEntrySet();
		return entries instanceof Double2ReferenceSortedMap.FastSortedEntrySet
				? ((Double2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	...
	public static class EmptySortedMap<V> extends Double2ReferenceMaps.EmptyMap<V>
			implements Double2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Double2ReferenceMaps.Singleton<V>
		...
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Double2ReferenceMaps.SynchronizedMap<V>
			implements Double2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Double2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Double2ReferenceMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2ReferenceEntrySet());
			return (ObjectSortedSet<Double2ReferenceMap.Entry<V>>) entries;
		}
