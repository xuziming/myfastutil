...
public final class Double2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<V> extends AbstractDouble2ReferenceFunction<V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<V> extends AbstractDouble2ReferenceFunction<V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Double2ReferenceFunction<V> singleton(final double key, V value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Double2ReferenceFunction<V> singleton(final Double key, final V value) {
		return new Singleton<>((key).doubleValue(), (value));
	}

	/** A synchronized wrapper class for functions. */
	public static class SynchronizedFunction<V> implements Double2ReferenceFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2ReferenceFunction<V> function;
		protected final Object sync;

		protected SynchronizedFunction(final Double2ReferenceFunction<V> f, final Object sync) {
			if (f == null)
		...
		protected SynchronizedFunction(final Double2ReferenceFunction<V> f) {
			if (f == null)
				throw new NullPointerException();
			this.function = f;
			this.sync = this;
	 ...
	 */
	public static <V> Double2ReferenceFunction<V> synchronize(final Double2ReferenceFunction<V> f) {
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Double2ReferenceFunction<V> synchronize(final Double2ReferenceFunction<V> f, final Object sync) {
		return new SynchronizedFunction<>(f, sync);
	}

	/** An unmodifiable wrapper class for functions. */
	public static class UnmodifiableFunction<V> extends AbstractDouble2ReferenceFunction<V>
			implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2ReferenceFunction<V> function;

		protected UnmodifiableFunction(final Double2ReferenceFunction<V> f) {
			if (f == null)
				throw new NullPointerException();
			this.function = f;
		}
	 ...
	 */
	public static <V> Double2ReferenceFunction<V> unmodifiable(final Double2ReferenceFunction<V> f) {
	...
	public static <V> Double2ReferenceFunction<V> primitive(
