 ...
 * @see HashCommon
 */
public class Double2ByteLinkedOpenHashMap extends AbstractDouble2ByteSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Double2ByteMap.Entry>
		...
		@Override
		public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry fromElement,
				Double2ByteMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if ((Double.doubleToLongBits(k) == 0))
				return Double2ByteLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			double curr;
			final double[] key = Double2ByteLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Double2ByteMap.Entry> iterator(final Double2ByteMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Double2ByteMap.Entry> fastIterator(final Double2ByteMap.Entry from) {
		...
		public void forEach(final Consumer<? super Double2ByteMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractDouble2ByteMap.BasicEntry(key[curr], value[curr]));
			}
		}
