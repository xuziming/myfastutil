...
public final class Double2ByteMaps {
	...
	public static ObjectIterator<Double2ByteMap.Entry> fastIterator(Double2ByteMap map) {
		...
		return entries instanceof Double2ByteMap.FastEntrySet ? ((Double2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Double2ByteFunctions.EmptyFunction
			implements Double2ByteMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Double2ByteFunctions.Singleton
		...
		public ObjectSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractDouble2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Double2ByteFunctions.SynchronizedFunction
			implements Double2ByteMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.double2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Double, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Double, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final double key, final java.util.function.DoubleToIntFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final double key,
		...
		@Override
		public byte computeIfPresent(final double key,
		...
		@Override
		public byte compute(final double key,
				final java.util.function.BiFunction<? super Double, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final double key, final byte value,
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Double key,
				final java.util.function.Function<? super Double, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Double2ByteFunctions.UnmodifiableFunction
		...
		public ObjectSet<Double2ByteMap.Entry> double2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.double2ByteEntrySet());
			return entries;
		}
