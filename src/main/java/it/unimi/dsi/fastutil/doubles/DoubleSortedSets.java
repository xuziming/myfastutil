...
public final class DoubleSortedSets {
	...
	public static class EmptySet extends DoubleSets.EmptySet
			implements DoubleSortedSet, java.io.Serializable, Cloneable {
	...
	public static class UnmodifiableSortedSet extends DoubleSets.UnmodifiableSet
		...
		@Override
		public DoubleBidirectionalIterator iterator() {
			return DoubleIterators.unmodifiable(sortedSet.iterator());
		}

		@Override
		public DoubleBidirectionalIterator iterator(final double from) {
			return DoubleIterators.unmodifiable(sortedSet.iterator(from));
		}
