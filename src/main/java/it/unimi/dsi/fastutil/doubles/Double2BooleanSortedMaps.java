...
public final class Double2BooleanSortedMaps {
	...
	public static Comparator<? super Map.Entry<Double, ?>> entryComparator(final DoubleComparator comparator) {
		return (Comparator<Map.Entry<Double, ?>>) (x, y) -> comparator.compare((x.getKey()).doubleValue(),
				(y.getKey()).doubleValue());
	}
	...
	public static ObjectBidirectionalIterator<Double2BooleanMap.Entry> fastIterator(Double2BooleanSortedMap map) {
		...
		return entries instanceof Double2BooleanSortedMap.FastSortedEntrySet
				? ((Double2BooleanSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Double2BooleanMaps.EmptyMap
			implements Double2BooleanSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Double2BooleanMaps.Singleton
			implements Double2BooleanSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final DoubleComparator comparator;

		protected Singleton(final double key, final boolean value, DoubleComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractDouble2BooleanMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Double2BooleanMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Double, Boolean>> entrySet() {
			return (ObjectSortedSet) double2BooleanEntrySet();
		}

		@Override
		public DoubleSortedSet keySet() {
			if (keys == null)
				keys = DoubleSortedSets.singleton(key, comparator);
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Double2BooleanSortedMap singleton(final Double key, Boolean value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Double2BooleanSortedMap singleton(final Double key, Boolean value, DoubleComparator comparator) {
	...
	public static class SynchronizedSortedMap extends Double2BooleanMaps.SynchronizedMap
		...
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.double2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Double2BooleanMap.Entry>) entries;
		}
		...
		public DoubleSortedSet keySet() {
			if (keys == null)
				keys = DoubleSortedSets.synchronize(sortedMap.keySet(), sync);
			return (DoubleSortedSet) keys;
		}
	...
	public static class UnmodifiableSortedMap extends Double2BooleanMaps.UnmodifiableMap
			implements Double2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Double2BooleanSortedMap sortedMap;
		...
		public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.double2BooleanEntrySet());
			return (ObjectSortedSet<Double2BooleanMap.Entry>) entries;
		}
		...
		public DoubleSortedSet keySet() {
			if (keys == null)
				keys = DoubleSortedSets.unmodifiable(sortedMap.keySet());
			return (DoubleSortedSet) keys;
		}
