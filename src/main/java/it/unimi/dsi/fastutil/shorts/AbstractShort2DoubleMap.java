...
public abstract class AbstractShort2DoubleMap extends AbstractShort2DoubleFunction
	...
	public boolean containsKey(final short k) {
		final ObjectIterator<Short2DoubleMap.Entry> i = short2DoubleEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Short2DoubleMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (value == null || !(value instanceof Double))
				return false;
			return ((this.key) == (((Short) (key)).shortValue())) && (Double.doubleToLongBits(this.value) == Double
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public BasicEntrySet(final Short2DoubleMap map) {
			this.map = map;
		}
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Short2DoubleMap.Entry) {
				final Short2DoubleMap.Entry e = (Short2DoubleMap.Entry) o;
				return map.remove(e.getShortKey(), e.getDoubleValue());
			}
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					private final ObjectIterator<Short2DoubleMap.Entry> i = Short2DoubleMaps
							.fastIterator(AbstractShort2DoubleMap.this);
	...
	public void putAll(final Map<? extends Short, ? extends Double> m) {
		if (m instanceof Short2DoubleMap) {
			...
			while (i.hasNext()) {
				final Short2DoubleMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Short2DoubleMap.Entry> i = Short2DoubleMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
	...
	public boolean equals(Object o) {
		...
		if (m.size() != size())
			return false;
		return short2DoubleEntrySet().containsAll(m.entrySet());
	}
