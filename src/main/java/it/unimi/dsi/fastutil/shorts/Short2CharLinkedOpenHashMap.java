 ...
 * @see HashCommon
 */
public class Short2CharLinkedOpenHashMap extends AbstractShort2CharSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2CharMap.Entry> implements FastSortedEntrySet {
		...
		@Override
		public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry fromElement,
				Short2CharMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2CharLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2CharLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
