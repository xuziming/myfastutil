...
public interface Short2LongSortedMap extends Short2LongMap, SortedMap<Short, Long> {
	 ...
	 */
	Short2LongSortedMap subMap(short fromKey, short toKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Short2LongMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Short2LongMap.Entry> fastIterator(Short2LongMap.Entry from);
	}
