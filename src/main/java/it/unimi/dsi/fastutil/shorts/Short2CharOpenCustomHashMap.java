...
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap
	...
	public Short2CharOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final Map<? extends Short, ? extends Character> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final Map<? extends Short, ? extends Character> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final Short2CharMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2CharOpenCustomHashMap(final Short2CharMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2CharOpenCustomHashMap(final short[] k, final char[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2CharOpenCustomHashMap(final short[] k, final char[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfAbsentNullable(final short k,
	...
	/** {@inheritDoc} */
	@Override
	public char computeIfPresent(final short k,
			final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public char compute(final short k,
			final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Character newValue = remappingFunction.apply(Short.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public char merge(final short k, final char v,
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2CharOpenCustomHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((short) 0))))
				return Short2CharOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2CharOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2CharMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2CharMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2CharMap.BasicEntry(key[pos], value[pos]));
		}
