...
public final class Short2ShortSortedMaps {
	...
	public static ObjectBidirectionalIterator<Short2ShortMap.Entry> fastIterator(Short2ShortSortedMap map) {
		...
		return entries instanceof Short2ShortSortedMap.FastSortedEntrySet
				? ((Short2ShortSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Short2ShortMaps.EmptyMap
			implements Short2ShortSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Short2ShortMaps.Singleton
			implements Short2ShortSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2ShortMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Short2ShortMaps.SynchronizedMap
			implements Short2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2ShortEntrySet(), sync);
			return (ObjectSortedSet<Short2ShortMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2ShortMaps.UnmodifiableMap
			implements Short2ShortSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2ShortSortedMap sortedMap;
		...
		public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2ShortEntrySet());
			return (ObjectSortedSet<Short2ShortMap.Entry>) entries;
		}
