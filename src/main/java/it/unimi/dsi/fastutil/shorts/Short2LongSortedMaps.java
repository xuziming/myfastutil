...
public final class Short2LongSortedMaps {
	...
	public static ObjectBidirectionalIterator<Short2LongMap.Entry> fastIterator(Short2LongSortedMap map) {
		...
		return entries instanceof Short2LongSortedMap.FastSortedEntrySet
	...
	public static class EmptySortedMap extends Short2LongMaps.EmptyMap
			implements Short2LongSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2LongMaps.Singleton
		...
		public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2LongMap.BasicEntry(key, value),
	...
	public static class SynchronizedSortedMap extends Short2LongMaps.SynchronizedMap
			implements Short2LongSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2LongEntrySet(), sync);
			return (ObjectSortedSet<Short2LongMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2LongMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2LongEntrySet());
			return (ObjectSortedSet<Short2LongMap.Entry>) entries;
		}
