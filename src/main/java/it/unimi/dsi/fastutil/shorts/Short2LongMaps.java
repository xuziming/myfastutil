...
public final class Short2LongMaps {
	...
	public static ObjectIterator<Short2LongMap.Entry> fastIterator(Short2LongMap map) {
		...
		return entries instanceof Short2LongMap.FastEntrySet ? ((Short2LongMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Short2LongFunctions.EmptyFunction
			implements Short2LongMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Short2LongFunctions.Singleton
			implements Short2LongMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2LongMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2LongFunctions.SynchronizedFunction
			implements Short2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2LongEntrySet(), sync);
				return entries;
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Long, ? extends Long> function) {
			synchronized (sync) {
		...
		@Override
		public long computeIfAbsentNullable(final short key,
		...
		@Override
		public long computeIfAbsentPartial(final short key, final Short2LongFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long computeIfPresent(final short key,
		...
		@Override
		public long compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Long, ? extends Long> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public long merge(final short key, final long value,
		...
		@Deprecated
		@Override
		public Long computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Long> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2LongFunctions.UnmodifiableFunction
			implements Short2LongMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2LongMap map;
		protected transient ObjectSet<Short2LongMap.Entry> entries;
		...
		public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2LongEntrySet());
			return entries;
		}
