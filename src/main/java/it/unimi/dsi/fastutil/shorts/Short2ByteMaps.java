...
public final class Short2ByteMaps {
	...
	public static ObjectIterator<Short2ByteMap.Entry> fastIterator(Short2ByteMap map) {
		...
		return entries instanceof Short2ByteMap.FastEntrySet ? ((Short2ByteMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Short2ByteMap map, final Consumer<? super Short2ByteMap.Entry> consumer) {
		final ObjectSet<Short2ByteMap.Entry> entries = map.short2ByteEntrySet();
	...
	public static class EmptyMap extends Short2ByteFunctions.EmptyFunction
			implements Short2ByteMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2ByteFunctions.Singleton
		...
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2ByteMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2ByteFunctions.SynchronizedFunction
		...
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2ByteEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Byte> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> function) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsent(final short key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte computeIfAbsentNullable(final short key,
		...
		@Override
		public byte computeIfPresent(final short key,
		...
		@Override
		public byte compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Byte, ? extends Byte> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public byte merge(final short key, final byte value,
		...
		@Deprecated
		@Override
		public Byte computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Byte> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2ByteFunctions.UnmodifiableFunction
		...
		public ObjectSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2ByteEntrySet());
			return entries;
		}
