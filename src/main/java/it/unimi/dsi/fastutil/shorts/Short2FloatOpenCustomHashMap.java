 ...
 * @see HashCommon
 */
public class Short2FloatOpenCustomHashMap extends AbstractShort2FloatMap
	...
	public Short2FloatOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2FloatOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2FloatOpenCustomHashMap(final Map<? extends Short, ? extends Float> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2FloatOpenCustomHashMap(final Map<? extends Short, ? extends Float> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2FloatOpenCustomHashMap(final Short2FloatMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2FloatOpenCustomHashMap(final Short2FloatMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2FloatOpenCustomHashMap(final short[] k, final float[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2FloatOpenCustomHashMap(final short[] k, final float[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
