...
public interface Short2ShortSortedMap extends Short2ShortMap, SortedMap<Short, Short> {
	 ...
	 */
	Short2ShortSortedMap subMap(short fromKey, short toKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Short2ShortMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Short2ShortMap.Entry> fastIterator(Short2ShortMap.Entry from);
	}
