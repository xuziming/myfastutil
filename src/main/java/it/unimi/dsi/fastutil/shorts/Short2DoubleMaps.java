...
public final class Short2DoubleMaps {
	...
	public static ObjectIterator<Short2DoubleMap.Entry> fastIterator(Short2DoubleMap map) {
		...
		return entries instanceof Short2DoubleMap.FastEntrySet ? ((Short2DoubleMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptyMap extends Short2DoubleFunctions.EmptyFunction
			implements Short2DoubleMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2DoubleFunctions.Singleton
		...
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2DoubleMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2DoubleFunctions.SynchronizedFunction
			implements Short2DoubleMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2DoubleEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Double> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Double, ? extends Double> function) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsent(final short key, final java.util.function.IntToDoubleFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double computeIfAbsentNullable(final short key,
		...
		@Override
		public double computeIfPresent(final short key,
		...
		@Override
		public double compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Double, ? extends Double> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public double merge(final short key, final double value,
		...
		@Deprecated
		@Override
		public Double computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Double> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2DoubleFunctions.UnmodifiableFunction
		...
		public ObjectSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2DoubleEntrySet());
			return entries;
		}
