 ...
 * @see HashCommon
 */
public class Short2BooleanOpenCustomHashMap extends AbstractShort2BooleanMap
	...
	public Short2BooleanOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final Map<? extends Short, ? extends Boolean> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final Map<? extends Short, ? extends Boolean> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final Short2BooleanMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2BooleanOpenCustomHashMap(final Short2BooleanMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2BooleanOpenCustomHashMap(final short[] k, final boolean[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2BooleanOpenCustomHashMap(final short[] k, final boolean[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsent(final short k, final java.util.function.IntPredicate mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfAbsentNullable(final short k,
	...
	/** {@inheritDoc} */
	@Override
	public boolean computeIfPresent(final short k,
			final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Boolean newValue = remappingFunction.apply(Short.valueOf(k), Boolean.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((short) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public boolean compute(final short k,
			final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Boolean newValue = remappingFunction.apply(Short.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public boolean merge(final short k, final boolean v,
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Short2BooleanOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2BooleanOpenCustomHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((short) 0))))
				return Short2BooleanOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2BooleanOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2BooleanMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2BooleanMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2BooleanMap.BasicEntry(key[pos], value[pos]));
		}
