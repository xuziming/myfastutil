...
public final class Short2ReferenceSortedMaps {
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> fastIterator(
			Short2ReferenceSortedMap<V> map) {
		...
		return entries instanceof Short2ReferenceSortedMap.FastSortedEntrySet
				? ((Short2ReferenceSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.0.0
	 */
	public static <V> ObjectBidirectionalIterable<Short2ReferenceMap.Entry<V>> fastIterable(
			Short2ReferenceSortedMap<V> map) {
		final ObjectSortedSet<Short2ReferenceMap.Entry<V>> entries = map.short2ReferenceEntrySet();
		return entries instanceof Short2ReferenceSortedMap.FastSortedEntrySet
				? ((Short2ReferenceSortedMap.FastSortedEntrySet<V>) entries)::fastIterator
	...
	public static class EmptySortedMap<V> extends Short2ReferenceMaps.EmptyMap<V>
			implements Short2ReferenceSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Short2ReferenceMaps.Singleton<V>
		...
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2ReferenceMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Short2ReferenceMaps.SynchronizedMap<V>
			implements Short2ReferenceSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2ReferenceEntrySet(), sync);
			return (ObjectSortedSet<Short2ReferenceMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Short2ReferenceMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2ReferenceEntrySet());
			return (ObjectSortedSet<Short2ReferenceMap.Entry<V>>) entries;
		}
