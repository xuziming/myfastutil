 ...
 * iterator}.
 */
public class Short2FloatAVLTreeMap extends AbstractShort2FloatSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Short2FloatAVLTreeMap(final Comparator<? super Short> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Short2FloatAVLTreeMap(final Map<? extends Short, ? extends Float> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2FloatAVLTreeMap(final SortedMap<Short, Float> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Short2FloatAVLTreeMap(final Short2FloatMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2FloatAVLTreeMap(final Short2FloatSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2FloatAVLTreeMap(final short[] k, final float v[], final Comparator<? super Short> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Short2FloatAVLTreeMap(final short[] k, final float v[]) {
		this(k, v, null);
	}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Short2FloatAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
				final Comparator<? super Short2FloatMap.Entry> comparator = (Comparator<Short2FloatMap.Entry>) (x,
						y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
				...
				@Override
				public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from,
						Short2FloatMap.Entry to) {
					return subMap(from.getShortKey(), to.getShortKey()).short2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) {
					return headMap(to.getShortKey()).short2FloatEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) {
					return tailMap(from.getShortKey()).short2FloatEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractShort2FloatSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final short k) {
			return (bottom || Short2FloatAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Short2FloatAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Float))
							return false;
						final Short2FloatAVLTreeMap.Entry f = findKey(((Short) (e.getKey())).shortValue());
		...
		public boolean containsKey(final short k) {
			return in(k) && Short2FloatAVLTreeMap.this.containsKey(k);
		}
		...
		public float get(final short k) {
			final Short2FloatAVLTreeMap.Entry e;
			final short kk = k;
		...
		public float put(final short k, final float v) {
			...
			final float oldValue = Short2FloatAVLTreeMap.this.put(k, v);
		...
		public float remove(final short k) {
			...
			final float oldValue = Short2FloatAVLTreeMap.this.remove(k);
		...
		@Override
		public short firstShortKey() {
			Short2FloatAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public short lastShortKey() {
			Short2FloatAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Short2FloatAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Short2FloatAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
