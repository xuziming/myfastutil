 ...
 * @see HashCommon
 */
public class Short2IntOpenHashMap extends AbstractShort2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Short2IntMap.Entry, Map.Entry<Short, Integer> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).shortValue())) && ((value[index]) == ((e.getValue()).intValue()));
		}
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Short2IntOpenHashMap.this.containsNullKey;
		/**
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2IntOpenHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2IntOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2IntOpenHashMap.this.key;
			int pos;
			// The starting point.
