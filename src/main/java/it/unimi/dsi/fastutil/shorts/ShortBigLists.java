...
public final class ShortBigLists {
	...
	public static class EmptyBigList extends ShortCollections.EmptyCollection
			implements ShortBigList, java.io.Serializable, Cloneable {
		...
		@Override
		public void addElements(long index, final short a[][]) {
			throw new UnsupportedOperationException();
		}
	...
	public static class Singleton extends AbstractShortBigList implements java.io.Serializable, Cloneable {
		...
		@Override
		public ShortBigListIterator listIterator() {
			return ShortBigListIterators.singleton(element);
		}
	...
	public static class SynchronizedBigList extends ShortCollections.SynchronizedCollection
			implements ShortBigList, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final ShortBigList list; // Due to the large number of methods that are not in COLLECTION, this is
											// worth caching.
		...
		@Override
		public boolean addAll(final long index, ShortBigList l) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public void add(final long i, Short k) {
			synchronized (sync) {
				list.add(i, k);
			}
		}
		...
		@Deprecated
		@Override
		public Short set(final long index, Short k) {
			synchronized (sync) {
	 ...
	 *
	 * @param l    the big list to be wrapped in a synchronized big list.
	 * @param sync an object that will be used to synchronize the access to the big
	 *             list.
	 * @return a synchronized view of the specified big list.
	 * @see java.util.Collections#synchronizedList(List)
	 */
	...
	public static class UnmodifiableBigList extends ShortCollections.UnmodifiableCollection
		...
		@Override
		public ShortBigListIterator listIterator() {
			return ShortBigListIterators.unmodifiable(list.listIterator());
		}

		@Override
		public ShortBigListIterator listIterator(final long i) {
			return ShortBigListIterators.unmodifiable(list.listIterator(i));
		}
	...
	public static class ListBigList extends AbstractShortBigList implements java.io.Serializable {
		...
		@Override
		public ShortBigListIterator iterator() {
			return ShortBigListIterators.asBigListIterator(list.iterator());
		}

		@Override
		public ShortBigListIterator listIterator() {
			return ShortBigListIterators.asBigListIterator(list.listIterator());
		}

		@Override
		public ShortBigListIterator listIterator(final long index) {
			return ShortBigListIterators.asBigListIterator(list.listIterator(intIndex(index)));
		}
		...
		public short getShort(long index) {
			return list.getShort(intIndex(index));
		}
		...
		public short removeShort(long index) {
			return list.removeShort(intIndex(index));
		}
