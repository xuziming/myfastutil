...
public final class Short2ObjectSortedMaps {
	...
	public static <V> ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator(Short2ObjectSortedMap<V> map) {
		...
		return entries instanceof Short2ObjectSortedMap.FastSortedEntrySet
				? ((Short2ObjectSortedMap.FastSortedEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap<V> extends Short2ObjectMaps.EmptyMap<V>
			implements Short2ObjectSortedMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Short2ObjectMaps.Singleton<V>
		...
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class SynchronizedSortedMap<V> extends Short2ObjectMaps.SynchronizedMap<V>
			implements Short2ObjectSortedMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2ObjectEntrySet(), sync);
			return (ObjectSortedSet<Short2ObjectMap.Entry<V>>) entries;
		}
	...
	public static class UnmodifiableSortedMap<V> extends Short2ObjectMaps.UnmodifiableMap<V>
		...
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2ObjectEntrySet());
			return (ObjectSortedSet<Short2ObjectMap.Entry<V>>) entries;
		}
