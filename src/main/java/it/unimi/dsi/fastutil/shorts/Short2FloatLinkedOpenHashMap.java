...
public class Short2FloatLinkedOpenHashMap extends AbstractShort2FloatSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2FloatMap.Entry>
		...
		@Override
		public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry fromElement,
				Short2FloatMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		 ...
		 */
		@Override
		public ObjectListIterator<Short2FloatMap.Entry> iterator(final Short2FloatMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Short2FloatMap.Entry> fastIterator(final Short2FloatMap.Entry from) {
		...
		public void forEach(final Consumer<? super Short2FloatMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractShort2FloatMap.BasicEntry(key[curr], value[curr]));
			}
		}
