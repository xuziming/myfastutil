...
public class Short2IntOpenCustomHashMap extends AbstractShort2IntMap implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2IntOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2IntOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2IntOpenCustomHashMap(final Map<? extends Short, ? extends Integer> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2IntOpenCustomHashMap(final Map<? extends Short, ? extends Integer> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2IntOpenCustomHashMap(final Short2IntMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2IntOpenCustomHashMap(final Short2IntMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2IntOpenCustomHashMap(final short[] k, final int[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2IntOpenCustomHashMap(final short[] k, final int[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public int computeIfAbsentNullable(final short k,
	...
	/** {@inheritDoc} */
	@Override
	public int computeIfPresent(final short k,
	...
	/** {@inheritDoc} */
	@Override
	public int compute(final short k,
			final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Integer newValue = remappingFunction.apply(Short.valueOf(k),
	...
	/** {@inheritDoc} */
	@Override
	public int merge(final short k, final int v,
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((short) 0))))
				return Short2IntOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2IntOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2IntMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2IntMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2IntMap.BasicEntry(key[pos], value[pos]));
		}
