 ...
 * @see HashCommon
 */
public class Short2ShortOpenHashMap extends AbstractShort2ShortMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).shortValue())) && ((value[index]) == ((e.getValue()).shortValue()));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2ShortOpenHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2ShortOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2ShortOpenHashMap.this.key;
			int pos;
			// The starting point.
