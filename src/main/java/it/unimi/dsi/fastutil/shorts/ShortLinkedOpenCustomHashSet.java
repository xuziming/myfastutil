 ...
 * @see HashCommon
 */
public class ShortLinkedOpenCustomHashSet extends AbstractShortSortedSet
	...
	public ShortLinkedOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final Collection<? extends Short> c, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final Collection<? extends Short> c,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final ShortCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final ShortCollection c,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final ShortIterator i, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final ShortIterator i,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final Iterator<?> i,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final short[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final short[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final short[] a, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortLinkedOpenCustomHashSet(final short[] a,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private class SetIterator implements ShortListIterator {
		...
		public short nextShort() {
			...
			if (index >= 0)
				index++;
			if (ASSERTS)
				assert curr == n || !((key[curr]) == ((short) 0)) : "Position " + curr + " is not used";
			return key[curr];
		}
		...
		public void remove() {
			...
			if (pos == n) {
				...
				ShortLinkedOpenCustomHashSet.this.key[n] = ((short) 0);
			} else {
				short curr;
				final short[] key = ShortLinkedOpenCustomHashSet.this.key;
	...
	protected void rehash(final int newN) {
		...
		first = -1;
		for (int j = size; j-- != 0;) {
			if ((strategy.equals((key[i]), ((short) 0))))
				pos = newN;
			else {
