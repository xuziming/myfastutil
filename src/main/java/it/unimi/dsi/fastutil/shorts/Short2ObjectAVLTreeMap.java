 ...
 * iterator}.
 */
public class Short2ObjectAVLTreeMap<V> extends AbstractShort2ObjectSortedMap<V>
	...
	private static final class Entry<V> extends AbstractShort2ObjectMap.BasicEntry<V> implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).shortValue())) && java.util.Objects.equals(value, (e.getValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Short2ObjectAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>() {
				final Comparator<? super Short2ObjectMap.Entry<V>> comparator = (Comparator<Short2ObjectMap.Entry<V>>) (
						x, y) -> Short2ObjectAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
				...
				@Override
				public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(
						final Short2ObjectMap.Entry<V> from) {
				...
				@Override
				public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from,
						Short2ObjectMap.Entry<V> to) {
					return subMap(from.getShortKey(), to.getShortKey()).short2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> to) {
					return headMap(to.getShortKey()).short2ObjectEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from) {
					return tailMap(from.getShortKey()).short2ObjectEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractShort2ObjectSortedMap<V> implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final short k) {
			return (bottom || Short2ObjectAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Short2ObjectAVLTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getKey() == null || !(e.getKey() instanceof Short))
							return false;
						final Short2ObjectAVLTreeMap.Entry<V> f = findKey(((Short) (e.getKey())).shortValue());
		...
		public boolean containsKey(final short k) {
			return in(k) && Short2ObjectAVLTreeMap.this.containsKey(k);
		}
		...
		@Override
		public short firstShortKey() {
			Short2ObjectAVLTreeMap.Entry<V> e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public short lastShortKey() {
			Short2ObjectAVLTreeMap.Entry<V> e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Short2ObjectAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Short2ObjectAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
