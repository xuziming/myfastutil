...
public interface Short2IntMap extends Short2IntFunction, Map<Short, Integer> {
	 ...
	 * @since 8.0.0
	 */
	default int computeIfAbsentNullable(final short key,
	 ...
	 * @since 8.0.0
	 */
	default int computeIfPresent(final short key,
	 ...
	 * @since 8.0.0
	 */
	default int compute(final short key,
			final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Integer newValue = remappingFunction.apply(Short.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default int merge(final short key, final int value,
	...
	@Deprecated
	@Override
	default Integer computeIfAbsent(final Short key,
	...
	@Deprecated
	@Override
	default Integer computeIfPresent(final Short key,
			final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer compute(final Short key,
			final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
	...
	@Deprecated
	@Override
	default Integer merge(final Short key, final Integer value,
			final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
