...
public final class Short2ObjectMaps {
	...
	public static <V> ObjectIterator<Short2ObjectMap.Entry<V>> fastIterator(Short2ObjectMap<V> map) {
		...
		return entries instanceof Short2ObjectMap.FastEntrySet
				? ((Short2ObjectMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Short2ObjectMap<V> map,
			final Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
		final ObjectSet<Short2ObjectMap.Entry<V>> entries = map.short2ObjectEntrySet();
		if (entries instanceof Short2ObjectMap.FastEntrySet)
			((Short2ObjectMap.FastEntrySet<V>) entries).fastForEach(consumer);
		else
	...
	public static <V> ObjectIterable<Short2ObjectMap.Entry<V>> fastIterable(Short2ObjectMap<V> map) {
		...
		return entries instanceof Short2ObjectMap.FastEntrySet ? new ObjectIterable<Short2ObjectMap.Entry<V>>() {
			public ObjectIterator<Short2ObjectMap.Entry<V>> iterator() {
				return ((Short2ObjectMap.FastEntrySet<V>) entries).fastIterator();
			}
	...
	public static class EmptyMap<V> extends Short2ObjectFunctions.EmptyFunction<V>
			implements Short2ObjectMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Short2ObjectFunctions.Singleton<V>
		...
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2ObjectMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Short2ObjectFunctions.SynchronizedFunction<V>
			implements Short2ObjectMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2ObjectEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public V computeIfPresent(final short key,
		...
		@Override
		public V compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super V, ? extends V> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public V merge(final short key, final V value,
		...
		@Deprecated
		@Override
		public V computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends V> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap<V> extends Short2ObjectFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2ObjectEntrySet());
			return entries;
		}
