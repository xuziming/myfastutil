 ...
 * @see HashCommon
 */
public class ShortOpenCustomHashSet extends AbstractShortSet implements java.io.Serializable, Cloneable, Hash {
	...
	public ShortOpenCustomHashSet(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final Collection<? extends Short> c, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final Collection<? extends Short> c,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final ShortCollection c, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final ShortCollection c,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(c, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final ShortIterator i, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final ShortIterator i,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final Iterator<?> i, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final Iterator<?> i, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final short[] a, final int offset, final int length, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final short[] a, final int offset, final int length,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final short[] a, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public ShortOpenCustomHashSet(final short[] a, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private class SetIterator implements ShortIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				ShortOpenCustomHashSet.this.key[n] = ((short) 0);
			} else if (pos >= 0)
				shiftKeys(last);
			else {
				// We're removing wrapped entries.
				ShortOpenCustomHashSet.this.remove(wrapped.getShort(-pos - 1));
	...
	private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
		...
		for (int i = size, pos; i-- != 0;) {
			...
			if ((strategy.equals((k), ((short) 0)))) {
				...
				if (!((key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode(k))) & mask]) == ((short) 0)))
					while (!((key[pos = (pos + 1) & mask]) == ((short) 0)))
						;
			}
			key[pos] = k;
		}
