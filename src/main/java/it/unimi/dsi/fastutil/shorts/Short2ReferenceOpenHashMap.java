...
public class Short2ReferenceOpenHashMap<V> extends AbstractShort2ReferenceMap<V>
	...
	final class MapEntry implements Short2ReferenceMap.Entry<V>, Map.Entry<Short, V> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).shortValue())) && ((value[index]) == ((e.getValue())));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2ReferenceOpenHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2ReferenceOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2ReferenceOpenHashMap.this.key;
			int pos;
			// The starting point.
