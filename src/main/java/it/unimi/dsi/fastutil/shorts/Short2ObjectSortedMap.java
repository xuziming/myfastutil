...
public interface Short2ObjectSortedMap<V> extends Short2ObjectMap<V>, SortedMap<Short, V> {
	 ...
	 */
	Short2ObjectSortedMap<V> subMap(short fromKey, short toKey);
	 ...
	 */
	Short2ObjectSortedMap<V> headMap(short toKey);
	 ...
	 */
	Short2ObjectSortedMap<V> tailMap(short fromKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet<V> extends ObjectSortedSet<Short2ObjectMap.Entry<V>>, FastEntrySet<V> {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator(Short2ObjectMap.Entry<V> from);
	}
