...
public class Short2ReferenceArrayMap<V> extends AbstractShort2ReferenceMap<V>
	...
	private final class EntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(Object o) {
			...
			return Short2ReferenceArrayMap.this.containsKey(k)
					&& ((Short2ReferenceArrayMap.this.get(k)) == ((e.getValue())));
		}
		...
		public boolean remove(final Object o) {
			...
			System.arraycopy(Short2ReferenceArrayMap.this.key, oldPos + 1, Short2ReferenceArrayMap.this.key, oldPos,
					tail);
			System.arraycopy(Short2ReferenceArrayMap.this.value, oldPos + 1, Short2ReferenceArrayMap.this.value, oldPos,
					tail);
