...
public final class Short2ByteSortedMaps {
	...
	public static ObjectBidirectionalIterator<Short2ByteMap.Entry> fastIterator(Short2ByteSortedMap map) {
		...
		return entries instanceof Short2ByteSortedMap.FastSortedEntrySet
				? ((Short2ByteSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Short2ByteMaps.EmptyMap
			implements Short2ByteSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Short2ByteMaps.Singleton
			implements Short2ByteSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2ByteMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2ByteMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Short2ByteMaps.SynchronizedMap
			implements Short2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2ByteEntrySet(), sync);
			return (ObjectSortedSet<Short2ByteMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2ByteMaps.UnmodifiableMap
			implements Short2ByteSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2ByteSortedMap sortedMap;
		...
		public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2ByteEntrySet());
			return (ObjectSortedSet<Short2ByteMap.Entry>) entries;
		}
