...
public final class Short2FloatFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractShort2FloatFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2FloatFunction singleton(final short key, float value) {
	...
	public static class SynchronizedFunction implements Short2FloatFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction extends AbstractShort2FloatFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2FloatFunction function;
	...
	public static class PrimitiveFunction implements Short2FloatFunction {
		...
		public float get(short key) {
			Float v = function.apply(Short.valueOf(key));
			if (v == null)
	...
	public static Short2FloatFunction primitive(final java.util.function.Function<? super Short, ? extends Float> f) {
