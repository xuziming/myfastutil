 ...
 *
 */
public class Short2ByteRBTreeMap extends AbstractShort2ByteSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Short2ByteRBTreeMap(final Comparator<? super Short> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Short2ByteRBTreeMap(final Map<? extends Short, ? extends Byte> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2ByteRBTreeMap(final SortedMap<Short, Byte> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Short2ByteRBTreeMap(final Short2ByteMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2ByteRBTreeMap(final Short2ByteSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2ByteRBTreeMap(final short[] k, final byte v[], final Comparator<? super Short> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Short2ByteRBTreeMap(final short[] k, final byte v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractShort2ByteMap.BasicEntry implements Cloneable {
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).shortValue())) && ((value) == ((e.getValue()).byteValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Short2ByteRBTreeMap.this.remove(curr.key);
			curr = null;
		}
	...
	public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
				final Comparator<? super Short2ByteMap.Entry> comparator = (Comparator<Short2ByteMap.Entry>) (x,
						y) -> Short2ByteRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
				...
				public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) {
					return subMap(from.getShortKey(), to.getShortKey()).short2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) {
					return headMap(to.getShortKey()).short2ByteEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) {
					return tailMap(from.getShortKey()).short2ByteEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractShort2ByteSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final short k) {
			return (bottom || Short2ByteRBTreeMap.this.compare(k, from) >= 0)
					&& (top || Short2ByteRBTreeMap.this.compare(k, to) < 0);
		}
			...
			if (entries == null)
				entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>() {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Byte))
							return false;
						final Short2ByteRBTreeMap.Entry f = findKey(((Short) (e.getKey())).shortValue());
					...
					@Override
					public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from,
							Short2ByteMap.Entry to) {
						return subMap(from.getShortKey(), to.getShortKey()).short2ByteEntrySet();
					}
		...
		public boolean containsKey(final short k) {
			return in(k) && Short2ByteRBTreeMap.this.containsKey(k);
		}
		...
		public byte get(final short k) {
			final Short2ByteRBTreeMap.Entry e;
			final short kk = k;
		...
		public byte put(final short k, final byte v) {
			...
			final byte oldValue = Short2ByteRBTreeMap.this.put(k, v);
		...
		public byte remove(final short k) {
			...
			final byte oldValue = Short2ByteRBTreeMap.this.remove(k);
		...
		@Override
		public short firstShortKey() {
			Short2ByteRBTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public short lastShortKey() {
			Short2ByteRBTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Short2ByteRBTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Short2ByteRBTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Short2ByteRBTreeMap clone() {
		...
		try {
			c = (Short2ByteRBTreeMap) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
