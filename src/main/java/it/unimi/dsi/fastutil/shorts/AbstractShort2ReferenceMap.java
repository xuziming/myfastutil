...
public abstract class AbstractShort2ReferenceMap<V> extends AbstractShort2ReferenceFunction<V>
	...
	public boolean containsKey(final short k) {
		final ObjectIterator<Short2ReferenceMap.Entry<V>> i = short2ReferenceEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry<V> implements Short2ReferenceMap.Entry<V> {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Short2ReferenceMap.Entry) {
				final Short2ReferenceMap.Entry<V> e = (Short2ReferenceMap.Entry<V>) o;
				return ((key) == (e.getShortKey())) && ((value) == (e.getValue()));
			}
			...
			return ((this.key) == (((Short) (key)).shortValue())) && ((this.value) == ((value)));
		}
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					private final ObjectIterator<Short2ReferenceMap.Entry<V>> i = Short2ReferenceMaps
							.fastIterator(AbstractShort2ReferenceMap.this);
	...
	public void putAll(final Map<? extends Short, ? extends V> m) {
		if (m instanceof Short2ReferenceMap) {
			...
			while (i.hasNext()) {
				final Short2ReferenceMap.Entry<? extends V> e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Short2ReferenceMap.Entry<V>> i = Short2ReferenceMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
