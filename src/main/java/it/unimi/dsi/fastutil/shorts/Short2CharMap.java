...
public interface Short2CharMap extends Short2CharFunction, Map<Short, Character> {
	 ...
	 * @since 8.0.0
	 */
	default char computeIfAbsentNullable(final short key,
	 ...
	 * @since 8.0.0
	 */
	default char computeIfPresent(final short key,
	 ...
	 * @since 8.0.0
	 */
	default char compute(final short key,
			final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final char oldValue = get(key), drv = defaultReturnValue();
		final boolean contained = oldValue != drv || containsKey(key);
		final Character newValue = remappingFunction.apply(Short.valueOf(key),
	 ...
	 * @since 8.0.0
	 */
	default char merge(final short key, final char value,
	...
	@Deprecated
	@Override
	default Character computeIfAbsent(final Short key,
	...
	@Deprecated
	@Override
	default Character computeIfPresent(final Short key,
			final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character compute(final Short key,
			final java.util.function.BiFunction<? super Short, ? super Character, ? extends Character> remappingFunction) {
	...
	@Deprecated
	@Override
	default Character merge(final Short key, final Character value,
			final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
