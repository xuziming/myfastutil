...
public final class Short2IntSortedMaps {
	...
	public static ObjectBidirectionalIterator<Short2IntMap.Entry> fastIterator(Short2IntSortedMap map) {
		...
		return entries instanceof Short2IntSortedMap.FastSortedEntrySet
				? ((Short2IntSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Short2IntMaps.EmptyMap
			implements Short2IntSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Short2IntMaps.Singleton
			implements Short2IntSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2IntMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2IntMap.Entry>) entries;
		}
	...
	public static class SynchronizedSortedMap extends Short2IntMaps.SynchronizedMap
			implements Short2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2IntEntrySet(), sync);
			return (ObjectSortedSet<Short2IntMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2IntMaps.UnmodifiableMap
			implements Short2IntSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2IntSortedMap sortedMap;
		...
		public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2IntEntrySet());
			return (ObjectSortedSet<Short2IntMap.Entry>) entries;
		}
