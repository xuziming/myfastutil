...
public interface Short2ByteSortedMap extends Short2ByteMap, SortedMap<Short, Byte> {
	 ...
	 */
	Short2ByteSortedMap subMap(short fromKey, short toKey);
	 ...
	 * (of course, mutated).
	 */
	interface FastSortedEntrySet extends ObjectSortedSet<Short2ByteMap.Entry>, FastEntrySet {
		/**
		 * {@inheritDoc}
		 */
		@Override
		 ...
		 *         mutated.
		 */
		ObjectBidirectionalIterator<Short2ByteMap.Entry> fastIterator(Short2ByteMap.Entry from);
	}
