...
public final class Short2IntFunctions {
	 ...
	 */
	public static class EmptyFunction extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
	 ...
	 * type-specific function.
	 */
	public static class Singleton extends AbstractShort2IntFunction implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2IntFunction singleton(final short key, int value) {
	...
	public static class SynchronizedFunction implements Short2IntFunction, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
	...
	public static class UnmodifiableFunction extends AbstractShort2IntFunction implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2IntFunction function;
	...
	public static class PrimitiveFunction implements Short2IntFunction {
		...
		public int get(short key) {
			Integer v = function.apply(Short.valueOf(key));
			if (v == null)
	...
	public static Short2IntFunction primitive(final java.util.function.Function<? super Short, ? extends Integer> f) {
