 ...
 * iterator}.
 */
public class Short2DoubleAVLTreeMap extends AbstractShort2DoubleSortedMap implements java.io.Serializable, Cloneable {
	 ...
	 */
	public Short2DoubleAVLTreeMap(final Comparator<? super Short> c) {
		this();
		storedComparator = c;
		setActualComparator();
	}
	 ...
	 */
	public Short2DoubleAVLTreeMap(final Map<? extends Short, ? extends Double> m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2DoubleAVLTreeMap(final SortedMap<Short, Double> m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 */
	public Short2DoubleAVLTreeMap(final Short2DoubleMap m) {
		this();
		putAll(m);
	}
	 ...
	 */
	public Short2DoubleAVLTreeMap(final Short2DoubleSortedMap m) {
		this(m.comparator());
		putAll(m);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2DoubleAVLTreeMap(final short[] k, final double v[], final Comparator<? super Short> c) {
		this(c);
	 ...
	 *                                  lengths.
	 */
	public Short2DoubleAVLTreeMap(final short[] k, final double v[]) {
		this(k, v, null);
	}
	...
	private static final class Entry extends AbstractShort2DoubleMap.BasicEntry implements Cloneable {
		 ...
		 * @param v a value.
		 */
		Entry(final short k, final double v) {
			super(k, v);
		...
		public boolean equals(final Object o) {
			...
			return ((key) == ((e.getKey()).shortValue()))
					&& (Double.doubleToLongBits(value) == Double.doubleToLongBits((e.getValue()).doubleValue()));
		}
	...
	private class TreeIterator {
		...
		public void remove() {
			...
			updatePrevious();
			updateNext();
			Short2DoubleAVLTreeMap.this.remove(curr.key);
			curr = null;
		}
	 ...
	 * This class can iterate in both directions on a threaded tree.
	 */
	private class EntryIterator extends TreeIterator implements ObjectListIterator<Short2DoubleMap.Entry> {
		EntryIterator() {
		}
	...
	public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
		if (entries == null)
			entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
				final Comparator<? super Short2DoubleMap.Entry> comparator = (Comparator<Short2DoubleMap.Entry>) (x,
						y) -> Short2DoubleAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
				...
				@Override
				public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(final Short2DoubleMap.Entry from) {
				...
				@Override
				public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from,
						Short2DoubleMap.Entry to) {
					return subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry to) {
					return headMap(to.getShortKey()).short2DoubleEntrySet();
				}

				@Override
				public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from) {
					return tailMap(from.getShortKey()).short2DoubleEntrySet();
				}
			};
		return entries;
	}
	 ...
	 */
	private final class Submap extends AbstractShort2DoubleSortedMap implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		final boolean in(final short k) {
			return (bottom || Short2DoubleAVLTreeMap.this.compare(k, from) >= 0)
					&& (top || Short2DoubleAVLTreeMap.this.compare(k, to) < 0);
		}
		...
		public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
					...
					@Override
					public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(
							final Short2DoubleMap.Entry from) {
					...
					public boolean contains(final Object o) {
						...
						if (e.getValue() == null || !(e.getValue() instanceof Double))
							return false;
						final Short2DoubleAVLTreeMap.Entry f = findKey(((Short) (e.getKey())).shortValue());
		...
		public boolean containsKey(final short k) {
			return in(k) && Short2DoubleAVLTreeMap.this.containsKey(k);
		}
		...
		public double get(final short k) {
			final Short2DoubleAVLTreeMap.Entry e;
			final short kk = k;
		...
		public double put(final short k, final double v) {
			...
			final double oldValue = Short2DoubleAVLTreeMap.this.put(k, v);
		...
		public double remove(final short k) {
			...
			final double oldValue = Short2DoubleAVLTreeMap.this.remove(k);
		...
		@Override
		public short firstShortKey() {
			Short2DoubleAVLTreeMap.Entry e = firstEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		@Override
		public short lastShortKey() {
			Short2DoubleAVLTreeMap.Entry e = lastEntry();
			if (e == null)
				throw new NoSuchElementException();
			return e.key;
		}
		...
		private class SubmapIterator extends TreeIterator {
			...
			void updatePrevious() {
				prev = prev.prev();
				if (!bottom && prev != null && Short2DoubleAVLTreeMap.this.compare(prev.key, from) < 0)
					prev = null;
			}
			...
			void updateNext() {
				next = next.next();
				if (!top && next != null && Short2DoubleAVLTreeMap.this.compare(next.key, to) >= 0)
					next = null;
			}
		}
	...
	public Short2DoubleAVLTreeMap clone() {
		...
		try {
			c = (Short2DoubleAVLTreeMap) super.clone();
		} catch (CloneNotSupportedException cantHappen) {
			throw new InternalError();
		}
		c.keys = null;
	...
	private Entry readTree(final java.io.ObjectInputStream s, final int n, final Entry pred, final Entry succ)
		...
		if (n == 1) {
			final Entry top = new Entry(s.readShort(), s.readDouble());
			top.pred(pred);
			top.succ(succ);
			return top;
		}
