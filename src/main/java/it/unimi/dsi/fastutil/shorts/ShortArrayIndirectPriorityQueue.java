...
public class ShortArrayIndirectPriorityQueue implements ShortIndirectPriorityQueue {
	 ...
	 *                 natural order.
	 */
	public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a, int size, final ShortComparator c) {
		this(refArray, 0, c);
		this.array = a;
		this.size = size;
	}
	 ...
	 *                 natural order.
	 */
	public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a, final ShortComparator c) {
	 ...
	 * @param size     the number of elements to be included in the queue.
	 */
	public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a, int size) {
	 ...
	 * @param a        an array of indices into {@code refArray}.
	 */
	public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a) {
	...
	private int findFirst() {
		...
		int i = size;
		int firstIndex = --i;
		short first = refArray[array[firstIndex]];
		if (c == null)
			while (i-- != 0) {
	...
	private int findLast() {
		int i = size;
		int lastIndex = --i;
		short last = refArray[array[lastIndex]];
		if (c == null) {
			while (i-- != 0)
	...
	public int front(int[] a) {
		final short top = refArray[array[findFirst()]];
		int i = size, c = 0;
		while (i-- != 0)
