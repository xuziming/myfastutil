...
public final class ShortIndirectHeaps {
	...
	public static int downHeap(final short[] refArray, final int[] heap, final int[] inv, final int size, int i,
	...
	public static int upHeap(final short[] refArray, final int[] heap, final int[] inv, final int size, int i,
			final ShortComparator c) {
		assert i < size;
		final int e = heap[i];
		final short E = refArray[e];
	...
	public static void makeHeap(final short[] refArray, final int offset, final int length, final int[] heap,
			final int[] inv, final ShortComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final short[] refArray, final int[] heap, final int[] inv, final int size,
			final ShortComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
