...
public final class Short2ReferenceFunctions {
	 ...
	 */
	public static class EmptyFunction<V> extends AbstractShort2ReferenceFunction<V>
	 ...
	 * type-specific function.
	 */
	public static class Singleton<V> extends AbstractShort2ReferenceFunction<V>
			implements java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Short2ReferenceFunction<V> singleton(final short key, V value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static <V> Short2ReferenceFunction<V> singleton(final Short key, final V value) {
		return new Singleton<>((key).shortValue(), (value));
	}

	/** A synchronized wrapper class for functions. */
	public static class SynchronizedFunction<V> implements Short2ReferenceFunction<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2ReferenceFunction<V> function;
		protected final Object sync;

		protected SynchronizedFunction(final Short2ReferenceFunction<V> f, final Object sync) {
			if (f == null)
		...
		protected SynchronizedFunction(final Short2ReferenceFunction<V> f) {
			if (f == null)
				throw new NullPointerException();
			this.function = f;
			this.sync = this;
	 ...
	 */
	public static <V> Short2ReferenceFunction<V> synchronize(final Short2ReferenceFunction<V> f) {
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Short2ReferenceFunction<V> synchronize(final Short2ReferenceFunction<V> f, final Object sync) {
		return new SynchronizedFunction<>(f, sync);
	}

	/** An unmodifiable wrapper class for functions. */
	public static class UnmodifiableFunction<V> extends AbstractShort2ReferenceFunction<V>
			implements java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2ReferenceFunction<V> function;

		protected UnmodifiableFunction(final Short2ReferenceFunction<V> f) {
			if (f == null)
				throw new NullPointerException();
			this.function = f;
		}
	 ...
	 */
	public static <V> Short2ReferenceFunction<V> unmodifiable(final Short2ReferenceFunction<V> f) {
	...
	public static class PrimitiveFunction<V> implements Short2ReferenceFunction<V> {
		...
		public V get(short key) {
			V v = function.apply(Short.valueOf(key));
			if (v == null)
				return null;
			return (v);
		}
	...
	public static <V> Short2ReferenceFunction<V> primitive(
			final java.util.function.Function<? super Short, ? extends V> f) {
