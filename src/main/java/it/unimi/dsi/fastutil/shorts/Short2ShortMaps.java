...
public final class Short2ShortMaps {
	...
	public static ObjectIterator<Short2ShortMap.Entry> fastIterator(Short2ShortMap map) {
		...
		return entries instanceof Short2ShortMap.FastEntrySet ? ((Short2ShortMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * type-specific map.
	 */
	public static class EmptyMap extends Short2ShortFunctions.EmptyFunction
			implements Short2ShortMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific map.
	 */
	public static class Singleton extends Short2ShortFunctions.Singleton
			implements Short2ShortMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2ShortMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2ShortFunctions.SynchronizedFunction
			implements Short2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2ShortEntrySet(), sync);
				return entries;
			}
		}
		...
		public ShortSet keySet() {
			synchronized (sync) {
				if (keys == null)
					keys = ShortSets.synchronize(map.keySet(), sync);
				return keys;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Short> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> function) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsent(final short key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short computeIfAbsentNullable(final short key,
		...
		@Override
		public short computeIfPresent(final short key,
		...
		@Override
		public short compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public short merge(final short key, final short value,
				final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
			synchronized (sync) {
		...
		@Deprecated
		@Override
		public Short computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Short> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2ShortFunctions.UnmodifiableFunction
			implements Short2ShortMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2ShortMap map;
		protected transient ObjectSet<Short2ShortMap.Entry> entries;
		...
		public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2ShortEntrySet());
			return entries;
		}
		...
		public ShortSet keySet() {
			if (keys == null)
				keys = ShortSets.unmodifiable(map.keySet());
			return keys;
		}
