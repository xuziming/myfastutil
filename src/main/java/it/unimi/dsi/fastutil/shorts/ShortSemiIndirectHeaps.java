...
public final class ShortSemiIndirectHeaps {
	 ...
	 * @param c        a type-specific comparator, or {@code null} for the natural
	 *                 order.
	 * @return the new position in the heap of the element of heap index {@code i}.
	 */

	public static int downHeap(final short[] refArray, final int[] heap, final int size, int i,
			final ShortComparator c) {
		assert i < size;
		final int e = heap[i];
		final short E = refArray[e];
		int child;
		if (c == null)
	...
	public static int upHeap(final short[] refArray, final int[] heap, final int size, int i, final ShortComparator c) {
		assert i < size;
		final int e = heap[i];
		final short E = refArray[e];
		if (c == null)
	 ...
	 *
	 * @param refArray the reference array.
	 * @param offset   the first element of the reference array to be put in the
	 *                 heap.
	 ...
	 *                 order.
	 */
	public static void makeHeap(final short[] refArray, final int offset, final int length, final int[] heap,
			final ShortComparator c) {
	 ...
	 */
	public static int[] makeHeap(final short[] refArray, final int offset, final int length, final ShortComparator c) {
	 ...
	 *                 order.
	 */
	public static void makeHeap(final short[] refArray, final int[] heap, final int size, final ShortComparator c) {
		int i = size >>> 1;
		while (i-- != 0)
	 ...
	 * @param heap     an array containing indices into {@code refArray}.
	 * @param size     the number of elements in the heap.
	 * @param a        an array large enough to hold the front (e.g., at least long
	 *                 as {@code refArray}).
	 * @return the number of elements actually written (starting from the first
	 *         position of {@code a}).
	 */

	public static int front(final short[] refArray, final int[] heap, final int size, final int[] a) {
		final short top = refArray[heap[0]];
