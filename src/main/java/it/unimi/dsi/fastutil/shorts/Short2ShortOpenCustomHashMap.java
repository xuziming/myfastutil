 ...
 * @see HashCommon
 */
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap
	...
	public Short2ShortOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final Map<? extends Short, ? extends Short> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final Map<? extends Short, ? extends Short> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final Short2ShortMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2ShortOpenCustomHashMap(final Short2ShortMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2ShortOpenCustomHashMap(final short[] k, final short[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2ShortOpenCustomHashMap(final short[] k, final short[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private void insert(final int pos, final short k, final short v) {
		if (pos == n)
	...
	public short getOrDefault(final short k, final short defaultValue) {
		if ((strategy.equals((k), ((short) 0))))
	...
	/** {@inheritDoc} */
	@Override
	public short putIfAbsent(final short k, final short v) {
		final int pos = find(k);
		if (pos >= 0)
			return value[pos];
		insert(-pos - 1, k, v);
	...
	public boolean remove(final short k, final short v) {
		if ((strategy.equals((k), ((short) 0)))) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean replace(final short k, final short oldValue, final short v) {
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public short replace(final short k, final short v) {
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final short oldValue = value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfAbsent(final short k, final java.util.function.IntUnaryOperator mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfAbsentNullable(final short k,
			final java.util.function.IntFunction<? extends Short> mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final int pos = find(k);
		if (pos >= 0)
			return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public short computeIfPresent(final short k,
			final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Short newValue = remappingFunction.apply(Short.valueOf(k), Short.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((short) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public short compute(final short k,
			final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Short newValue = remappingFunction.apply(Short.valueOf(k), pos >= 0 ? Short.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), ((short) 0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public short merge(final short k, final short v,
			final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0) {
	...
	final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey()).shortValue())))
					&& ((value[index]) == ((e.getValue()).shortValue()));
		}
	...
	private class MapIterator {
		...
		public int nextEntry() {
			...
			final short key[] = Short2ShortOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2ShortOpenCustomHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((short) 0))))
				return Short2ShortOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2ShortOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2ShortMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2ShortMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2ShortMap.BasicEntry(key[pos], value[pos]));
		}

		/** {@inheritDoc} */
		@Override
		public void fastForEach(final Consumer<? super Short2ShortMap.Entry> consumer) {
