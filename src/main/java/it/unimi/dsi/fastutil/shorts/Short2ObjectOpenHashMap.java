 ...
 * @see HashCommon
 */
public class Short2ObjectOpenHashMap<V> extends AbstractShort2ObjectMap<V>
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2ObjectOpenHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements FastEntrySet<V> {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2ObjectOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			short curr;
			final short[] key = Short2ObjectOpenHashMap.this.key;
			int pos;
			// The starting point.
