...
public final class Short2CharSortedMaps {
	...
	public static ObjectBidirectionalIterator<Short2CharMap.Entry> fastIterator(Short2CharSortedMap map) {
		...
		return entries instanceof Short2CharSortedMap.FastSortedEntrySet
				? ((Short2CharSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static class EmptySortedMap extends Short2CharMaps.EmptyMap
			implements Short2CharSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2CharMaps.Singleton
		...
		protected Singleton(final short key, final char value, ShortComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2CharMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2CharMap.Entry>) entries;
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2CharSortedMap singleton(final Short key, Character value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2CharSortedMap singleton(final Short key, Character value, ShortComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2CharSortedMap singleton(final short key, final char value, ShortComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Short2CharMaps.SynchronizedMap
			implements Short2CharSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2CharEntrySet(), sync);
			return (ObjectSortedSet<Short2CharMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2CharMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2CharEntrySet());
			return (ObjectSortedSet<Short2CharMap.Entry>) entries;
		}
