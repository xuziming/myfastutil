 ...
 * @see HashCommon
 */
public class Short2ShortLinkedOpenHashMap extends AbstractShort2ShortSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2ShortMap.Entry>
		...
		@Override
		public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry fromElement,
				Short2ShortMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2ShortLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2ShortLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Short2ShortMap.Entry> iterator(final Short2ShortMap.Entry from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Short2ShortMap.Entry> fastIterator(final Short2ShortMap.Entry from) {
		...
		public void forEach(final Consumer<? super Short2ShortMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractShort2ShortMap.BasicEntry(key[curr], value[curr]));
			}
		}
