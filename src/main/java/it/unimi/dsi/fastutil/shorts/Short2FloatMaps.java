...
public final class Short2FloatMaps {
	...
	public static ObjectIterator<Short2FloatMap.Entry> fastIterator(Short2FloatMap map) {
		...
		return entries instanceof Short2FloatMap.FastEntrySet ? ((Short2FloatMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Short2FloatMap map, final Consumer<? super Short2FloatMap.Entry> consumer) {
		final ObjectSet<Short2FloatMap.Entry> entries = map.short2FloatEntrySet();
	...
	public static class EmptyMap extends Short2FloatFunctions.EmptyFunction
			implements Short2FloatMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2FloatFunctions.Singleton
		...
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2FloatMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2FloatFunctions.SynchronizedFunction
			implements Short2FloatMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2FloatEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Float> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Float, ? extends Float> function) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsent(final short key, final java.util.function.IntToDoubleFunction mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float computeIfAbsentNullable(final short key,
		...
		@Override
		public float computeIfPresent(final short key,
		...
		@Override
		public float compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Float, ? extends Float> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public float merge(final short key, final float value,
		...
		@Deprecated
		@Override
		public Float computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Float> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
	...
	public static class UnmodifiableMap extends Short2FloatFunctions.UnmodifiableFunction
		...
		public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2FloatEntrySet());
			return entries;
		}
