...
public abstract class AbstractShort2ShortMap extends AbstractShort2ShortFunction
	...
	public boolean containsKey(final short k) {
		final ObjectIterator<Short2ShortMap.Entry> i = short2ShortEntrySet().iterator();
		while (i.hasNext())
	...
	public static class BasicEntry implements Short2ShortMap.Entry {
		...
		public boolean equals(final Object o) {
			...
			if (o instanceof Short2ShortMap.Entry) {
				final Short2ShortMap.Entry e = (Short2ShortMap.Entry) o;
				return ((key) == (e.getShortKey())) && ((value) == (e.getShortValue()));
			}
			...
			if (value == null || !(value instanceof Short))
				return false;
			return ((this.key) == (((Short) (key)).shortValue())) && ((this.value) == (((Short) (value)).shortValue()));
		}
	...
	public abstract static class BasicEntrySet extends AbstractObjectSet<Entry> {
		...
		public boolean remove(final Object o) {
			...
			if (o instanceof Short2ShortMap.Entry) {
				final Short2ShortMap.Entry e = (Short2ShortMap.Entry) o;
				return map.remove(e.getShortKey(), e.getShortValue());
			}
		...
		return new AbstractShortSet() {
			...
			public ShortIterator iterator() {
				return new ShortIterator() {
					private final ObjectIterator<Short2ShortMap.Entry> i = Short2ShortMaps
							.fastIterator(AbstractShort2ShortMap.this);
	...
	public void putAll(final Map<? extends Short, ? extends Short> m) {
		if (m instanceof Short2ShortMap) {
			...
			while (i.hasNext()) {
				final Short2ShortMap.Entry e = i.next();
	...
	public int hashCode() {
		int h = 0, n = size();
		final ObjectIterator<Short2ShortMap.Entry> i = Short2ShortMaps.fastIterator(this);
		while (n-- != 0)
			h += i.next().hashCode();
		return h;
	}
