...
public final class Short2FloatSortedMaps {
	 ...
	 */
	public static class EmptySortedMap extends Short2FloatMaps.EmptyMap
			implements Short2FloatSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Short2FloatMaps.Singleton
			implements Short2FloatSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2FloatMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2FloatMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Short, Float>> entrySet() {
			return (ObjectSortedSet) short2FloatEntrySet();
		}
	...
	public static class SynchronizedSortedMap extends Short2FloatMaps.SynchronizedMap
			implements Short2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2FloatEntrySet(), sync);
			return (ObjectSortedSet<Short2FloatMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2FloatMaps.UnmodifiableMap
			implements Short2FloatSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2FloatSortedMap sortedMap;
		...
		public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2FloatEntrySet());
			return (ObjectSortedSet<Short2FloatMap.Entry>) entries;
		}
