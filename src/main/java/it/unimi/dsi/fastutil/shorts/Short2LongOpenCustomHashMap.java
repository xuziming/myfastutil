...
public class Short2LongOpenCustomHashMap extends AbstractShort2LongMap
	...
	public Short2LongOpenCustomHashMap(final int expected, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final Map<? extends Short, ? extends Long> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final Map<? extends Short, ? extends Long> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final Short2LongMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2LongOpenCustomHashMap(final Short2LongMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2LongOpenCustomHashMap(final short[] k, final long[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2LongOpenCustomHashMap(final short[] k, final long[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private void insert(final int pos, final short k, final long v) {
		if (pos == n)
	...
	public long addTo(final short k, final long incr) {
		...
		if ((strategy.equals((k), ((short) 0)))) {
			...
			final short[] key = this.key;
			// The starting point.
			if (!((curr = key[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode(k)))
					& mask]) == ((short) 0))) {
	...
	public long getOrDefault(final short k, final long defaultValue) {
		if ((strategy.equals((k), ((short) 0))))
	...
	/** {@inheritDoc} */
	@Override
	public long putIfAbsent(final short k, final long v) {
		final int pos = find(k);
		if (pos >= 0)
			return value[pos];
		insert(-pos - 1, k, v);
	...
	public boolean remove(final short k, final long v) {
		if ((strategy.equals((k), ((short) 0)))) {
	...
	/** {@inheritDoc} */
	@Override
	public boolean replace(final short k, final long oldValue, final long v) {
		final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public long replace(final short k, final long v) {
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final long oldValue = value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsent(final short k, final java.util.function.IntToLongFunction mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfAbsentNullable(final short k,
			final java.util.function.IntFunction<? extends Long> mappingFunction) {
		java.util.Objects.requireNonNull(mappingFunction);
		final int pos = find(k);
		if (pos >= 0)
			return value[pos];
	...
	/** {@inheritDoc} */
	@Override
	public long computeIfPresent(final short k,
			final java.util.function.BiFunction<? super Short, ? super Long, ? extends Long> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		if (pos < 0)
			return defRetValue;
		final Long newValue = remappingFunction.apply(Short.valueOf(k), Long.valueOf(value[pos]));
		if (newValue == null) {
			if ((strategy.equals((k), ((short) 0))))
				removeNullEntry();
			else
	...
	/** {@inheritDoc} */
	@Override
	public long compute(final short k,
			final java.util.function.BiFunction<? super Short, ? super Long, ? extends Long> remappingFunction) {
		java.util.Objects.requireNonNull(remappingFunction);
		final int pos = find(k);
		final Long newValue = remappingFunction.apply(Short.valueOf(k), pos >= 0 ? Long.valueOf(value[pos]) : null);
		if (newValue == null) {
			if (pos >= 0) {
				if ((strategy.equals((k), ((short) 0))))
					removeNullEntry();
	...
	/** {@inheritDoc} */
	@Override
	public long merge(final short k, final long v,
	...
	final class MapEntry implements Short2LongMap.Entry, Map.Entry<Short, Long> {
		...
		public boolean equals(final Object o) {
			...
			return (strategy.equals((key[index]), ((e.getKey()).shortValue())))
	...
	private class MapIterator {
		 ...
		 */
		boolean mustReturnNullKey = Short2LongOpenCustomHashMap.this.containsNullKey;
		/**
		...
		public int nextEntry() {
			...
			final short key[] = Short2LongOpenCustomHashMap.this.key;
			for (;;) {
				if (--pos < 0) {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2LongOpenCustomHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements FastEntrySet {
		@Override
		...
		public boolean contains(final Object o) {
			...
			if ((strategy.equals((k), ((short) 0))))
				return Short2LongOpenCustomHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2LongOpenCustomHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2LongMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2LongMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2LongMap.BasicEntry(key[pos], value[pos]));
		}

		/** {@inheritDoc} */
		@Override
		public void fastForEach(final Consumer<? super Short2LongMap.Entry> consumer) {
	...
	protected void rehash(final int newN) {
		...
		for (int j = realSize(); j-- != 0;) {
			while (((key[--i]) == ((short) 0)))
				;
			if (!((newKey[pos = (it.unimi.dsi.fastutil.HashCommon.mix(strategy.hashCode(key[i])))
					& mask]) == ((short) 0)))
