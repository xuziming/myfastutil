 ...
 * @see HashCommon
 */
public class Short2BooleanLinkedOpenHashMap extends AbstractShort2BooleanSortedMap
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2BooleanMap.Entry>
		...
		@Override
		public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry fromElement,
				Short2BooleanMap.Entry toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2BooleanLinkedOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2BooleanLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		...
		public void forEach(final Consumer<? super Short2BooleanMap.Entry> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractShort2BooleanMap.BasicEntry(key[curr], value[curr]));
			}
		}
