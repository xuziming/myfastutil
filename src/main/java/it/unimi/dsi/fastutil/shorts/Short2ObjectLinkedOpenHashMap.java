 ...
 * @see HashCommon
 */
public class Short2ObjectLinkedOpenHashMap<V> extends AbstractShort2ObjectSortedMap<V>
	...
	public Short2ObjectLinkedOpenHashMap(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 * @param expected the expected number of elements in the hash map.
	 */
	public Short2ObjectLinkedOpenHashMap(final int expected) {
	 ...
	 * @param f the load factor.
	 */
	public Short2ObjectLinkedOpenHashMap(final Map<? extends Short, ? extends V> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a {@link Map} to be copied into the new hash map.
	 */
	public Short2ObjectLinkedOpenHashMap(final Map<? extends Short, ? extends V> m) {
	 ...
	 * @param f the load factor.
	 */
	public Short2ObjectLinkedOpenHashMap(final Short2ObjectMap<V> m, final float f) {
		this(m.size(), f);
		putAll(m);
	}
	 ...
	 * @param m a type-specific map to be copied into the new hash map.
	 */
	public Short2ObjectLinkedOpenHashMap(final Short2ObjectMap<V> m) {
		this(m, DEFAULT_LOAD_FACTOR);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2ObjectLinkedOpenHashMap(final short[] k, final V[] v, final float f) {
		this(k.length, f);
	 ...
	 *                                  lengths.
	 */
	public Short2ObjectLinkedOpenHashMap(final short[] k, final V[] v) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (pos == n) {
				...
				short curr;
				final short[] key = Short2ObjectLinkedOpenHashMap.this.key;
	...
	private final class MapEntrySet extends AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>
		...
		@Override
		public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> fromElement,
				Short2ObjectMap.Entry<V> toElement) {
			throw new UnsupportedOperationException();
		}
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2ObjectLinkedOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
			short curr;
			final short[] key = Short2ObjectLinkedOpenHashMap.this.key;
			int pos;
			// The starting point.
		 ...
		 */
		@Override
		public ObjectListIterator<Short2ObjectMap.Entry<V>> iterator(final Short2ObjectMap.Entry<V> from) {
		 ...
		 */
		@Override
		public ObjectListIterator<Short2ObjectMap.Entry<V>> fastIterator(final Short2ObjectMap.Entry<V> from) {
		...
		public void forEach(final Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
			for (int i = size, curr, next = first; i-- != 0;) {
				curr = next;
				next = (int) link[curr];
				consumer.accept(new AbstractShort2ObjectMap.BasicEntry<V>(key[curr], value[curr]));
			}
		}
	...
	@Override
	public FastSortedEntrySet<V> short2ObjectEntrySet() {
		if (entries == null)
	...
	public Short2ObjectLinkedOpenHashMap<V> clone() {
		...
		try {
			c = (Short2ObjectLinkedOpenHashMap<V>) super.clone();
