...
public final class Short2BooleanSortedMaps {
	...
	public static Comparator<? super Map.Entry<Short, ?>> entryComparator(final ShortComparator comparator) {
		return (Comparator<Map.Entry<Short, ?>>) (x, y) -> comparator.compare((x.getKey()).shortValue(),
				(y.getKey()).shortValue());
	}
	...
	public static ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanSortedMap map) {
		...
		return entries instanceof Short2BooleanSortedMap.FastSortedEntrySet
				? ((Short2BooleanSortedMap.FastSortedEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 */
	public static class EmptySortedMap extends Short2BooleanMaps.EmptyMap
			implements Short2BooleanSortedMap, java.io.Serializable, Cloneable {
	 ...
	 * type-specific sorted map.
	 */
	public static class Singleton extends Short2BooleanMaps.Singleton
			implements Short2BooleanSortedMap, java.io.Serializable, Cloneable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2BooleanMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2BooleanMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() {
			return (ObjectSortedSet) short2BooleanEntrySet();
		}

		@Override
		public ShortSortedSet keySet() {
			if (keys == null)
				keys = ShortSortedSets.singleton(key, comparator);
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2BooleanSortedMap singleton(final Short key, Boolean value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2BooleanSortedMap singleton(final Short key, Boolean value, ShortComparator comparator) {
	...
	public static class SynchronizedSortedMap extends Short2BooleanMaps.SynchronizedMap
			implements Short2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2BooleanEntrySet(), sync);
			return (ObjectSortedSet<Short2BooleanMap.Entry>) entries;
		}
		...
		public ShortSortedSet keySet() {
			if (keys == null)
				keys = ShortSortedSets.synchronize(sortedMap.keySet(), sync);
			return (ShortSortedSet) keys;
		}
	 ...
	 */
	public static Short2BooleanSortedMap synchronize(final Short2BooleanSortedMap m) {
	 ...
	 * @see java.util.Collections#synchronizedSortedMap(SortedMap)
	 */
	public static Short2BooleanSortedMap synchronize(final Short2BooleanSortedMap m, final Object sync) {
		return new SynchronizedSortedMap(m, sync);
	}

	/** An unmodifiable wrapper class for sorted maps. */
	public static class UnmodifiableSortedMap extends Short2BooleanMaps.UnmodifiableMap
			implements Short2BooleanSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		protected final Short2BooleanSortedMap sortedMap;
		...
		public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2BooleanEntrySet());
			return (ObjectSortedSet<Short2BooleanMap.Entry>) entries;
		}
		...
		public ShortSortedSet keySet() {
			if (keys == null)
				keys = ShortSortedSets.unmodifiable(sortedMap.keySet());
			return (ShortSortedSet) keys;
		}
	 ...
	 */
	public static Short2BooleanSortedMap unmodifiable(final Short2BooleanSortedMap m) {
