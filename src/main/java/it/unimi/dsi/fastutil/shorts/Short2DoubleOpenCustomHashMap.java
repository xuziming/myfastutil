...
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap
	...
	public Short2DoubleOpenCustomHashMap(final int expected, final float f,
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final int expected,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final Map<? extends Short, ? extends Double> m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final Map<? extends Short, ? extends Double> m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final Short2DoubleMap m, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m.size(), f, strategy);
		putAll(m);
	}
	 ...
	 * @param strategy the strategy.
	 */
	public Short2DoubleOpenCustomHashMap(final Short2DoubleMap m,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
		this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 *                                  lengths.
	 */
	public Short2DoubleOpenCustomHashMap(final short[] k, final double[] v, final float f,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 *                                  lengths.
	 */
	public Short2DoubleOpenCustomHashMap(final short[] k, final double[] v,
			final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2DoubleOpenCustomHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements FastEntrySet {
		@Override
		...
		public void forEach(final Consumer<? super Short2DoubleMap.Entry> consumer) {
			if (containsNullKey)
				consumer.accept(new AbstractShort2DoubleMap.BasicEntry(key[n], value[n]));
			for (int pos = n; pos-- != 0;)
				if (!((key[pos]) == ((short) 0)))
					consumer.accept(new AbstractShort2DoubleMap.BasicEntry(key[pos], value[pos]));
		}
