...
public final class Short2BooleanMaps {
	...
	public static ObjectIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanMap map) {
		...
		return entries instanceof Short2BooleanMap.FastEntrySet
				? ((Short2BooleanMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Short2BooleanMap map, final Consumer<? super Short2BooleanMap.Entry> consumer) {
		final ObjectSet<Short2BooleanMap.Entry> entries = map.short2BooleanEntrySet();
	...
	public static class EmptyMap extends Short2BooleanFunctions.EmptyFunction
			implements Short2BooleanMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2BooleanFunctions.Singleton
		...
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2BooleanMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2BooleanFunctions.SynchronizedFunction
		...
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2BooleanEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Boolean> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> function) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsent(final short key, final java.util.function.IntPredicate mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean computeIfAbsentNullable(final short key,
		...
		@Override
		public boolean computeIfPresent(final short key,
		...
		@Override
		public boolean compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Boolean, ? extends Boolean> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public boolean merge(final short key, final boolean value,
		...
		@Deprecated
		@Override
		public Boolean computeIfAbsent(final Short key,
	...
	public static class UnmodifiableMap extends Short2BooleanFunctions.UnmodifiableFunction
		...
		public ObjectSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2BooleanEntrySet());
			return entries;
		}
