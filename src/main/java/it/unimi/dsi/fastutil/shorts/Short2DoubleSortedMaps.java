...
public final class Short2DoubleSortedMaps {
	...
	public static class EmptySortedMap extends Short2DoubleMaps.EmptyMap
			implements Short2DoubleSortedMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2DoubleMaps.Singleton
		...
		protected Singleton(final short key, final double value, ShortComparator comparator) {
			super(key, value);
		...
		public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.singleton(new AbstractShort2DoubleMap.BasicEntry(key, value),
						entryComparator(comparator));
			return (ObjectSortedSet<Short2DoubleMap.Entry>) entries;
		}
		...
		public ObjectSortedSet<Map.Entry<Short, Double>> entrySet() {
			return (ObjectSortedSet) short2DoubleEntrySet();
		}
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2DoubleSortedMap singleton(final Short key, Double value) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2DoubleSortedMap singleton(final Short key, Double value, ShortComparator comparator) {
	 ...
	 *         {@code &lt;key,value&gt;}.
	 */
	public static Short2DoubleSortedMap singleton(final short key, final double value, ShortComparator comparator) {
		return new Singleton(key, value, comparator);
	}

	/** A synchronized wrapper class for sorted maps. */
	public static class SynchronizedSortedMap extends Short2DoubleMaps.SynchronizedMap
			implements Short2DoubleSortedMap, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.synchronize(sortedMap.short2DoubleEntrySet(), sync);
			return (ObjectSortedSet<Short2DoubleMap.Entry>) entries;
		}
	...
	public static class UnmodifiableSortedMap extends Short2DoubleMaps.UnmodifiableMap
		...
		public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
			if (entries == null)
				entries = ObjectSortedSets.unmodifiable(sortedMap.short2DoubleEntrySet());
			return (ObjectSortedSet<Short2DoubleMap.Entry>) entries;
		}
