 ...
 * @see HashCommon
 */
public class Short2LongOpenHashMap extends AbstractShort2LongMap implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Short2LongMap.Entry, Map.Entry<Short, Long> {
		...
		public boolean equals(final Object o) {
			...
			return ((key[index]) == ((e.getKey()).shortValue())) && ((value[index]) == ((e.getValue()).longValue()));
		}
	...
	private class MapIterator {
		...
		public void remove() {
			...
			if (last == n) {
				...
				Short2LongOpenHashMap.this.remove(wrapped.getShort(-pos - 1));
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements FastEntrySet {
		...
		public boolean contains(final Object o) {
			...
			if (((k) == ((short) 0)))
				return Short2LongOpenHashMap.this.containsNullKey && ((value[n]) == (v));
			short curr;
			final short[] key = Short2LongOpenHashMap.this.key;
			int pos;
			// The starting point.
