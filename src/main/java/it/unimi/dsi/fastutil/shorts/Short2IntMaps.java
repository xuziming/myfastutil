...
public final class Short2IntMaps {
	...
	public static ObjectIterator<Short2IntMap.Entry> fastIterator(Short2IntMap map) {
		...
		return entries instanceof Short2IntMap.FastEntrySet ? ((Short2IntMap.FastEntrySet) entries).fastIterator()
				: entries.iterator();
	}
	...
	public static void fastForEach(Short2IntMap map, final Consumer<? super Short2IntMap.Entry> consumer) {
		final ObjectSet<Short2IntMap.Entry> entries = map.short2IntEntrySet();
	...
	public static class EmptyMap extends Short2IntFunctions.EmptyFunction
			implements Short2IntMap, java.io.Serializable, Cloneable {
	...
	public static class Singleton extends Short2IntFunctions.Singleton
		...
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2IntMap.BasicEntry(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap extends Short2IntFunctions.SynchronizedFunction
		...
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2IntEntrySet(), sync);
				return entries;
			}
		}
		...
		@Override
		public void forEach(final java.util.function.BiConsumer<? super Short, ? super Integer> action) {
			synchronized (sync) {
				map.forEach(action);
			}
		}
		...
		public void replaceAll(
				final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> function) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsent(final short key, final java.util.function.IntUnaryOperator mappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int computeIfAbsentNullable(final short key,
		...
		@Override
		public int computeIfPresent(final short key,
				final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int compute(final short key,
				final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
		...
		@Override
		public int merge(final short key, final int value,
		...
		@Deprecated
		@Override
		public Integer computeIfAbsent(final Short key,
				final java.util.function.Function<? super Short, ? extends Integer> mappingFunction) {
			synchronized (sync) {
				return map.computeIfAbsent(key, mappingFunction);
			}
		}
		...
		@Deprecated
		@Override
		public Integer computeIfPresent(final Short key,
				final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.computeIfPresent(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer compute(final Short key,
				final java.util.function.BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.compute(key, remappingFunction);
			}
		...
		@Deprecated
		@Override
		public Integer merge(final Short key, final Integer value,
				final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
			synchronized (sync) {
				return map.merge(key, value, remappingFunction);
			}
	...
	public static class UnmodifiableMap extends Short2IntFunctions.UnmodifiableFunction
		...
		public ObjectSet<Short2IntMap.Entry> short2IntEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2IntEntrySet());
			return entries;
		}
