 ...
 */
public class Short2ShortArrayMap extends AbstractShort2ShortMap implements java.io.Serializable, Cloneable {
	...
	private final class EntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements FastEntrySet {
		@Override
		public ObjectIterator<Short2ShortMap.Entry> iterator() {
			return new ObjectIterator<Short2ShortMap.Entry>() {
				...
				public Entry next() {
					...
					return new AbstractShort2ShortMap.BasicEntry(key[curr = next], value[next++]);
				}
		...
		public boolean contains(Object o) {
			...
			return Short2ShortArrayMap.this.containsKey(k)
					&& ((Short2ShortArrayMap.this.get(k)) == (((Short) (e.getValue())).shortValue()));
		}
