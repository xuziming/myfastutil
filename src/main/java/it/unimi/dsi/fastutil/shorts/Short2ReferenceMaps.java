...
public final class Short2ReferenceMaps {
	...
	public static <V> ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator(Short2ReferenceMap<V> map) {
		...
		return entries instanceof Short2ReferenceMap.FastEntrySet
				? ((Short2ReferenceMap.FastEntrySet<V>) entries).fastIterator()
				: entries.iterator();
	}
	 ...
	 * @since 8.1.0
	 */
	public static <V> void fastForEach(Short2ReferenceMap<V> map,
			final Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
		final ObjectSet<Short2ReferenceMap.Entry<V>> entries = map.short2ReferenceEntrySet();
	...
	public static class EmptyMap<V> extends Short2ReferenceFunctions.EmptyFunction<V>
			implements Short2ReferenceMap<V>, java.io.Serializable, Cloneable {
	...
	public static class Singleton<V> extends Short2ReferenceFunctions.Singleton<V>
		...
		public ObjectSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.singleton(new AbstractShort2ReferenceMap.BasicEntry<>(key, value));
			return entries;
		}
	...
	public static class SynchronizedMap<V> extends Short2ReferenceFunctions.SynchronizedFunction<V>
			implements Short2ReferenceMap<V>, java.io.Serializable {
		private static final long serialVersionUID = -7046029254386353129L;
		...
		public ObjectSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			synchronized (sync) {
				if (entries == null)
					entries = ObjectSets.synchronize(map.short2ReferenceEntrySet(), sync);
				return entries;
			}
		}
	...
	public static class UnmodifiableMap<V> extends Short2ReferenceFunctions.UnmodifiableFunction<V>
		...
		public ObjectSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
			if (entries == null)
				entries = ObjectSets.unmodifiable(map.short2ReferenceEntrySet());
			return entries;
		}
