 ...
 *
 * <p>
 * This class will automatically enlarge the backing array, doubling its size
 * whenever new space is needed. The {@link #reset()} method will mark the
 * content as empty, but will not decrease the capacity: use {@link #trim()} for
 * that purpose.
 *
...
public class FastByteArrayOutputStream extends MeasurableOutputStream implements RepositionableStream {
	 ...
	 * {@link #DEFAULT_INITIAL_CAPACITY} bytes.
	 */
