 ...
 * {@link #read(byte[], int, int)} as described in {@link java.io.InputStream}.
...
public class FastByteArrayInputStream extends MeasurableInputStream implements RepositionableStream {
	 ...
	 * {@link java.io.InputStream#read(byte[], int, int)}. Note that the
	 * implementation given in
	 * {@link java.io.ByteArrayInputStream#read(byte[], int, int)} will return -1 on
	 * a zero-length read at EOF, contrarily to the specification. We won't.
	 */
