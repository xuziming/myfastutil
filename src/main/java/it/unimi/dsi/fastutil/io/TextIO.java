 ...
 *
 * <p>
 * This class fills a gap in the Java API: a natural operation on sequences of
 * primitive elements is to load or store them in textual form. This format
 * makes files humanly readable.
 *
 * <p>
 * For each primitive type, this class provides methods that read elements from
 * a {@link BufferedReader} or from a filename (which will be opened using a
 ...
 * returned by an iterator to a {@link PrintStream} or to a given filename.
 *
 * <p>
 ...
 * {@linkplain BinIO#loadInts(CharSequence) load from a file without providing
 * an array}. You can easily work around the problem as follows:
 * 
 * <pre>
...
public class TextIO {
	 ...
	 */
	/**
	 * Loads elements from a given fast buffered reader, storing them in a given
	 * array fragment.
	 *
	 ...
	 * @return the number of elements actually read from {@code reader} (it might be
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadInts(final BufferedReader reader, final int[] array, final int offset, final int length)
			throws IOException {
	 ...
	 * @param array  an array which will be filled with data from {@code reader}.
	 * @return the number of elements actually read from {@code reader} (it might be
	 *         less than the array length if {@code reader} ends).
	 */
	...
	/**
	 * Loads elements from a file given by a filename, storing them in a given
	 * array.
	 *
	 * @param filename a filename.
	 * @param array    an array which will be filled with data from the specified
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadInts(final BufferedReader reader, final int[][] array, final long offset, final long length)
			throws IOException {
	...
	public static long loadInts(final BufferedReader reader, final int[][] array) throws IOException {
		return loadInts(reader, array, 0, length(array));
	}
	...
	public static long loadInts(final File file, final int[][] array) throws IOException {
		return loadInts(file, array, 0, length(array));
	}
	...
	public static long loadInts(final CharSequence filename, final int[][] array) throws IOException {
		return loadInts(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeInts(final int array[][], final PrintStream stream) {
		storeInts(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeInts(final int array[][], final File file) throws IOException {
		storeInts(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeInts(final int array[][], final CharSequence filename) throws IOException {
		storeInts(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadLongs(final BufferedReader reader, final long[] array, final int offset, final int length)
			throws IOException {
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadLongs(final BufferedReader reader, final long[][] array, final long offset,
	...
	public static long loadLongs(final BufferedReader reader, final long[][] array) throws IOException {
		return loadLongs(reader, array, 0, length(array));
	}
	...
	public static long loadLongs(final File file, final long[][] array) throws IOException {
		return loadLongs(file, array, 0, length(array));
	}
	...
	public static long loadLongs(final CharSequence filename, final long[][] array) throws IOException {
		return loadLongs(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeLongs(final long array[][], final PrintStream stream) {
		storeLongs(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeLongs(final long array[][], final File file) throws IOException {
		storeLongs(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeLongs(final long array[][], final CharSequence filename) throws IOException {
		storeLongs(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadDoubles(final BufferedReader reader, final double[] array, final int offset, final int length)
			throws IOException {
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadDoubles(final BufferedReader reader, final double[][] array, final long offset,
			final long length) throws IOException {
		ensureOffsetLength(array, offset, length);
		long c = 0;
		String s;
	...
	public static long loadDoubles(final BufferedReader reader, final double[][] array) throws IOException {
		return loadDoubles(reader, array, 0, length(array));
	}
	...
	public static long loadDoubles(final File file, final double[][] array) throws IOException {
		return loadDoubles(file, array, 0, length(array));
	}
	...
	public static long loadDoubles(final CharSequence filename, final double[][] array) throws IOException {
		return loadDoubles(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeDoubles(final double array[][], final PrintStream stream) {
		storeDoubles(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeDoubles(final double array[][], final File file) throws IOException {
		storeDoubles(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeDoubles(final double array[][], final CharSequence filename) throws IOException {
		storeDoubles(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadBooleans(final BufferedReader reader, final boolean[] array, final int offset,
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadBooleans(final BufferedReader reader, final boolean[][] array, final long offset,
			final long length) throws IOException {
		ensureOffsetLength(array, offset, length);
		long c = 0;
		String s;
	...
	public static long loadBooleans(final BufferedReader reader, final boolean[][] array) throws IOException {
		return loadBooleans(reader, array, 0, length(array));
	}
	...
	public static long loadBooleans(final File file, final boolean[][] array) throws IOException {
		return loadBooleans(file, array, 0, length(array));
	}
	...
	public static long loadBooleans(final CharSequence filename, final boolean[][] array) throws IOException {
		return loadBooleans(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeBooleans(final boolean array[][], final PrintStream stream) {
		storeBooleans(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeBooleans(final boolean array[][], final File file) throws IOException {
		storeBooleans(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeBooleans(final boolean array[][], final CharSequence filename) throws IOException {
		storeBooleans(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadBytes(final BufferedReader reader, final byte[] array, final int offset, final int length)
			throws IOException {
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadBytes(final BufferedReader reader, final byte[][] array, final long offset,
			final long length) throws IOException {
		ensureOffsetLength(array, offset, length);
		long c = 0;
		String s;
	...
	public static long loadBytes(final BufferedReader reader, final byte[][] array) throws IOException {
		return loadBytes(reader, array, 0, length(array));
	}
	...
	public static long loadBytes(final File file, final byte[][] array) throws IOException {
		return loadBytes(file, array, 0, length(array));
	}
	...
	public static long loadBytes(final CharSequence filename, final byte[][] array) throws IOException {
		return loadBytes(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeBytes(final byte array[][], final PrintStream stream) {
		storeBytes(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeBytes(final byte array[][], final File file) throws IOException {
		storeBytes(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeBytes(final byte array[][], final CharSequence filename) throws IOException {
		storeBytes(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadShorts(final BufferedReader reader, final short[] array, final int offset, final int length)
			throws IOException {
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadShorts(final BufferedReader reader, final short[][] array, final long offset,
			final long length) throws IOException {
		ensureOffsetLength(array, offset, length);
		long c = 0;
		String s;
	...
	public static long loadShorts(final BufferedReader reader, final short[][] array) throws IOException {
		return loadShorts(reader, array, 0, length(array));
	}
	...
	public static long loadShorts(final File file, final short[][] array) throws IOException {
		return loadShorts(file, array, 0, length(array));
	}
	...
	public static long loadShorts(final CharSequence filename, final short[][] array) throws IOException {
		return loadShorts(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeShorts(final short array[][], final PrintStream stream) {
		storeShorts(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeShorts(final short array[][], final File file) throws IOException {
		storeShorts(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeShorts(final short array[][], final CharSequence filename) throws IOException {
		storeShorts(array, 0, length(array), filename);
	}
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static int loadFloats(final BufferedReader reader, final float[] array, final int offset, final int length)
			throws IOException {
	 ...
	 *         less than {@code length} if {@code reader} ends).
	 */
	public static long loadFloats(final BufferedReader reader, final float[][] array, final long offset,
			final long length) throws IOException {
		ensureOffsetLength(array, offset, length);
		long c = 0;
		String s;
	...
	public static long loadFloats(final BufferedReader reader, final float[][] array) throws IOException {
		return loadFloats(reader, array, 0, length(array));
	}
	...
	public static long loadFloats(final File file, final float[][] array) throws IOException {
		return loadFloats(file, array, 0, length(array));
	}
	...
	public static long loadFloats(final CharSequence filename, final float[][] array) throws IOException {
		return loadFloats(filename, array, 0, length(array));
	}
	 ...
	 */
	public static void storeFloats(final float array[][], final PrintStream stream) {
		storeFloats(array, 0, length(array), stream);
	}
	 ...
	 */
	public static void storeFloats(final float array[][], final File file) throws IOException {
		storeFloats(array, 0, length(array), file);
	}
	 ...
	 */
	public static void storeFloats(final float array[][], final CharSequence filename) throws IOException {
		storeFloats(array, 0, length(array), filename);
	}
